...
const MCPAgentServerMenu_js_1 = require("./MCPAgentServerMenu.js");
const MCPListPanel_js_1 = require("./MCPListPanel.js");
const MCPRemoteServerMenu_js_1 = require("./MCPRemoteServerMenu.js");
const MCPStdioServerMenu_js_1 = require("./MCPStdioServerMenu.js");
const MCPToolDetailView_js_1 = require("./MCPToolDetailView.js");
const MCPToolListView_js_1 = require("./MCPToolListView.js");
function MCPSettings(t0) {
    const $ = (0, compiler_runtime_1.c)(66);
    const { onComplete } = t0;
    const mcp = (0, AppState_js_1.useAppState)(_temp);
    const agentDefinitions = (0, AppState_js_1.useAppState)(_temp2);
    ...
    const [viewState, setViewState] = react_1.default.useState(t1);
    let t2;
    ...
    const [servers, setServers] = react_1.default.useState(t2);
    let t3;
        ...
        t5 = () => {
            ...
            const prepareServers = async function prepareServers() {
                const serverInfos = await Promise.all(filteredClients.map(async (client_0) => {
                    ...
                    if (isSSE || isHTTP) {
                        const authProvider = new auth_js_1.ClaudeAuthProvider(client_0.name, client_0.config);
                        const tokens = await authProvider.tokens();
                        const hasSessionAuth = (0, sessionIngressAuth_js_1.getSessionIngressAuthToken)() !== null && client_0.type === "connected";
                        const hasToolsAndConnected = client_0.type === "connected" && (0, utils_js_1.filterToolsByServer)(mcp.tools, client_0.name).length > 0;
        ...
        case "list":
            {
                ...
                if ($[18] !== agentMcpServers || $[19] !== onComplete || $[20] !== servers || $[21] !== viewState.defaultTab) {
                    t11 = react_1.default.createElement(MCPListPanel_js_1.MCPListPanel, { servers: servers, agentServers: agentMcpServers, onSelectServer: t9, onSelectAgentServer: t10, onComplete: onComplete, defaultTab: viewState.defaultTab });
                    $[18] = agentMcpServers;
                    $[19] = onComplete;
                    $[20] = servers;
        ...
        case "server-menu":
            {
                ...
                if (viewState.server.transport === "stdio") {
                    ...
                    if ($[30] !== onComplete || $[31] !== serverTools_0.length || $[32] !== t10 || $[33] !== t11 || $[34] !== viewState.server) {
                        t12 = react_1.default.createElement(MCPStdioServerMenu_js_1.MCPStdioServerMenu, { server: viewState.server, serverToolsCount: serverTools_0.length, onViewTools: t10, onCancel: t11, onComplete: onComplete });
                        $[30] = onComplete;
                    ...
                    if ($[40] !== onComplete || $[41] !== serverTools_0.length || $[42] !== t10 || $[43] !== t11 || $[44] !== viewState.server) {
                        t12 = react_1.default.createElement(MCPRemoteServerMenu_js_1.MCPRemoteServerMenu, { server: viewState.server, serverToolsCount: serverTools_0.length, onViewTools: t10, onCancel: t11, onComplete: onComplete });
                        $[40] = onComplete;
        ...
        case "server-tools":
            {
                ...
                if ($[49] !== t10 || $[50] !== t9 || $[51] !== viewState.server) {
                    t11 = react_1.default.createElement(MCPToolListView_js_1.MCPToolListView, { server: viewState.server, onSelectTool: t9, onBack: t10 });
                    $[49] = t10;
                    $[50] = t9;
                    $[51] = viewState.server;
                    $[52] = t11;
        ...
        case "server-tool-detail":
            {
                ...
                if ($[58] !== t10 || $[59] !== tool || $[60] !== viewState.server) {
                    t11 = react_1.default.createElement(MCPToolDetailView_js_1.MCPToolDetailView, { tool: tool, server: viewState.server, onBack: t10 });
                    $[58] = t10;
                    $[59] = tool;
                    $[60] = viewState.server;
                    $[61] = t11;
        ...
        case "agent-server-menu":
            {
                ...
                if ($[63] !== onComplete || $[64] !== viewState.agentServer) {
                    t10 = react_1.default.createElement(MCPAgentServerMenu_js_1.MCPAgentServerMenu, { agentServer: viewState.agentServer, onCancel: t9, onComplete: onComplete });
                    $[63] = onComplete;
