...
function DiffDetailView(t0) {
    const $ = (0, compiler_runtime_1.c)(53);
    ...
    bb0: {
        ...
        let t2;
        if ($[1] !== filePath) {
            const fullPath = (0, path_1.resolve)((0, cwd_js_1.getCwd)(), filePath);
    ...
    if (isUntracked) {
        let t2;
        if ($[7] !== filePath) {
            t2 = react_1.default.createElement(ink_js_1.Text, { bold: true }, filePath);
            $[7] = filePath;
            $[8] = t2;
        }
        else {
        ...
        if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " (untracked)");
            $[9] = t3;
        }
        else {
            t3 = $[9];
        ...
        let t4;
        if ($[10] !== t2) {
            t4 = react_1.default.createElement(ink_js_1.Box, null,
                t2,
                t3);
            $[10] = t2;
            $[11] = t4;
        ...
        if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = react_1.default.createElement(Divider_js_1.Divider, { padding: 4 });
            $[12] = t5;
        }
        else {
            t5 = $[12];
        ...
        if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
            t6 = react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "New file not yet staged.");
            $[13] = t6;
        }
        else {
            t6 = $[13];
        ...
        let t7;
        if ($[14] !== filePath) {
            t7 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                t6,
        ...
        let t8;
        if ($[16] !== t4 || $[17] !== t7) {
            t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", width: "100%" },
                t4,
                t5,
                t7);
            $[16] = t4;
    ...
    if (isBinary) {
        let t2;
        if ($[19] !== filePath) {
            t2 = react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(ink_js_1.Text, { bold: true }, filePath));
            $[19] = filePath;
            $[20] = t2;
        }
        else {
        ...
        if ($[21] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = react_1.default.createElement(Divider_js_1.Divider, { padding: 4 });
            $[21] = t3;
        }
        else {
            t3 = $[21];
        ...
        if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Binary file - cannot display diff"));
            $[22] = t4;
        }
        else {
            t4 = $[22];
        ...
        let t5;
        if ($[23] !== t2) {
            t5 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", width: "100%" },
                t2,
                t3,
                t4);
            $[23] = t2;
    ...
    if (isLargeFile) {
        ...
        if ($[28] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Large file - diff exceeds 1 MB limit"));
            $[28] = t4;
        }
        else {
            t4 = $[28];
    ...
    let t3;
    if ($[33] !== isTruncated) {
        t3 = isTruncated && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " (truncated)");
        $[33] = isTruncated;
        $[34] = t3;
    }
    else {
    ...
    if ($[39] !== columns || $[40] !== fileContent || $[41] !== filePath || $[42] !== firstLine || $[43] !== hunks) {
        t6 = hunks.length === 0 ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "No diff content") : hunks.map((hunk, index) => react_1.default.createElement(StructuredDiff_js_1.StructuredDiff, { key: index, patch: hunk, filePath: filePath, firstLine: firstLine, fileContent: fileContent, dim: false, width: columns - 2 - 2 }));
        $[39] = columns;
        $[40] = fileContent;
        $[41] = filePath;
        $[42] = firstLine;
    ...
    let t7;
    if ($[45] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" }, t6);
        $[45] = t6;
        $[46] = t7;
    }
    else {
    ...
    let t8;
    if ($[47] !== isTruncated) {
        t8 = isTruncated && react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "\u2026 diff truncated (exceeded 400 line limit)");
        $[47] = isTruncated;
        $[48] = t8;
    }
    else {
    ...
    if ($[49] !== t4 || $[50] !== t7 || $[51] !== t8) {
        t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", width: "100%" },
            t4,
            t5,
            t7,
            t8);
