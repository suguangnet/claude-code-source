...
const sandbox_ui_utils_js_1 = require("src/utils/sandbox/sandbox-ui-utils.js");
...
const OutputLine_js_1 = require("../../components/shell/OutputLine.js");
const ShellTimeDisplay_js_1 = require("../../components/shell/ShellTimeDisplay.js");
...
function extractSandboxViolations(stderr) {
    ...
    const cleanedStderr = (0, sandbox_ui_utils_js_1.removeSandboxViolationTags)(stderr).trim();
    return {
        cleanedStderr
    };
}
...
function BashToolResultMessage(t0) {
        ...
        bb0: {
            ...
            if (isImage) {
                ...
                if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
                    t8 = react_1.default.createElement(MessageResponse_js_1.MessageResponse, { height: 1 },
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "[Image data detected and sent to Claude]"));
                    $[11] = t8;
                }
                else {
                    t8 = $[11];
            ...
            if ($[12] !== stdout || $[13] !== verbose) {
                t5 = stdout !== "" ? react_1.default.createElement(OutputLine_js_1.OutputLine, { content: stdout, verbose: verbose }) : null;
                $[12] = stdout;
                $[13] = verbose;
                $[14] = t5;
            }
            ...
            t6 = stderr.trim() !== "" ? react_1.default.createElement(OutputLine_js_1.OutputLine, { content: stderr, verbose: verbose, isError: true }) : null;
        }
        $[0] = isImage;
    ...
    if ($[15] !== cwdResetWarning) {
        t8 = cwdResetWarning ? react_1.default.createElement(MessageResponse_js_1.MessageResponse, null,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, cwdResetWarning)) : null;
        $[15] = cwdResetWarning;
        $[16] = t8;
    }
    else {
    ...
    if ($[17] !== backgroundTaskId || $[18] !== cwdResetWarning || $[19] !== noOutputExpected || $[20] !== returnCodeInterpretation || $[21] !== stderr || $[22] !== stdout) {
        t9 = stdout === "" && stderr.trim() === "" && !cwdResetWarning ? react_1.default.createElement(MessageResponse_js_1.MessageResponse, { height: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, backgroundTaskId ? react_1.default.createElement(react_1.default.Fragment, null,
                "Running in the background",
                " ",
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\u2193", action: "manage", parens: true })) : returnCodeInterpretation || (noOutputExpected ? "Done" : "(No output)"))) : null;
        $[17] = backgroundTaskId;
        $[18] = cwdResetWarning;
        $[19] = noOutputExpected;
    ...
    let t10;
    if ($[24] !== timeoutMs) {
        t10 = timeoutMs && react_1.default.createElement(MessageResponse_js_1.MessageResponse, null,
            react_1.default.createElement(ShellTimeDisplay_js_1.ShellTimeDisplay, { timeoutMs: timeoutMs }));
        $[24] = timeoutMs;
        $[25] = t10;
    }
    else {
    ...
    if ($[26] !== T0 || $[27] !== t10 || $[28] !== t4 || $[29] !== t5 || $[30] !== t6 || $[31] !== t8 || $[32] !== t9) {
        t11 = react_1.default.createElement(T0, { flexDirection: t4 },
            t5,
            t6,
            t8,
            t9,
