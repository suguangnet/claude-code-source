...
function UserCommandMessage(t0) {
    ...
    const args = t3;
    const isSkillFormat = (0, messages_js_1.extractTag)(text, "skill-format") === "true";
    if (!commandMessage) {
        return null;
    }
    if (isSkillFormat) {
        ...
        if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = React.createElement(ink_js_1.Text, { color: "subtle" },
        ...
        if ($[5] !== commandMessage) {
            t6 = React.createElement(ink_js_1.Text, null,
                t5,
                React.createElement(ink_js_1.Text, { color: "text" },
                    "Skill(",
                    commandMessage,
                    ")"));
            $[5] = commandMessage;
        ...
        let t7;
        if ($[7] !== t4 || $[8] !== t6) {
            t7 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: t4, backgroundColor: "userMessageBackground", paddingRight: 1 }, t6);
            $[7] = t4;
            $[8] = t6;
            $[9] = t7;
        }
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(ink_js_1.Text, { color: "subtle" },
            figures_1.default.pointer,
            " ");
        $[13] = t6;
    }
    ...
    if ($[14] !== content) {
        t7 = React.createElement(ink_js_1.Text, null,
            t6,
            React.createElement(ink_js_1.Text, { color: "text" }, content));
        $[14] = content;
        $[15] = t7;
    }
    else {
    ...
    let t8;
    if ($[16] !== t5 || $[17] !== t7) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: t5, backgroundColor: "userMessageBackground", paddingRight: 1 }, t7);
        $[16] = t5;
        $[17] = t7;
        $[18] = t8;
    }
