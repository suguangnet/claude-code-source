...
function UltrareviewOverageDialog(t0) {
    ...
    const [isLaunching, setIsLaunching] = (0, react_1.useState)(false);
    let t1;
    ...
    const abortControllerRef = (0, react_1.useRef)(t1);
    let t2;
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, null, "Your free ultrareviews for this organization are used. Further reviews bill as Extra Usage (pay-per-use).");
        $[7] = t5;
    }
    else {
        t5 = $[7];
    ...
    if ($[8] !== handleCancel || $[9] !== handleSelect || $[10] !== isLaunching) {
        t6 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t5,
            isLaunching ? react_1.default.createElement(ink_js_1.Text, { color: "background" }, "Launching\u2026") : react_1.default.createElement(select_js_1.Select, { options: options, onChange: handleSelect, onCancel: handleCancel }));
        $[8] = handleCancel;
        $[9] = handleSelect;
        $[10] = isLaunching;
        $[11] = t6;
    ...
    if ($[12] !== handleCancel || $[13] !== t6) {
        t7 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Ultrareview billing", onCancel: handleCancel, color: "background" }, t6);
        $[12] = handleCancel;
        $[13] = t6;
        $[14] = t7;
    }
