...
const getOauthProfile_js_1 = require("src/services/oauth/getOauthProfile.js");
const auth_js_1 = require("src/utils/auth.js");
const ink_js_1 = require("../../ink.js");
const index_js_1 = require("../../services/analytics/index.js");
const config_js_1 = require("../../utils/config.js");
const useStartupNotification_js_1 = require("./useStartupNotification.js");
...
async function _temp2() {
    if (((0, config_js_1.getGlobalConfig)().subscriptionNoticeCount ?? 0) >= MAX_SHOW_COUNT) {
        return null;
    }
    ...
    return {
        ...
        jsx: React.createElement(ink_js_1.Text, { color: "suggestion" },
            "Use your existing Claude ",
            subscriptionType,
            " plan with Claude Code",
            React.createElement(ink_js_1.Text, { color: "text", dimColor: true },
                " ",
                "\u00B7 /login to activate")),
        priority: "low"
    };
...
async function getExistingClaudeSubscription() {
    ...
    const profile = await (0, getOauthProfile_js_1.getOauthProfileFromApiKey)();
    if (!profile) {
        return null;
    }
