...
function useRateLimitWarningNotification(model) {
    ...
    const shownWarningRef = (0, react_1.useRef)(null);
    let t2;
    ...
    const [hasShownOverageNotification, setHasShownOverageNotification] = (0, react_1.useState)(false);
    let t4;
    let t5;
        ...
        t6 = () => {
            ...
            if (rateLimitWarning && rateLimitWarning !== shownWarningRef.current) {
                ...
                addNotification({
                    ...
                    jsx: React.createElement(ink_js_1.Text, null,
                        React.createElement(ink_js_1.Text, { color: "warning" }, rateLimitWarning)),
                    priority: "high"
                });
            }
        };
