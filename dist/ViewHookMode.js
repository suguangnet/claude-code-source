...
const hooksSettings_js_1 = require("../../utils/hooks/hooksSettings.js");
...
function ViewHookMode(t0) {
    ...
    if ($[0] !== selectedHook.event) {
        t1 = React.createElement(ink_js_1.Text, null,
            "Event: ",
            React.createElement(ink_js_1.Text, { bold: true }, selectedHook.event));
    ...
    if ($[2] !== eventSupportsMatcher || $[3] !== selectedHook.matcher) {
        t2 = eventSupportsMatcher && React.createElement(ink_js_1.Text, null,
            "Matcher: ",
            React.createElement(ink_js_1.Text, { bold: true }, selectedHook.matcher || "(all)"));
    ...
    if ($[5] !== selectedHook.config.type) {
        t3 = React.createElement(ink_js_1.Text, null,
            "Type: ",
            React.createElement(ink_js_1.Text, { bold: true }, selectedHook.config.type));
    ...
    if ($[9] !== t4) {
        t5 = React.createElement(ink_js_1.Text, null,
            "Source:",
            " ",
            React.createElement(ink_js_1.Text, { dimColor: true }, t4));
        $[9] = t4;
        $[10] = t5;
    }
    else {
    ...
    if ($[11] !== selectedHook.pluginName) {
        t6 = selectedHook.pluginName && React.createElement(ink_js_1.Text, null,
            "Plugin: ",
            React.createElement(ink_js_1.Text, { dimColor: true }, selectedHook.pluginName));
    ...
    if ($[13] !== t1 || $[14] !== t2 || $[15] !== t3 || $[16] !== t5 || $[17] !== t6) {
        t7 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t1,
            t2,
            t3,
            t5,
    ...
    let t11;
    if ($[25] !== t10) {
        t11 = React.createElement(ink_js_1.Box, { borderStyle: "round", borderDimColor: true, paddingLeft: 1, paddingRight: 1 },
            React.createElement(ink_js_1.Text, null, t10));
        $[25] = t10;
        $[26] = t11;
    }
    else {
    ...
    if ($[30] !== selectedHook.config) {
        t13 = "statusMessage" in selectedHook.config && selectedHook.config.statusMessage && React.createElement(ink_js_1.Text, null,
            "Status message:",
            " ",
            React.createElement(ink_js_1.Text, { dimColor: true }, selectedHook.config.statusMessage));
    ...
    if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = React.createElement(ink_js_1.Text, { dimColor: true }, "To modify or remove this hook, edit settings.json directly or ask Claude to help.");
        $[32] = t14;
    }
    else {
        t14 = $[32];
    ...
    if ($[33] !== t12 || $[34] !== t13 || $[35] !== t7) {
        t15 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t7,
            t12,
            t13,
            t14);
    ...
    if ($[37] !== onCancel || $[38] !== t15) {
        t16 = React.createElement(Dialog_js_1.Dialog, { title: "Hook details", onCancel: onCancel, inputGuide: _temp }, t15);
        $[37] = onCancel;
        $[38] = t15;
        $[39] = t16;
    }
 ...
 */
function _temp() {
    return React.createElement(ink_js_1.Text, null, "Esc to go back");
}
