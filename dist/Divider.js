...
function Divider(t0) {
    ...
    if (title) {
        const titleWidth = (0, stringWidth_js_1.stringWidth)(title) + 2;
        ...
        if ($[3] !== title) {
            t5 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                react_1.default.createElement(ink_js_1.Ansi, null, title));
            $[3] = title;
            $[4] = t5;
        }
        else {
        ...
        if ($[8] !== color || $[9] !== t3 || $[10] !== t4 || $[11] !== t5 || $[12] !== t6) {
            t7 = react_1.default.createElement(ink_js_1.Text, { color: color, dimColor: t3 },
                t4,
                " ",
                t5,
                " ",
    ...
    if ($[17] !== color || $[18] !== t3 || $[19] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Text, { color: color, dimColor: t3 }, t4);
        $[17] = color;
        $[18] = t3;
        $[19] = t4;
        $[20] = t5;
