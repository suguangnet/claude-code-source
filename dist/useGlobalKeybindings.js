...
const terminalPanel_js_1 = require("../utils/terminalPanel.js");
/**
 ...
 */
function GlobalKeybindingHandlers({ screen, setScreen, showAllInTranscript, setShowAllInTranscript, messageCount, onEnterTranscript, onExitTranscript, virtualScrollActive, searchBarOpen = false }) {
    const expandedView = (0, AppState_js_1.useAppState)(s => s.expandedView);
    const setAppState = (0, AppState_js_1.useSetAppState)();
    // Toggle todo list (ctrl+t) - cycles through views
    const handleToggleTodos = (0, react_1.useCallback)(() => {
        ...
        setAppState(prev => {
            ...
            const hasTeammates = (0, array_js_1.count)(getAllInProcessTeammateTasks(prev.tasks), t => t.status === 'running') > 0;
            if (hasTeammates) {
    ...
    const handleToggleTranscript = (0, react_1.useCallback)(() => {
    ...
    const handleToggleShowAll = (0, react_1.useCallback)(() => {
    ...
    const handleExitTranscript = (0, react_1.useCallback)(() => {
    ...
    const handleToggleBrief = (0, react_1.useCallback)(() => {
        if ((0, bun_bundle_1.feature)('KAIROS') || (0, bun_bundle_1.feature)('KAIROS_BRIEF')) {
            /* eslint-disable @typescript-eslint/no-require-imports */
    ...
    (0, useKeybinding_js_1.useKeybinding)('app:toggleTeammatePreview', () => {
        setAppState(prev_3 => ({
            ...prev_3,
    ...
    const handleToggleTerminal = (0, react_1.useCallback)(() => {
    ...
    const handleRedraw = (0, react_1.useCallback)(() => {
        instances_js_1.default.get(process.stdout)?.forceRedraw();
    }, []);
