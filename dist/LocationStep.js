...
function LocationStep() {
    ...
    const { goNext, updateWizardData, cancel } = (0, index_js_1.useWizard)();
    let t0;
    ...
    let t5;
    if ($[8] !== t3 || $[9] !== t4) {
        t5 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Choose location", footerText: t2 },
            react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(select_js_1.Select, { key: "location-select", options: locationOptions, onChange: t3, onCancel: t4 })));
        $[8] = t3;
        $[9] = t4;
        $[10] = t5;
    }
