...
function McpConfigErrorSection(t0) {
    ...
    if ($[0] !== hasErrors || $[1] !== hasWarnings) {
        t1 = (hasErrors || hasWarnings) && react_1.default.createElement(ink_js_1.Text, { color: hasErrors ? "error" : "warning" },
            "[",
    ...
    let t3;
    if ($[5] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Text, null, t2);
        $[5] = t2;
        $[6] = t3;
    }
    else {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Location: ");
        $[10] = t5;
    }
    else {
        t5 = $[10];
    ...
    if ($[13] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Box, null,
            t5,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, t6));
        $[13] = t6;
        $[14] = t7;
    }
    else {
    ...
    let t10;
    if ($[19] !== t8 || $[20] !== t9) {
        t10 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 1, flexDirection: "column" },
            t8,
            t9);
        $[19] = t8;
        $[20] = t9;
    ...
    if ($[22] !== t10 || $[23] !== t4 || $[24] !== t7) {
        t11 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            t4,
            t7,
            t10);
        $[22] = t10;
...
function _temp2(warning, i_0) {
    ...
    return react_1.default.createElement(ink_js_1.Box, { key: `warning-${i_0}` },
...
function _temp(error, i) {
    ...
    return react_1.default.createElement(ink_js_1.Box, { key: `error-${i}` },
        react_1.default.createElement(ink_js_1.Text, null,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "\u2514 "),
...
function McpParsingWarnings() {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "MCP Config Diagnostics");
        $[4] = t4;
    }
    else {
        t4 = $[4];
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1, marginBottom: 1 },
            t4,
...
function _temp5(t0) {
    ...
    return react_1.default.createElement(McpConfigErrorSection, { key: scope, scope: scope, parsingErrors: filterErrors(config_1.errors, "fatal"), warnings: filterErrors(config_1.errors, "warning") });
}
function _temp4(t0) {
