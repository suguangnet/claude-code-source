...
const collapseReadSearch_js_1 = require("src/utils/collapseReadSearch.js");
/**
...
function describeTeammateActivity(t) {
    ...
    if (t.isIdle)
        return 'idle';
    return (t.progress?.recentActivities && (0, collapseReadSearch_js_1.summarizeRecentActivities)(t.progress.recentActivities)) ?? t.progress?.lastActivity?.activityDescription ?? 'working';
}
/**
