...
const PromptInputFooterSuggestions_js_1 = require("../../PromptInput/PromptInputFooterSuggestions.js");
...
function PermissionDescription() {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = React.createElement(ink_js_1.Text, { dimColor: true }, "Claude Code will be able to read files in this directory and make edits when auto-accept edits is on.");
        $[0] = t0;
    }
    else {
        t0 = $[0];
...
function DirectoryDisplay(t0) {
    ...
    let t1;
    if ($[0] !== path) {
        t1 = React.createElement(ink_js_1.Text, { color: "permission" }, path);
        $[0] = path;
        $[1] = t1;
    }
    else {
    ...
    let t3;
    if ($[3] !== t1) {
        t3 = React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, gap: 1 },
            t1,
            t2);
        $[3] = t1;
        $[4] = t3;
...
function DirectoryInput(t0) {
    ...
    let t1;
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = React.createElement(ink_js_1.Text, null, "Enter the path to the directory:");
        $[0] = t1;
    }
    else {
        t1 = $[0];
    ...
    if ($[1] !== onChange || $[2] !== onSubmit || $[3] !== value) {
        t2 = React.createElement(ink_js_1.Box, { borderDimColor: true, borderStyle: "round", marginY: 1, paddingLeft: 1 },
            React.createElement(TextInput_js_1.default, { showCursor: true, placeholder: `Directory path${figures_1.default.ellipsis}`, value: value, onChange: onChange, onSubmit: onSubmit, columns: 80, cursorOffset: value.length, onChangeCursorOffset: _temp }));
        $[1] = onChange;
        $[2] = onSubmit;
        $[3] = value;
        $[4] = t2;
    ...
    if ($[5] !== selectedSuggestion || $[6] !== suggestions) {
        t3 = suggestions.length > 0 && React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(PromptInputFooterSuggestions_js_1.PromptInputFooterSuggestions, { suggestions: suggestions, selectedSuggestion: selectedSuggestion }));
    ...
    let t4;
    if ($[8] !== error) {
        t4 = error && React.createElement(ink_js_1.Text, { color: "error" }, error);
        $[8] = error;
        $[9] = t4;
    }
    else {
    ...
    if ($[10] !== t2 || $[11] !== t3 || $[12] !== t4) {
        t5 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t1,
            t2,
            t3,
            t4);
...
function AddWorkspaceDirectory(t0) {
    ...
    const [directoryInput, setDirectoryInput] = (0, react_1.useState)("");
    ...
    const [suggestions, setSuggestions] = (0, react_1.useState)(t1);
    const [selectedSuggestion, setSelectedSuggestion] = (0, react_1.useState)(0);
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = async (path) => {
            ...
            const completions = await (0, directoryCompletion_js_1.getDirectoryCompletions)(path);
    ...
    const debouncedFetchSuggestions = (0, usehooks_ts_1.useDebounceCallback)(fetchSuggestions, 100);
    let t3;
    let t4;
    ...
    if ($[7] !== onAddDirectory || $[8] !== permissionContext) {
        t6 = async (newPath_0) => {
            const result = await (0, validation_js_1.validateDirectoryForWorkspace)(newPath_0, permissionContext);
    ...
    if ($[19] !== directoryInput || $[20] !== directoryPath || $[21] !== error || $[22] !== handleSelect || $[23] !== handleSubmit || $[24] !== selectedSuggestion || $[25] !== suggestions) {
        t11 = directoryPath ? React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            React.createElement(DirectoryDisplay, { path: directoryPath }),
            React.createElement(select_js_1.Select, { options: REMEMBER_DIRECTORY_OPTIONS, onChange: handleSelect, onCancel: () => handleSelect("no") })) : React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, marginX: 2 },
    ...
    if ($[27] !== onCancel || $[28] !== t10 || $[29] !== t11) {
        t12 = React.createElement(Dialog_js_1.Dialog, { title: "Add directory to workspace", onCancel: onCancel, color: "permission", isCancelActive: false, inputGuide: t10 }, t11);
        $[27] = onCancel;
        $[28] = t10;
        $[29] = t11;
        $[30] = t12;
    ...
    if ($[31] !== handleKeyDown || $[32] !== t12) {
        t13 = React.createElement(ink_js_1.Box, { flexDirection: "column", tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown }, t12);
        $[31] = handleKeyDown;
        $[32] = t12;
        $[33] = t13;
    }
...
function _temp2(exitState) {
    return exitState.pending ? React.createElement(ink_js_1.Text, null,
        "Press ",
        exitState.keyName,
        " again to exit") : React.createElement(Byline_js_1.Byline, null,
        React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Tab", action: "complete" }),
        React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "add" }),
        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Settings", fallback: "Esc", description: "cancel" }));
}
