...
function ConfirmStep(t0) {
    const $ = (0, compiler_runtime_1.c)(88);
    const { tools, existingAgents, onSave, onSaveAndEdit, error } = t0;
    const { goBack, wizardData } = (0, index_js_1.useWizard)();
    let t1;
    ...
    if ($[4] !== agent || $[5] !== existingAgents || $[6] !== handleKeyDown || $[7] !== tools || $[8] !== wizardData.location) {
        const validation = (0, validateAgent_js_1.validateAgent)(agent, tools, existingAgents);
        let t20;
        if ($[28] !== agent) {
            t20 = (0, format_js_1.truncateToWidth)(agent.getSystemPrompt(), 240);
            $[28] = agent;
            $[29] = t20;
        }
        else {
        ...
        if ($[30] !== agent.whenToUse) {
            t21 = (0, format_js_1.truncateToWidth)(agent.whenToUse, 240);
            $[30] = agent.whenToUse;
            $[31] = t21;
        }
        else {
        ...
        let t22;
        if ($[32] !== agent.memory) {
            t22 = (0, paths_js_1.isAutoMemoryEnabled)() ? react_1.default.createElement(ink_js_1.Text, null,
                react_1.default.createElement(ink_js_1.Text, { bold: true }, "Memory"),
                ": ",
                (0, agentMemory_js_1.getMemoryScopeDisplay)(agent.memory)) : null;
            $[32] = agent.memory;
            $[33] = t22;
        }
        else {
        ...
        if ($[34] === Symbol.for("react.memo_cache_sentinel")) {
            t19 = react_1.default.createElement(Byline_js_1.Byline, null,
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "s/Enter", action: "save" }),
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "e", action: "edit in your editor" }),
        ...
        if ($[35] === Symbol.for("react.memo_cache_sentinel")) {
            t23 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Name");
            $[35] = t23;
        }
        else {
            t23 = $[35];
        ...
        if ($[38] === Symbol.for("react.memo_cache_sentinel")) {
            t24 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Location");
            $[38] = t24;
        }
        else {
            t24 = $[38];
        ...
        if ($[39] !== agent.agentType || $[40] !== wizardData.location) {
            t25 = (0, agentFileUtils_js_1.getNewRelativeAgentFilePath)({
        ...
        if ($[44] === Symbol.for("react.memo_cache_sentinel")) {
            t26 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Tools");
            $[44] = t26;
        }
        else {
            t26 = $[44];
        ...
        if ($[49] === Symbol.for("react.memo_cache_sentinel")) {
            t28 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Model");
            $[49] = t28;
        }
        else {
            t28 = $[49];
        ...
        if ($[54] === Symbol.for("react.memo_cache_sentinel")) {
            t12 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Description"),
        ...
        if ($[55] !== whenToUsePreview) {
            t13 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 2, marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null, whenToUsePreview));
            $[55] = whenToUsePreview;
            $[56] = t13;
        }
        else {
        ...
        if ($[57] === Symbol.for("react.memo_cache_sentinel")) {
            t14 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "System prompt"),
                    ":"));
            $[57] = t14;
        }
        else {
        ...
        if ($[58] !== systemPromptPreview) {
            t15 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 2, marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null, systemPromptPreview));
        ...
        t16 = validation.warnings.length > 0 && react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, { color: "warning" }, "Warnings:"),
            validation.warnings.map(_temp2));
        t17 = validation.errors.length > 0 && react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, { color: "error" }, "Errors:"),
    ...
    let t20;
    if ($[60] !== error) {
        t20 = error && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
    ...
    if ($[62] === Symbol.for("react.memo_cache_sentinel")) {
        t21 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "s");
        $[62] = t21;
    }
    else {
        t21 = $[62];
    ...
    if ($[63] === Symbol.for("react.memo_cache_sentinel")) {
        t22 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Enter");
        $[63] = t22;
    }
    else {
        t22 = $[63];
    ...
    if ($[64] === Symbol.for("react.memo_cache_sentinel")) {
        t23 = react_1.default.createElement(ink_js_1.Box, { marginTop: 2 },
            react_1.default.createElement(ink_js_1.Text, { color: "success" },
                ...
                " to save,",
                " ",
                react_1.default.createElement(ink_js_1.Text, { bold: true }, "e"),
                " to save and edit"));
        $[64] = t23;
    }
    else {
    ...
    if ($[65] !== T0 || $[66] !== t10 || $[67] !== t11 || $[68] !== t12 || $[69] !== t13 || $[70] !== t14 || $[71] !== t15 || $[72] !== t16 || $[73] !== t17 || $[74] !== t20 || $[75] !== t3 || $[76] !== t4 || $[77] !== t5 || $[78] !== t6 || $[79] !== t7 || $[80] !== t8 || $[81] !== t9) {
        t24 = react_1.default.createElement(T0, { flexDirection: t3, tabIndex: t4, autoFocus: t5, onKeyDown: t6 },
            t7,
            t8,
            t9,
            t10,
    ...
    if ($[83] !== T1 || $[84] !== t18 || $[85] !== t19 || $[86] !== t24) {
        t25 = react_1.default.createElement(T1, { subtitle: t18, footerText: t19 }, t24);
        $[83] = T1;
        $[84] = t18;
        $[85] = t19;
        $[86] = t24;
...
function _temp3(err, i_0) {
    return react_1.default.createElement(ink_js_1.Text, { key: i_0, color: "error" },
        " ",
        "\u2022 ",
        err);
}
