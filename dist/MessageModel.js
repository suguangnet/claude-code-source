...
function MessageModel(t0) {
    ...
    const t1 = (0, stringWidth_js_1.stringWidth)(message.message.model) + 8;
    let t2;
    if ($[0] !== message.message.model) {
        t2 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, message.message.model);
    ...
    let t3;
    if ($[2] !== t1 || $[3] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Box, { minWidth: t1 }, t2);
        $[2] = t1;
        $[3] = t2;
        $[4] = t3;
    }
