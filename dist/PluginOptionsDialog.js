...
function PluginOptionsDialog(t0) {
    ...
    const [values, setValues] = (0, react_1.useState)(t3);
    let t4;
    ...
    const [currentInput, setCurrentInput] = (0, react_1.useState)(t4);
    ...
    let t13;
    if ($[34] !== isRequired) {
        t13 = isRequired && react_1.default.createElement(ink_js_1.Text, { color: "error" }, " *");
        $[34] = isRequired;
        $[35] = t13;
    }
    else {
    ...
    let t14;
    if ($[36] !== t12 || $[37] !== t13) {
        t14 = react_1.default.createElement(ink_js_1.Text, { bold: true },
            t12,
            t13);
        $[36] = t12;
        $[37] = t13;
    ...
    if ($[39] !== fieldSchema.description) {
        t15 = fieldSchema.description && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, fieldSchema.description);
    ...
    let t17;
    if ($[42] !== displayValue) {
        t17 = react_1.default.createElement(ink_js_1.Text, null, displayValue);
        $[42] = displayValue;
        $[43] = t17;
    }
    else {
    ...
    let t19;
    if ($[45] !== t17) {
        t19 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            t16,
            t17,
            t18);
        $[45] = t17;
    ...
    if ($[51] !== fields.length || $[52] !== t21) {
        t22 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            "Field ",
            t21,
            " of ",
            fields.length);
    ...
    if ($[54] !== currentFieldIndex || $[55] !== fields.length) {
        t23 = currentFieldIndex < fields.length - 1 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Tab: Next field \u00B7 Enter: Save and continue");
    ...
    if ($[57] !== currentFieldIndex || $[58] !== fields.length) {
        t24 = currentFieldIndex === fields.length - 1 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Enter: Save configuration");
    ...
    if ($[60] !== t22 || $[61] !== t23 || $[62] !== t24) {
        t25 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t22,
            t23,
            t24);
        $[60] = t22;
    ...
    if ($[64] !== onCancel || $[65] !== subtitle || $[66] !== t20 || $[67] !== t25 || $[68] !== title) {
        t26 = react_1.default.createElement(Dialog_js_1.Dialog, { title: title, subtitle: subtitle, onCancel: onCancel, isCancelActive: false },
            t20,
            t25);
        $[64] = onCancel;
        $[65] = subtitle;
