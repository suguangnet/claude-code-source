...
function ScrollBox({ children, ref, stickyScroll, ...style }) {
    ...
    const renderQueuedRef = (0, react_1.useRef)(false);
    const notify = () => {
    ...
    return react_1.default.createElement("ink-box", { ref: el => {
            domRef.current = el;
            if (el)
        ...
        react_1.default.createElement(Box_js_1.default, { flexDirection: "column", flexGrow: 1, flexShrink: 0, width: "100%" }, children));
}
