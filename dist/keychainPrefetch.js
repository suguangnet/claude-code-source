...
function spawnSecurity(serviceName) {
    return new Promise(resolve => {
        (0, child_process_1.execFile)('security', ['find-generic-password', '-a', (0, macOsKeychainHelpers_js_1.getUsername)(), '-w', '-s', serviceName], { encoding: 'utf-8', timeout: KEYCHAIN_PREFETCH_TIMEOUT_MS }, (err, stdout) => {
...
function startKeychainPrefetch() {
    ...
    const oauthSpawn = spawnSecurity((0, macOsKeychainHelpers_js_1.getMacOsKeychainStorageServiceName)(macOsKeychainHelpers_js_1.CREDENTIALS_SERVICE_SUFFIX));
    const legacySpawn = spawnSecurity((0, macOsKeychainHelpers_js_1.getMacOsKeychainStorageServiceName)());
