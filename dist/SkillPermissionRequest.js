...
const PermissionPrompt_js_1 = require("../PermissionPrompt.js");
...
function SkillPermissionRequest(props) {
    ...
    if ($[6] !== skill) {
        ...
        if (showAlwaysAllowOptions) {
            const t5 = react_1.default.createElement(ink_js_1.Text, { bold: true }, skill);
            let t6;
            if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
                t6 = react_1.default.createElement(ink_js_1.Text, { bold: true }, originalCwd);
                $[8] = t6;
            }
            else {
                t6 = $[8];
            ...
            if (spaceIndex > 0) {
                ...
                let t9;
                if ($[11] !== t8) {
                    t9 = react_1.default.createElement(ink_js_1.Text, { bold: true }, t8);
                    $[11] = t8;
                    $[12] = t9;
                }
                else {
                ...
                if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
                    t10 = react_1.default.createElement(ink_js_1.Text, { bold: true }, originalCwd);
                    $[13] = t10;
                }
                else {
                    t10 = $[13];
    ...
    if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(ink_js_1.Text, null, "Claude may use instructions, code, or files from this Skill.");
        $[33] = t13;
    }
    else {
        t13 = $[33];
    ...
    let t15;
    if ($[34] !== t14) {
        t15 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, t14));
        $[34] = t14;
        $[35] = t15;
    }
    else {
    ...
    if ($[36] !== toolUseConfirm.permissionResult) {
        t16 = react_1.default.createElement(PermissionRuleExplanation_js_1.PermissionRuleExplanation, { permissionResult: toolUseConfirm.permissionResult, toolType: "tool" });
    ...
    if ($[38] !== handleCancel || $[39] !== handleSelect || $[40] !== options || $[41] !== toolAnalyticsContext) {
        t17 = react_1.default.createElement(PermissionPrompt_js_1.PermissionPrompt, { options: options, onSelect: handleSelect, onCancel: handleCancel, toolAnalyticsContext: toolAnalyticsContext });
        $[38] = handleCancel;
        $[39] = handleSelect;
        $[40] = options;
    ...
    let t18;
    if ($[43] !== t16 || $[44] !== t17) {
        t18 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t16,
            t17);
        $[43] = t16;
        $[44] = t17;
    ...
    if ($[46] !== t12 || $[47] !== t15 || $[48] !== t18 || $[49] !== workerBadge) {
        t19 = react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { title: t12, workerBadge: workerBadge },
            t13,
            t15,
            t18);
        $[46] = t12;
...
function _temp(input) {
    const result = SkillTool_js_1.SkillTool.inputSchema.safeParse(input);
    if (!result.success) {
        (0, log_js_1.logError)(new Error(`Failed to parse skill tool input: ${result.error.message}`));
        return "";
    }
