...
const defaultBindings_js_1 = require("../../keybindings/defaultBindings.js");
const loadUserBindings_js_1 = require("../../keybindings/loadUserBindings.js");
const reservedShortcuts_js_1 = require("../../keybindings/reservedShortcuts.js");
const schema_js_1 = require("../../keybindings/schema.js");
...
function generateContextsTable() {
    return markdownTable(['Context', 'Description'], schema_js_1.KEYBINDING_CONTEXTS.map(ctx => [
        `\`${ctx}\``,
...
function generateActionsTable() {
    ...
    const actionInfo = {};
    for (const block of defaultBindings_js_1.DEFAULT_BINDINGS) {
    ...
    return markdownTable(['Action', 'Default Key(s)', 'Context'], schema_js_1.KEYBINDING_ACTIONS.map(action => {
