...
function LoadingState(t0) {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(Spinner_js_1.Spinner, null);
        $[0] = t3;
    }
    else {
        t3 = $[0];
    ...
    if ($[1] !== bold || $[2] !== dimColor || $[3] !== message) {
        t4 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row" },
            t3,
            react_1.default.createElement(ink_js_1.Text, { bold: bold, dimColor: dimColor },
                " ",
                message));
        $[1] = bold;
        $[2] = dimColor;
    ...
    let t5;
    if ($[5] !== subtitle) {
        t5 = subtitle && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, subtitle);
        $[5] = subtitle;
        $[6] = t5;
    }
    else {
