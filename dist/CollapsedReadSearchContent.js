...
const useMinDisplayTime_js_1 = require("../../hooks/useMinDisplayTime.js");
const ink_js_1 = require("../../ink.js");
const Tool_js_1 = require("../../Tool.js");
const primitiveTools_js_1 = require("../../tools/REPLTool/primitiveTools.js");
const array_js_1 = require("../../utils/array.js");
const collapseReadSearch_js_1 = require("../../utils/collapseReadSearch.js");
const file_js_1 = require("../../utils/file.js");
const format_js_1 = require("../../utils/format.js");
const fullscreen_js_1 = require("../../utils/fullscreen.js");
const CtrlOToExpand_js_1 = require("../CtrlOToExpand.js");
const messageActions_js_1 = require("../messageActions.js");
const PrBadge_js_1 = require("../PrBadge.js");
const ToolUseLoader_js_1 = require("../ToolUseLoader.js");
/* eslint-disable @typescript-eslint/no-require-imports */
const teamMemCollapsed = (0, bun_bundle_1.feature)('TEAMMEM') ? require('./teamMemCollapsed.js') : null;
...
function VerboseToolUse(t0) {
    const $ = (0, compiler_runtime_1.c)(24);
    const { content, tools, lookups, inProgressToolUseIDs, shouldAnimate, theme } = t0;
    const bg = (0, messageActions_js_1.useSelectedMessageBg)();
    let t1;
    let t2;
    if ($[0] !== bg || $[1] !== content.id || $[2] !== content.input || $[3] !== content.name || $[4] !== inProgressToolUseIDs || $[5] !== lookups || $[6] !== shouldAnimate || $[7] !== theme || $[8] !== tools) {
        ...
        bb0: {
            const tool = (0, Tool_js_1.findToolByName)(tools, content.name) ?? (0, Tool_js_1.findToolByName)((0, primitiveTools_js_1.getReplPrimitiveTools)(), content.name);
            if (!tool) {
                t2 = null;
                break bb0;
            }
            ...
            if ($[20] !== isError || $[21] !== t6 || $[22] !== t7) {
                t8 = react_1.default.createElement(ToolUseLoader_js_1.ToolUseLoader, { shouldAnimate: t6, isUnresolved: t7, isError: isError });
                $[20] = isError;
                $[21] = t6;
                $[22] = t7;
                $[23] = t8;
            ...
            t1 = react_1.default.createElement(ink_js_1.Box, { key: content.id, flexDirection: "column", marginTop: 1, backgroundColor: bg },
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "row" },
                    t8,
                    react_1.default.createElement(ink_js_1.Text, null,
                        react_1.default.createElement(ink_js_1.Text, { bold: true }, userFacingName),
                        toolUseMessage && react_1.default.createElement(ink_js_1.Text, null,
                            "(",
                            toolUseMessage,
                            ")")),
                    input && tool.renderToolUseTag?.(input)),
                isResolved && !isError && toolResult !== undefined && react_1.default.createElement(ink_js_1.Box, null, tool.renderToolResultMessage?.(toolResult, [], {
                    verbose: true,
                    tools,
                    theme
                })));
...
function CollapsedReadSearchContent({ message, inProgressToolUseIDs, shouldAnimate, verbose, tools, lookups, isActiveGroup }) {
    const bg = (0, messageActions_js_1.useSelectedMessageBg)();
    ...
    const toolUseIds = (0, collapseReadSearch_js_1.getToolUseIdsFromCollapsedGroup)(message);
    ...
    const hasTeamMemoryOps = (0, bun_bundle_1.feature)('TEAMMEM') ? teamMemCollapsed.checkHasTeamMemOps(message) : false;
    ...
    const maxReadCountRef = (0, react_1.useRef)(0);
    const maxSearchCountRef = (0, react_1.useRef)(0);
    const maxListCountRef = (0, react_1.useRef)(0);
    const maxMcpCountRef = (0, react_1.useRef)(0);
    const maxBashCountRef = (0, react_1.useRef)(0);
    ...
    const bashCount = (0, fullscreen_js_1.isFullscreenEnvEnabled)() ? Math.max(0, maxBashCountRef.current - gitOpBashCount) : 0;
    ...
    const displayedHint = (0, useMinDisplayTime_js_1.useMinDisplayTime)(incomingHint, MIN_HINT_DISPLAY_MS);
        ...
        return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            toolUses.map(msg_0 => {
                ...
                if (content?.type !== 'tool_use')
                    return null;
                return react_1.default.createElement(VerboseToolUse, { key: content.id, content: content, tools: tools, lookups: lookups, inProgressToolUseIDs: inProgressToolUseIDs, shouldAnimate: shouldAnimate, theme: theme });
            }),
            message.hookInfos && message.hookInfos.length > 0 && react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    ...
                    " (",
                    (0, format_js_1.formatSecondsShort)(message.hookTotalMs ?? 0),
                    ")"),
                message.hookInfos.map((info, idx) => react_1.default.createElement(ink_js_1.Text, { key: `hook-${idx}`, dimColor: true },
                    '     ⎿ ',
                    info.command,
                    " (",
                    (0, format_js_1.formatSecondsShort)(info.durationMs ?? 0),
                    ")"))),
            message.relevantMemories?.map(m => react_1.default.createElement(ink_js_1.Box, { key: m.path, flexDirection: "column", marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    '  ⎿  ',
                    "Recalled ",
                    (0, path_1.basename)(m.path)),
                react_1.default.createElement(ink_js_1.Box, { paddingLeft: 5 },
                    react_1.default.createElement(ink_js_1.Text, null,
                        react_1.default.createElement(ink_js_1.Ansi, null, m.content))))));
    }
    ...
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && isActiveGroup) {
        ...
        if (elapsed !== undefined && elapsed >= 2) {
            const time = (0, format_js_1.formatDuration)(elapsed * 1000);
    ...
    function pushPart(key, verb, body) {
        ...
        if (!isFirst)
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: `comma-${key}` }, ", "));
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: key },
            isFirst ? verb[0].toUpperCase() + verb.slice(1) : verb,
            " ",
            body));
    }
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && message.commits?.length) {
        const byKind = {
            committed: 'committed',
        ...
        for (const kind of ['committed', 'amended', 'cherry-picked']) {
            ...
            if (shas.length) {
                pushPart(kind, byKind[kind], react_1.default.createElement(ink_js_1.Text, { bold: true }, shas.join(', ')));
            }
        }
    }
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && message.pushes?.length) {
        const branches = (0, array_js_1.uniq)(message.pushes.map(p => p.branch));
        pushPart('push', 'pushed to', react_1.default.createElement(ink_js_1.Text, { bold: true }, branches.join(', ')));
    }
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && message.branches?.length) {
        const byAction = {
            merged: 'merged',
            rebased: 'rebased onto'
        };
        for (const b of message.branches) {
            pushPart(`br-${b.action}-${b.ref}`, byAction[b.action], react_1.default.createElement(ink_js_1.Text, { bold: true }, b.ref));
        }
    }
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && message.prs?.length) {
        const verbs = {
            created: 'created',
            edited: 'edited',
            merged: 'merged',
        ...
        for (const pr of message.prs) {
            pushPart(`pr-${pr.action}-${pr.number}`, verbs[pr.action], pr.url ? react_1.default.createElement(PrBadge_js_1.PrBadge, { number: pr.number, url: pr.url, bold: true }) : react_1.default.createElement(ink_js_1.Text, { bold: true },
                "PR #",
                pr.number));
        }
    }
    if (searchCount > 0) {
        ...
        if (!isFirst_0) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-s" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "search" },
            searchVerb,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, searchCount),
            ' ',
    ...
    if (readCount > 0) {
        ...
        if (!isFirst_1) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-r" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "read" },
            readVerb,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, readCount),
            ' ',
    ...
    if (listCount > 0) {
        ...
        if (!isFirst_2) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-l" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "list" },
            listVerb,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, listCount),
            ' ',
    ...
    if (replCount > 0) {
        ...
        if (nonMemParts.length > 0) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-repl" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "repl" },
            replVerb,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, replCount),
            ' ',
    ...
    if (mcpCallCount > 0) {
        ...
        if (!isFirst_3) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-mcp" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "mcp" },
            verb_0,
            " ",
            serverLabel,
            mcpCallCount > 1 && react_1.default.createElement(react_1.default.Fragment, null,
                ' ',
                react_1.default.createElement(ink_js_1.Text, { bold: true }, mcpCallCount),
                " times")));
    }
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)() && bashCount > 0) {
        ...
        if (!isFirst_4) {
            nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-bash" }, ", "));
        }
        nonMemParts.push(react_1.default.createElement(ink_js_1.Text, { key: "bash" },
            verb_1,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, bashCount),
            " bash",
            ' ',
    ...
    if (memoryReadCount > 0) {
        ...
        if (!isFirst_5) {
            memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-mr" }, ", "));
        }
        memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "mem-read" },
            verb_2,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, memoryReadCount),
            ' ',
    ...
    if (memorySearchCount > 0) {
        ...
        if (!isFirst_6) {
            memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-ms" }, ", "));
        }
        memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "mem-search" }, `${verb_3} memories`));
    }
    if (memoryWriteCount > 0) {
        ...
        if (!isFirst_7) {
            memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "comma-mw" }, ", "));
        }
        memParts.push(react_1.default.createElement(ink_js_1.Text, { key: "mem-write" },
            verb_4,
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, memoryWriteCount),
            ' ',
            memoryWriteCount === 1 ? 'memory' : 'memories'));
    }
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1, backgroundColor: bg },
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "row" },
            isActiveGroup ? react_1.default.createElement(ToolUseLoader_js_1.ToolUseLoader, { shouldAnimate: true, isUnresolved: true, isError: anyError }) : react_1.default.createElement(ink_js_1.Box, { minWidth: 2 }),
            react_1.default.createElement(ink_js_1.Text, { dimColor: !isActiveGroup },
                nonMemParts,
                memParts,
                ...
                isActiveGroup && react_1.default.createElement(ink_js_1.Text, { key: "ellipsis" }, "\u2026"),
                " ",
                react_1.default.createElement(CtrlOToExpand_js_1.CtrlOToExpand, null))),
        isActiveGroup && displayedHint !== undefined &&
            ...
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "row" },
                react_1.default.createElement(ink_js_1.Box, { width: 5, flexShrink: 0 },
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true }, '  ⎿  ')),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", flexGrow: 1 }, displayedHint.split('\n').map((line, i, arr) => react_1.default.createElement(ink_js_1.Text, { key: `hint-${i}`, dimColor: true },
                    line,
                    i === arr.length - 1 && shellProgressSuffix)))),
        message.hookTotalMs !== undefined && message.hookTotalMs > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            '  ⎿  ',
            "Ran ",
            message.hookCount,
            " PreToolUse",
