...
const useBlink_js_1 = require("../hooks/useBlink.js");
...
function ToolUseLoader(t0) {
    ...
    const [ref, isBlinking] = (0, useBlink_js_1.useBlink)(shouldAnimate);
    const color = isUnresolved ? undefined : isError ? "error" : "success";
    const t1 = !shouldAnimate || isBlinking || isError || !isUnresolved ? figures_js_1.BLACK_CIRCLE : " ";
    let t2;
    if ($[0] !== color || $[1] !== isUnresolved || $[2] !== t1) {
        t2 = react_1.default.createElement(ink_js_1.Text, { color: color, dimColor: isUnresolved }, t1);
        $[0] = color;
        $[1] = isUnresolved;
        $[2] = t1;
        $[3] = t2;
    ...
    let t3;
    if ($[4] !== ref || $[5] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Box, { ref: ref, minWidth: 2 }, t2);
        $[4] = ref;
        $[5] = t2;
        $[6] = t3;
    }
