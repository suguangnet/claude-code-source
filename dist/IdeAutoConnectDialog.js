...
function IdeAutoConnectDialog(t0) {
    ...
    let t3;
    if ($[3] !== handleSelect) {
        t3 = react_1.default.createElement(index_js_1.Select, { options: options, onChange: handleSelect, defaultValue: "yes" });
        $[3] = handleSelect;
        $[4] = t3;
    }
    else {
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "You can also configure this in /config or with the --ide flag");
        $[5] = t4;
    }
    else {
        t4 = $[5];
    ...
    if ($[6] !== onComplete || $[7] !== t3) {
        t5 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Do you wish to enable auto-connect to IDE?", color: "ide", onCancel: onComplete },
            t3,
            t4);
        $[6] = onComplete;
        $[7] = t3;
...
function IdeDisableAutoConnectDialog(t0) {
    ...
    let t4;
    if ($[5] !== handleSelect) {
        t4 = react_1.default.createElement(index_js_1.Select, { options: options, onChange: handleSelect, defaultValue: "no" });
        $[5] = handleSelect;
        $[6] = t4;
    }
    else {
    ...
    if ($[7] !== handleCancel || $[8] !== t4) {
        t5 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Do you wish to disable auto-connect to IDE?", subtitle: "You can also configure this in /config", onCancel: handleCancel, color: "ide" }, t4);
        $[7] = handleCancel;
        $[8] = t4;
        $[9] = t5;
    }
