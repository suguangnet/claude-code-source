...
function getMcpPrefix(serverName) {
    return `mcp__${(0, normalization_js_1.normalizeNameForMCP)(serverName)}__`;
}
/**
...
function buildMcpToolName(serverName, toolName) {
    return `${getMcpPrefix(serverName)}${(0, normalization_js_1.normalizeNameForMCP)(toolName)}`;
}
/**
...
function getMcpDisplayName(fullName, serverName) {
    const prefix = `mcp__${(0, normalization_js_1.normalizeNameForMCP)(serverName)}__`;
