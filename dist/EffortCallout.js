...
const PermissionDialog_js_1 = require("./permissions/PermissionDialog.js");
...
function EffortCallout(t0) {
    ...
    let t7;
    if ($[7] !== model) {
        const defaultEffort = (0, effort_js_1.getDefaultEffortForModel)(model);
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = [{
                label: react_1.default.createElement(EffortOptionLabel, { level: "medium", text: "Medium (recommended)" }),
                value: "medium"
            }, {
                label: react_1.default.createElement(EffortOptionLabel, { level: "high", text: "High" }),
                value: "high"
            }, {
                label: react_1.default.createElement(EffortOptionLabel, { level: "low", text: "Low" }),
                value: "low"
            }];
        $[11] = t9;
    }
    ...
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = react_1.default.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, null, defaultEffortConfig.dialogDescription));
        $[12] = t10;
    }
    else {
        t10 = $[12];
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = react_1.default.createElement(EffortIndicatorSymbol, { level: "low" });
        $[13] = t11;
    }
    else {
        t11 = $[13];
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = react_1.default.createElement(EffortIndicatorSymbol, { level: "medium" });
        $[14] = t12;
    }
    else {
        t12 = $[14];
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                ...
                "\xB7",
                " ",
                react_1.default.createElement(EffortIndicatorSymbol, { level: "high" }),
                " high"));
        $[15] = t13;
    }
    else {
    ...
    let t14;
    if ($[16] !== handleSelect) {
        t14 = react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { title: defaultEffortConfig.dialogTitle },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
                t10,
                t13,
                react_1.default.createElement(select_js_1.Select, { options: options, onChange: handleSelect, onCancel: handleCancel })));
        $[16] = handleSelect;
        $[17] = t14;
    }
    else {
...
function EffortIndicatorSymbol(t0) {
    ...
    let t2;
    if ($[2] !== t1) {
        t2 = react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, t1);
        $[2] = t1;
        $[3] = t2;
    }
    else {
...
function EffortOptionLabel(t0) {
    ...
    let t1;
    if ($[0] !== level) {
        t1 = react_1.default.createElement(EffortIndicatorSymbol, { level: level });
        $[0] = level;
        $[1] = t1;
    }
    else {
    ...
    let t2;
    if ($[2] !== t1 || $[3] !== text) {
        t2 = react_1.default.createElement(react_1.default.Fragment, null,
            t1,
            " ",
            text);
        $[2] = t1;
...
function shouldShowEffortCallout(model) {
    ...
    const parsed = (0, model_js_1.parseUserSpecifiedModel)(model);
