...
const Settings_js_1 = require("../../components/Settings/Settings.js");
async function call(onDone, context) {
    return React.createElement(Settings_js_1.Settings, { onClose: onDone, context: context, defaultTab: "Status" });
}
