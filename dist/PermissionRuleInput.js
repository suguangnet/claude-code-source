...
function PermissionRuleInput(t0) {
    ...
    if ($[1] !== onSubmit || $[2] !== ruleBehavior) {
        t2 = value => {
            ...
            const ruleValue = (0, permissionRuleParser_js_1.permissionRuleValueFromString)(trimmedValue);
    ...
    let t3;
    if ($[4] !== ruleBehavior) {
        t3 = React.createElement(ink_js_1.Text, { bold: true, color: "permission" },
            "Add ",
            ruleBehavior,
            " permission rule");
        $[4] = ruleBehavior;
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = React.createElement(ink_js_1.Newline, null);
        $[6] = t4;
    }
    else {
        t4 = $[6];
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = React.createElement(ink_js_1.Text, { bold: true }, (0, permissionRuleParser_js_1.permissionRuleValueToString)({
            toolName: WebFetchTool_js_1.WebFetchTool.name
        }));
        t6 = React.createElement(ink_js_1.Text, { bold: false }, " or ");
        $[7] = t5;
        $[8] = t6;
    }
    else {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = React.createElement(ink_js_1.Text, null,
            ...
            t5,
            t6,
            React.createElement(ink_js_1.Text, { bold: true }, (0, permissionRuleParser_js_1.permissionRuleValueToString)({
    ...
    if ($[10] !== cursorOffset || $[11] !== handleSubmit || $[12] !== inputValue || $[13] !== textInputColumns) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t7,
            React.createElement(ink_js_1.Box, { borderDimColor: true, borderStyle: "round", marginY: 1, paddingLeft: 1 },
                React.createElement(TextInput_js_1.default, { showCursor: true, value: inputValue, onChange: setInputValue, onSubmit: handleSubmit, placeholder: `Enter permission rule${figures_1.default.ellipsis}`, columns: textInputColumns, cursorOffset: cursorOffset, onChangeCursorOffset: setCursorOffset })));
        $[10] = cursorOffset;
        $[11] = handleSubmit;
        $[12] = inputValue;
        $[13] = textInputColumns;
    ...
    let t9;
    if ($[15] !== t3 || $[16] !== t8) {
        t9 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, borderStyle: "round", paddingLeft: 1, paddingRight: 1, borderColor: "permission" },
            t3,
            t8);
        $[15] = t3;
        $[16] = t8;
    ...
    if ($[18] !== exitState.keyName || $[19] !== exitState.pending) {
        t10 = React.createElement(ink_js_1.Box, { marginLeft: 3 }, exitState.pending ? React.createElement(ink_js_1.Text, { dimColor: true },
            "Press ",
            exitState.keyName,
            " again to exit") : React.createElement(ink_js_1.Text, { dimColor: true }, "Enter to submit \u00B7 Esc to cancel"));
