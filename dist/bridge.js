...
const bridgeEnabled_js_1 = require("../../bridge/bridgeEnabled.js");
const envLessBridgeConfig_js_1 = require("../../bridge/envLessBridgeConfig.js");
const types_js_1 = require("../../bridge/types.js");
const Dialog_js_1 = require("../../components/design-system/Dialog.js");
const ListItem_js_1 = require("../../components/design-system/ListItem.js");
const RemoteCallout_js_1 = require("../../components/RemoteCallout.js");
...
function BridgeToggle(t0) {
    ...
    const replBridgeConnected = (0, AppState_js_1.useAppState)(_temp);
    const replBridgeEnabled = (0, AppState_js_1.useAppState)(_temp2);
    const replBridgeOutboundOnly = (0, AppState_js_1.useAppState)(_temp3);
    const [showDisconnectDialog, setShowDisconnectDialog] = (0, react_1.useState)(false);
    let t1;
...
function BridgeDisconnectDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(61);
    const { onDone } = t0;
    (0, overlayContext_js_1.useRegisterOverlay)("bridge-disconnect-dialog");
    const setAppState = (0, AppState_js_1.useSetAppState)();
    const sessionUrl = (0, AppState_js_1.useAppState)(_temp4);
    const connectUrl = (0, AppState_js_1.useAppState)(_temp5);
    const sessionActive = (0, AppState_js_1.useAppState)(_temp6);
    const [focusIndex, setFocusIndex] = (0, react_1.useState)(2);
    const [showQR, setShowQR] = (0, react_1.useState)(false);
    const [qrText, setQrText] = (0, react_1.useState)("");
    ...
    if ($[17] !== displayUrl || $[18] !== handleContinue || $[19] !== qrText || $[20] !== showQR) {
        ...
        if ($[30] !== t17) {
            t12 = React.createElement(ink_js_1.Text, null,
        ...
        t13 = showQR && qrLines.length > 0 && React.createElement(ink_js_1.Box, { flexDirection: "column" }, qrLines.map(_temp10));
        $[17] = displayUrl;
        $[18] = handleContinue;
        $[19] = qrText;
        $[20] = showQR;
    ...
    if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
        t18 = React.createElement(ink_js_1.Text, null, "Disconnect this session");
        $[32] = t18;
    }
    else {
        t18 = $[32];
    ...
    let t19;
    if ($[33] !== t17) {
        t19 = React.createElement(ListItem_js_1.ListItem, { isFocused: t17 }, t18);
        $[33] = t17;
        $[34] = t19;
    }
    else {
    ...
    let t22;
    if ($[35] !== t21) {
        t22 = React.createElement(ink_js_1.Text, null, t21);
        $[35] = t21;
        $[36] = t22;
    }
    else {
    ...
    let t23;
    if ($[37] !== t20 || $[38] !== t22) {
        t23 = React.createElement(ListItem_js_1.ListItem, { isFocused: t20 }, t22);
        $[37] = t20;
        $[38] = t22;
        $[39] = t23;
    }
    ...
    if ($[40] === Symbol.for("react.memo_cache_sentinel")) {
        t25 = React.createElement(ink_js_1.Text, null, "Continue");
        $[40] = t25;
    }
    else {
        t25 = $[40];
    ...
    let t26;
    if ($[41] !== t24) {
        t26 = React.createElement(ListItem_js_1.ListItem, { isFocused: t24 }, t25);
        $[41] = t24;
        $[42] = t26;
    }
    else {
    ...
    if ($[43] !== t19 || $[44] !== t23 || $[45] !== t26) {
        t27 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t19,
            t23,
            t26);
        $[43] = t19;
    ...
    if ($[47] === Symbol.for("react.memo_cache_sentinel")) {
        t28 = React.createElement(ink_js_1.Text, { dimColor: true }, "Enter to select \u00B7 Esc to continue");
        $[47] = t28;
    }
    else {
        t28 = $[47];
...
function _temp10(line, i_1) {
    return React.createElement(ink_js_1.Text, { key: i_1 }, line);
}
function _temp1(l) {
    return l.length > 0;
}
...
async function checkBridgePrerequisites() {
    ...
    const disabledReason = await (0, bridgeEnabled_js_1.getBridgeDisabledReason)();
    if (disabledReason) {
    ...
    let useV2 = (0, bridgeEnabled_js_1.isEnvLessBridgeEnabled)();
    if ((0, bun_bundle_1.feature)('KAIROS') && useV2) {
        const { isAssistantMode } = await Promise.resolve().then(() => __importStar(require('../../assistant/index.js')));
        if (isAssistantMode()) {
            useV2 = false;
        }
    }
    const versionError = useV2 ? await (0, envLessBridgeConfig_js_1.checkEnvLessBridgeMinVersion)() : (0, bridgeEnabled_js_1.checkBridgeMinVersion)();
    if (versionError) {
        return versionError;
    }
    if (!(0, bridgeConfig_js_1.getBridgeAccessToken)()) {
        return types_js_1.BRIDGE_LOGIN_INSTRUCTION;
    }
