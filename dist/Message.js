...
const CompactSummary_js_1 = require("./CompactSummary.js");
const AdvisorMessage_js_1 = require("./messages/AdvisorMessage.js");
const AssistantRedactedThinkingMessage_js_1 = require("./messages/AssistantRedactedThinkingMessage.js");
const AssistantTextMessage_js_1 = require("./messages/AssistantTextMessage.js");
const AssistantThinkingMessage_js_1 = require("./messages/AssistantThinkingMessage.js");
const AssistantToolUseMessage_js_1 = require("./messages/AssistantToolUseMessage.js");
const AttachmentMessage_js_1 = require("./messages/AttachmentMessage.js");
const CollapsedReadSearchContent_js_1 = require("./messages/CollapsedReadSearchContent.js");
const CompactBoundaryMessage_js_1 = require("./messages/CompactBoundaryMessage.js");
const GroupedToolUseContent_js_1 = require("./messages/GroupedToolUseContent.js");
const SystemTextMessage_js_1 = require("./messages/SystemTextMessage.js");
const UserImageMessage_js_1 = require("./messages/UserImageMessage.js");
const UserTextMessage_js_1 = require("./messages/UserTextMessage.js");
const UserToolResultMessage_js_1 = require("./messages/UserToolResultMessage/UserToolResultMessage.js");
const OffscreenFreeze_js_1 = require("./OffscreenFreeze.js");
const ExpandShellOutputContext_js_1 = require("./shell/ExpandShellOutputContext.js");
        ...
        case "attachment":
            {
                ...
                if ($[0] !== addMargin || $[1] !== isTranscriptMode || $[2] !== message.attachment || $[3] !== verbose) {
                    t2 = React.createElement(AttachmentMessage_js_1.AttachmentMessage, { addMargin: addMargin, attachment: message.attachment, verbose: verbose, isTranscriptMode: isTranscriptMode });
                    $[0] = addMargin;
                    $[1] = isTranscriptMode;
        ...
        case "assistant":
            {
                ...
                let t4;
                if ($[38] !== t2 || $[39] !== t3) {
                    t4 = React.createElement(ink_js_1.Box, { flexDirection: "column", width: t2 }, t3);
                    $[38] = t2;
                    $[39] = t3;
                    $[40] = t4;
                }
        ...
        case "user":
            {
                if (message.isCompactSummary) {
                    ...
                    let t3;
                    if ($[41] !== message || $[42] !== t2) {
                        t3 = React.createElement(CompactSummary_js_1.CompactSummary, { message: message, screen: t2 });
                        $[41] = message;
                        $[42] = t2;
                        $[43] = t3;
                    }
                ...
                if ($[61] !== content || $[62] !== isLatestBashOutput) {
                    t5 = isLatestBashOutput ? React.createElement(ExpandShellOutputContext_js_1.ExpandShellOutputProvider, null, content) : content;
                    $[61] = content;
        ...
        case "system":
            {
                if (message.subtype === "compact_boundary") {
                    ...
                    if ($[64] === Symbol.for("react.memo_cache_sentinel")) {
                        t2 = React.createElement(CompactBoundaryMessage_js_1.CompactBoundaryMessage, null);
                        $[64] = t2;
                    }
                    else {
                        t2 = $[64];
                ...
                if (message.subtype === "local_command") {
                    ...
                    if ($[70] !== addMargin || $[71] !== isTranscriptMode || $[72] !== t2 || $[73] !== verbose) {
                        t3 = React.createElement(UserTextMessage_js_1.UserTextMessage, { addMargin: addMargin, param: t2, verbose: verbose, isTranscriptMode: isTranscriptMode });
                        $[70] = addMargin;
                        $[71] = isTranscriptMode;
                        $[72] = t2;
                        $[73] = verbose;
                ...
                if ($[75] !== addMargin || $[76] !== isTranscriptMode || $[77] !== message || $[78] !== verbose) {
                    t2 = React.createElement(SystemTextMessage_js_1.SystemTextMessage, { message: message, addMargin: addMargin, verbose: verbose, isTranscriptMode: isTranscriptMode });
                    $[75] = addMargin;
                    $[76] = isTranscriptMode;
                    $[77] = message;
                    $[78] = verbose;
        ...
        case "grouped_tool_use":
            {
                ...
                if ($[80] !== inProgressToolUseIDs || $[81] !== lookups || $[82] !== message || $[83] !== shouldAnimate || $[84] !== tools) {
                    t2 = React.createElement(GroupedToolUseContent_js_1.GroupedToolUseContent, { message: message, tools: tools, lookups: lookups, inProgressToolUseIDs: inProgressToolUseIDs, shouldAnimate: shouldAnimate });
        ...
        case "collapsed_read_search":
            {
                ...
                if ($[86] !== inProgressToolUseIDs || $[87] !== isActiveCollapsedGroup || $[88] !== lookups || $[89] !== message || $[90] !== shouldAnimate || $[91] !== t2 || $[92] !== tools) {
                    t3 = React.createElement(OffscreenFreeze_js_1.OffscreenFreeze, null,
                        React.createElement(CollapsedReadSearchContent_js_1.CollapsedReadSearchContent, { message: message, inProgressToolUseIDs: inProgressToolUseIDs, shouldAnimate: shouldAnimate, verbose: t2, tools: tools, lookups: lookups, isActiveGroup: isActiveCollapsedGroup }));
...
function UserMessage(t0) {
    const $ = (0, compiler_runtime_1.c)(20);
        ...
        case "text":
            {
                ...
                if ($[0] !== addMargin || $[1] !== isTranscriptMode || $[2] !== message.planContent || $[3] !== message.timestamp || $[4] !== param || $[5] !== verbose) {
                    t1 = React.createElement(UserTextMessage_js_1.UserTextMessage, { addMargin: addMargin, param: param, verbose: verbose, planContent: message.planContent, isTranscriptMode: isTranscriptMode, timestamp: message.timestamp });
                    $[0] = addMargin;
                    $[1] = isTranscriptMode;
        ...
        case "image":
            {
                ...
                if ($[7] !== imageIndex || $[8] !== t1) {
                    t2 = React.createElement(UserImageMessage_js_1.UserImageMessage, { imageId: imageIndex, addMargin: t1 });
                    $[7] = imageIndex;
                    $[8] = t1;
                    $[9] = t2;
                }
        ...
        case "tool_result":
            {
                ...
                if ($[10] !== isTranscriptMode || $[11] !== lookups || $[12] !== message || $[13] !== param || $[14] !== progressMessagesForMessage || $[15] !== style || $[16] !== t1 || $[17] !== tools || $[18] !== verbose) {
                    t2 = React.createElement(UserToolResultMessage_js_1.UserToolResultMessage, { param: param, message: message, lookups: lookups, progressMessagesForMessage: progressMessagesForMessage, style: style, tools: tools, verbose: verbose, width: t1, isTranscriptMode: isTranscriptMode });
                    $[10] = isTranscriptMode;
                    $[11] = lookups;
                    $[12] = message;
                    $[13] = param;
...
function AssistantMessageBlock(t0) {
    const $ = (0, compiler_runtime_1.c)(45);
    ...
    if ((0, bun_bundle_1.feature)("CONNECTOR_TEXT")) {
        if ((0, connectorText_js_1.isConnectorTextBlock)(param)) {
            ...
            if ($[2] !== addMargin || $[3] !== onOpenRateLimitOptions || $[4] !== shouldShowDot || $[5] !== t1 || $[6] !== verbose || $[7] !== width) {
                t2 = React.createElement(AssistantTextMessage_js_1.AssistantTextMessage, { param: t1, addMargin: addMargin, shouldShowDot: shouldShowDot, verbose: verbose, width: width, onOpenRateLimitOptions: onOpenRateLimitOptions });
                $[2] = addMargin;
        ...
        case "tool_use":
            {
                ...
                if ($[9] !== addMargin || $[10] !== commands || $[11] !== inProgressToolCallCount || $[12] !== inProgressToolUseIDs || $[13] !== isTranscriptMode || $[14] !== lookups || $[15] !== param || $[16] !== progressMessagesForMessage || $[17] !== shouldAnimate || $[18] !== shouldShowDot || $[19] !== tools || $[20] !== verbose) {
                    t1 = React.createElement(AssistantToolUseMessage_js_1.AssistantToolUseMessage, { param: param, addMargin: addMargin, tools: tools, commands: commands, verbose: verbose, inProgressToolUseIDs: inProgressToolUseIDs, progressMessagesForMessage: progressMessagesForMessage, shouldAnimate: shouldAnimate, shouldShowDot: shouldShowDot, inProgressToolCallCount: inProgressToolCallCount, lookups: lookups, isTranscriptMode: isTranscriptMode });
                    $[9] = addMargin;
                    $[10] = commands;
        ...
        case "text":
            {
                ...
                if ($[22] !== addMargin || $[23] !== onOpenRateLimitOptions || $[24] !== param || $[25] !== shouldShowDot || $[26] !== verbose || $[27] !== width) {
                    t1 = React.createElement(AssistantTextMessage_js_1.AssistantTextMessage, { param: param, addMargin: addMargin, shouldShowDot: shouldShowDot, verbose: verbose, width: width, onOpenRateLimitOptions: onOpenRateLimitOptions });
                    $[22] = addMargin;
        ...
        case "redacted_thinking":
            {
                ...
                let t1;
                if ($[29] !== addMargin) {
                    t1 = React.createElement(AssistantRedactedThinkingMessage_js_1.AssistantRedactedThinkingMessage, { addMargin: addMargin });
                    $[29] = addMargin;
                    $[30] = t1;
                }
                else {
        ...
        case "thinking":
            {
                ...
                if ($[31] !== addMargin || $[32] !== isTranscriptMode || $[33] !== param || $[34] !== t1 || $[35] !== verbose) {
                    t2 = React.createElement(AssistantThinkingMessage_js_1.AssistantThinkingMessage, { addMargin: addMargin, param: param, isTranscriptMode: isTranscriptMode, verbose: verbose, hideInTranscript: t1 });
                    $[31] = addMargin;
                    $[32] = isTranscriptMode;
                    $[33] = param;
                    $[34] = t1;
        ...
        case "advisor_tool_result":
            {
                if ((0, advisor_js_1.isAdvisorBlock)(param)) {
                    ...
                    if ($[37] !== addMargin || $[38] !== advisorModel || $[39] !== lookups.erroredToolUseIDs || $[40] !== lookups.resolvedToolUseIDs || $[41] !== param || $[42] !== shouldAnimate || $[43] !== t1) {
                        t2 = React.createElement(AdvisorMessage_js_1.AdvisorMessage, { block: param, addMargin: addMargin, resolvedToolUseIDs: lookups.resolvedToolUseIDs, erroredToolUseIDs: lookups.erroredToolUseIDs, shouldAnimate: shouldAnimate, verbose: t1, advisorModel: advisorModel });
                        $[37] = addMargin;
                        $[38] = advisorModel;
                ...
                (0, log_js_1.logError)(new Error(`Unable to render server tool block: ${param.type}`));
                return null;
            }
        default:
            {
                (0, log_js_1.logError)(new Error(`Unable to render message type: ${param.type}`));
                return null;
            }
    }
}
