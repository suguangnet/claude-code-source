...
function ApiKeyStep(t0) {
    const $ = (0, compiler_runtime_1.c)(55);
    ...
    if ($[26] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: true }, "Install GitHub App"),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Choose API key"));
        $[26] = t10;
    }
    else {
        t10 = $[26];
    ...
    if ($[27] !== existingApiKey || $[28] !== selectedOption || $[29] !== theme) {
        t11 = existingApiKey && react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, null,
                selectedOption === "existing" ? (0, ink_js_1.color)("success", theme)("> ") : "  ",
    ...
    if ($[31] !== onCreateOAuthToken || $[32] !== selectedOption || $[33] !== theme) {
        t12 = onCreateOAuthToken && react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, null,
                selectedOption === "oauth" ? (0, ink_js_1.color)("success", theme)("> ") : "  ",
