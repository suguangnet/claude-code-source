...
function TreeSelect(t0) {
    ...
    const [internalExpandedIds, setInternalExpandedIds] = react_1.default.useState(t4);
    const isProgrammaticFocusRef = react_1.default.useRef(false);
    const lastFocusedIdRef = react_1.default.useRef(null);
    let t5;
    ...
    if ($[34] !== focusNodeId || $[35] !== handleChange || $[36] !== handleFocus || $[37] !== hideIndexes || $[38] !== isDisabled || $[39] !== layout || $[40] !== onCancel || $[41] !== onUpFromFirstItem || $[42] !== options || $[43] !== visibleOptionCount) {
        t13 = react_1.default.createElement(select_js_1.Select, { options: options, onChange: handleChange, onFocus: handleFocus, onCancel: onCancel, defaultFocusValue: focusNodeId, visibleOptionCount: visibleOptionCount, layout: layout, isDisabled: isDisabled, hideIndexes: hideIndexes, onUpFromFirstItem: onUpFromFirstItem });
        $[34] = focusNodeId;
        $[35] = handleChange;
        $[36] = handleFocus;
        $[37] = hideIndexes;
    ...
    if ($[45] !== handleKeyDown || $[46] !== t13) {
        t14 = react_1.default.createElement(ink_js_1.Box, { tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown }, t13);
        $[45] = handleKeyDown;
        $[46] = t13;
        $[47] = t14;
    }
