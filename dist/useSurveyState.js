...
function useSurveyState({ hideThanksAfterMs, onOpen, onSelect, shouldShowTranscriptPrompt, onTranscriptPromptShown, onTranscriptSelect }) {
    const [state, setState] = (0, react_1.useState)('closed');
    const [lastResponse, setLastResponse] = (0, react_1.useState)(null);
    const appearanceId = (0, react_1.useRef)((0, crypto_1.randomUUID)());
    const lastResponseRef = (0, react_1.useRef)(null);
    const showThanksThenClose = (0, react_1.useCallback)(() => {
        setState('thanks');
    ...
    const showSubmittedThenClose = (0, react_1.useCallback)(() => {
        setState('submitted');
    ...
    const handleTranscriptSelect = (0, react_1.useCallback)((selected_0) => {
        switch (selected_0) {
            case 'yes':
                setState('submitting');
                void (async () => {
