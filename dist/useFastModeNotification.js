...
function useFastModeNotification() {
    ...
    if ($[0] !== addNotification || $[1] !== isFastMode || $[2] !== setAppState) {
        t0 = () => {
            ...
            return (0, fastMode_js_1.onOrgFastModeChanged)(orgEnabled => {
                if (orgEnabled) {
                    addNotification({
                        key: ORG_CHANGED_KEY,
                        color: "fastMode",
    ...
    if ($[5] !== addNotification || $[6] !== setAppState) {
        t2 = () => {
            ...
            return (0, fastMode_js_1.onFastModeOverageRejection)(message => {
                setAppState(_temp3);
                addNotification({
    ...
    if ($[9] !== addNotification || $[10] !== isFastMode) {
        t4 = () => {
            ...
            const unsubTriggered = (0, fastMode_js_1.onCooldownTriggered)((resetAt, reason) => {
                const resetIn = (0, format_js_1.formatDuration)(resetAt - Date.now(), {
            ...
            const unsubExpired = (0, fastMode_js_1.onCooldownExpired)(() => {
                addNotification({
