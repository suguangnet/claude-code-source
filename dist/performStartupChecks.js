...
const PluginInstallationManager_js_1 = require("../../services/plugins/PluginInstallationManager.js");
...
async function performStartupChecks(setAppState) {
    ...
    try {
        ...
        await (0, PluginInstallationManager_js_1.performBackgroundPluginInstallations)(setAppState);
    }
    catch (error) {
        // Even if something fails here, don't block startup
        (0, debug_js_1.logForDebugging)(`Error initiating background plugin installations: ${error}`);
    }
}
