...
const WorktreeExitDialog_js_1 = require("./WorktreeExitDialog.js");
const GOODBYE_MESSAGES = ['Goodbye!', 'See ya!', 'Bye!', 'Catch you later!'];
function getRandomGoodbyeMessage() {
    return (0, sample_js_1.default)(GOODBYE_MESSAGES) ?? 'Goodbye!';
}
function ExitFlow(t0) {
    ...
    if ($[0] !== onDone) {
        t1 = async function onExit(resultMessage) {
            ...
            await (0, gracefulShutdown_js_1.gracefulShutdown)(0, "prompt_input_exit");
        };
        $[0] = onDone;
        $[1] = t1;
    }
    ...
    if (showWorktree) {
        ...
        if ($[2] !== onCancel || $[3] !== onExit) {
            t2 = react_1.default.createElement(WorktreeExitDialog_js_1.WorktreeExitDialog, { onDone: onExit, onCancel: onCancel });
            $[2] = onCancel;
            $[3] = onExit;
            $[4] = t2;
        }
