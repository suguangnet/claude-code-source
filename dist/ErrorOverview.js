...
function getStackUtils() {
    return stackUtils ?? (stackUtils = new stack_utils_1.default({
        cwd: process.cwd(),
...
function ErrorOverview({ error }) {
    ...
    return react_1.default.createElement(Box_js_1.default, { flexDirection: "column", padding: 1 },
        react_1.default.createElement(Box_js_1.default, null,
            react_1.default.createElement(Text_js_1.default, { backgroundColor: "ansi:red", color: "ansi:white" },
                ' ',
                "ERROR",
                ' '),
            react_1.default.createElement(Text_js_1.default, null,
                " ",
                error.message)),
        origin && filePath && react_1.default.createElement(Box_js_1.default, { marginTop: 1 },
            react_1.default.createElement(Text_js_1.default, { dim: true },
                filePath,
                ":",
                origin.line,
                ":",
                origin.column)),
        origin && excerpt && react_1.default.createElement(Box_js_1.default, { marginTop: 1, flexDirection: "column" }, excerpt.map(({ line: line_0, value }) => react_1.default.createElement(Box_js_1.default, { key: line_0 },
            react_1.default.createElement(Box_js_1.default, { width: lineWidth + 1 },
                react_1.default.createElement(Text_js_1.default, { dim: line_0 !== origin.line, backgroundColor: line_0 === origin.line ? 'ansi:red' : undefined, color: line_0 === origin.line ? 'ansi:white' : undefined },
                    String(line_0).padStart(lineWidth, ' '),
                    ":")),
            react_1.default.createElement(Text_js_1.default, { key: line_0, backgroundColor: line_0 === origin.line ? 'ansi:red' : undefined, color: line_0 === origin.line ? 'ansi:white' : undefined }, ' ' + value)))),
        error.stack && react_1.default.createElement(Box_js_1.default, { marginTop: 1, flexDirection: "column" }, error.stack.split('\n').slice(1).map(line_1 => {
            const parsedLine = getStackUtils().parseLine(line_1);
            // If the line from the stack cannot be parsed, we print out the unparsed line.
            if (!parsedLine) {
                return react_1.default.createElement(Box_js_1.default, { key: line_1 },
                    react_1.default.createElement(Text_js_1.default, { dim: true }, "- "),
                    react_1.default.createElement(Text_js_1.default, { bold: true }, line_1));
            }
            return react_1.default.createElement(Box_js_1.default, { key: line_1 },
                react_1.default.createElement(Text_js_1.default, { dim: true }, "- "),
                react_1.default.createElement(Text_js_1.default, { bold: true }, parsedLine.function),
                react_1.default.createElement(Text_js_1.default, { dim: true },
                    ' ',
                    "(",
