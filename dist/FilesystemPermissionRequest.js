...
function FilesystemPermissionRequest(t0) {
    ...
    if (!path) {
        ...
        if ($[5] !== onDone || $[6] !== onReject || $[7] !== toolUseConfirm || $[8] !== toolUseContext || $[9] !== verbose || $[10] !== workerBadge) {
            t3 = react_1.default.createElement(FallbackPermissionRequest_js_1.FallbackPermissionRequest, { toolUseConfirm: toolUseConfirm, toolUseContext: toolUseContext, onDone: onDone, onReject: onReject, verbose: verbose, workerBadge: workerBadge });
            $[5] = onDone;
            $[6] = onReject;
            $[7] = toolUseConfirm;
            $[8] = toolUseContext;
    ...
    if ($[17] !== t3 || $[18] !== userFacingName) {
        t4 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
    ...
    if ($[20] !== content || $[21] !== onDone || $[22] !== onReject || $[23] !== path || $[24] !== t5 || $[25] !== title || $[26] !== toolUseConfirm || $[27] !== toolUseContext || $[28] !== workerBadge) {
        t6 = react_1.default.createElement(FilePermissionDialog_js_1.FilePermissionDialog, { toolUseConfirm: toolUseConfirm, toolUseContext: toolUseContext, onDone: onDone, onReject: onReject, workerBadge: workerBadge, title: title, content: content, path: path, parseInput: parseInput, operationType: t5, completionType: "tool_use_single" });
        $[20] = content;
        $[21] = onDone;
        $[22] = onReject;
        $[23] = path;
