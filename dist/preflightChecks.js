...
const useTimeout_js_1 = require("../hooks/useTimeout.js");
    ...
    try {
        ...
        const checkEndpoint = async (url) => {
            try {
                ...
                const hostname = new URL(url).hostname;
                const sslHint = (0, errorUtils_js_1.getSSLErrorHint)(error);
                return {
                    success: false,
...
function PreflightStep(t0) {
    ...
    const showSpinner = (0, useTimeout_js_1.useTimeout)(1000) && isChecking;
    let t1;
    let t2;
    ...
    if ($[6] !== isChecking || $[7] !== result || $[8] !== showSpinner) {
        t5 = isChecking && showSpinner ? react_1.default.createElement(ink_js_1.Box, { paddingLeft: 1 },
            react_1.default.createElement(Spinner_js_1.Spinner, null),
            react_1.default.createElement(ink_js_1.Text, null, "Checking connectivity...")) : !result?.success && !isChecking && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            react_1.default.createElement(ink_js_1.Text, { color: "error" }, "Unable to connect to Anthropic services"),
            react_1.default.createElement(ink_js_1.Text, { color: "error" }, result?.error),
            result?.sslHint ? react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, null, result.sslHint),
                react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, "See https://code.claude.com/docs/en/network-config")) : react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, null, "Please check your internet connection and network settings."),
                react_1.default.createElement(ink_js_1.Text, null,
                    "Note: Claude Code might not be available in your country. Check supported countries at",
                    " ",
                    react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, "https://anthropic.com/supported-countries"))));
        $[6] = isChecking;
        $[7] = result;
        $[8] = showSpinner;
        $[9] = t5;
    ...
    let t6;
    if ($[10] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, paddingLeft: 1 }, t5);
        $[10] = t5;
        $[11] = t6;
    }
    else {
