    ...
    switch (saveDestination) {
        case 'localSettings':
            return {
                ...
                description: `Saved in ${(0, settings_js_1.getRelativeSettingsFilePathForSource)('localSettings')}`,
                value: saveDestination
            };
        case 'projectSettings':
            return {
                label: 'Project settings',
                description: `Checked in at ${(0, settings_js_1.getRelativeSettingsFilePathForSource)('projectSettings')}`,
                value: saveDestination
            };
        case 'userSettings':
            return {
...
function AddPermissionRules(t0) {
        ...
        t2 = selectedValue => {
            if (selectedValue === "cancel") {
                ...
                if (constants_js_1.SOURCES.includes(selectedValue)) {
                    ...
                    const allUnreachable = (0, shadowedRuleDetection_js_1.detectUnreachableRules)(updatedContext, {
    ...
    let t5;
    if ($[12] !== t4) {
        t5 = React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2 }, t4);
        $[12] = t4;
        $[13] = t5;
    }
    else {
    ...
    let t7;
    if ($[14] !== t6) {
        t7 = React.createElement(ink_js_1.Text, null, t6);
        $[14] = t6;
        $[15] = t7;
    }
    else {
    ...
    let t8;
    if ($[16] !== onSelect) {
        t8 = React.createElement(select_js_1.Select, { options: allOptions, onChange: onSelect });
        $[16] = onSelect;
        $[17] = t8;
    }
    else {
    ...
    let t9;
    if ($[18] !== t7 || $[19] !== t8) {
        t9 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginY: 1 },
            t7,
            t8);
        $[18] = t7;
        $[19] = t8;
    ...
    if ($[21] !== onCancel || $[22] !== t5 || $[23] !== t9 || $[24] !== title) {
        t10 = React.createElement(Dialog_js_1.Dialog, { title: title, onCancel: onCancel, color: "permission" },
            t5,
            t9);
        $[21] = onCancel;
        $[22] = t5;
...
function _temp(ruleValue_0) {
    return React.createElement(ink_js_1.Box, { flexDirection: "column", key: (0, permissionRuleParser_js_1.permissionRuleValueToString)(ruleValue_0) },
        React.createElement(ink_js_1.Text, { bold: true }, (0, permissionRuleParser_js_1.permissionRuleValueToString)(ruleValue_0)),
        React.createElement(PermissionRuleDescription_js_1.PermissionRuleDescription, { ruleValue: ruleValue_0 }));
}
