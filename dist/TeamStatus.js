...
function TeamStatus(t0) {
    ...
    const teamContext = (0, AppState_js_1.useAppState)(_temp);
    let t1;
    if ($[0] !== teamContext) {
    ...
    if ($[2] !== showHint || $[3] !== teamsSelected) {
        t2 = showHint && teamsSelected ? React.createElement(React.Fragment, null,
            ...
            React.createElement(ink_js_1.Text, { dimColor: true }, "Enter to view")) : null;
        $[2] = showHint;
        $[3] = teamsSelected;
        $[4] = t2;
    }
    ...
    if ($[5] !== statusText || $[6] !== t3 || $[7] !== teamsSelected) {
        t4 = React.createElement(ink_js_1.Text, { key: t3, color: "background", inverse: teamsSelected }, statusText);
        $[5] = statusText;
        $[6] = t3;
        $[7] = teamsSelected;
        $[8] = t4;
    ...
    let t5;
    if ($[9] !== hint) {
        t5 = hint ? React.createElement(ink_js_1.Text, null,
            " ",
            hint) : null;
        $[9] = hint;
        $[10] = t5;
