...
function getTabWidth(tab, maxWidth) {
    ...
    const tagWidth = (0, stringWidth_js_1.stringWidth)(tab);
...
function TagTabs({ tabs, selectedIndex, availableWidth, showAllProjects = false }) {
    ...
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
        react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, resumeLabel),
        hiddenLeft > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            LEFT_ARROW_PREFIX,
            hiddenLeft),
        visibleTabs.map((tab_0, i_1) => {
            ...
            return react_1.default.createElement(ink_js_1.Text, { key: tab_0, backgroundColor: isSelected ? 'suggestion' : undefined, color: isSelected ? 'inverseText' : undefined, bold: isSelected },
                ' ',
                displayText,
                ' ');
        }),
        hiddenRight > 0 ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            RIGHT_HINT_WITH_COUNT_PREFIX,
            hiddenRight,
            RIGHT_HINT_SUFFIX) : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, RIGHT_HINT_NO_COUNT));
}
