...
const DesktopHandoff_js_1 = require("../DesktopHandoff.js");
...
function DesktopUpsellStartup(t0) {
    ...
    const { onDone } = t0;
    const [showHandoff, setShowHandoff] = (0, react_1.useState)(false);
    let t1;
    ...
    if (showHandoff) {
        let t2;
        if ($[1] !== onDone) {
            t2 = React.createElement(DesktopHandoff_js_1.DesktopHandoff, { onDone: () => onDone() });
            $[1] = onDone;
            $[2] = t2;
        }
        else {
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, null, "Same Claude Code with visual diffs, live app preview, parallel sessions, and more."));
        $[8] = t6;
    }
    else {
        t6 = $[8];
    ...
    if ($[11] !== handleSelect || $[12] !== t7) {
        t8 = React.createElement(PermissionDialog_js_1.PermissionDialog, { title: "Try Claude Code Desktop" },
            React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
                t6,
                React.createElement(select_js_1.Select, { options: options, onChange: handleSelect, onCancel: t7 })));
        $[11] = handleSelect;
        $[12] = t7;
        $[13] = t8;
    }
...
function _temp() {
    const newCount = ((0, config_js_1.getGlobalConfig)().desktopUpsellSeenCount ?? 0) + 1;
