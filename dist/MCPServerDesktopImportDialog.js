...
const SelectMulti_js_1 = require("./CustomSelect/SelectMulti.js");
...
function MCPServerDesktopImportDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(36);
    ...
    const [existingServers, setExistingServers] = (0, react_1.useState)(t2);
    let t3;
    let t4;
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = () => {
            (0, config_js_1.getAllMcpConfigs)().then(t5 => {
    ...
    const onSubmit = async function onSubmit(selectedServers) {
        ...
        for (const serverName of selectedServers) {
            ...
            if (serverConfig) {
                ...
                await (0, config_js_1.addMcpConfig)(finalName, serverConfig, scope);
                importedCount++;
            }
        }
        done(importedCount);
    ...
    if ($[8] !== onDone || $[9] !== scope || $[10] !== theme) {
        t6 = importedCount_0 => {
            if (importedCount_0 > 0) {
                (0, process_js_1.writeToStdout)(`\n${(0, ink_js_1.color)("success", theme)(`Successfully imported ${importedCount_0} MCP ${(0, stringUtils_js_1.plural)(importedCount_0, "server")} to ${scope} config.`)}\n`);
            }
            else {
    ...
    if ($[16] !== collisions.length) {
        t11 = collisions.length > 0 && react_1.default.createElement(ink_js_1.Text, { color: "warning" }, "Note: Some servers already exist with the same name. If selected, they will be imported with a numbered suffix.");
    ...
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = react_1.default.createElement(ink_js_1.Text, null, "Please select the servers you want to import:");
        $[18] = t12;
    }
    else {
        t12 = $[18];
    ...
    if ($[23] !== handleEscCancel || $[24] !== onSubmit || $[25] !== t13 || $[26] !== t14) {
        t15 = react_1.default.createElement(SelectMulti_js_1.SelectMulti, { options: t13, defaultValue: t14, onSubmit: onSubmit, onCancel: handleEscCancel, hideIndexes: true });
        $[23] = handleEscCancel;
        $[24] = onSubmit;
        $[25] = t13;
        $[26] = t14;
    ...
    if ($[28] !== handleEscCancel || $[29] !== t10 || $[30] !== t11 || $[31] !== t15) {
        t16 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Import MCP Servers from Claude Desktop", subtitle: t10, color: "success", onCancel: handleEscCancel, hideInputGuide: true },
            t11,
            t12,
            t15);
        $[28] = handleEscCancel;
    ...
    if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
        t17 = react_1.default.createElement(ink_js_1.Box, { paddingX: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                react_1.default.createElement(Byline_js_1.Byline, null,
                    react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Space", action: "select" }),
    ...
    let t18;
    if ($[34] !== t16) {
        t18 = react_1.default.createElement(react_1.default.Fragment, null,
            t16,
            t17);
        $[34] = t16;
        $[35] = t18;
