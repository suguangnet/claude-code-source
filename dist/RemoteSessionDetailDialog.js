...
const useElapsedTime_js_1 = require("../../hooks/useElapsedTime.js");
...
const RemoteSessionProgress_js_1 = require("./RemoteSessionProgress.js");
...
function formatToolUseSummary(name, input) {
    ...
    if (name === prompt_js_1.ASK_USER_QUESTION_TOOL_NAME && 'questions' in input) {
        ...
        if (Array.isArray(qs) && qs[0] && typeof qs[0] === 'object') {
            ...
            if (q) {
                ...
                return `Answer in browser: ${(0, format_js_1.truncateToWidth)(oneLine, 50)}`;
            }
        }
    }
    for (const v of Object.values(input)) {
        if (typeof v === 'string' && v.trim()) {
            ...
            return `${name} ${(0, format_js_1.truncateToWidth)(oneLine, 60)}`;
        }
    }
    return name;
}
...
function UltraplanSessionDetail(t0) {
    const $ = (0, compiler_runtime_1.c)(70);
    ...
    const elapsedTime = (0, useElapsedTime_js_1.useElapsedTime)(session.startTime, running, 1000, 0, session.endTime);
    let spawns = 0;
    let calls = 0;
    let lastBlock = null;
    ...
    if (confirmingStop) {
        ...
        if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
            t7 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "This will terminate the Claude Code on the web session.");
            $[12] = t7;
        }
        else {
            t7 = $[12];
        ...
        if ($[15] !== goBackOrClose || $[16] !== onKill) {
            t10 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Stop ultraplan?", onCancel: t6, color: "background" },
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                    t7,
                    react_1.default.createElement(select_js_1.Select, { options: t9, onChange: v => {
                            if (v === "stop") {
                                onKill?.();
                                goBackOrClose();
                            }
    ...
    const t6 = phase === "plan_ready" ? figures_js_1.DIAMOND_FILLED : figures_js_1.DIAMOND_OPEN;
    let t7;
    if ($[18] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Text, { color: "background" },
            t6,
            " ");
        $[18] = t6;
        $[19] = t7;
    ...
    if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "ultraplan");
        $[20] = t8;
    }
    else {
        t8 = $[20];
    ...
    if ($[21] !== elapsedTime || $[22] !== statusText) {
        t9 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            " \xB7 ",
            elapsedTime,
            " \xB7 ",
            statusText);
    ...
    let t10;
    if ($[24] !== t7 || $[25] !== t9) {
        t10 = react_1.default.createElement(ink_js_1.Text, null,
            t7,
            t8,
            t9);
        $[24] = t7;
    ...
    let t11;
    if ($[27] !== phase) {
        t11 = phase === "plan_ready" && react_1.default.createElement(ink_js_1.Text, { color: "success" },
    ...
    if ($[33] !== agentsWorking || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 || $[37] !== t14 || $[38] !== toolCalls) {
        t15 = react_1.default.createElement(ink_js_1.Text, null,
            t11,
            agentsWorking,
            " ",
            t12,
    ...
    let t16;
    if ($[40] !== lastToolCall) {
        t16 = lastToolCall && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, lastToolCall);
        $[40] = lastToolCall;
        $[41] = t16;
    }
    else {
    ...
    let t17;
    if ($[42] !== sessionUrl) {
        t17 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, sessionUrl);
        $[42] = sessionUrl;
        $[43] = t17;
    }
    else {
    ...
    if ($[44] !== sessionUrl || $[45] !== t17) {
        t18 = react_1.default.createElement(ink_js_1.Link, { url: sessionUrl }, t17);
        $[44] = sessionUrl;
        $[45] = t17;
        $[46] = t18;
    }
    ...
    let t24;
    if ($[58] !== t22 || $[59] !== t23) {
        t24 = react_1.default.createElement(select_js_1.Select, { options: t22, onChange: t23 });
        $[58] = t22;
        $[59] = t23;
        $[60] = t24;
    }
    ...
    if ($[61] !== t15 || $[62] !== t16 || $[63] !== t18 || $[64] !== t24) {
        t25 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t15,
            t16,
            t18,
            t24);
    ...
    if ($[66] !== goBackOrClose || $[67] !== t10 || $[68] !== t25) {
        t26 = react_1.default.createElement(Dialog_js_1.Dialog, { title: t10, onCancel: goBackOrClose, color: "background" }, t25);
        $[66] = goBackOrClose;
        $[67] = t10;
        $[68] = t25;
        $[69] = t26;
...
function StagePipeline(t0) {
    ...
    let t2;
    if ($[2] !== inSetup) {
        t2 = inSetup ? react_1.default.createElement(ink_js_1.Text, { color: "background" }, "Setup") : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Setup");
        $[2] = inSetup;
        $[3] = t2;
    }
    else {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " \u2192 ");
        $[4] = t3;
    }
    else {
        t3 = $[4];
    ...
    if ($[5] !== completed || $[6] !== currentIdx || $[7] !== inSetup) {
        t4 = STAGES.map((s, i) => {
            ...
            return react_1.default.createElement(react_1.default.Fragment, { key: s },
                i > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " \u2192 "),
                isCurrent ? react_1.default.createElement(ink_js_1.Text, { color: "background" }, STAGE_LABELS[s]) : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, STAGE_LABELS[s]));
        });
        $[5] = completed;
        $[6] = currentIdx;
        $[7] = inSetup;
    ...
    let t5;
    if ($[9] !== completed) {
        t5 = completed && react_1.default.createElement(ink_js_1.Text, { color: "success" }, " \u2713");
        $[9] = completed;
        $[10] = t5;
    }
    else {
    ...
    if ($[11] !== t2 || $[12] !== t4 || $[13] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Text, null,
            t2,
            t3,
            t4,
            t5);
...
function reviewCountsLine(session) {
    ...
    if (session.status === 'completed') {
        const parts = [`${verified} ${(0, stringUtils_js_1.plural)(verified, 'finding')}`];
        if (refuted > 0)
...
function ReviewSessionDetail(t0) {
    const $ = (0, compiler_runtime_1.c)(56);
    const { session, onDone, onBack, onKill } = t0;
    ...
    if (confirmingStop) {
        ...
        if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "This archives the remote session and stops local tracking. The review will not complete and any findings so far are discarded.");
            $[5] = t4;
        }
        else {
            t4 = $[5];
        ...
        if ($[8] !== goBackOrClose || $[9] !== onKill) {
            t7 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Stop ultrareview?", onCancel: t3, color: "background" },
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                    t4,
                    react_1.default.createElement(select_js_1.Select, { options: t6, onChange: v => {
                            if (v === "stop") {
                                onKill?.();
                                goBackOrClose();
                            }
    ...
    const t5 = completed ? figures_js_1.DIAMOND_FILLED : figures_js_1.DIAMOND_OPEN;
    let t6;
    if ($[20] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Text, { color: "background" },
            t5,
            " ");
        $[20] = t5;
        $[21] = t6;
    ...
    if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "ultrareview");
        $[22] = t7;
    }
    else {
        t7 = $[22];
    ...
    if ($[23] !== elapsedTime || $[24] !== statusLabel) {
        t8 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            " \xB7 ",
            elapsedTime,
            " \xB7 ",
            statusLabel);
    ...
    let t9;
    if ($[26] !== t6 || $[27] !== t8) {
        t9 = react_1.default.createElement(ink_js_1.Text, null,
            t6,
            t7,
            t8);
        $[26] = t6;
    ...
    if ($[29] !== completed || $[30] !== t10 || $[31] !== t11) {
        t12 = react_1.default.createElement(StagePipeline, { stage: t10, completed: completed, hasProgress: t11 });
        $[29] = completed;
        $[30] = t10;
        $[31] = t11;
        $[32] = t12;
    ...
    let t14;
    if ($[35] !== t13) {
        t14 = react_1.default.createElement(ink_js_1.Text, null, t13);
        $[35] = t13;
        $[36] = t14;
    }
    else {
    ...
    let t15;
    if ($[37] !== sessionUrl) {
        t15 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, sessionUrl);
        $[37] = sessionUrl;
        $[38] = t15;
    }
    else {
    ...
    if ($[39] !== sessionUrl || $[40] !== t15) {
        t16 = react_1.default.createElement(ink_js_1.Link, { url: sessionUrl }, t15);
        $[39] = sessionUrl;
        $[40] = t15;
        $[41] = t16;
    }
    ...
    let t17;
    if ($[42] !== t14 || $[43] !== t16) {
        t17 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t14,
            t16);
        $[42] = t14;
        $[43] = t16;
    ...
    if ($[45] !== handleSelect || $[46] !== options) {
        t18 = react_1.default.createElement(select_js_1.Select, { options: options, onChange: handleSelect });
        $[45] = handleSelect;
        $[46] = options;
        $[47] = t18;
    }
    ...
    if ($[48] !== t12 || $[49] !== t17 || $[50] !== t18) {
        t19 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t12,
            t17,
            t18);
        $[48] = t12;
    ...
    if ($[52] !== goBackOrClose || $[53] !== t19 || $[54] !== t9) {
        t20 = react_1.default.createElement(Dialog_js_1.Dialog, { title: t9, onCancel: goBackOrClose, color: "background", inputGuide: _temp }, t19);
        $[52] = goBackOrClose;
        $[53] = t19;
        $[54] = t9;
        $[55] = t20;
...
function _temp(exitState) {
    return exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
        "Press ",
        exitState.keyName,
        ...
        react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Esc", action: "go back" }));
}
function RemoteSessionDetailDialog({ session, toolUseContext, onDone, onBack, onKill }) {
    const [isTeleporting, setIsTeleporting] = (0, react_1.useState)(false);
    const [teleportError, setTeleportError] = (0, react_1.useState)(null);
    ...
    const lastMessages = (0, react_1.useMemo)(() => {
        if (session.isUltraplan || session.isRemoteReview)
            return [];
        return (0, messages_js_1.normalizeMessages)((0, mappers_js_1.toInternalMessages)(session.log)).filter(_ => _.type !== 'progress').slice(-3);
    }, [session]);
    if (session.isUltraplan) {
        return react_1.default.createElement(UltraplanSessionDetail, { session: session, onDone: onDone, onBack: onBack, onKill: onKill });
    }
    ...
    if (session.isRemoteReview) {
        return react_1.default.createElement(ReviewSessionDetail, { session: session, onDone: onDone, onBack: onBack, onKill: onKill });
    }
    ...
    async function handleTeleport() {
        ...
        try {
            await (0, teleport_js_1.teleportResumeCodeSession)(session.sessionId);
        }
        catch (err) {
            setTeleportError((0, errors_js_1.errorMessage)(err));
        }
        finally {
    ...
    const displayTitle = (0, format_js_1.truncateToWidth)(session.title, 50);
    ...
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
        react_1.default.createElement(Dialog_js_1.Dialog, { title: "Remote session details", onCancel: handleClose, color: "background", inputGuide: exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
                "Press ",
                exitState.keyName,
                " again to exit") : react_1.default.createElement(Byline_js_1.Byline, null,
                onBack && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\u2190", action: "go back" }),
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Esc/Enter/Space", action: "close" }),
                !isTeleporting && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "t", action: "teleport" })) },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Text, null,
                    ...
                    ":",
                    ' ',
                    displayStatus === 'running' || displayStatus === 'starting' ? react_1.default.createElement(ink_js_1.Text, { color: "background" }, displayStatus) : displayStatus === 'completed' ? react_1.default.createElement(ink_js_1.Text, { color: "success" }, displayStatus) : react_1.default.createElement(ink_js_1.Text, { color: "error" }, displayStatus)),
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Runtime"),
                    ":",
                    ' ',
                    (0, format_js_1.formatDuration)((session.endTime ?? Date.now()) - session.startTime)),
                react_1.default.createElement(ink_js_1.Text, { wrap: "truncate-end" },
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Title"),
                    ": ",
                    displayTitle),
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Progress"),
                    ":",
                    ' ',
                    react_1.default.createElement(RemoteSessionProgress_js_1.RemoteSessionProgress, { session: session })),
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Session URL"),
                    ":",
                    ' ',
                    react_1.default.createElement(ink_js_1.Link, { url: (0, RemoteAgentTask_js_1.getRemoteTaskSessionUrl)(session.sessionId) },
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, (0, RemoteAgentTask_js_1.getRemoteTaskSessionUrl)(session.sessionId))))),
            session.log.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Recent messages"),
                    ":"),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", height: 10, overflowY: "hidden" }, lastMessages.map((msg, i) => react_1.default.createElement(Message_js_1.Message, { key: i, message: msg, lookups: messages_js_1.EMPTY_LOOKUPS, addMargin: i > 0, tools: toolUseContext.options.tools, commands: toolUseContext.options.commands, verbose: toolUseContext.options.verbose, inProgressToolUseIDs: new Set(), progressMessagesForMessage: [], shouldAnimate: false, shouldShowDot: false, style: "condensed", isTranscriptMode: false, isStatic: true }))),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                        ...
                        ' ',
                        "messages"))),
            teleportError && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, { color: "error" },
                    "Teleport failed: ",
                    teleportError)),
            isTeleporting && react_1.default.createElement(ink_js_1.Text, { color: "background" }, "Teleporting to session\u2026")));
}
