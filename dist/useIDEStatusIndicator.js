...
const ide_js_1 = require("src/utils/ide.js");
const state_js_1 = require("../../bootstrap/state.js");
const useIdeConnectionStatus_js_1 = require("../useIdeConnectionStatus.js");
...
function useIDEStatusIndicator(t0) {
    ...
    const { status: ideStatus, ideName } = (0, useIdeConnectionStatus_js_1.useIdeConnectionStatus)(mcpClients);
    const hasShownHintRef = (0, react_1.useRef)(false);
    let t1;
    if ($[0] !== ideInstallationStatus) {
        t1 = ideInstallationStatus ? (0, ide_js_1.isJetBrainsIde)(ideInstallationStatus?.ideType) : false;
    ...
    if ($[2] !== addNotification || $[3] !== ideStatus || $[4] !== removeNotification || $[5] !== showJetBrainsInfo) {
        t2 = () => {
            ...
            if (hasShownHintRef.current || ((0, config_js_1.getGlobalConfig)().ideHintShownCount ?? 0) >= MAX_IDE_HINT_SHOW_COUNT) {
                return;
            }
...
function _temp2(hasShownHintRef_0, addNotification_0) {
    (0, ide_js_1.detectIDEs)(true).then(infos => {
        ...
        if (ideName_0 && !hasShownHintRef_0.current) {
            ...
            addNotification_0({
                ...
                jsx: react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    "/ide for ",
                    react_1.default.createElement(ink_js_1.Text, { color: "ide" }, ideName_0)),
                priority: "low"
            });
        }
    });
