...
function AdvisorMessage(t0) {
    ...
    if (block.type === "server_tool_use") {
        let t1;
        if ($[0] !== block.input) {
            t1 = block.input && Object.keys(block.input).length > 0 ? (0, slowOperations_js_1.jsonStringify)(block.input) : null;
            $[0] = block.input;
            $[1] = t1;
        }
        else {
        ...
        if ($[8] !== shouldAnimate || $[9] !== t4 || $[10] !== t5) {
            t6 = react_1.default.createElement(ToolUseLoader_js_1.ToolUseLoader, { shouldAnimate: shouldAnimate, isUnresolved: t4, isError: t5 });
            $[8] = shouldAnimate;
            $[9] = t4;
            $[10] = t5;
            $[11] = t6;
        ...
        if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
            t7 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Advising");
            $[12] = t7;
        }
        else {
            t7 = $[12];
        ...
        let t8;
        if ($[13] !== advisorModel) {
            t8 = advisorModel ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                " using ",
                (0, model_js_1.renderModelName)(advisorModel)) : null;
            $[13] = advisorModel;
            $[14] = t8;
        }
        else {
        ...
        let t9;
        if ($[15] !== input) {
            t9 = input ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                " \u00B7 ",
                input) : null;
            $[15] = input;
            $[16] = t9;
        ...
        if ($[17] !== t2 || $[18] !== t6 || $[19] !== t8 || $[20] !== t9) {
            t10 = react_1.default.createElement(ink_js_1.Box, { marginTop: t2, paddingRight: 2, flexDirection: "row" },
                t6,
                t7,
                t8,
                t9);
        ...
        case "advisor_result":
            {
                ...
                if ($[24] !== block.content.text || $[25] !== verbose) {
                    t1 = verbose ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, block.content.text) : react_1.default.createElement(ink_js_1.Text, { dimColor: true },
    ...
    let t1;
    if ($[28] !== body) {
        t1 = react_1.default.createElement(ink_js_1.Box, { paddingRight: 2 },
            react_1.default.createElement(MessageResponse_js_1.MessageResponse, null, body));
        $[28] = body;
        $[29] = t1;
    }
    else {
