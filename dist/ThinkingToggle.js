...
function ThinkingToggle(t0) {
    ...
    const [confirmationPending, setConfirmationPending] = (0, react_1.useState)(null);
    let t1;
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = React.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
            React.createElement(ink_js_1.Text, { color: "remember", bold: true }, "Toggle thinking mode"),
            React.createElement(ink_js_1.Text, { dimColor: true }, "Enable or disable thinking for this session."));
        $[14] = t8;
    }
    else {
        t8 = $[14];
    ...
    if ($[15] !== confirmationPending || $[16] !== currentValue || $[17] !== handleSelectChange || $[18] !== onCancel) {
        t9 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t8,
            confirmationPending !== null ? React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1, gap: 1 },
                React.createElement(ink_js_1.Text, { color: "warning" }, "Changing thinking mode mid-conversation will increase latency and may reduce quality. For best results, set this at the start of a session."),
                React.createElement(ink_js_1.Text, { color: "warning" }, "Do you want to proceed?")) : React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(index_js_1.Select, { defaultValue: currentValue ? "true" : "false", defaultFocusValue: currentValue ? "true" : "false", options: options, onChange: handleSelectChange, onCancel: onCancel ?? _temp, visibleOptionCount: 2 })));
    ...
    if ($[20] !== confirmationPending || $[21] !== exitState.keyName || $[22] !== exitState.pending) {
        t10 = React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, exitState.pending ? React.createElement(React.Fragment, null,
            "Press ",
            exitState.keyName,
            " again to exit") : confirmationPending !== null ? React.createElement(Byline_js_1.Byline, null,
            React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "confirm" }),
            React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" })) : React.createElement(Byline_js_1.Byline, null,
            React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "confirm" }),
            React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "exit" })));
    ...
    let t11;
    if ($[24] !== t10 || $[25] !== t9) {
        t11 = React.createElement(Pane_js_1.Pane, { color: "permission" },
            t9,
            t10);
        $[24] = t10;
        $[25] = t9;
