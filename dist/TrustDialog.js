...
function TrustDialog(t0) {
    ...
    const hasTrustDialogAccepted = (0, config_js_2.checkHasTrustDialogAccepted)();
    let t12;
    let t13;
    if ($[13] !== hasAnyBashExecution) {
        t12 = () => {
            const isHomeDir = (0, os_1.homedir)() === (0, cwd_js_1.getCwd)();
    ...
    if ($[16] !== hasAnyBashExecution || $[17] !== onDone) {
        t14 = function onChange(value) {
            ...
            const isHomeDir_0 = (0, os_1.homedir)() === (0, cwd_js_1.getCwd)();
    ...
    const onChange = t14;
    const exitState = (0, useExitOnCtrlCDWithKeybindings_js_1.useExitOnCtrlCDWithKeybindings)(_temp6);
    let t15;
    ...
    if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
        t16 = react_1.default.createElement(ink_js_1.Text, { bold: true }, (0, fsOperations_js_1.getFsImplementation)().cwd());
    ...
    if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            react_1.default.createElement(ink_js_1.Link, { url: "https://code.claude.com/docs/en/security" }, "Security guide"));
        $[23] = t19;
    }
    else {
        t19 = $[23];
    ...
    let t21;
    if ($[25] !== onChange) {
        t21 = react_1.default.createElement(index_js_2.Select, { options: t20, onChange: value_0 => onChange(value_0), onCancel: () => onChange("exit") });
        $[25] = onChange;
        $[26] = t21;
    }
    else {
    ...
    if ($[27] !== exitState.keyName || $[28] !== exitState.pending) {
        t22 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, exitState.pending ? react_1.default.createElement(react_1.default.Fragment, null,
            "Press ",
            exitState.keyName,
            " again to exit") : react_1.default.createElement(react_1.default.Fragment, null, "Enter to confirm \u00B7 Esc to cancel"));
    ...
    let t23;
    if ($[30] !== t21 || $[31] !== t22) {
        t23 = react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { color: "warning", titleColor: "warning", title: "Accessing workspace:" },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, paddingTop: 1 },
                t16,
                t17,
                t18,
                t19,
