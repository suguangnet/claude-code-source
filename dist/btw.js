...
const SpinnerGlyph_js_1 = require("../../components/Spinner/SpinnerGlyph.js");
...
function BtwSideQuestion(t0) {
    ...
    const { rows } = (0, modalContext_js_1.useModalOrTerminalSize)((0, useTerminalSize_js_1.useTerminalSize)());
    let t1;
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = React.createElement(ink_js_1.Text, { color: "warning", bold: true },
            "/btw",
            " ");
        $[7] = t5;
    }
    ...
    let t6;
    if ($[8] !== question) {
        t6 = React.createElement(ink_js_1.Box, null,
            t5,
            React.createElement(ink_js_1.Text, { dimColor: true }, question));
        $[8] = question;
        $[9] = t6;
    }
    else {
    ...
    if ($[10] !== error || $[11] !== frame || $[12] !== response) {
        t7 = React.createElement(ScrollBox_js_1.default, { ref: scrollRef, flexDirection: "column", flexGrow: 1 }, error ? React.createElement(ink_js_1.Text, { color: "error" }, error) : response ? React.createElement(Markdown_js_1.Markdown, null, response) : React.createElement(ink_js_1.Box, null,
            React.createElement(SpinnerGlyph_js_1.SpinnerGlyph, { frame: frame, messageColor: "warning" }),
            React.createElement(ink_js_1.Text, { color: "warning" }, "Answering...")));
        $[10] = error;
        $[11] = frame;
        $[12] = response;
        $[13] = t7;
    ...
    if ($[14] !== maxContentHeight || $[15] !== t7) {
        t8 = React.createElement(ink_js_1.Box, { marginTop: 1, marginLeft: 2, maxHeight: maxContentHeight }, t7);
        $[14] = maxContentHeight;
        $[15] = t7;
        $[16] = t8;
    }
    ...
    if ($[17] !== error || $[18] !== response) {
        t9 = (response || error) && React.createElement(ink_js_1.Box, { marginTop: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true },
                figures_js_1.UP_ARROW,
                "/",
                figures_js_1.DOWN_ARROW,
    ...
    if ($[20] !== handleKeyDown || $[21] !== t6 || $[22] !== t8 || $[23] !== t9) {
        t10 = React.createElement(ink_js_1.Box, { flexDirection: "column", paddingLeft: 2, marginTop: 1, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
            t6,
            t8,
            t9);
        $[20] = handleKeyDown;
...
async function buildCacheSafeParams(context) {
    const forkContextMessages = (0, messages_js_1.getMessagesAfterCompactBoundary)(stripInProgressAssistantMessage(context.messages));
    ...
    const [rawSystemPrompt, userContext, systemContext] = await Promise.all([(0, prompts_js_1.getSystemPrompt)(context.options.tools, context.options.mainLoopModel, [], context.options.mcpClients), (0, context_js_1.getUserContext)(), (0, context_js_1.getSystemContext)()]);
    return {
