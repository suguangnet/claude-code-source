...
function IdleReturnDialog(t0) {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, null, "If this is a new task, clearing context will save usage and be faster."));
        $[6] = t5;
    }
    else {
        t5 = $[6];
    ...
    let t9;
    if ($[10] !== onDone) {
        t9 = react_1.default.createElement(index_js_1.Select, { options: t8, onChange: value => onDone(value) });
        $[10] = onDone;
        $[11] = t9;
    }
    else {
    ...
    if ($[12] !== t3 || $[13] !== t4 || $[14] !== t9) {
        t10 = react_1.default.createElement(Dialog_js_1.Dialog, { title: t3, onCancel: t4 },
            t5,
            t9);
        $[12] = t3;
        $[13] = t4;
