...
function DiagnosticsDisplay(t0) {
    ...
    if (verbose) {
        ...
        let t3;
        if ($[4] !== t2) {
            t3 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" }, t2);
            $[4] = t2;
            $[5] = t3;
        }
        else {
        ...
        let t2;
        if ($[6] !== totalIssues) {
            t2 = react_1.default.createElement(ink_js_1.Text, { bold: true }, totalIssues);
            $[6] = totalIssues;
            $[7] = t2;
        }
        else {
        ...
        if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = react_1.default.createElement(CtrlOToExpand_js_1.CtrlOToExpand, null);
            $[8] = t5;
        }
        else {
            t5 = $[8];
        ...
        if ($[9] !== fileCount || $[10] !== t2 || $[11] !== t3 || $[12] !== t4) {
            t6 = react_1.default.createElement(MessageResponse_js_1.MessageResponse, null,
...
function _temp3(file_0, fileIndex) {
    return react_1.default.createElement(react_1.default.Fragment, { key: fileIndex },
        react_1.default.createElement(MessageResponse_js_1.MessageResponse, null,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true, wrap: "wrap" },
                react_1.default.createElement(ink_js_1.Text, { bold: true }, (0, path_1.relative)((0, cwd_js_1.getCwd)(), file_0.uri.replace("file://", "").replace("_claude_fs_right:", ""))),
                " ",
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, file_0.uri.startsWith("file://") ? "(file://)" : file_0.uri.startsWith("_claude_fs_right:") ? "(claude_fs_right)" : `(${file_0.uri.split(":")[0]})`),
                ":")),
        file_0.diagnostics.map(_temp2));
}
function _temp2(diagnostic, diagIndex) {
    return react_1.default.createElement(MessageResponse_js_1.MessageResponse, { key: diagIndex },
        react_1.default.createElement(ink_js_1.Text, { dimColor: true, wrap: "wrap" },
            "  ",
            diagnosticTracking_js_1.DiagnosticTrackingService.getSeveritySymbol(diagnostic.severity),
            " [Line ",
