...
function resolveCwdReentry(normalized) {
    if (!normalized.startsWith('../'))
        return normalized;
    const cwdBase = (0, path_1.basename)((0, cwd_js_1.getCwd)()).toLowerCase();
    if (!cwdBase)
        return normalized;
...
function resolveEscapingPathToCwdRelative(n) {
    ...
    const abs = (0, path_1.resolve)(cwd, n);
    const cwdWithSep = cwd.endsWith(path_1.sep) ? cwd : cwd + path_1.sep;
