...
async function getTaskOutput(shell) {
    const path = (0, diskOutput_js_1.getTaskOutputPath)(shell.id);
    try {
        const result = await (0, fsOperations_js_1.tailFile)(path, SHELL_DETAIL_TAIL_BYTES);
        return {
...
function ShellDetailDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(57);
    ...
    const [outputPromise, setOutputPromise] = (0, react_1.useState)(t1);
    const deferredOutputPromise = (0, react_1.useDeferredValue)(outputPromise);
    let t2;
    if ($[2] !== shell) {
        t2 = () => {
    ...
    if ($[19] !== onBack || $[20] !== onKillShell || $[21] !== shell.status) {
        t10 = exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
            "Press ",
            exitState.keyName,
            ...
            shell.status === "running" && onKillShell && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "x", action: "stop" }));
        $[19] = onBack;
        $[20] = onKillShell;
        $[21] = shell.status;
        $[22] = t10;
    ...
    if ($[23] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Status:");
        $[23] = t11;
    }
    else {
        t11 = $[23];
    ...
    if ($[24] !== shell.result || $[25] !== shell.status) {
        t12 = react_1.default.createElement(ink_js_1.Text, null,
            t11,
            " ",
            shell.status === "running" ? react_1.default.createElement(ink_js_1.Text, { color: "background" },
                shell.status,
                shell.result?.code !== undefined && ` (exit code: ${shell.result.code})`) : shell.status === "completed" ? react_1.default.createElement(ink_js_1.Text, { color: "success" },
                shell.status,
                shell.result?.code !== undefined && ` (exit code: ${shell.result.code})`) : react_1.default.createElement(ink_js_1.Text, { color: "error" },
                shell.status,
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Runtime:");
        $[27] = t13;
    }
    else {
        t13 = $[27];
    ...
    let t17;
    if ($[32] !== t16) {
        t17 = react_1.default.createElement(ink_js_1.Text, null,
            t13,
            " ",
            t16);
        $[32] = t16;
    ...
    let t19;
    if ($[34] !== t18) {
        t19 = react_1.default.createElement(ink_js_1.Text, { bold: true }, t18);
        $[34] = t18;
        $[35] = t19;
    }
    else {
    ...
    if ($[36] !== displayCommand || $[37] !== t19) {
        t20 = react_1.default.createElement(ink_js_1.Text, { wrap: "wrap" },
            t19,
            " ",
            displayCommand);
        $[36] = displayCommand;
    ...
    if ($[39] !== t12 || $[40] !== t17 || $[41] !== t20) {
        t21 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t12,
            t17,
            t20);
        $[39] = t12;
    ...
    if ($[43] === Symbol.for("react.memo_cache_sentinel")) {
        t22 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Output:");
        $[43] = t22;
    }
    else {
        t22 = $[43];
    ...
    if ($[44] === Symbol.for("react.memo_cache_sentinel")) {
        t23 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Loading output\u2026");
        $[44] = t23;
    }
    else {
        t23 = $[44];
    ...
    if ($[45] !== columns || $[46] !== deferredOutputPromise) {
        t24 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t22,
            react_1.default.createElement(react_1.Suspense, { fallback: t23 },
                react_1.default.createElement(ShellOutputContent, { outputPromise: deferredOutputPromise, columns: columns })));
        $[45] = columns;
    ...
    if ($[48] !== handleClose || $[49] !== t10 || $[50] !== t21 || $[51] !== t24 || $[52] !== t9) {
        t25 = react_1.default.createElement(Dialog_js_1.Dialog, { title: t9, onCancel: handleClose, color: "background", inputGuide: t10 },
            t21,
            t24);
        $[48] = handleClose;
        $[49] = t10;
    ...
    if ($[54] !== handleKeyDown || $[55] !== t25) {
        t26 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown }, t25);
        $[54] = handleKeyDown;
        $[55] = t25;
        $[56] = t26;
    }
...
function ShellOutputContent(t0) {
    ...
    const { content, bytesTotal } = (0, react_1.use)(outputPromise);
    if (!content) {
        let t1;
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "No output available");
            $[0] = t1;
        }
        else {
            t1 = $[0];
    ...
    let t3;
    if ($[7] !== t1 || $[8] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Box, { borderStyle: "round", paddingX: 1, flexDirection: "column", height: 12, maxWidth: t1 }, t2);
        $[7] = t1;
        $[8] = t2;
        $[9] = t3;
    }
    ...
    if ($[10] !== bytesTotal || $[11] !== isIncomplete) {
        t5 = isIncomplete ? ` of ${(0, format_js_1.formatFileSize)(bytesTotal)}` : "";
        $[10] = bytesTotal;
        $[11] = isIncomplete;
        $[12] = t5;
    }
    ...
    let t6;
    if ($[13] !== t4 || $[14] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true },
            t4,
            t5);
        $[13] = t4;
        $[14] = t5;
    ...
    let t7;
    if ($[16] !== t3 || $[17] !== t6) {
        t7 = react_1.default.createElement(react_1.default.Fragment, null,
            t3,
            t6);
        $[16] = t3;
        $[17] = t6;
...
function _temp2(line_0, i_1) {
    return react_1.default.createElement(ink_js_1.Text, { key: i_1, wrap: "truncate-end" }, line_0);
}
