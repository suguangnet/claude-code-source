...
const FeedbackSurveyView_js_1 = require("./FeedbackSurveyView.js");
const TranscriptSharePrompt_js_1 = require("./TranscriptSharePrompt.js");
...
function FeedbackSurvey(t0) {
    ...
    if (state === "thanks") {
        ...
        if ($[0] !== inputValue || $[1] !== lastResponse || $[2] !== onRequestFeedback || $[3] !== setInputValue) {
            t1 = react_1.default.createElement(FeedbackSurveyThanks, { lastResponse: lastResponse, inputValue: inputValue, setInputValue: setInputValue, onRequestFeedback: onRequestFeedback });
            $[0] = inputValue;
            $[1] = lastResponse;
            $[2] = onRequestFeedback;
            $[3] = setInputValue;
    ...
    if (state === "transcript_prompt") {
        ...
        if ($[7] !== handleTranscriptSelect || $[8] !== inputValue || $[9] !== setInputValue) {
            t1 = react_1.default.createElement(TranscriptSharePrompt_js_1.TranscriptSharePrompt, { onSelect: handleTranscriptSelect, inputValue: inputValue, setInputValue: setInputValue });
    ...
    if ($[11] !== handleSelect || $[12] !== inputValue || $[13] !== message || $[14] !== setInputValue) {
        t1 = react_1.default.createElement(FeedbackSurveyView_js_1.FeedbackSurveyView, { onSelect: handleSelect, inputValue: inputValue, setInputValue: setInputValue, message: message });
        $[11] = handleSelect;
        $[12] = inputValue;
        $[13] = message;
        $[14] = setInputValue;
...
function FeedbackSurveyThanks(t0) {
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Text, { color: "success" }, "Thanks for the feedback!");
        $[8] = t4;
    }
    else {
        t4 = $[8];
    ...
    if ($[9] !== lastResponse || $[10] !== showFollowUp) {
        t5 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
            t4,
            showFollowUp ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                "(Optional) Press [",
                react_1.default.createElement(ink_js_1.Text, { color: "ansi:cyan" }, "1"),
                "] to tell us what went well ",
                " \xB7 ",
                feedbackCommand) : lastResponse === "bad" ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Use /issue to report model behavior issues.") : react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                "Use ",
                feedbackCommand,
