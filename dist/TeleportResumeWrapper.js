...
const useTeleportResume_js_1 = require("../hooks/useTeleportResume.js");
const ink_js_1 = require("../ink.js");
const useKeybinding_js_1 = require("../keybindings/useKeybinding.js");
const ResumeTask_js_1 = require("./ResumeTask.js");
...
function TeleportResumeWrapper(t0) {
    ...
    const { resumeSession, isResuming, error, selectedSession } = (0, useTeleportResume_js_1.useTeleportResume)(source);
    let t2;
    let t3;
    if ($[0] !== source) {
        t2 = () => {
    ...
    if (isResuming && selectedSession) {
        ...
        if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row" },
                ...
                react_1.default.createElement(ink_js_1.Text, { bold: true }, "Resuming session\u2026"));
            $[12] = t8;
        }
        else {
            t8 = $[12];
        ...
        if ($[13] !== selectedSession.title) {
            t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", padding: 1 },
                t8,
    ...
    if (error && !onError) {
        ...
        if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = react_1.default.createElement(ink_js_1.Text, { bold: true, color: "error" }, "Failed to resume session");
            $[15] = t8;
        }
        else {
            t8 = $[15];
        ...
        let t9;
        if ($[16] !== error.message) {
            t9 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, error.message);
            $[16] = error.message;
            $[17] = t9;
        }
        else {
        ...
        if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    "Press ",
        ...
        let t11;
        if ($[19] !== t9) {
            t11 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", padding: 1 },
                t8,
                t9,
                t10);
            $[19] = t9;
    ...
    if ($[21] !== handleCancel || $[22] !== handleSelect || $[23] !== isEmbedded) {
        t8 = react_1.default.createElement(ResumeTask_js_1.ResumeTask, { onSelect: handleSelect, onCancel: handleCancel, isEmbedded: isEmbedded });
        $[21] = handleCancel;
        $[22] = handleSelect;
        $[23] = isEmbedded;
        $[24] = t8;
