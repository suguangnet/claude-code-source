...
const createMovedToPluginCommand_js_1 = require("./createMovedToPluginCommand.js");
...
exports.default = (0, createMovedToPluginCommand_js_1.createMovedToPluginCommand)({
    ...
    async getPromptWhileMarketplaceIsPrivate(_args, context) {
        ...
        const parsed = (0, frontmatterParser_js_1.parseFrontmatter)(SECURITY_REVIEW_MARKDOWN);
        // Parse allowed tools from frontmatter
        const allowedTools = (0, markdownConfigLoader_js_1.parseSlashCommandToolsFromFrontmatter)(parsed.frontmatter['allowed-tools']);
        // Execute bash commands in the prompt
        const processedContent = await (0, promptShellExecution_js_1.executeShellCommandsInPrompt)(parsed.content, {
            ...context,
            getAppState() {
