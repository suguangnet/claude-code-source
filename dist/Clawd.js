...
function Clawd(t0) {
    ...
    let t3;
    if ($[4] !== p.r1L) {
        t3 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, p.r1L);
        $[4] = p.r1L;
        $[5] = t3;
    }
    else {
    ...
    let t4;
    if ($[6] !== p.r1E) {
        t4 = React.createElement(ink_js_1.Text, { color: "clawd_body", backgroundColor: "clawd_background" }, p.r1E);
        $[6] = p.r1E;
        $[7] = t4;
    }
    else {
    ...
    let t5;
    if ($[8] !== p.r1R) {
        t5 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, p.r1R);
        $[8] = p.r1R;
        $[9] = t5;
    }
    else {
    ...
    let t7;
    if ($[14] !== p.r2L) {
        t7 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, p.r2L);
        $[14] = p.r2L;
        $[15] = t7;
    }
    else {
    ...
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = React.createElement(ink_js_1.Text, { color: "clawd_body", backgroundColor: "clawd_background" }, "\u2588\u2588\u2588\u2588\u2588");
        $[16] = t8;
    }
    else {
        t8 = $[16];
    ...
    let t9;
    if ($[17] !== p.r2R) {
        t9 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, p.r2R);
        $[17] = p.r2R;
        $[18] = t9;
    }
    else {
    ...
    if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = React.createElement(ink_js_1.Text, { color: "clawd_body" },
            "  ",
            "\u2598\u2598 \u259D\u259D",
            "  ");
        $[22] = t11;
...
function AppleTerminalClawd(t0) {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, "\u2597");
        $[0] = t1;
    }
    else {
        t1 = $[0];
    ...
    let t3;
    if ($[1] !== t2) {
        t3 = React.createElement(ink_js_1.Text, { color: "clawd_background", backgroundColor: "clawd_body" }, t2);
        $[1] = t2;
        $[2] = t3;
    }
    else {
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, "\u2596");
        $[3] = t4;
    }
    else {
        t4 = $[3];
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(ink_js_1.Text, { backgroundColor: "clawd_body" }, " ".repeat(7));
        t7 = React.createElement(ink_js_1.Text, { color: "clawd_body" }, "\u2598\u2598 \u259D\u259D");
        $[6] = t6;
        $[7] = t7;
    }
    else {
    ...
    let t8;
    if ($[8] !== t5) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column", alignItems: "center" },
            t5,
            t6,
            t7);
        $[8] = t5;
