...
function Button(t0) {
    ...
    const activeTimer = (0, react_1.useRef)(null);
    let t2;
    let t3;
    ...
    if ($[22] !== autoFocus || $[23] !== content || $[24] !== handleClick || $[25] !== handleKeyDown || $[26] !== ref || $[27] !== style || $[28] !== tabIndex) {
        t11 = react_1.default.createElement(Box_js_1.default, { ref: ref, tabIndex: tabIndex, autoFocus: autoFocus, onKeyDown: handleKeyDown, onClick: handleClick, onFocus: handleFocus, onBlur: handleBlur, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...style }, content);
        $[22] = autoFocus;
        $[23] = content;
        $[24] = handleClick;
        $[25] = handleKeyDown;
