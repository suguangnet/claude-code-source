...
const index_js_1 = require("src/commands/extra-usage/index.js");
const ink_js_1 = require("src/ink.js");
const claudeAiLimitsHook_js_1 = require("src/services/claudeAiLimitsHook.js");
const rateLimitMocking_js_1 = require("src/services/rateLimitMocking.js"); // Used for /mock-limits command
const auth_js_1 = require("src/utils/auth.js");
const billing_js_1 = require("src/utils/billing.js");
const MessageResponse_js_1 = require("../MessageResponse.js");
function getUpsellMessage({ shouldShowUpsell, isMax20x, isExtraUsageCommandEnabled, shouldAutoOpenRateLimitOptionsMenu, isTeamOrEnterprise, hasBillingAccess }) {
    if (!shouldShowUpsell)
        return null;
    if (isMax20x) {
...
function RateLimitMessage(t0) {
    ...
    const [hasOpenedInteractiveMenu, setHasOpenedInteractiveMenu] = (0, react_1.useState)(false);
    ...
    bb0: {
        ...
        let t8;
        if ($[9] !== message) {
            t8 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, message);
            $[9] = message;
            $[10] = t8;
        }
        else {
    ...
    let t7;
    if ($[11] !== text) {
        t7 = react_1.default.createElement(ink_js_1.Text, { color: "error" }, text);
        $[11] = text;
        $[12] = t7;
    }
    else {
    ...
    let t9;
    if ($[13] !== t7 || $[14] !== t8) {
        t9 = react_1.default.createElement(MessageResponse_js_1.MessageResponse, null,
