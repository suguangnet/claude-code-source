...
function Byline(t0) {
    ...
    if ($[0] !== children) {
        ...
        bb0: {
            const validChildren = react_1.Children.toArray(children);
    ...
    let t3;
    if ($[3] !== t1) {
        t3 = react_1.default.createElement(react_1.default.Fragment, null, t1);
        $[3] = t1;
        $[4] = t3;
    }
    else {
...
function _temp(child, index) {
    return react_1.default.createElement(react_1.default.Fragment, { key: (0, react_1.isValidElement)(child) ? child.key ?? index : index },
        index > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " \u00B7 "),
        child);
}
