...
const PreviewBox_js_1 = require("./PreviewBox.js");
const QuestionNavigationBar_js_1 = require("./QuestionNavigationBar.js");
/**
 ...
 */
function PreviewQuestionView({ question, questions, currentQuestionIndex, answers, questionStates, hideSubmitTab = false, minContentHeight, minContentWidth, onUpdateQuestionState, onAnswer, onTextInputFocus, onCancel, onTabPrev, onTabNext, onRespondToClaude, onFinishPlanInterview }) {
    const isInPlanMode = (0, AppState_js_1.useAppState)(s => s.toolPermissionContext.mode) === 'plan';
    const [isFooterFocused, setIsFooterFocused] = (0, react_1.useState)(false);
    const [footerIndex, setFooterIndex] = (0, react_1.useState)(0);
    const [isInNotesInput, setIsInNotesInput] = (0, react_1.useState)(false);
    ...
    const prevQuestionText = (0, react_1.useRef)(questionText);
    ...
    const handleSelectOption = (0, react_1.useCallback)((index) => {
    ...
    (0, useKeybinding_js_1.useKeybinding)('chat:externalEditor', async () => {
        const currentValue = questionState?.textInputValue || '';
        const result = await (0, promptEditor_js_1.editPromptInEditor)(currentValue);
    ...
    const handleNotesExit = (0, react_1.useCallback)(() => {
    ...
    const handleDownFromPreview = (0, react_1.useCallback)(() => {
        setIsFooterFocused(true);
    }, []);
    const handleUpFromFooter = (0, react_1.useCallback)(() => {
    ...
    const previewMaxLines = (0, react_1.useMemo)(() => {
        return minContentHeight ? Math.max(1, minContentHeight - PREVIEW_OVERHEAD) : undefined;
    }, [minContentHeight]);
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
        react_1.default.createElement(Divider_js_1.Divider, { color: "inactive" }),
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingTop: 0 },
            react_1.default.createElement(QuestionNavigationBar_js_1.QuestionNavigationBar, { questions: questions, currentQuestionIndex: currentQuestionIndex, answers: answers, hideSubmitTab: hideSubmitTab }),
            react_1.default.createElement(PermissionRequestTitle_js_1.PermissionRequestTitle, { title: question.question, color: 'text' }),
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", minHeight: minContentHeight },
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "row", gap: 4 },
                    react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", width: 30 }, allOptions.map((option_0, index_0) => {
                        const isFocused = focusedIndex === index_0;
                        const isSelected = selectedValue === option_0.label;
                        return react_1.default.createElement(ink_js_1.Box, { key: option_0.label, flexDirection: "row" },
                            isFocused ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : react_1.default.createElement(ink_js_1.Text, null, " "),
                            react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                                " ",
                                index_0 + 1,
                                "."),
                            react_1.default.createElement(ink_js_1.Text, { color: isSelected ? 'success' : isFocused ? 'suggestion' : undefined, bold: isFocused },
                                ' ',
                                option_0.label),
                            isSelected && react_1.default.createElement(ink_js_1.Text, { color: "success" },
                                " ",
                                figures_1.default.tick));
                    })),
                    react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", flexGrow: 1 },
                        react_1.default.createElement(PreviewBox_js_1.PreviewBox, { content: previewContent || 'No preview available', maxLines: previewMaxLines, minWidth: minContentWidth, maxWidth: previewMaxWidth }),
                        react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "row", gap: 1 },
                            react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, "Notes:"),
                            isInNotesInput ? react_1.default.createElement(TextInput_js_1.default, { value: notesValue, placeholder: "Add notes on this design\u2026", onChange: value => {
                                    onUpdateQuestionState(questionText, {
                                        textInputValue: value
                                    }, false);
                                }, onSubmit: handleNotesExit, onExit: handleNotesExit, focus: true, showCursor: true, columns: 60, cursorOffset: cursorOffset, onChangeCursorOffset: setCursorOffset }) : react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, notesValue || 'press n to add notes')))),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
                    ...
                    react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
                        isFooterFocused && footerIndex === 0 ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : react_1.default.createElement(ink_js_1.Text, null, " "),
                        react_1.default.createElement(ink_js_1.Text, { color: isFooterFocused && footerIndex === 0 ? 'suggestion' : undefined }, "Chat about this")),
                    isInPlanMode && react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
                        isFooterFocused && footerIndex === 1 ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : react_1.default.createElement(ink_js_1.Text, null, " "),
                        react_1.default.createElement(ink_js_1.Text, { color: isFooterFocused && footerIndex === 1 ? 'suggestion' : undefined }, "Skip interview and plan immediately"))),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(ink_js_1.Text, { color: "inactive", dimColor: true },
                        "Enter to select \u00B7 ",
                        figures_1.default.arrowUp,
                        "/",
                        figures_1.default.arrowDown,
                        " to navigate \u00B7 n to add notes",
                        questions.length > 1 && react_1.default.createElement(react_1.default.Fragment, null, " \u00B7 Tab to switch questions"),
                        isInNotesInput && editorName && react_1.default.createElement(react_1.default.Fragment, null,
                            " \u00B7 ctrl+g to edit in ",
                            editorName),
                        ' ',
                        "\u00B7 Esc to cancel")))));
