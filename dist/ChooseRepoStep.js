...
function ChooseRepoStep(t0) {
    ...
    const [showEmptyError, setShowEmptyError] = (0, react_1.useState)(false);
    ...
    if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: true }, "Install GitHub App"),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Select GitHub repository"));
        $[20] = t9;
    }
    else {
        t9 = $[20];
    ...
    if ($[21] !== currentRepo || $[22] !== useCurrentRepo) {
        t10 = currentRepo && react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: useCurrentRepo, color: useCurrentRepo ? "permission" : undefined },
                useCurrentRepo ? "> " : "  ",
    ...
    if ($[24] !== t11 || $[25] !== t12 || $[26] !== t13 || $[27] !== t14) {
        t15 = react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: t11, color: t12 },
                t13,
                t14));
        $[24] = t11;
        $[25] = t12;
    ...
    if ($[29] !== currentRepo || $[30] !== cursorOffset || $[31] !== handleSubmit || $[32] !== onRepoUrlChange || $[33] !== repoUrl || $[34] !== textInputColumns || $[35] !== useCurrentRepo) {
        t16 = (!useCurrentRepo || !currentRepo) && react_1.default.createElement(ink_js_1.Box, { marginLeft: 2, marginBottom: 1 },
            react_1.default.createElement(TextInput_js_1.default, { value: repoUrl, onChange: value => {
    ...
    if ($[37] !== t10 || $[38] !== t15 || $[39] !== t16) {
        t17 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", borderStyle: "round", paddingX: 1 },
            t9,
            t10,
            t15,
            t16);
    ...
    if ($[41] !== showEmptyError) {
        t18 = showEmptyError && react_1.default.createElement(ink_js_1.Box, { marginLeft: 3, marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { color: "error" }, "Please enter a repository name to continue"));
        $[41] = showEmptyError;
        $[42] = t18;
    }
    else {
    ...
    let t20;
    if ($[43] !== t19) {
        t20 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 3 },
    ...
    if ($[45] !== t17 || $[46] !== t18 || $[47] !== t20) {
        t21 = react_1.default.createElement(react_1.default.Fragment, null,
            t17,
            t18,
            t20);
        $[45] = t17;
