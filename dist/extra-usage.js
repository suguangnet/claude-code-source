...
async function call(onDone, context) {
    ...
    return react_1.default.createElement(login_js_1.Login, { startingMessage: 'Starting new login following /extra-usage. Exit with Ctrl-C to use existing account.', onDone: success => {
