...
const QuestionView_js_1 = require("./QuestionView.js");
const SubmitQuestionsView_js_1 = require("./SubmitQuestionsView.js");
const use_multiple_choice_state_js_1 = require("./use-multiple-choice-state.js");
...
function AskUserQuestionPermissionRequest(props) {
    ...
    if (settings.syntaxHighlightingDisabled) {
        let t0;
        if ($[0] !== props) {
            t0 = react_1.default.createElement(AskUserQuestionPermissionRequestBody, { ...props, highlight: null });
            $[0] = props;
            $[1] = t0;
        }
        else {
    ...
    let t0;
    if ($[2] !== props) {
        t0 = react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(AskUserQuestionPermissionRequestBody, { ...props, highlight: null }) },
            react_1.default.createElement(AskUserQuestionWithHighlight, { ...props }));
        $[2] = props;
        $[3] = t0;
    }
    else {
...
function AskUserQuestionWithHighlight(props) {
    ...
    const highlight = (0, react_1.use)(t0);
    let t1;
    if ($[1] !== highlight || $[2] !== props) {
        t1 = react_1.default.createElement(AskUserQuestionPermissionRequestBody, { ...props, highlight: highlight });
        $[1] = highlight;
        $[2] = props;
        $[3] = t1;
    }
...
function AskUserQuestionPermissionRequestBody(t0) {
    const $ = (0, compiler_runtime_1.c)(115);
    ...
    const questions = t2;
    const { rows: terminalRows } = (0, useTerminalSize_js_1.useTerminalSize)();
        ...
        for (const q of questions) {
            ...
            if (hasPreview) {
                ...
                for (const opt_0 of q.options) {
                    if (opt_0.preview) {
                        const rendered = (0, markdown_js_1.applyMarkdown)(opt_0.preview, theme, highlight);
    ...
    const [pastedContentsByQuestion, setPastedContentsByQuestion] = (0, react_1.useState)(t6);
    ...
    const toolPermissionContextMode = (0, AppState_js_1.useAppState)(_temp4);
    ...
    const state = (0, use_multiple_choice_state_js_1.useMultipleChoiceState)();
...
Questions asked and answers provided:\n${questionsWithAnswers_0}`;
    ...
    if (isInSubmitView) {
        ...
        if ($[107] !== allQuestionsAnswered || $[108] !== answers || $[109] !== currentQuestionIndex || $[110] !== globalContentHeight || $[111] !== handleFinalResponse || $[112] !== questions || $[113] !== toolUseConfirm.permissionResult) {
            t23 = react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(SubmitQuestionsView_js_1.SubmitQuestionsView, { questions: questions, currentQuestionIndex: currentQuestionIndex, answers: answers, allQuestionsAnswered: allQuestionsAnswered, permissionResult: toolUseConfirm.permissionResult, minContentHeight: globalContentHeight, onFinalResponse: handleFinalResponse }));
