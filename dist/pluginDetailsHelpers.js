...
function PluginSelectionKeyHint(t0) {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "plugin:toggle", context: "Plugin", fallback: "Space", description: "toggle" });
        t3 = React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "details" });
        t4 = React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" });
        $[2] = t2;
        $[3] = t3;
        $[4] = t4;
    }
    ...
    let t5;
    if ($[5] !== t1) {
        t5 = React.createElement(ink_js_1.Box, { marginTop: 1 },
