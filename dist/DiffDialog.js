...
const useDiffData_js_1 = require("../../hooks/useDiffData.js");
const useTurnDiffs_js_1 = require("../../hooks/useTurnDiffs.js");
...
const DiffDetailView_js_1 = require("./DiffDetailView.js");
const DiffFileList_js_1 = require("./DiffFileList.js");
...
function DiffDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(73);
    const { messages, onDone } = t0;
    const gitDiffData = (0, useDiffData_js_1.useDiffData)();
    const turnDiffs = (0, useTurnDiffs_js_1.useTurnDiffs)(messages);
    ...
    const prevSourceIndex = (0, react_1.useRef)(sourceIndex);
    let t7;
    let t8;
    if ($[13] !== sourceIndex) {
        t7 = () => {
    ...
    if ($[38] !== diffData.stats) {
        t17 = diffData.stats ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            diffData.stats.filesCount,
            " ",
            (0, stringUtils_js_1.plural)(diffData.stats.filesCount, "file"),
            " ",
            "changed",
            diffData.stats.linesAdded > 0 && react_1.default.createElement(ink_js_1.Text, { color: "diffAddedWord" },
                " +",
                diffData.stats.linesAdded),
            diffData.stats.linesRemoved > 0 && react_1.default.createElement(ink_js_1.Text, { color: "diffRemovedWord" },
                " -",
    ...
    if ($[40] !== sourceIndex || $[41] !== sources) {
        t18 = sources.length > 1 ? react_1.default.createElement(ink_js_1.Box, null,
            sourceIndex > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "\u25C0 "),
            sources.map((source, i) => {
                const isSelected = i === sourceIndex;
                const label = source.type === "current" ? "Current" : `T${source.turn.turnIndex}`;
                return react_1.default.createElement(ink_js_1.Text, { key: i, dimColor: !isSelected, bold: isSelected },
                    i > 0 ? " \xB7 " : "",
                    label);
            }),
            sourceIndex < sources.length - 1 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " \u25B6")) : null;
        $[40] = sourceIndex;
        $[41] = sources;
        $[42] = t18;
    }
    ...
    const dismissShortcut = (0, useShortcutDisplay_js_1.useShortcutDisplay)("diff:dismiss", "DiffDialog", "esc");
    let t19;
    bb0: {
        if (diffData.loading) {
            t19 = "Loading diff\u2026";
    ...
    if ($[43] !== headerSubtitle) {
        t20 = headerSubtitle && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            " ",
            headerSubtitle);
        $[43] = headerSubtitle;
        $[44] = t20;
    ...
    if ($[45] !== headerTitle || $[46] !== t20) {
        t21 = react_1.default.createElement(ink_js_1.Text, null,
            headerTitle,
            t20);
        $[45] = headerTitle;
        $[46] = t20;
    ...
    if ($[51] !== dismissShortcut || $[52] !== sources.length || $[53] !== viewMode) {
        t23 = exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
            "Press ",
            exitState.keyName,
            " again to exit") : viewMode === "list" ? react_1.default.createElement(Byline_js_1.Byline, null,
            sources.length > 1 && react_1.default.createElement(ink_js_1.Text, null, "\u2190/\u2192 source"),
            react_1.default.createElement(ink_js_1.Text, null, "\u2191/\u2193 select"),
            react_1.default.createElement(ink_js_1.Text, null, "Enter view"),
            react_1.default.createElement(ink_js_1.Text, null,
                dismissShortcut,
                " close")) : react_1.default.createElement(Byline_js_1.Byline, null,
            react_1.default.createElement(ink_js_1.Text, null, "\u2190 back"),
            react_1.default.createElement(ink_js_1.Text, null,
                dismissShortcut,
                " close"));
        $[51] = dismissShortcut;
    ...
    if ($[55] !== diffData.files || $[56] !== emptyMessage || $[57] !== selectedFile?.isBinary || $[58] !== selectedFile?.isLargeFile || $[59] !== selectedFile?.isTruncated || $[60] !== selectedFile?.isUntracked || $[61] !== selectedFile?.path || $[62] !== selectedHunks || $[63] !== selectedIndex || $[64] !== viewMode) {
        t24 = diffData.files.length === 0 ? react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, emptyMessage)) : viewMode === "list" ? react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            react_1.default.createElement(DiffFileList_js_1.DiffFileList, { files: diffData.files, selectedIndex: selectedIndex })) : react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            react_1.default.createElement(DiffDetailView_js_1.DiffDetailView, { filePath: selectedFile?.path || "", hunks: selectedHunks, isLargeFile: selectedFile?.isLargeFile, isBinary: selectedFile?.isBinary, isTruncated: selectedFile?.isTruncated, isUntracked: selectedFile?.isUntracked }));
        $[55] = diffData.files;
        $[56] = emptyMessage;
    ...
    if ($[66] !== handleCancel || $[67] !== sourceSelector || $[68] !== subtitle || $[69] !== t23 || $[70] !== t24 || $[71] !== title) {
        t25 = react_1.default.createElement(Dialog_js_1.Dialog, { title: title, onCancel: handleCancel, color: "background", inputGuide: t23 },
            sourceSelector,
            subtitle,
            t24);
        $[66] = handleCancel;
