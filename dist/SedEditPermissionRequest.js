...
const FileEditToolDiff_js_1 = require("src/components/FileEditToolDiff.js");
...
const FilePermissionDialog_js_1 = require("../FilePermissionDialog/FilePermissionDialog.js");
function SedEditPermissionRequest(t0) {
    ...
    if ($[3] !== filePath) {
        t1 = (async () => {
            const encoding = (0, fileRead_js_1.detectEncodingForResolvedPath)(filePath);
            const raw = await (0, fsOperations_js_1.getFsImplementation)().readFile(filePath, {
                encoding
            });
            return {
    ...
    if ($[5] !== contentPromise || $[6] !== props || $[7] !== sedInfo) {
        t2 = react_1.default.createElement(react_1.Suspense, { fallback: null },
            react_1.default.createElement(SedEditPermissionRequestInner, { sedInfo: sedInfo, contentPromise: contentPromise, ...props }));
        $[5] = contentPromise;
        $[6] = props;
        $[7] = sedInfo;
        $[8] = t2;
...
function SedEditPermissionRequestInner(t0) {
    ...
    const { filePath } = sedInfo;
    const { oldContent, fileExists } = (0, react_1.use)(contentPromise);
    let t1;
    ...
    if ($[18] !== t10) {
        t11 = react_1.default.createElement(ink_js_1.Text, null,
            ...
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, t10),
            "?");
        $[18] = t10;
        $[19] = t11;
    }
    ...
    if ($[20] !== edits || $[21] !== filePath || $[22] !== noChangesMessage) {
        t12 = edits.length > 0 ? react_1.default.createElement(FileEditToolDiff_js_1.FileEditToolDiff, { file_path: filePath, edits: edits }) : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, noChangesMessage);
        $[20] = edits;
        $[21] = filePath;
        $[22] = noChangesMessage;
        $[23] = t12;
    ...
    if ($[24] !== filePath || $[25] !== parseInput || $[26] !== props.onDone || $[27] !== props.onReject || $[28] !== props.toolUseConfirm || $[29] !== props.toolUseContext || $[30] !== props.workerBadge || $[31] !== t11 || $[32] !== t12 || $[33] !== t9) {
        t13 = react_1.default.createElement(FilePermissionDialog_js_1.FilePermissionDialog, { toolUseConfirm: t5, toolUseContext: t6, onDone: t7, onReject: t8, title: "Edit file", subtitle: t9, question: t11, content: t12, path: filePath, completionType: "str_replace_single", parseInput: parseInput, workerBadge: props.workerBadge });
        $[24] = filePath;
        $[25] = parseInput;
        $[26] = props.onDone;
        $[27] = props.onReject;
