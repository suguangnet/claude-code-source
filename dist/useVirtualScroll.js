 ...
 */
columns) {
    const heightCache = (0, react_1.useRef)(new Map());
    ...
    const offsetVersionRef = (0, react_1.useRef)(0);
    ...
    const refCache = (0, react_1.useRef)(new Map());
    ...
    const prevColumns = (0, react_1.useRef)(columns);
    const skipMeasurementRef = (0, react_1.useRef)(false);
    ...
    const prevRangeRef = (0, react_1.useRef)(null);
    const freezeRendersRef = (0, react_1.useRef)(0);
    ...
    const listOriginRef = (0, react_1.useRef)(0);
    const spacerRef = (0, react_1.useRef)(null);
    ...
    const dStart = (0, react_1.useDeferredValue)(start);
    const dEnd = (0, react_1.useDeferredValue)(end);
    ...
    const measureRef = (0, react_1.useCallback)((key) => {
    ...
    const getItemTop = (0, react_1.useCallback)((index) => {
        const yoga = itemRefs.current.get(itemKeys[index])?.yogaNode;
        if (!yoga || yoga.getComputedWidth() === 0)
            return -1;
        return yoga.getComputedTop();
    }, [itemKeys]);
    const getItemElement = (0, react_1.useCallback)((index) => itemRefs.current.get(itemKeys[index]) ?? null, [itemKeys]);
    const getItemHeight = (0, react_1.useCallback)((index) => heightCache.current.get(itemKeys[index]), [itemKeys]);
    const scrollToIndex = (0, react_1.useCallback)((i) => {
