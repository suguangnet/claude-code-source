...
function UnifiedInstalledCell(t0) {
    const $ = (0, compiler_runtime_1.c)(142);
    ...
    if (item.type === "plugin") {
        ...
        if (item.pendingToggle) {
            let t1;
            if ($[0] !== theme) {
                t1 = (0, ink_js_1.color)("suggestion", theme)(figures_1.default.arrowRight);
                $[0] = theme;
                $[1] = t1;
            }
            else {
            ...
            if (item.errorCount > 0) {
                let t1;
                if ($[2] !== theme) {
                    t1 = (0, ink_js_1.color)("error", theme)(figures_1.default.cross);
                    $[2] = theme;
                    $[3] = t1;
                }
                else {
                ...
                if ($[4] !== item.errorCount) {
                    t3 = (0, stringUtils_js_1.plural)(item.errorCount, "error");
                    $[4] = item.errorCount;
                    $[5] = t3;
                }
                else {
                ...
                if (!item.isEnabled) {
                    let t1;
                    if ($[6] !== theme) {
                        t1 = (0, ink_js_1.color)("inactive", theme)(figures_1.default.radioOff);
                        $[6] = theme;
                        $[7] = t1;
                    }
                    else {
                    ...
                    let t1;
                    if ($[8] !== theme) {
                        t1 = (0, ink_js_1.color)("success", theme)(figures_1.default.tick);
                        $[8] = theme;
                        $[9] = t1;
                    }
                    else {
        ...
        const t2 = isSelected ? `${figures_1.default.pointer} ` : "  ";
        let t3;
        if ($[10] !== t1 || $[11] !== t2) {
            t3 = React.createElement(ink_js_1.Text, { color: t1 }, t2);
            $[10] = t1;
            $[11] = t2;
            $[12] = t3;
        }
        ...
        if ($[13] !== item.name || $[14] !== t4) {
            t5 = React.createElement(ink_js_1.Text, { color: t4 }, item.name);
            $[13] = item.name;
            $[14] = t4;
            $[15] = t5;
        }
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
            t7 = React.createElement(ink_js_1.Text, { backgroundColor: "userMessageBackground" }, "Plugin");
            $[16] = t7;
        }
        else {
            t7 = $[16];
        ...
        let t8;
        if ($[17] !== t6) {
            t8 = React.createElement(ink_js_1.Text, { dimColor: t6 },
                " ",
                t7);
            $[17] = t6;
            $[18] = t8;
        ...
        if ($[21] !== statusIcon || $[22] !== t10) {
            t11 = React.createElement(ink_js_1.Text, { dimColor: t10 },
                " \u00B7 ",
                statusIcon,
                " ");
            $[21] = statusIcon;
        ...
        if ($[24] !== statusText || $[25] !== t12) {
            t13 = React.createElement(ink_js_1.Text, { dimColor: t12 }, statusText);
            $[24] = statusText;
            $[25] = t12;
            $[26] = t13;
        }
        ...
        if ($[27] !== t11 || $[28] !== t13 || $[29] !== t3 || $[30] !== t5 || $[31] !== t8 || $[32] !== t9) {
            t14 = React.createElement(ink_js_1.Box, null,
                t3,
                t5,
                t8,
                t9,
    ...
    if (item.type === "flagged-plugin") {
        let t1;
        if ($[34] !== theme) {
            t1 = (0, ink_js_1.color)("warning", theme)(figures_1.default.warning);
            $[34] = theme;
            $[35] = t1;
        }
        else {
        ...
        let t4;
        if ($[36] !== t2 || $[37] !== t3) {
            t4 = React.createElement(ink_js_1.Text, { color: t2 }, t3);
            $[36] = t2;
            $[37] = t3;
            $[38] = t4;
        }
        ...
        if ($[39] !== item.name || $[40] !== t5) {
            t6 = React.createElement(ink_js_1.Text, { color: t5 }, item.name);
            $[39] = item.name;
            $[40] = t5;
            $[41] = t6;
        }
        ...
        if ($[42] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = React.createElement(ink_js_1.Text, { backgroundColor: "userMessageBackground" }, "Plugin");
            $[42] = t8;
        }
        else {
            t8 = $[42];
        ...
        let t9;
        if ($[43] !== t7) {
            t9 = React.createElement(ink_js_1.Text, { dimColor: t7 },
                " ",
                t8);
            $[43] = t7;
            $[44] = t9;
        ...
        if ($[45] !== item.marketplace) {
            t10 = React.createElement(ink_js_1.Text, { dimColor: true },
                " \u00B7 ",
                item.marketplace);
            $[45] = item.marketplace;
            $[46] = t10;
        ...
        if ($[47] !== statusIcon_0 || $[48] !== t11) {
            t12 = React.createElement(ink_js_1.Text, { dimColor: t11 },
                " \u00B7 ",
                statusIcon_0,
                " ");
            $[47] = statusIcon_0;
        ...
        let t14;
        if ($[50] !== t13) {
            t14 = React.createElement(ink_js_1.Text, { dimColor: t13 }, "removed");
            $[50] = t13;
            $[51] = t14;
        }
        else {
        ...
        if ($[52] !== t10 || $[53] !== t12 || $[54] !== t14 || $[55] !== t4 || $[56] !== t6 || $[57] !== t9) {
            t15 = React.createElement(ink_js_1.Box, null,
                t4,
                t6,
                t9,
                t10,
    ...
    if (item.type === "failed-plugin") {
        ...
        const t4 = isSelected ? "suggestion" : undefined;
        const t5 = isSelected ? `${figures_1.default.pointer} ` : "  ";
        let t6;
        if ($[63] !== t4 || $[64] !== t5) {
            t6 = React.createElement(ink_js_1.Text, { color: t4 }, t5);
            $[63] = t4;
            $[64] = t5;
            $[65] = t6;
        }
        ...
        if ($[66] !== item.name || $[67] !== t7) {
            t8 = React.createElement(ink_js_1.Text, { color: t7 }, item.name);
            $[66] = item.name;
            $[67] = t7;
            $[68] = t8;
        }
        ...
        if ($[69] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = React.createElement(ink_js_1.Text, { backgroundColor: "userMessageBackground" }, "Plugin");
            $[69] = t10;
        }
        else {
            t10 = $[69];
        ...
        let t11;
        if ($[70] !== t9) {
            t11 = React.createElement(ink_js_1.Text, { dimColor: t9 },
                " ",
                t10);
            $[70] = t9;
            $[71] = t11;
        ...
        if ($[72] !== item.marketplace) {
            t12 = React.createElement(ink_js_1.Text, { dimColor: true },
                " \u00B7 ",
                item.marketplace);
            $[72] = item.marketplace;
            $[73] = t12;
        ...
        if ($[74] !== statusIcon_1 || $[75] !== t13) {
            t14 = React.createElement(ink_js_1.Text, { dimColor: t13 },
                " \u00B7 ",
                statusIcon_1,
                " ");
            $[74] = statusIcon_1;
        ...
        if ($[77] !== statusText_0 || $[78] !== t15) {
            t16 = React.createElement(ink_js_1.Text, { dimColor: t15 }, statusText_0);
            $[77] = statusText_0;
            $[78] = t15;
            $[79] = t16;
        }
        ...
        if ($[80] !== t11 || $[81] !== t12 || $[82] !== t14 || $[83] !== t16 || $[84] !== t6 || $[85] !== t8) {
            t17 = React.createElement(ink_js_1.Box, null,
                t6,
                t8,
                t11,
                t12,
        ...
        if (item.status === "disabled") {
            ...
            if (item.status === "pending") {
                ...
                if (item.status === "needs-auth") {
                    let t1;
                    if ($[93] !== theme) {
                        t1 = (0, ink_js_1.color)("warning", theme)(figures_1.default.triangleUpOutline);
                        $[93] = theme;
                        $[94] = t1;
                    }
                    else {
    ...
    if (item.indented) {
        ...
        let t5;
        if ($[100] !== t4) {
            t5 = React.createElement(ink_js_1.Text, { dimColor: t4 }, "\u2514 ");
            $[100] = t4;
            $[101] = t5;
        }
        else {
        ...
        if ($[102] !== item.name || $[103] !== t6) {
            t7 = React.createElement(ink_js_1.Text, { color: t6 }, item.name);
            $[102] = item.name;
            $[103] = t6;
            $[104] = t7;
        }
        ...
        if ($[105] === Symbol.for("react.memo_cache_sentinel")) {
            t9 = React.createElement(ink_js_1.Text, { backgroundColor: "userMessageBackground" }, "MCP");
            $[105] = t9;
        }
        else {
            t9 = $[105];
        ...
        let t10;
        if ($[106] !== t8) {
            t10 = React.createElement(ink_js_1.Text, { dimColor: t8 },
                " ",
                t9);
            $[106] = t8;
            $[107] = t10;
        ...
        if ($[111] !== statusText_1 || $[112] !== t13) {
            t14 = React.createElement(ink_js_1.Text, { dimColor: t13 }, statusText_1);
            $[111] = statusText_1;
            $[112] = t13;
            $[113] = t14;
        }
    ...
    if ($[127] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = React.createElement(ink_js_1.Text, { backgroundColor: "userMessageBackground" }, "MCP");
        $[127] = t7;
    }
    else {
        t7 = $[127];
    ...
    if ($[130] !== statusIcon_2 || $[131] !== t9) {
        t10 = React.createElement(ink_js_1.Text, { dimColor: t9 },
            " \u00B7 ",
            statusIcon_2,
            " ");
        $[130] = statusIcon_2;
    ...
    if ($[133] !== statusText_1 || $[134] !== t11) {
        t12 = React.createElement(ink_js_1.Text, { dimColor: t11 }, statusText_1);
        $[133] = statusText_1;
        $[134] = t11;
        $[135] = t12;
    }
    ...
    if ($[136] !== t10 || $[137] !== t12 || $[138] !== t3 || $[139] !== t5 || $[140] !== t8) {
        t13 = React.createElement(ink_js_1.Box, null,
            t3,
            t5,
            t8,
            t10,
