...
function LanguagePicker(t0) {
    ...
    const [language, setLanguage] = (0, react_1.useState)(initialLanguage);
    const [cursorOffset, setCursorOffset] = (0, react_1.useState)((initialLanguage ?? "").length);
    let t1;
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, null, "Enter your preferred response and voice language:");
        $[4] = t3;
    }
    else {
        t3 = $[4];
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Text, null, figures_1.default.pointer);
        $[5] = t4;
    }
    else {
        t4 = $[5];
    ...
    if ($[6] !== cursorOffset || $[7] !== handleSubmit || $[8] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
            t4,
            react_1.default.createElement(TextInput_js_1.default, { value: t5, onChange: setLanguage, onSubmit: handleSubmit, focus: true, showCursor: true, placeholder: `e.g., Japanese, 日本語, Español${figures_1.default.ellipsis}`, columns: 60, cursorOffset: cursorOffset, onChangeCursorOffset: setCursorOffset }));
        $[6] = cursorOffset;
        $[7] = handleSubmit;
        $[8] = t5;
        $[9] = t6;
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Leave empty for default (English)");
        $[10] = t7;
    }
    else {
        t7 = $[10];
    ...
    let t8;
    if ($[11] !== t6) {
        t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t3,
            t6,
            t7);
        $[11] = t6;
