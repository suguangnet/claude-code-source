...
const use_terminal_focus_js_1 = require("../hooks/use-terminal-focus.js");
...
const BLURRED_TICK_INTERVAL_MS = constants_js_1.FRAME_INTERVAL_MS * 2;
...
function ClockProvider(t0) {
    ...
    const { children } = t0;
    const [clock] = (0, react_1.useState)(_temp);
    const focused = (0, use_terminal_focus_js_1.useTerminalFocus)();
    let t1;
    let t2;
    ...
    if ($[4] !== children || $[5] !== clock) {
        t3 = react_1.default.createElement(exports.ClockContext.Provider, { value: clock }, children);
        $[4] = children;
        $[5] = clock;
        $[6] = t3;
    }
