...
const envDynamic_js_1 = require("src/utils/envDynamic.js");
...
function IdeOnboardingDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(23);
    ...
    if ($[3] !== installationStatus?.ideType) {
        t3 = installationStatus?.ideType ?? (0, ide_js_1.getTerminalIdeType)();
    ...
    const ideType = t3;
    const isJetBrains = (0, ide_js_1.isJetBrainsIde)(ideType);
    let t4;
    if ($[5] !== ideType) {
    ...
    const mentionShortcut = env_js_1.env.platform === "darwin" ? "Cmd+Option+K" : "Ctrl+Alt+K";
    let t5;
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, { color: "claude" }, "\u273B ");
        $[7] = t5;
    }
    else {
        t5 = $[7];
    ...
    let t6;
    if ($[8] !== ideName) {
        t6 = react_1.default.createElement(react_1.default.Fragment, null,
            t5,
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, "\u29C9 open files");
        $[10] = t8;
    }
    else {
        t8 = $[10];
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = react_1.default.createElement(ink_js_1.Text, null,
            ...
            " ",
            "and ",
            react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, "\u29C9 selected lines"));
        $[11] = t9;
    }
    else {
        t9 = $[11];
    ...
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = react_1.default.createElement(ink_js_1.Text, { color: "diffAddedWord" }, "+11");
        $[12] = t10;
    }
    else {
        t10 = $[12];
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = react_1.default.createElement(ink_js_1.Text, null,
            ...
            t10,
            " ",
            react_1.default.createElement(ink_js_1.Text, { color: "diffRemovedWord" }, "-22"),
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = react_1.default.createElement(ink_js_1.Text, null,
            "\u2022 Cmd+Esc",
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " for Quick Launch"));
        $[14] = t12;
    }
    else {
        t12 = $[14];
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t9,
            t11,
            t12,
            react_1.default.createElement(ink_js_1.Text, null,
                "\u2022 ",
                mentionShortcut,
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " to reference files or lines in your input")));
        $[15] = t13;
    }
    else {
        t13 = $[15];
    ...
    if ($[16] !== onDone || $[17] !== t6 || $[18] !== t7) {
        t14 = react_1.default.createElement(Dialog_js_1.Dialog, { title: t6, subtitle: t7, color: "ide", onCancel: onDone, hideInputGuide: true }, t13);
        $[16] = onDone;
        $[17] = t6;
        $[18] = t7;
        $[19] = t14;
    ...
    if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
        t15 = react_1.default.createElement(ink_js_1.Box, { paddingX: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Press Enter to continue"));
        $[20] = t15;
    }
    else {
        t15 = $[20];
    ...
    let t16;
    if ($[21] !== t14) {
        t16 = react_1.default.createElement(react_1.default.Fragment, null,
            t14,
            t15);
        $[21] = t14;
        $[22] = t16;
...
function hasIdeOnboardingDialogBeenShown() {
    ...
    const terminal = envDynamic_js_1.envDynamic.terminal || 'unknown';
