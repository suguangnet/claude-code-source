...
const syncCache_js_1 = require("../services/remoteManagedSettings/syncCache.js");
const caCerts_js_1 = require("./caCerts.js");
const config_js_1 = require("./config.js");
const envUtils_js_1 = require("./envUtils.js");
const managedEnvConstants_js_1 = require("./managedEnvConstants.js");
...
function applySafeConfigEnvironmentVariables() {
    ...
    for (const source of TRUSTED_SETTING_SOURCES) {
        ...
        if (!(0, constants_js_1.isSettingSourceEnabled)(source))
            continue;
        Object.assign(process.env, filterSettingsEnv((0, settings_js_1.getSettingsForSource)(source)?.env));
    }
    ...
    Object.assign(process.env, filterSettingsEnv((0, settings_js_1.getSettingsForSource)('policySettings')?.env));
    ...
    const settingsEnv = filterSettingsEnv((0, settings_js_1.getSettings_DEPRECATED)()?.env);
...
function applyConfigEnvironmentVariables() {
    Object.assign(process.env, filterSettingsEnv((0, config_js_1.getGlobalConfig)().env));
    Object.assign(process.env, filterSettingsEnv((0, settings_js_1.getSettings_DEPRECATED)()?.env));
