...
function SelectEventMode(t0) {
    ...
    if ($[2] !== restrictedByPolicy) {
        t2 = restrictedByPolicy && React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, { color: "suggestion" },
                figures_1.default.info,
                " Hooks Restricted by Policy"),
            React.createElement(ink_js_1.Text, { dimColor: true }, "Only hooks from managed settings can run. User-defined hooks from ~/.claude/settings.json, .claude/settings.json, and .claude/settings.local.json are blocked."));
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, { dimColor: true },
                ...
                " ",
                React.createElement(ink_js_1.Link, { url: "https://code.claude.com/docs/en/hooks" }, "Learn more")));
        $[4] = t3;
    }
    else {
        t3 = $[4];
    ...
    if ($[9] !== hooksByEvent || $[10] !== t5) {
        t6 = t5.map(t7 => {
            ...
            return {
                label: count > 0 ? React.createElement(ink_js_1.Text, null,
                    name,
                    " ",
                    React.createElement(ink_js_1.Text, { color: "suggestion" },
                        "(",
    ...
    if ($[12] !== onCancel || $[13] !== t4 || $[14] !== t6) {
        t7 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(select_js_1.Select, { onChange: t4, onCancel: onCancel, options: t6 }));
        $[12] = onCancel;
        $[13] = t4;
        $[14] = t6;
        $[15] = t7;
    ...
    let t8;
    if ($[16] !== t2 || $[17] !== t7) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t2,
            t3,
            t7);
        $[16] = t2;
    ...
    if ($[19] !== onCancel || $[20] !== subtitle || $[21] !== t8) {
        t9 = React.createElement(Dialog_js_1.Dialog, { title: "Hooks", subtitle: subtitle, onCancel: onCancel }, t8);
        $[19] = onCancel;
        $[20] = subtitle;
        $[21] = t8;
        $[22] = t9;
