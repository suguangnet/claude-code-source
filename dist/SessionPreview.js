...
function SessionPreview(t0) {
    ...
    const [fullLog, setFullLog] = react_1.default.useState(null);
    let t1;
    let t2;
    if ($[0] !== log) {
        t1 = () => {
    ...
    const isLoading = (0, sessionStorage_js_1.isLiteLog)(log) && fullLog === null;
    ...
    if (isLoading) {
        ...
        if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = react_1.default.createElement(LoadingState_js_1.LoadingState, { message: "Loading session\u2026" });
            $[12] = t8;
        }
        else {
            t8 = $[12];
    ...
    if ($[18] !== conversationId || $[19] !== displayLog.messages) {
        t12 = react_1.default.createElement(Messages_js_1.Messages, { messages: displayLog.messages, tools: tools, commands: t8, verbose: true, toolJSX: null, toolUseConfirmQueue: t9, inProgressToolUseIDs: t10, isMessageSelectorVisible: false, conversationId: conversationId, screen: "transcript", streamingToolUses: t11, showAllInTranscript: true, isLoading: false });
        $[18] = conversationId;
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t16 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            react_1.default.createElement(Byline_js_1.Byline, null,
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "resume" }),
                react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" })));
        $[27] = t16;
    }
    else {
    ...
    let t17;
    if ($[28] !== t15) {
        t17 = react_1.default.createElement(ink_js_1.Box, { flexShrink: 0, flexDirection: "column", borderTopDimColor: true, borderBottom: false, borderLeft: false, borderRight: false, borderStyle: "single", paddingLeft: 2 },
            t15,
            t16);
        $[28] = t15;
        $[29] = t17;
