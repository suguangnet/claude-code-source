...
function SandboxPermissionRequest(t0) {
    ...
    if ($[4] !== host) {
        t5 = !managedDomainsOnly ? [{
                label: React.createElement(ink_js_1.Text, null,
                    ...
                    React.createElement(ink_js_1.Text, { bold: true }, host)),
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = React.createElement(ink_js_1.Text, { dimColor: true }, "Host:");
        $[9] = t8;
    }
    else {
        t8 = $[9];
    ...
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = React.createElement(ink_js_1.Box, { marginTop: 1 },
            React.createElement(ink_js_1.Text, null, "Do you want to allow this connection?"));
        $[12] = t10;
    }
    else {
        t10 = $[12];
    ...
    if ($[15] !== onSelect || $[16] !== options || $[17] !== t11) {
        t12 = React.createElement(ink_js_1.Box, null,
            React.createElement(select_js_1.Select, { options: options, onChange: onSelect, onCancel: t11 }));
        $[15] = onSelect;
        $[16] = options;
        $[17] = t11;
        $[18] = t12;
    ...
    let t13;
    if ($[19] !== t12 || $[20] !== t9) {
        t13 = React.createElement(PermissionDialog_js_1.PermissionDialog, { title: "Network request outside of sandbox" },
