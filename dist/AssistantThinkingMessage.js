...
function AssistantThinkingMessage(t0) {
    ...
    if (!shouldShowFullThinking) {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                "\u2234 Thinking",
                " ",
        ...
        let t6;
        if ($[1] !== t4) {
            t6 = react_1.default.createElement(ink_js_1.Box, { marginTop: t4 }, t5);
            $[1] = t4;
            $[2] = t6;
        }
        else {
    ...
    let t6;
    if ($[4] !== thinking) {
        t6 = react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
            react_1.default.createElement(Markdown_js_1.Markdown, { dimColor: true }, thinking));
        $[4] = thinking;
        $[5] = t6;
    }
    else {
    ...
    let t7;
    if ($[6] !== t4 || $[7] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, marginTop: t4, width: "100%" },
            t5,
            t6);
        $[6] = t4;
        $[7] = t6;
