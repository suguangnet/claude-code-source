...
function InvalidConfigDialog(t0) {
    ...
    if ($[5] !== errorDescription) {
        t3 = react_1.default.createElement(ink_js_1.Text, null, errorDescription);
        $[5] = errorDescription;
        $[6] = t3;
    }
    else {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Choose an option:");
        $[10] = t5;
    }
    else {
        t5 = $[10];
    ...
    if ($[12] !== handleSelect || $[13] !== onExit) {
        t7 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t5,
            react_1.default.createElement(index_js_1.Select, { options: t6, onChange: handleSelect, onCancel: onExit }));
        $[12] = handleSelect;
        $[13] = onExit;
        $[14] = t7;
    }
    ...
    if ($[15] !== onExit || $[16] !== t4 || $[17] !== t7) {
        t8 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Configuration Error", color: "error", onCancel: onExit },
            t4,
            t7);
        $[15] = onExit;
        $[16] = t4;
...
async function showInvalidConfigDialog({ error }) {
    const renderOptions = {
        ...(0, renderOptions_js_1.getBaseRenderOptions)(false),
    ...
    await new Promise(async (resolve) => {
        const { unmount } = await (0, ink_js_1.render)(react_1.default.createElement(AppState_js_1.AppStateProvider, null,
            react_1.default.createElement(KeybindingProviderSetup_js_1.KeybindingSetup, null,
                react_1.default.createElement(InvalidConfigDialog, { filePath: error.filePath, errorDescription: error.message, onExit: () => {
                        unmount();
                        void resolve();
                        process.exit(1);
                    }, onReset: () => {
