...
function Pane(t0) {
    ...
    if ((0, modalContext_js_1.useIsInsideModal)()) {
        let t1;
        if ($[0] !== children) {
            t1 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1, flexShrink: 0 }, children);
            $[0] = children;
            $[1] = t1;
        }
        else {
    ...
    let t1;
    if ($[2] !== color) {
        t1 = react_1.default.createElement(Divider_js_1.Divider, { color: color });
        $[2] = color;
        $[3] = t1;
    }
    else {
    ...
    let t2;
    if ($[4] !== children) {
        t2 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2 }, children);
        $[4] = children;
        $[5] = t2;
    }
    else {
    ...
    let t3;
    if ($[6] !== t1 || $[7] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingTop: 1 },
            t1,
            t2);
        $[6] = t1;
        $[7] = t2;
