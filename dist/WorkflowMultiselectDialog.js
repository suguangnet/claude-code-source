...
function renderInputGuide(exitState) {
    ...
    return react_1.default.createElement(Byline_js_1.Byline, null,
        ...
        react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Space", action: "toggle" }),
...
function WorkflowMultiselectDialog(t0) {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Box, null,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                ...
                " ",
                react_1.default.createElement(ink_js_1.Link, { url: "https://github.com/anthropics/claude-code-action/blob/main/examples/" }, "https://github.com/anthropics/claude-code-action/blob/main/examples/")));
        $[4] = t4;
    }
    else {
        t4 = $[4];
    ...
    if ($[6] !== defaultSelections || $[7] !== handleSubmit) {
        t6 = react_1.default.createElement(SelectMulti_js_1.SelectMulti, { options: t5, defaultValue: defaultSelections, onSubmit: handleSubmit, onChange: handleChange, onCancel: handleCancel, hideIndexes: true });
        $[6] = defaultSelections;
        $[7] = handleSubmit;
        $[8] = t6;
    }
    ...
    let t7;
    if ($[9] !== showError) {
        t7 = showError && react_1.default.createElement(ink_js_1.Box, null,
            react_1.default.createElement(ink_js_1.Text, { color: "error" }, "You must select at least one workflow to continue"));
        $[9] = showError;
        $[10] = t7;
    }
    else {
    ...
    let t8;
    if ($[11] !== t6 || $[12] !== t7) {
        t8 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Select GitHub workflows to install", subtitle: "We'll create a workflow file in your repository for each one you select.", onCancel: handleCancel, inputGuide: renderInputGuide },
            t4,
            t6,
            t7);
        $[11] = t6;
