...
function modelBelongsToFamily(model, family) {
    ...
    if ((0, aliases_js_1.isModelAlias)(model)) {
        const resolved = (0, model_js_1.parseUserSpecifiedModel)(model).toLowerCase();
...
function modelMatchesVersionPrefix(model, entry) {
    ...
    const resolvedModel = (0, aliases_js_1.isModelAlias)(model)
...
function isModelAllowed(model) {
    ...
    const resolvedModel = (0, modelStrings_js_1.resolveOverriddenModel)(model);
    ...
    if ((0, aliases_js_1.isModelAlias)(normalizedModel)) {
        const resolved = (0, model_js_1.parseUserSpecifiedModel)(normalizedModel).toLowerCase();
    ...
    for (const entry of normalizedAllowlist) {
        if (!(0, aliases_js_1.isModelFamilyAlias)(entry) && (0, aliases_js_1.isModelAlias)(entry)) {
            const resolved = (0, model_js_1.parseUserSpecifiedModel)(entry).toLowerCase();
