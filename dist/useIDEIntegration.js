    ...
    if ($[0] !== autoConnectIdeFlag || $[1] !== ideToInstallExtension || $[2] !== setDynamicMcpConfig || $[3] !== setIDEInstallationState || $[4] !== setShowIdeOnboarding) {
        t1 = () => {
            const addIde = function addIde(ide) {
                ...
                const autoConnectEnabled = (globalConfig.autoConnectIde || autoConnectIdeFlag || (0, ide_js_1.isSupportedTerminal)() || process.env.CLAUDE_CODE_SSE_PORT || ideToInstallExtension || (0, envUtils_js_1.isEnvTruthy)(process.env.CLAUDE_CODE_AUTO_CONNECT_IDE)) && !(0, envUtils_js_1.isEnvDefinedFalsy)(process.env.CLAUDE_CODE_AUTO_CONNECT_IDE);
            ...
            (0, ide_js_1.initializeIdeIntegration)(addIde, ideToInstallExtension, () => setShowIdeOnboarding(true), status => setIDEInstallationState(status));
        };
