...
function PermissionPrompt(t0) {
    ...
    const [acceptInputMode, setAcceptInputMode] = (0, react_1.useState)(false);
    const [rejectInputMode, setRejectInputMode] = (0, react_1.useState)(false);
    const [focusedValue, setFocusedValue] = (0, react_1.useState)(null);
    const [acceptFeedbackModeEntered, setAcceptFeedbackModeEntered] = (0, react_1.useState)(false);
    const [rejectFeedbackModeEntered, setRejectFeedbackModeEntered] = (0, react_1.useState)(false);
    let t2;
    ...
    let t8;
    if ($[34] !== question) {
        t8 = typeof question === "string" ? react_1.default.createElement(ink_js_1.Text, null, question) : question;
        $[34] = question;
        $[35] = t8;
    }
    else {
    ...
    if ($[42] !== handleCancel || $[43] !== handleInputModeToggle || $[44] !== handleSelect || $[45] !== selectOptions || $[46] !== t9) {
        t10 = react_1.default.createElement(select_js_1.Select, { options: selectOptions, inlineDescriptions: true, onChange: handleSelect, onCancel: handleCancel, onFocus: t9, onInputModeToggle: handleInputModeToggle });
        $[42] = handleCancel;
    ...
    let t12;
    if ($[48] !== t11) {
        t12 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
    ...
    if ($[50] !== t10 || $[51] !== t12 || $[52] !== t8) {
        t13 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t8,
            t10,
            t12);
        $[50] = t10;
