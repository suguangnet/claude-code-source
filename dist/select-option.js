...
function SelectOption(t0) {
    ...
    if ($[0] !== children || $[1] !== declareCursor || $[2] !== description || $[3] !== isFocused || $[4] !== isSelected || $[5] !== shouldShowDownArrow || $[6] !== shouldShowUpArrow) {
        t1 = react_1.default.createElement(ListItem_js_1.ListItem, { isFocused: isFocused, isSelected: isSelected, description: description, showScrollDown: shouldShowDownArrow, showScrollUp: shouldShowUpArrow, styled: false, declareCursor: declareCursor }, children);
        $[0] = children;
        $[1] = declareCursor;
        $[2] = description;
        $[3] = isFocused;
