...
function OffscreenFreeze({ children }) {
    ...
    const [ref, { isVisible }] = (0, use_terminal_viewport_js_1.useTerminalViewport)();
    const cached = (0, react_1.useRef)(children);
    ...
    return react_1.default.createElement(ink_js_1.Box, { ref: ref }, cached.current);
}
