...
function ShowInIDEPrompt(t0) {
    ...
    let t1;
    if ($[0] !== ideName) {
        t1 = react_1.default.createElement(ink_js_1.Text, { bold: true, color: "permission" },
            "Opened changes in ",
            ideName,
            " \u29C9");
        $[0] = ideName;
    ...
    let t2;
    if ($[2] !== symlinkTarget) {
        t2 = symlinkTarget && react_1.default.createElement(ink_js_1.Text, { color: "warning" }, (0, path_1.relative)((0, cwd_js_1.getCwd)(), symlinkTarget).startsWith("..") ? `This will modify ${symlinkTarget} (outside working directory) via a symlink` : `Symlink target: ${symlinkTarget}`);
        $[2] = symlinkTarget;
        $[3] = t2;
    }
    else {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = (0, ide_js_1.isSupportedVSCodeTerminal)() && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Save file to continue\u2026");
        $[4] = t3;
    }
    else {
        t3 = $[4];
    ...
    if ($[7] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Text, null,
            ...
            " ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, t4),
            "?");
        $[7] = t4;
        $[8] = t5;
    }
    ...
    if ($[20] !== onInputModeToggle || $[21] !== options || $[22] !== t6 || $[23] !== t7 || $[24] !== t8) {
        t9 = react_1.default.createElement(index_js_1.Select, { options: options, inlineDescriptions: true, onChange: t6, onCancel: t7, onFocus: t8, onInputModeToggle: onInputModeToggle });
    ...
    let t10;
    if ($[26] !== t5 || $[27] !== t9) {
        t10 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t5,
            t9);
        $[26] = t5;
        $[27] = t9;
    ...
    if ($[31] !== t1 || $[32] !== t10 || $[33] !== t12 || $[34] !== t2) {
        t13 = react_1.default.createElement(Pane_js_1.Pane, { color: "permission" },
