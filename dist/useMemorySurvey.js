...
function useMemorySurvey(messages, isLoading, hasActivePrompt = false, { enabled = true } = {}) {
    ...
    const onTranscriptPromptShown = (0, react_1.useCallback)((appearanceId_1) => {
        (0, index_js_1.logEvent)(MEMORY_SURVEY_EVENT, {
    ...
    const onTranscriptSelect = (0, react_1.useCallback)(async (appearanceId_2, selected_1) => {
        (0, index_js_1.logEvent)(MEMORY_SURVEY_EVENT, {
        ...
        if (selected_1 === 'yes') {
            const result = await (0, submitTranscriptShare_js_1.submitTranscriptShare)(messagesRef.current, TRANSCRIPT_SHARE_TRIGGER, appearanceId_2);
            (0, index_js_1.logEvent)(MEMORY_SURVEY_EVENT, {
    ...
    const lastAssistant = (0, react_1.useMemo)(() => (0, messages_js_1.getLastAssistantMessage)(messages), [messages]);
    (0, react_1.useEffect)(() => {
        if (!enabled)
            return;
        ...
        const text = (0, messages_js_1.extractTextContent)(lastAssistant.message.content, ' ');
