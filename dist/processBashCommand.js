...
const BashModeProgress_js_1 = require("src/components/BashModeProgress.js");
const BashTool_js_1 = require("src/tools/BashTool/BashTool.js");
const index_js_1 = require("../../services/analytics/index.js");
const errors_js_1 = require("../errors.js");
const messages_js_1 = require("../messages.js");
const resolveDefaultShell_js_1 = require("../shell/resolveDefaultShell.js");
...
async function processBashCommand(inputString, precedingInputBlocks, attachmentMessages, context, setToolJSX) {
    ...
    const usePowerShell = (0, shellToolUtils_js_1.isPowerShellToolEnabled)() && (0, resolveDefaultShell_js_1.resolveDefaultShell)() === 'powershell';
    ...
    setToolJSX({
        jsx: React.createElement(BashModeProgress_js_1.BashModeProgress, { input: inputString, progress: null, verbose: context.options.verbose }),
    ...
    try {
        ...
        const onProgress = (progress) => {
            setToolJSX({
                jsx: React.createElement(React.Fragment, null,
                    React.createElement(BashModeProgress_js_1.BashModeProgress, { input: inputString, progress: progress.data, verbose: context.options.verbose }),
                    jsx),
                shouldHidePromptInput: false,
                showSpinner: false
            });
        ...
        const shellTool = PowerShellTool ?? BashTool_js_1.BashTool;
        const response = PowerShellTool ? await PowerShellTool.call({
            command: inputString,
            dangerouslyDisableSandbox: true
        }, bashModeContext, undefined, undefined, onProgress) : await BashTool_js_1.BashTool.call({
            command: inputString,
            dangerouslyDisableSandbox: true
        ...
        const mapped = await (0, toolResultStorage_js_1.processToolResultBlock)(shellTool, {
            ...data,
            stderr: ''
        ...
        const stdout = typeof mapped.content === 'string' ? mapped.content : (0, xml_js_1.escapeXml)(data.stdout);
        return {
            messages: [(0, messages_js_1.createSyntheticUserCaveatMessage)(), userMessage, ...attachmentMessages, (0, messages_js_1.createUserMessage)({
                    content: `<bash-stdout>${stdout}</bash-stdout><bash-stderr>${(0, xml_js_1.escapeXml)(stderr)}</bash-stderr>`
                })],
            shouldQuery: false
        };
    }
        ...
        if (e instanceof errors_js_1.ShellError) {
            if (e.interrupted) {
                return {
                    messages: [(0, messages_js_1.createSyntheticUserCaveatMessage)(), userMessage, (0, messages_js_1.createUserInterruptionMessage)({
                            toolUse: false
                        }), ...attachmentMessages],
                    shouldQuery: false
                };
            ...
            return {
                messages: [(0, messages_js_1.createSyntheticUserCaveatMessage)(), userMessage, ...attachmentMessages, (0, messages_js_1.createUserMessage)({
                        content: `<bash-stdout>${(0, xml_js_1.escapeXml)(e.stdout)}</bash-stdout><bash-stderr>${(0, xml_js_1.escapeXml)(e.stderr)}</bash-stderr>`
                    })],
                shouldQuery: false
            };
        }
        return {
            messages: [(0, messages_js_1.createSyntheticUserCaveatMessage)(), userMessage, ...attachmentMessages, (0, messages_js_1.createUserMessage)({
                    content: `<bash-stderr>Command failed: ${(0, xml_js_1.escapeXml)((0, errors_js_1.errorMessage)(e))}</bash-stderr>`
                })],
            shouldQuery: false
        };
    }
