...
const colorDiff_js_1 = require("./StructuredDiff/colorDiff.js");
const StructuredDiff_js_1 = require("./StructuredDiff.js");
function ThemePicker(t0) {
    const $ = (0, compiler_runtime_1.c)(59);
    ...
    const themeSetting = (0, ink_js_1.useThemeSetting)();
    ...
    const { setPreviewTheme, savePreview, cancelPreview } = (0, ink_js_1.usePreviewTheme)();
    const syntaxHighlightingDisabled = (0, AppState_js_1.useAppState)(_temp) ?? false;
    const setAppState = (0, AppState_js_1.useSetAppState)();
    (0, KeybindingContext_js_1.useRegisterKeybindingContext)("ThemePicker");
    const syntaxToggleShortcut = (0, useShortcutDisplay_js_1.useShortcutDisplay)("theme:toggleSyntaxHighlighting", "ThemePicker", "ctrl+t");
    let t8;
    ...
    const exitState = (0, useExitOnCtrlCDWithKeybindings_js_1.useExitOnCtrlCDWithKeybindings)(skipExitHandling ? _temp2 : undefined);
    let t10;
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = [...((0, bun_bundle_1.feature)("AUTO_THEME") ? [{
    ...
    let t11;
    if ($[8] !== showIntroText) {
        t11 = showIntroText ? React.createElement(ink_js_1.Text, null, "Let's get started.") : React.createElement(ink_js_1.Text, { bold: true, color: "permission" }, "Theme");
        $[8] = showIntroText;
        $[9] = t11;
    }
    else {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = React.createElement(ink_js_1.Text, { bold: true }, "Choose the text style that looks best with your terminal");
        $[10] = t12;
    }
    else {
        t12 = $[10];
    ...
    if ($[11] !== helpText || $[12] !== showHelpTextBelow) {
        t13 = helpText && !showHelpTextBelow && React.createElement(ink_js_1.Text, { dimColor: true }, helpText);
        $[11] = helpText;
    ...
    let t14;
    if ($[14] !== t13) {
        t14 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t12,
            t13);
        $[14] = t13;
        $[15] = t14;
    ...
    if ($[25] !== t15 || $[26] !== t16 || $[27] !== t17 || $[28] !== themeSetting) {
        t18 = React.createElement(index_js_1.Select, { options: themeOptions, onFocus: t15, onChange: t16, onCancel: t17, visibleOptionCount: themeOptions.length, defaultValue: themeSetting, defaultFocusValue: themeSetting });
        $[25] = t15;
        $[26] = t16;
        $[27] = t17;
        $[28] = themeSetting;
    ...
    if ($[30] !== t11 || $[31] !== t14 || $[32] !== t18) {
        t19 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t11,
            t14,
            t18);
        $[30] = t11;
    ...
    let t21;
    if ($[35] !== columns) {
        t21 = React.createElement(ink_js_1.Box, { flexDirection: "column", borderTop: true, borderBottom: true, borderLeft: false, borderRight: false, borderStyle: "dashed", borderColor: "subtle" },
            React.createElement(StructuredDiff_js_1.StructuredDiff, { patch: t20, dim: false, filePath: "demo.js", firstLine: null, width: columns }));
        $[35] = columns;
        $[36] = t21;
    }
    else {
    ...
    let t23;
    if ($[37] !== t22) {
        t23 = React.createElement(ink_js_1.Text, { dimColor: true },
            " ",
            t22);
        $[37] = t22;
        $[38] = t23;
    ...
    let t24;
    if ($[39] !== t21 || $[40] !== t23) {
        t24 = React.createElement(ink_js_1.Box, { flexDirection: "column", width: "100%" },
            t21,
            t23);
        $[39] = t21;
        $[40] = t23;
    ...
    let t25;
    if ($[42] !== t19 || $[43] !== t24) {
        t25 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t19,
            t24);
        $[42] = t19;
        $[43] = t24;
    ...
    if (!showIntroText) {
        let t26;
        if ($[45] !== content) {
            t26 = React.createElement(ink_js_1.Box, { flexDirection: "column" }, content);
            $[45] = content;
            $[46] = t26;
        }
        else {
        ...
        if ($[47] !== helpText || $[48] !== showHelpTextBelow) {
            t27 = showHelpTextBelow && helpText && React.createElement(ink_js_1.Box, { marginLeft: 3 },
                React.createElement(ink_js_1.Text, { dimColor: true }, helpText));
            $[47] = helpText;
        ...
        if ($[50] !== exitState || $[51] !== hideEscToCancel) {
            t28 = !hideEscToCancel && React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, exitState.pending ? React.createElement(React.Fragment, null,
                    ...
                    React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Esc", action: "cancel" }))));
            $[50] = exitState;
            $[51] = hideEscToCancel;
            $[52] = t28;
        }
        ...
        let t29;
        if ($[53] !== t27 || $[54] !== t28) {
            t29 = React.createElement(ink_js_1.Box, { marginTop: 1 },
                t27,
                t28);
            $[53] = t27;
            $[54] = t28;
