...
const SETTLED_GREY = (0, utils_js_1.toRGBColor)({
    r: 153,
    g: 153,
    b: 153
});
function AnimatedAsterisk({ char = figures_js_1.TEARDROP_ASTERISK }) {
    // Read prefersReducedMotion once at mount — no useSettings() subscription,
    // since that would re-render whenever settings change.
    const [reducedMotion] = (0, react_1.useState)(() => (0, settings_js_1.getInitialSettings)().prefersReducedMotion ?? false);
    const [done, setDone] = (0, react_1.useState)(reducedMotion);
    ...
    const [ref, time] = (0, ink_js_1.useAnimationFrame)(done ? null : 50);
    (0, react_1.useEffect)(() => {
        if (done)
            return;
    ...
    if (done) {
        return React.createElement(ink_js_1.Box, { ref: ref },
            React.createElement(ink_js_1.Text, { color: SETTLED_GREY }, char));
    }
    ...
    return React.createElement(ink_js_1.Box, { ref: ref },
        React.createElement(ink_js_1.Text, { color: (0, utils_js_1.toRGBColor)((0, utils_js_1.hueToRgb)(hue)) }, char));
}
