...
function LspRecommendationMenu({ pluginName, pluginDescription, fileExtension, onResponse }) {
    ...
    const options = [{
            label: React.createElement(ink_js_1.Text, null,
                "Yes, install ",
                React.createElement(ink_js_1.Text, { bold: true }, pluginName)),
            value: 'yes'
        }, {
            label: 'No, not now',
            value: 'no'
    ...
    return React.createElement(PermissionDialog_js_1.PermissionDialog, { title: "LSP Plugin Recommendation" },
        React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            React.createElement(ink_js_1.Box, { marginBottom: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "LSP provides code intelligence like go-to-definition and error checking")),
            React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, "Plugin:"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    pluginName)),
            pluginDescription && React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, pluginDescription)),
            React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, "Triggered by:"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    fileExtension,
                    " files")),
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, null, "Would you like to install this LSP plugin?")),
            React.createElement(ink_js_1.Box, null,
                React.createElement(select_js_1.Select, { options: options, onChange: onSelect, onCancel: () => onResponse('no') }))));
}
