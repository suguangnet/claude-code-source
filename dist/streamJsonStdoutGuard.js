    ...
    process.stdout.write = function (chunk, encodingOrCb, cb) {
        ...
        while ((newlineIdx = buffer.indexOf('\n')) !== -1) {
            ...
            if (isJsonLine(line)) {
                ...
                process.stderr.write(`${exports.STDOUT_GUARD_MARKER} ${line}\n`);
                (0, debug_js_1.logForDebugging)(`streamJsonStdoutGuard diverted non-JSON stdout line: ${line.slice(0, 200)}`);
            }
        }
    ...
    (0, cleanupRegistry_js_1.registerCleanup)(async () => {
        ...
        if (buffer.length > 0) {
            if (originalWrite && isJsonLine(buffer)) {
                ...
                process.stderr.write(`${exports.STDOUT_GUARD_MARKER} ${buffer}\n`);
            }
            buffer = '';
        }
        if (originalWrite) {
