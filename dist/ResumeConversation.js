...
const LogSelector_js_1 = require("../components/LogSelector.js");
...
const agenticSessionSearch_js_1 = require("../utils/agenticSessionSearch.js");
const asciicast_js_1 = require("../utils/asciicast.js");
const concurrentSessions_js_1 = require("../utils/concurrentSessions.js");
const conversationRecovery_js_1 = require("../utils/conversationRecovery.js");
const crossProjectResume_js_1 = require("../utils/crossProjectResume.js");
const log_js_1 = require("../utils/log.js");
const messages_js_1 = require("../utils/messages.js");
const sessionRestore_js_1 = require("../utils/sessionRestore.js");
...
function ResumeConversation({ commands, worktreePaths, initialTools, mcpClients, dynamicMcpConfig, debug, mainThreadAgentDefinition, autoConnectIdeFlag, strictMcpConfig = false, systemPrompt, appendSystemPrompt, initialSearchQuery, disableSlashCommands = false, forkSession, taskListId, filterByPr, thinkingConfig, onTurnComplete }) {
    const { rows } = (0, useTerminalSize_js_1.useTerminalSize)();
    const agentDefinitions = (0, AppState_js_1.useAppState)(s => s.agentDefinitions);
    const setAppState = (0, AppState_js_1.useSetAppState)();
    const [logs, setLogs] = react_1.default.useState([]);
    const [loading, setLoading] = react_1.default.useState(true);
    const [resuming, setResuming] = react_1.default.useState(false);
    const [showAllProjects, setShowAllProjects] = react_1.default.useState(false);
    const [resumeData, setResumeData] = react_1.default.useState(null);
    const [crossProjectCommand, setCrossProjectCommand] = react_1.default.useState(null);
    const sessionLogResultRef = react_1.default.useRef(null);
    ...
    const logCountRef = react_1.default.useRef(0);
    const filteredLogs = react_1.default.useMemo(() => {
    ...
    const isResumeWithRenameEnabled = (0, sessionStorage_js_1.isCustomTitleEnabled)();
    react_1.default.useEffect(() => {
        (0, sessionStorage_js_1.loadSameRepoMessageLogsProgressive)(worktreePaths).then(result_0 => {
    ...
    const loadMoreLogs = react_1.default.useCallback((count) => {
        const ref = sessionLogResultRef.current;
        if (!ref || ref.nextIndex >= ref.allStatLogs.length)
            return;
        void (0, sessionStorage_js_1.enrichLogs)(ref.allStatLogs, ref.nextIndex, count).then(result_1 => {
    ...
    const loadLogs = react_1.default.useCallback((allProjects) => {
        setLoading(true);
        const promise = allProjects ? (0, sessionStorage_js_1.loadAllProjectsMessageLogsProgressive)() : (0, sessionStorage_js_1.loadSameRepoMessageLogsProgressive)(worktreePaths);
    ...
    const handleToggleAllProjects = react_1.default.useCallback(() => {
    ...
    async function onSelect(log_0) {
        ...
        const crossProjectCheck = (0, crossProjectResume_js_1.checkCrossProjectResume)(log_0, showAllProjects, worktreePaths);
        if (crossProjectCheck.isCrossProject) {
            if (!crossProjectCheck.isSameRepoWorktree) {
                const raw = await (0, osc_js_1.setClipboard)(crossProjectCheck.command);
                if (raw)
        ...
        try {
            const result_3 = await (0, conversationRecovery_js_1.loadConversationForResume)(log_0, undefined);
            if (!result_3) {
            ...
            if ((0, bun_bundle_1.feature)('COORDINATOR_MODE')) {
                ...
                if (warning) {
                    ...
                    const freshAgentDefs = await getAgentDefinitionsWithOverrides((0, state_js_1.getOriginalCwd)());
                    setAppState(prev_0 => ({
                        ...prev_0,
                        agentDefinitions: {
                            ...freshAgentDefs,
            ...
            if (result_3.sessionId && !forkSession) {
                ...
                await (0, sessionStorage_js_1.recordContentReplacement)(result_3.contentReplacements);
            }
            const { agentDefinition: resolvedAgentDef } = (0, sessionRestore_js_1.restoreAgentFromSession)(result_3.agentSetting, mainThreadAgentDefinition, agentDefinitions);
            setAppState(prev_1 => ({
                ...prev_1,
            ...
            const standaloneAgentContext = (0, sessionRestore_js_1.computeStandaloneAgentContext)(result_3.agentName, result_3.agentColor);
            ...
            (0, sessionStorage_js_1.restoreSessionMetadata)(forkSession ? {
                ...result_3,
...
function NoConversationsMessage() {
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, null, "No conversations found to resume."),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Press Ctrl+C to exit and start a new conversation."));
        $[1] = t1;
    }
    else {
        t1 = $[1];
...
function CrossProjectMessage(t0) {
    ...
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = react_1.default.createElement(ink_js_1.Text, null, "This conversation is from a different directory.");
        $[1] = t2;
    }
    else {
        t2 = $[1];
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, null, "To resume, run:");
        $[2] = t3;
    }
    else {
        t3 = $[2];
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "(Command copied to clipboard)");
        $[5] = t5;
    }
    else {
        t5 = $[5];
    ...
    let t6;
    if ($[6] !== t4) {
        t6 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t2,
            t4,
            t5);
        $[6] = t4;
