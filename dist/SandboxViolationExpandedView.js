...
function SandboxViolationExpandedView() {
    ...
    const [violations, setViolations] = (0, react_1.useState)(t0);
    ...
    if ($[3] !== t3 || $[4] !== totalCount) {
        t4 = React.createElement(ink_js_1.Box, { marginLeft: 0 },
            React.createElement(ink_js_1.Text, { color: "permission" },
                "\u29C8 Sandbox blocked ",
                totalCount,
                " total",
                " ",
    ...
    if ($[8] !== t6 || $[9] !== totalCount) {
        t7 = React.createElement(ink_js_1.Box, { paddingLeft: 2 },
    ...
    if ($[11] !== t4 || $[12] !== t5 || $[13] !== t7) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            t4,
            t5,
            t7);
        $[11] = t4;
...
function _temp(v, i) {
    return React.createElement(ink_js_1.Box, { key: `${v.timestamp.getTime()}-${i}`, paddingLeft: 2 },
        React.createElement(ink_js_1.Text, { dimColor: true },
