...
function MCPReconnect(t0) {
    ...
    const [isReconnecting, setIsReconnecting] = (0, react_1.useState)(true);
    ...
    if (isReconnecting) {
        let t3;
        if ($[6] !== serverName) {
            t3 = react_1.default.createElement(ink_js_1.Text, { color: "text" },
                "Reconnecting to ",
                react_1.default.createElement(ink_js_1.Text, { bold: true }, serverName));
            $[6] = serverName;
            $[7] = t3;
        }
        else {
        ...
        let t5;
        if ($[9] !== t3) {
            t5 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, padding: 1 },
                t3,
                t4);
            $[9] = t3;
            $[10] = t5;
    ...
    if (error) {
        ...
        let t5;
        if ($[15] !== serverName) {
            t5 = react_1.default.createElement(ink_js_1.Text, { color: "error" },
        ...
        let t6;
        if ($[17] !== t4 || $[18] !== t5) {
            t6 = react_1.default.createElement(ink_js_1.Box, null,
                t4,
                t5);
            $[17] = t4;
            $[18] = t5;
        ...
        let t7;
        if ($[20] !== error) {
            t7 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                "Error: ",
                error);
            $[20] = error;
            $[21] = t7;
        ...
        let t8;
        if ($[22] !== t6 || $[23] !== t7) {
            t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, padding: 1 },
                t6,
                t7);
            $[22] = t6;
            $[23] = t7;
