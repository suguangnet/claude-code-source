...
const stringWidth_js_1 = require("src/ink/stringWidth.js");
...
const pillLabel_js_1 = require("src/tasks/pillLabel.js");
const types_js_1 = require("src/tasks/types.js");
const horizontalScroll_js_1 = require("src/utils/horizontalScroll.js");
...
const taskStatusUtils_js_1 = require("./taskStatusUtils.js");
function BackgroundTaskStatus(t0) {
    ...
    const tasks = (0, AppState_js_1.useAppState)(_temp);
    const viewingAgentTaskId = (0, AppState_js_1.useAppState)(_temp2);
    let t3;
    if ($[0] !== tasks) {
    ...
    const expandedView = (0, AppState_js_1.useAppState)(_temp4);
    ...
    if (allTeammates || !showSpinnerTree && isViewingTeammate) {
        ...
        if ($[15] !== availableWidth || $[16] !== pillWidths || $[17] !== t9) {
            t10 = (0, horizontalScroll_js_1.calculateHorizontalScrollWindow)(pillWidths, availableWidth, 2, t9);
            $[15] = availableWidth;
            $[16] = pillWidths;
            $[17] = t9;
            $[18] = t10;
        ...
        let t12;
        if ($[23] !== showLeftArrow) {
            t12 = showLeftArrow && React.createElement(ink_js_1.Text, { dimColor: true },
        ...
        if ($[25] !== selectedIdx || $[26] !== setAppState || $[27] !== viewedIdx || $[28] !== visiblePills) {
            t13 = visiblePills.map((pill_1, i_1) => {
                ...
                return React.createElement(React.Fragment, { key: pill_1.name },
                    needsSeparator && React.createElement(ink_js_1.Text, null, " "),
                    React.createElement(AgentPill, { name: pill_1.name, color: pill_1.color, isSelected: selectedIdx === pill_1.idx, isViewed: viewedIdx === pill_1.idx, isIdle: pill_1.isIdle, onClick: () => pill_1.taskId ? (0, teammateViewHelpers_js_1.enterTeammateView)(pill_1.taskId, setAppState) : (0, teammateViewHelpers_js_1.exitTeammateView)(setAppState) }));
            });
            $[25] = selectedIdx;
            $[26] = setAppState;
            $[27] = viewedIdx;
        ...
        if ($[30] !== showRightArrow) {
            t14 = showRightArrow && React.createElement(ink_js_1.Text, { dimColor: true },
                " ",
        ...
        if ($[32] === Symbol.for("react.memo_cache_sentinel")) {
            t15 = React.createElement(ink_js_1.Text, { dimColor: true },
                " \xB7 ",
                React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "shift + \u2193", action: "expand" }));
            $[32] = t15;
        }
        else {
            t15 = $[32];
    ...
    if ((0, taskStatusUtils_js_1.shouldHideTasksFooter)(tasks ?? {}, showSpinnerTree)) {
        return null;
    }
    ...
    let t10;
    if ($[43] !== runningTasks) {
        t10 = (0, pillLabel_js_1.pillNeedsCta)(runningTasks) && React.createElement(ink_js_1.Text, { dimColor: true },
            " \u00B7 ",
...
function AgentPill(t0) {
    ...
    if (highlighted) {
        ...
        if ($[0] !== color || $[1] !== isViewed || $[2] !== name) {
            t1 = color ? React.createElement(ink_js_1.Text, { backgroundColor: color, color: "inverseText", bold: isViewed },
                "@",
                name) : React.createElement(ink_js_1.Text, { color: "background", inverse: true, bold: isViewed },
                "@",
                name);
            $[0] = color;
            $[1] = isViewed;
        ...
        if (isIdle) {
            ...
            if ($[4] !== isViewed || $[5] !== name) {
                t1 = React.createElement(ink_js_1.Text, { dimColor: true, bold: isViewed },
                    "@",
                    name);
                $[4] = isViewed;
                $[5] = name;
            ...
            if (isViewed) {
                let t1;
                if ($[7] !== color || $[8] !== name) {
                    t1 = React.createElement(ink_js_1.Text, { color: color, bold: true },
                        "@",
                        name);
                    $[7] = color;
                    $[8] = name;
                ...
                if ($[10] !== color || $[11] !== name || $[12] !== t1) {
                    t2 = React.createElement(ink_js_1.Text, { color: color, dimColor: t1 },
                        "@",
                        name);
                    $[10] = color;
                    $[11] = name;
    ...
    if ($[16] !== label || $[17] !== onClick) {
        t3 = React.createElement(ink_js_1.Box, { onClick: onClick, onMouseEnter: t1, onMouseLeave: t2 }, label);
        $[16] = label;
        $[17] = onClick;
        $[18] = t3;
    }
...
function SummaryPill(t0) {
    ...
    let t2;
    if ($[0] !== children || $[1] !== t1) {
        t2 = React.createElement(ink_js_1.Text, { color: "background", inverse: t1 }, children);
        $[0] = children;
        $[1] = t1;
        $[2] = t2;
    }
    ...
    if ($[5] !== label || $[6] !== onClick) {
        t5 = React.createElement(ink_js_1.Box, { onClick: onClick, onMouseEnter: t3, onMouseLeave: t4 }, label);
        $[5] = label;
        $[6] = onClick;
        $[7] = t5;
    }
