...
const ExportDialog_js_1 = require("../../components/ExportDialog.js");
const cwd_js_1 = require("../../utils/cwd.js");
const exportRenderer_js_1 = require("../../utils/exportRenderer.js");
...
async function exportWithReactRenderer(context) {
    ...
    return (0, exportRenderer_js_1.renderMessagesToPlainText)(context.messages, tools);
}
async function call(onDone, context, args) {
    ...
    return react_1.default.createElement(ExportDialog_js_1.ExportDialog, { content: content, defaultFilename: defaultFilename, onDone: result => {
