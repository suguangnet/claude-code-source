...
function ListItem(t0) {
    ...
    if ($[0] !== disabled || $[1] !== isFocused || $[2] !== showScrollDown || $[3] !== showScrollUp) {
        t4 = function renderIndicator() {
            ...
            if (isFocused) {
                return react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer);
            }
            if (showScrollDown) {
                return react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.arrowDown);
            }
            if (showScrollUp) {
                return react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.arrowUp);
            }
            return react_1.default.createElement(ink_js_1.Text, null, " ");
        };
        $[0] = disabled;
    ...
    const cursorRef = (0, use_declared_cursor_js_1.useDeclaredCursor)(t7);
    let t8;
    ...
    if ($[14] !== children || $[15] !== disabled || $[16] !== styled || $[17] !== textColor) {
        t9 = styled ? react_1.default.createElement(ink_js_1.Text, { color: textColor, dimColor: disabled }, children) : children;
        $[14] = children;
        $[15] = disabled;
        $[16] = styled;
        $[17] = textColor;
    ...
    if ($[19] !== disabled || $[20] !== isSelected) {
        t10 = isSelected && !disabled && react_1.default.createElement(ink_js_1.Text, { color: "success" }, figures_1.default.tick);
        $[19] = disabled;
        $[20] = isSelected;
        $[21] = t10;
    }
    ...
    if ($[22] !== t10 || $[23] !== t8 || $[24] !== t9) {
        t11 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
            t8,
            t9,
            t10);
        $[22] = t10;
    ...
    let t12;
    if ($[26] !== description) {
        t12 = description && react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
            react_1.default.createElement(ink_js_1.Text, { color: "inactive" }, description));
        $[26] = description;
        $[27] = t12;
    }
    else {
    ...
    if ($[28] !== cursorRef || $[29] !== t11 || $[30] !== t12) {
        t13 = react_1.default.createElement(ink_js_1.Box, { ref: cursorRef, flexDirection: "column" },
            t11,
            t12);
        $[28] = cursorRef;
        $[29] = t11;
