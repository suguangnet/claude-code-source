...
function AgentsList(t0) {
    const $ = (0, compiler_runtime_1.c)(96);
    ...
    let t1;
    if ($[0] !== agents) {
        t1 = [...agents].sort(agentDisplay_js_1.compareAgentsByName);
        $[0] = agents;
        $[1] = t1;
    }
    else {
    ...
    if ($[2] !== isCreateNewSelected) {
        t2 = () => React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { color: isCreateNewSelected ? "suggestion" : undefined }, isCreateNewSelected ? `${figures_1.default.pointer} ` : "  "),
            React.createElement(ink_js_1.Text, { color: isCreateNewSelected ? "suggestion" : undefined }, "Create new agent"));
    ...
    if ($[4] !== isCreateNewSelected || $[5] !== selectedAgent?.agentType || $[6] !== selectedAgent?.source) {
        t3 = agent_0 => {
            ...
            const resolvedModel = (0, agentDisplay_js_1.resolveAgentModelDisplay)(agent_0);
            return React.createElement(ink_js_1.Box, { key: `${agent_0.agentType}-${agent_0.source}` },
                React.createElement(ink_js_1.Text, { dimColor: dimmed && !isSelected, color: textColor }, isBuiltIn ? "" : isSelected ? `${figures_1.default.pointer} ` : "  "),
                React.createElement(ink_js_1.Text, { dimColor: dimmed && !isSelected, color: textColor }, agent_0.agentType),
                resolvedModel && React.createElement(ink_js_1.Text, { dimColor: true, color: textColor },
                    " \xB7 ",
                    resolvedModel),
                agent_0.memory && React.createElement(ink_js_1.Text, { dimColor: true, color: textColor },
                    " \xB7 ",
                    agent_0.memory,
                    " memory"),
                overriddenBy && React.createElement(ink_js_1.Text, { dimColor: !isSelected, color: isSelected ? "warning" : undefined },
                    " ",
                    figures_1.default.warning,
                    " shadowed by ",
                    (0, agentDisplay_js_1.getOverrideSourceLabel)(overriddenBy)));
        };
    ...
    if ($[8] !== sortedAgents || $[9] !== source) {
        bb0: {
            ...
            if (source === "all") {
                t4 = agentDisplay_js_1.AGENT_SOURCE_GROUPS.filter(_temp3).flatMap(t5 => {
    ...
    if ($[23] !== renderAgent || $[24] !== sortedAgents) {
        t8 = t9 => {
            ...
            return React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1, paddingLeft: 2 },
                React.createElement(ink_js_1.Text, { bold: true, dimColor: true }, title),
    ...
    if ($[26] !== renderAgent) {
        t9 = (title_0, groupAgents) => {
            ...
            return React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
                React.createElement(ink_js_1.Box, { paddingLeft: 2 },
                    React.createElement(ink_js_1.Text, { bold: true, dimColor: true }, title_0),
                    folderPath && React.createElement(ink_js_1.Text, { dimColor: true },
                        " (",
                        folderPath,
                        ")")),
        ...
        bb1: {
            ...
            if (hasNoAgents) {
                ...
                if ($[55] !== onCreateNew || $[56] !== renderCreateNewOption) {
                    t23 = onCreateNew && React.createElement(ink_js_1.Box, null, renderCreateNewOption());
                    $[55] = onCreateNew;
                ...
                if ($[58] === Symbol.for("react.memo_cache_sentinel")) {
                    t24 = React.createElement(ink_js_1.Text, { dimColor: true }, "No agents found. Create specialized subagents that Claude can delegate to.");
                    t25 = React.createElement(ink_js_1.Text, { dimColor: true }, "Each subagent has its own context window, custom system prompt, and specific tools.");
                    t26 = React.createElement(ink_js_1.Text, { dimColor: true }, "Try creating: Code Reviewer, Code Simplifier, Security Reviewer, Tech Lead, or UX Reviewer.");
                    $[58] = t24;
                    $[59] = t25;
                    $[60] = t26;
                }
                ...
                if ($[61] !== renderBuiltInAgentsSection || $[62] !== sortedAgents || $[63] !== source) {
                    t27 = source !== "built-in" && sortedAgents.some(_temp7) && React.createElement(React.Fragment, null,
                        React.createElement(Divider_js_1.Divider, null),
                ...
                if ($[65] !== handleKeyDown || $[66] !== t23 || $[67] !== t27) {
                    t28 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
                        t23,
                        t24,
                        t25,
                        t26,
                ...
                if ($[69] !== onBack || $[70] !== sourceTitle || $[71] !== t28) {
                    t29 = React.createElement(Dialog_js_1.Dialog, { title: sourceTitle, subtitle: "No agents found", onCancel: onBack, hideInputGuide: true }, t28);
                    $[69] = onBack;
                    $[70] = sourceTitle;
                    $[71] = t28;
                    $[72] = t29;
            ...
            let t23;
            if ($[73] !== sortedAgents) {
                t23 = (0, array_js_1.count)(sortedAgents, _temp8);
                $[73] = sortedAgents;
                $[74] = t23;
            }
            else {
            ...
            t20 = true;
            if ($[75] !== changes) {
                t21 = changes && changes.length > 0 && React.createElement(ink_js_1.Box, { marginTop: 1 },
                    React.createElement(ink_js_1.Text, { dimColor: true }, changes[changes.length - 1]));
                $[75] = changes;
                $[76] = t21;
            }
            else {
            ...
            if ($[77] !== onCreateNew || $[78] !== renderCreateNewOption) {
                t15 = onCreateNew && React.createElement(ink_js_1.Box, { marginBottom: 1 }, renderCreateNewOption());
                $[77] = onCreateNew;
            ...
            t16 = source === "all" ? React.createElement(React.Fragment, null,
                agentDisplay_js_1.AGENT_SOURCE_GROUPS.filter(_temp9).map(t24 => {
                ...
                builtInAgents_0.length > 0 && React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1, paddingLeft: 2 },
                    React.createElement(ink_js_1.Text, { dimColor: true },
                        React.createElement(ink_js_1.Text, { bold: true }, "Built-in agents"),
                        " (always available)"),
                    builtInAgents_0.map(renderAgent))) : source === "built-in" ? React.createElement(React.Fragment, null,
                React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Built-in agents are provided by default and cannot be modified."),
                React.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" }, sortedAgents.map(agent_2 => renderAgent(agent_2)))) : React.createElement(React.Fragment, null,
