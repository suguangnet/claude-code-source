        ...
        case 'assistant':
            {
                ...
                return b?.type === 'text' && !(0, messages_js_1.isEmptyMessageText)(b.text) && !messages_js_1.SYNTHETIC_MESSAGES.has(b.text) || b?.type === 'tool_use' && b.name in PRIMARY_INPUT;
            }
        case 'user':
            {
...
function useMessageActions(cursor, setCursor, navRef, caps) {
    ...
    const cursorRef = (0, react_1.useRef)(cursor);
    cursorRef.current = cursor;
    const capsRef = (0, react_1.useRef)(caps);
    ...
    const handlers = (0, react_1.useMemo)(() => {
        ...
        for (const key of new Set(exports.MESSAGE_ACTIONS.map(a_1 => a_1.key))) {
            h[`messageActions:${key}`] = () => {
                const c_0 = cursorRef.current;
                if (!c_0)
                    return;
                const a_0 = exports.MESSAGE_ACTIONS.find(a => a.key === key && isApplicable(a, c_0));
                if (!a_0)
                    return;
                if (a_0.stays) {
                    setCursor(c_1 => c_1 ? {
...
function MessageActionsBar(t0) {
    const $ = (0, compiler_runtime_1.c)(28);
    const { cursor } = t0;
    let T0;
    let T1;
    let t1;
    ...
    let t7;
    if ($[0] !== cursor) {
        const applicable = exports.MESSAGE_ACTIONS.filter(a => isApplicable(a, cursor));
        T1 = ink_js_1.Box;
        t4 = "column";
        t5 = 0;
        t6 = 1;
        if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
            t7 = react_1.default.createElement(ink_js_1.Box, { borderStyle: "single", borderTop: true, borderBottom: false, borderLeft: false, borderRight: false, borderDimColor: true });
            $[10] = t7;
        }
        else {
            t7 = $[10];
        ...
        t3 = applicable.map((a_0, i) => {
            ...
            return react_1.default.createElement(react_1.default.Fragment, { key: a_0.key },
                i > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " \u00B7 "),
                react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: false }, a_0.key),
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t9 = react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: false },
            figures_1.default.arrowUp,
            figures_1.default.arrowDown);
        t10 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " navigate \u00B7 ");
        t11 = react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: false }, "esc");
        t12 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " back");
        $[11] = t10;
        $[12] = t11;
        $[13] = t12;
        $[14] = t8;
    ...
    if ($[16] !== T0 || $[17] !== t1 || $[18] !== t2 || $[19] !== t3) {
        t13 = react_1.default.createElement(T0, { paddingX: t1, paddingY: t2 },
            t3,
            t8,
            t9,
            t10,
    ...
    if ($[21] !== T1 || $[22] !== t13 || $[23] !== t4 || $[24] !== t5 || $[25] !== t6 || $[26] !== t7) {
        t14 = react_1.default.createElement(T1, { flexDirection: t4, flexShrink: t5, paddingY: t6 },
            t7,
            t13);
        $[21] = T1;
        $[22] = t13;
