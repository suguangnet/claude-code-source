...
function detectUnreachableRules(context, options) {
    const unreachable = [];
    const allowRules = (0, permissions_js_1.getAllowRules)(context);
    const askRules = (0, permissions_js_1.getAskRules)(context);
    const denyRules = (0, permissions_js_1.getDenyRules)(context);
