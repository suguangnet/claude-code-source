...
function PreviewBox(props) {
    ...
    if (settings.syntaxHighlightingDisabled) {
        let t0;
        if ($[0] !== props) {
            t0 = react_1.default.createElement(PreviewBoxBody, { ...props, highlight: null });
            $[0] = props;
            $[1] = t0;
        }
        else {
    ...
    let t0;
    if ($[2] !== props) {
        t0 = react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(PreviewBoxBody, { ...props, highlight: null }) },
            react_1.default.createElement(PreviewBoxWithHighlight, { ...props }));
        $[2] = props;
        $[3] = t0;
    }
    else {
...
function PreviewBoxWithHighlight(props) {
    ...
    if ($[1] !== highlight || $[2] !== props) {
        t1 = react_1.default.createElement(PreviewBoxBody, { ...props, highlight: highlight });
        $[1] = highlight;
        $[2] = props;
        $[3] = t1;
    }
...
function PreviewBoxBody(t0) {
    ...
    if ($[4] !== effectiveMaxLines || $[5] !== effectiveMaxWidth || $[6] !== minHeight || $[7] !== minWidth || $[8] !== rendered) {
        ...
        truncationBar = isTruncated ? (() => {
            ...
            const labelWidth = (0, stringWidth_js_1.stringWidth)(label);
        ...
        t3 = "column";
        if ($[19] !== topBorder) {
            t4 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, topBorder);
            $[19] = topBorder;
            $[20] = t4;
        }
        else {
        ...
        if ($[21] !== innerWidth) {
            t8 = (line_0, index) => {
                const lineWidth = (0, stringWidth_js_1.stringWidth)(line_0);
                const displayLine = lineWidth > innerWidth ? (0, sliceAnsi_js_1.default)(line_0, 0, innerWidth) : line_0;
                const padding = " ".repeat(Math.max(0, innerWidth - (0, stringWidth_js_1.stringWidth)(displayLine)));
                return react_1.default.createElement(ink_js_1.Box, { key: index, flexDirection: "row" },
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                        BOX_CHARS.vertical,
                        " "),
                    react_1.default.createElement(ink_js_1.Ansi, null, displayLine),
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                        padding,
                        " ",
                        BOX_CHARS.vertical));
    ...
    let t6;
    if ($[23] !== truncationBar) {
        t6 = truncationBar && react_1.default.createElement(ink_js_1.Text, { color: "warning" }, truncationBar);
        $[23] = truncationBar;
        $[24] = t6;
    }
    else {
    ...
    let t7;
    if ($[25] !== bottomBorder) {
        t7 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, bottomBorder);
        $[25] = bottomBorder;
        $[26] = t7;
    }
    else {
    ...
    if ($[27] !== T0 || $[28] !== t3 || $[29] !== t4 || $[30] !== t5 || $[31] !== t6 || $[32] !== t7) {
        t8 = react_1.default.createElement(T0, { flexDirection: t3 },
            t4,
            t5,
            t6,
            t7);
