...
function DiffFileList(t0) {
    ...
    if (files.length === 0) {
        ...
        if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "No changed files");
            $[5] = t2;
        }
        else {
            t2 = $[5];
    ...
    if ($[6] !== columns || $[7] !== endIndex || $[8] !== files || $[9] !== selectedIndex || $[10] !== startIndex) {
        ...
        if ($[17] !== hasMoreAbove || $[18] !== needsPagination || $[19] !== startIndex) {
            t3 = needsPagination && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, hasMoreAbove ? ` ↑ ${startIndex} more ${(0, stringUtils_js_1.plural)(startIndex, "file")}` : " ");
            $[17] = hasMoreAbove;
            $[18] = needsPagination;
            $[19] = startIndex;
            $[20] = t3;
        ...
        if ($[21] !== maxPathWidth || $[22] !== selectedIndex || $[23] !== startIndex) {
            t5 = (file, index) => react_1.default.createElement(FileItem, { key: file.path, file: file, isSelected: startIndex + index === selectedIndex, maxPathWidth: maxPathWidth });
            $[21] = maxPathWidth;
            $[22] = selectedIndex;
            $[23] = startIndex;
            $[24] = t5;
    ...
    if ($[25] !== endIndex || $[26] !== files.length || $[27] !== hasMoreBelow || $[28] !== needsPagination) {
        t5 = needsPagination && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, hasMoreBelow ? ` ↓ ${files.length - endIndex} more ${(0, stringUtils_js_1.plural)(files.length - endIndex, "file")}` : " ");
        $[25] = endIndex;
        $[26] = files.length;
        $[27] = hasMoreBelow;
        $[28] = needsPagination;
    ...
    if ($[30] !== T0 || $[31] !== t2 || $[32] !== t3 || $[33] !== t4 || $[34] !== t5) {
        t6 = react_1.default.createElement(T0, { flexDirection: t2 },
            t3,
            t4,
            t5);
        $[30] = T0;
...
function FileItem(t0) {
    ...
    const pointer = isSelected ? figures_1.default.pointer + " " : "  ";
    const line = `${pointer}${displayPath}`;
    const t2 = isSelected ? "background" : undefined;
    let t3;
    if ($[3] !== isSelected || $[4] !== line || $[5] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Text, { bold: isSelected, color: t2, inverse: isSelected }, line);
        $[3] = isSelected;
        $[4] = line;
        $[5] = t2;
        $[6] = t3;
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Box, { flexGrow: 1 });
        $[7] = t4;
    }
    else {
        t4 = $[7];
    ...
    if ($[8] !== file || $[9] !== isSelected) {
        t5 = react_1.default.createElement(FileStats, { file: file, isSelected: isSelected });
        $[8] = file;
        $[9] = isSelected;
        $[10] = t5;
    }
...
function FileStats(t0) {
    ...
    if (file.isUntracked) {
        ...
        let t2;
        if ($[0] !== t1) {
            t2 = react_1.default.createElement(ink_js_1.Text, { dimColor: t1, italic: true }, "untracked");
            $[0] = t1;
            $[1] = t2;
        }
        else {
    ...
    if (file.isBinary) {
        ...
        let t2;
        if ($[2] !== t1) {
            t2 = react_1.default.createElement(ink_js_1.Text, { dimColor: t1, italic: true }, "Binary file");
            $[2] = t1;
            $[3] = t2;
        }
        else {
    ...
    if (file.isLargeFile) {
        ...
        let t2;
        if ($[4] !== t1) {
            t2 = react_1.default.createElement(ink_js_1.Text, { dimColor: t1, italic: true }, "Large file modified");
            $[4] = t1;
            $[5] = t2;
        }
        else {
    ...
    if ($[6] !== file.linesAdded || $[7] !== isSelected) {
        t1 = file.linesAdded > 0 && react_1.default.createElement(ink_js_1.Text, { color: "diffAddedWord", bold: isSelected },
            "+",
            file.linesAdded);
        $[6] = file.linesAdded;
        $[7] = isSelected;
    ...
    if ($[9] !== file.linesRemoved || $[10] !== isSelected) {
        t3 = file.linesRemoved > 0 && react_1.default.createElement(ink_js_1.Text, { color: "diffRemovedWord", bold: isSelected },
            "-",
            file.linesRemoved);
        $[9] = file.linesRemoved;
        $[10] = isSelected;
    ...
    if ($[12] !== file.isTruncated || $[13] !== isSelected) {
        t4 = file.isTruncated && react_1.default.createElement(ink_js_1.Text, { dimColor: !isSelected }, " (truncated)");
        $[12] = file.isTruncated;
        $[13] = isSelected;
        $[14] = t4;
    }
