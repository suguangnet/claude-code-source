...
function CreatingStep(t0) {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: true }, "Install GitHub App"),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Create GitHub Actions workflow"));
        $[6] = t3;
    }
    else {
        t3 = $[6];
    ...
    if ($[7] !== currentWorkflowInstallStep || $[8] !== progressSteps) {
        t4 = react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", borderStyle: "round", paddingX: 1 },
                ...
                progressSteps.map((stepText, index) => {
                    ...
                    return react_1.default.createElement(ink_js_1.Box, { key: index },
                        react_1.default.createElement(ink_js_1.Text, { color: status === "completed" ? "success" : status === "in-progress" ? "warning" : undefined },
                            status === "completed" ? "\u2713 " : "",
                            stepText,
                            status === "in-progress" ? "\u2026" : ""));
                })));
