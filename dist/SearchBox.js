...
function SearchBox(t0) {
    ...
    if ($[0] !== isFocused || $[1] !== isTerminalFocused || $[2] !== offset || $[3] !== placeholder || $[4] !== query) {
        t9 = isFocused ? react_1.default.createElement(react_1.default.Fragment, null, query ? isTerminalFocused ? react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Text, null, query.slice(0, offset)),
            react_1.default.createElement(ink_js_1.Text, { inverse: true }, offset < query.length ? query[offset] : " "),
            offset < query.length && react_1.default.createElement(ink_js_1.Text, null, query.slice(offset + 1))) : react_1.default.createElement(ink_js_1.Text, null, query) : isTerminalFocused ? react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Text, { inverse: true }, placeholder.charAt(0)),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, placeholder.slice(1))) : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, placeholder)) : query ? react_1.default.createElement(ink_js_1.Text, null, query) : react_1.default.createElement(ink_js_1.Text, null, placeholder);
        $[0] = isFocused;
        $[1] = isTerminalFocused;
        $[2] = offset;
        $[3] = placeholder;
    ...
    if ($[6] !== prefix || $[7] !== t8 || $[8] !== t9) {
        t10 = react_1.default.createElement(ink_js_1.Text, { dimColor: t8 },
            prefix,
            " ",
            t9);
        $[6] = prefix;
    ...
    if ($[10] !== t10 || $[11] !== t4 || $[12] !== t5 || $[13] !== t6 || $[14] !== t7 || $[15] !== width) {
        t11 = react_1.default.createElement(ink_js_1.Box, { flexShrink: 0, borderStyle: t4, borderColor: t5, borderDimColor: t6, paddingX: t7, width: width }, t10);
        $[10] = t10;
        $[11] = t4;
        $[12] = t5;
        $[13] = t6;
