...
const renderPlaceholder_js_1 = require("../hooks/renderPlaceholder.js");
const usePasteHandler_js_1 = require("../hooks/usePasteHandler.js");
const use_declared_cursor_js_1 = require("../ink/hooks/use-declared-cursor.js");
const ink_js_1 = require("../ink.js");
const ShimmeredInput_js_1 = require("./PromptInput/ShimmeredInput.js");
/**
...
function BaseTextInput(t0) {
    ...
    const cursorRef = (0, use_declared_cursor_js_1.useDeclaredCursor)(t2);
    const { wrappedOnInput, isPasting: t3 } = (0, usePasteHandler_js_1.usePasteHandler)({
    ...
    const { showPlaceholder, renderedPlaceholder } = (0, renderPlaceholder_js_1.renderPlaceholder)({
    ...
    if (hasHighlights) {
        return react_1.default.createElement(ink_js_1.Box, { ref: cursorRef },
            react_1.default.createElement(ShimmeredInput_js_1.HighlightedInput, { text: renderedValue, highlights: filteredHighlights }),
            showArgumentHint && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                props.value?.endsWith(" ") ? "" : " ",
                props.argumentHint),
            children);
    }
    const T0 = ink_js_1.Box;
    const T1 = ink_js_1.Text;
    const t4 = "truncate-end";
    const t5 = showPlaceholder && props.placeholderElement ? props.placeholderElement : showPlaceholder && renderedPlaceholder ? react_1.default.createElement(ink_js_1.Ansi, null, renderedPlaceholder) : react_1.default.createElement(ink_js_1.Ansi, null, renderedValue);
    const t6 = showArgumentHint && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
        props.value?.endsWith(" ") ? "" : " ",
        props.argumentHint);
    let t7;
    if ($[4] !== T1 || $[5] !== children || $[6] !== props || $[7] !== t5 || $[8] !== t6) {
        t7 = react_1.default.createElement(T1, { wrap: t4, dimColor: props.dimColor },
            t5,
            t6,
            children);
        $[4] = T1;
    ...
    if ($[10] !== T0 || $[11] !== cursorRef || $[12] !== t7) {
        t8 = react_1.default.createElement(T0, { ref: cursorRef }, t7);
        $[10] = T0;
        $[11] = cursorRef;
        $[12] = t7;
        $[13] = t8;
