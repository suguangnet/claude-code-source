...
function commandListDisplay(commands) {
    switch (commands.length) {
        case 0:
            return '';
        case 1:
            return react_1.default.createElement(ink_js_1.Text, { bold: true }, commands[0]);
        case 2:
            return react_1.default.createElement(ink_js_1.Text, null,
                react_1.default.createElement(ink_js_1.Text, { bold: true }, commands[0]),
                " and ",
                react_1.default.createElement(ink_js_1.Text, { bold: true }, commands[1]));
        default:
            return react_1.default.createElement(ink_js_1.Text, null,
                react_1.default.createElement(ink_js_1.Text, { bold: true }, commands.slice(0, -1).join(', ')),
                ", and",
                ' ',
                react_1.default.createElement(ink_js_1.Text, { bold: true }, commands.slice(-1)[0]));
    }
}
...
function formatPathList(paths) {
    ...
    const names = paths.map(p => (0, path_1.basename)(p) || p);
    if (names.length === 1) {
        return react_1.default.createElement(ink_js_1.Text, null,
            react_1.default.createElement(ink_js_1.Text, { bold: true }, names[0]),
            path_1.sep);
    }
    if (names.length === 2) {
        return react_1.default.createElement(ink_js_1.Text, null,
            ...
            path_1.sep,
            " and ",
            react_1.default.createElement(ink_js_1.Text, { bold: true }, names[1]),
            path_1.sep);
    }
...
function generateShellSuggestionsLabel(suggestions, shellToolName, commandTransform) {
    ...
    const shellCommands = [...new Set(shellRules.flatMap(rule => {
            if (!rule.ruleContent)
                return [];
            const command = (0, shellRuleMatching_js_1.permissionRuleExtractPrefix)(rule.ruleContent) ?? rule.ruleContent;
    ...
    if (hasReadPaths && !hasDirectories && !hasCommands) {
        ...
        if (readPaths.length === 1) {
            ...
            const dirName = (0, path_1.basename)(firstPath) || firstPath;
            return react_1.default.createElement(ink_js_1.Text, null,
                "Yes, allow reading from ",
                react_1.default.createElement(ink_js_1.Text, { bold: true }, dirName),
                path_1.sep,
                " from this project");
        }
        // Multiple read paths
    ...
    if (hasDirectories && !hasReadPaths && !hasCommands) {
        ...
        if (directories.length === 1) {
            ...
            const dirName = (0, path_1.basename)(firstDir) || firstDir;
            return react_1.default.createElement(ink_js_1.Text, null,
    ...
    if (hasCommands && !hasDirectories && !hasReadPaths) {
        ...
        return react_1.default.createElement(ink_js_1.Text, null,
            ...
            " commands in",
            ' ',
            react_1.default.createElement(ink_js_1.Text, { bold: true }, (0, state_js_1.getOriginalCwd)()));
    }
    // Handle mixed cases
    if ((hasDirectories || hasReadPaths) && !hasCommands) {
