...
function ApproveApiKey(t0) {
    ...
    if ($[0] !== customApiKeyTruncated || $[1] !== onDone) {
        t1 = function onChange(value) {
            bb2: switch (value) {
                case "yes":
                    {
                        (0, config_js_1.saveGlobalConfig)(current_0 => ({
                            ...current_0,
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "ANTHROPIC_API_KEY");
        $[5] = t3;
    }
    else {
        t3 = $[5];
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, null, "Do you want to use this API key?");
        $[8] = t5;
    }
    else {
        t5 = $[8];
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = [t6, {
                label: react_1.default.createElement(ink_js_1.Text, null,
                    "No (",
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "recommended"),
                    ")"),
                value: "no"
            }];
        $[10] = t7;
    ...
    let t8;
    if ($[11] !== onChange) {
        t8 = react_1.default.createElement(index_js_1.Select, { defaultValue: "no", defaultFocusValue: "no", options: t7, onChange: value_0 => onChange(value_0), onCancel: () => onChange("no") });
        $[11] = onChange;
        $[12] = t8;
    }
    else {
    ...
    if ($[13] !== t2 || $[14] !== t4 || $[15] !== t8) {
        t9 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Detected a custom API key in your environment", color: "warning", onCancel: t2 },
            t4,
            t5,
            t8);
        $[13] = t2;
