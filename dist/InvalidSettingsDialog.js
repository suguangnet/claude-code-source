...
const ValidationErrorsList_js_1 = require("./ValidationErrorsList.js");
/**
...
function InvalidSettingsDialog(t0) {
    ...
    let t2;
    if ($[3] !== settingsErrors) {
        t2 = react_1.default.createElement(ValidationErrorsList_js_1.ValidationErrorsList, { errors: settingsErrors });
        $[3] = settingsErrors;
        $[4] = t2;
    }
    else {
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Files with errors are skipped entirely, not just the invalid settings.");
        $[5] = t3;
    }
    else {
        t3 = $[5];
    ...
    let t5;
    if ($[7] !== handleSelect) {
        t5 = react_1.default.createElement(index_js_1.Select, { options: t4, onChange: handleSelect });
        $[7] = handleSelect;
        $[8] = t5;
    }
    else {
    ...
    if ($[9] !== onExit || $[10] !== t2 || $[11] !== t5) {
        t6 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Settings Error", onCancel: onExit, color: "warning" },
            t2,
            t3,
            t5);
        $[9] = onExit;
