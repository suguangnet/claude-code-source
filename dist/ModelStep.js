...
function ModelStep() {
    ...
    if ($[4] !== goBack || $[5] !== handleComplete || $[6] !== wizardData.selectedModel) {
        t2 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Select model", footerText: t1 },
            react_1.default.createElement(ModelSelector_js_1.ModelSelector, { initialModel: wizardData.selectedModel, onComplete: handleComplete, onCancel: goBack }));
        $[4] = goBack;
        $[5] = handleComplete;
