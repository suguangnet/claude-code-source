...
const ClickableImageRef_js_1 = require("../ClickableImageRef.js");
...
function SelectInputOption(t0) {
    const $ = (0, compiler_runtime_1.c)(100);
    ...
    const [cursorOffset, setCursorOffset] = (0, react_1.useState)(inputValue.length);
    const isUserEditing = (0, react_1.useRef)(false);
    let t5;
    ...
    if ($[16] !== onImagePaste) {
        t10 = () => {
            ...
            (0, imagePaste_js_1.getImageFromClipboard)().then(imageData => {
                if (imageData) {
    ...
    let t31;
    if ($[57] !== t30) {
        t31 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, t30);
        $[57] = t30;
        $[58] = t31;
    }
    else {
    ...
    if ($[59] !== cursorOffset || $[60] !== imagesSelected || $[61] !== inputValue || $[62] !== isFocused || $[63] !== onExit || $[64] !== onImagePaste || $[65] !== onInputChange || $[66] !== onSubmit || $[67] !== option || $[68] !== showLabel) {
        t32 = showLabel ? react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Text, { color: isFocused ? "suggestion" : undefined }, option.label),
            isFocused ? react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, option.labelValueSeparator ?? ", "),
                react_1.default.createElement(TextInput_js_1.default, { value: inputValue, onChange: value => {
                    ...
                    } })) : inputValue && react_1.default.createElement(ink_js_1.Text, null,
                option.labelValueSeparator ?? ", ",
                inputValue)) : isFocused ? react_1.default.createElement(TextInput_js_1.default, { value: inputValue, onChange: value_0 => {
                isUserEditing.current = true;
            ...
            } }) : react_1.default.createElement(ink_js_1.Text, { color: inputValue ? undefined : "inactive" }, inputValue || option.placeholder || option.label);
        $[59] = cursorOffset;
        $[60] = imagesSelected;
        $[61] = inputValue;
        $[62] = isFocused;
    ...
    if ($[70] !== children || $[71] !== t28 || $[72] !== t31 || $[73] !== t32) {
        t33 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", flexShrink: t28 },
            t31,
            children,
            t32);
        $[70] = children;
    ...
    if ($[75] !== isFocused || $[76] !== isSelected || $[77] !== shouldShowDownArrow || $[78] !== shouldShowUpArrow || $[79] !== t33) {
        t34 = react_1.default.createElement(select_option_js_1.SelectOption, { isFocused: isFocused, isSelected: isSelected, shouldShowDownArrow: shouldShowDownArrow, shouldShowUpArrow: shouldShowUpArrow, declareCursor: false }, t33);
        $[75] = isFocused;
        $[76] = isSelected;
    ...
    if ($[81] !== descriptionPaddingLeft || $[82] !== isFocused || $[83] !== isSelected || $[84] !== option.description || $[85] !== option.dimDescription) {
        t35 = option.description && react_1.default.createElement(ink_js_1.Box, { paddingLeft: descriptionPaddingLeft },
            react_1.default.createElement(ink_js_1.Text, { dimColor: option.dimDescription !== false, color: isSelected ? "success" : isFocused ? "suggestion" : undefined }, option.description));
    ...
    if ($[87] !== descriptionPaddingLeft || $[88] !== imageAttachments || $[89] !== imagesSelected || $[90] !== isFocused || $[91] !== selectedImageIndex) {
        t36 = imageAttachments.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1, paddingLeft: descriptionPaddingLeft },
            imageAttachments.map((img_0, idx) => react_1.default.createElement(ClickableImageRef_js_1.ClickableImageRef, { key: img_0.id, imageId: img_0.id, isSelected: !!imagesSelected && idx === selectedImageIndex })),
            react_1.default.createElement(ink_js_1.Box, { flexGrow: 1, justifyContent: "flex-start", flexDirection: "row" },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, imagesSelected ? react_1.default.createElement(Byline_js_1.Byline, null,
                    imageAttachments.length > 1 && react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "attachments:next", context: "Attachments", fallback: "\u2192", description: "next" }),
                        react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "attachments:previous", context: "Attachments", fallback: "\u2190", description: "prev" })),
                    react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "attachments:remove", context: "Attachments", fallback: "backspace", description: "remove" }),
                    react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "attachments:exit", context: "Attachments", fallback: "esc", description: "cancel" })) : isFocused ? "(\u2193 to select)" : null)));
    ...
    let t37;
    if ($[93] !== layout) {
        t37 = layout === "expanded" && react_1.default.createElement(ink_js_1.Text, null, " ");
        $[93] = layout;
        $[94] = t37;
    }
    else {
    ...
    if ($[95] !== t34 || $[96] !== t35 || $[97] !== t36 || $[98] !== t37) {
        t38 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", flexShrink: 0 },
            t34,
            t35,
            t36,
            t37);
