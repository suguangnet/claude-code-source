...
function UserMemoryInputMessage(t0) {
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = React.createElement(ink_js_1.Text, { color: "remember", backgroundColor: "memoryBackgroundColor" }, "#");
        $[3] = t4;
    }
    else {
        t4 = $[3];
    ...
    let t5;
    if ($[4] !== input) {
        t5 = React.createElement(ink_js_1.Box, null,
            t4,
            React.createElement(ink_js_1.Text, { backgroundColor: "memoryBackgroundColor", color: "text" },
                " ",
                input,
                " "));
        $[4] = input;
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(MessageResponse_js_1.MessageResponse, { height: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true }, savingText));
        $[6] = t6;
    }
    else {
        t6 = $[6];
    ...
    let t7;
    if ($[7] !== t3 || $[8] !== t5) {
        t7 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: t3, width: "100%" },
            t5,
            t6);
        $[7] = t3;
        $[8] = t5;
