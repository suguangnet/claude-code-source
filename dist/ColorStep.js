...
function ColorStep() {
    ...
    if ($[11] !== handleConfirm || $[12] !== t3) {
        t4 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Choose background color", footerText: t2 },
            react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(ColorPicker_js_1.ColorPicker, { agentName: t3, currentColor: "automatic", onConfirm: handleConfirm })));
        $[11] = handleConfirm;
        $[12] = t3;
        $[13] = t4;
    }
