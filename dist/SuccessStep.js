...
function SuccessStep(t0) {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: true }, "Install GitHub App"),
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Success"));
        $[0] = t2;
    }
    else {
        t2 = $[0];
    ...
    let t3;
    if ($[1] !== skipWorkflow) {
        t3 = !skipWorkflow && react_1.default.createElement(ink_js_1.Text, { color: "success" }, "\u2713 GitHub Actions workflow created!");
        $[1] = skipWorkflow;
        $[2] = t3;
    }
    else {
    ...
    if ($[3] !== secretExists || $[4] !== useExistingSecret) {
        t4 = secretExists && useExistingSecret && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            react_1.default.createElement(ink_js_1.Text, { color: "success" }, "\u2713 Using existing ANTHROPIC_API_KEY secret"));
        $[3] = secretExists;
        $[4] = useExistingSecret;
        $[5] = t4;
    }
    ...
    if ($[6] !== secretExists || $[7] !== secretName || $[8] !== useExistingSecret) {
        t5 = (!secretExists || !useExistingSecret) && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            react_1.default.createElement(ink_js_1.Text, null, "Next steps:"));
        $[10] = t6;
    }
    else {
        t6 = $[10];
    ...
    let t7;
    if ($[11] !== skipWorkflow) {
        t7 = skipWorkflow ? react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Text, null, "1. Install the Claude GitHub App if you haven't already"),
            react_1.default.createElement(ink_js_1.Text, null, "2. Your workflow file was kept unchanged"),
            react_1.default.createElement(ink_js_1.Text, null, "3. API key is configured and ready to use")) : react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(ink_js_1.Text, null, "1. A pre-filled PR page has been created"),
            react_1.default.createElement(ink_js_1.Text, null, "2. Install the Claude GitHub App if you haven't already"),
            react_1.default.createElement(ink_js_1.Text, null, "3. Merge the PR to enable Claude PR assistance"));
        $[11] = skipWorkflow;
        $[12] = t7;
    }
    else {
    ...
    if ($[13] !== t3 || $[14] !== t4 || $[15] !== t5 || $[16] !== t7) {
        t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", borderStyle: "round", paddingX: 1 },
            t2,
            t3,
            t4,
            t5,
    ...
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 3 },
    ...
    let t10;
    if ($[19] !== t8) {
        t10 = react_1.default.createElement(react_1.default.Fragment, null,
            t8,
            t9);
        $[19] = t8;
        $[20] = t10;
