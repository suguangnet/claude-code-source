...
const resolver_js_1 = require("../keybindings/resolver.js");
const stringUtils_js_1 = require("../utils/stringUtils.js");
const useVoiceEnabled_js_1 = require("./useVoiceEnabled.js");
...
const voiceNs = (0, bun_bundle_1.feature)('VOICE_MODE') ? require('./useVoice.js') : {
    useVoice: ({ enabled: _e }) => ({
        state: 'idle',
...
function useVoiceIntegration({ setInputValueRaw, inputValueRef, insertTextRef }) {
    ...
    const voicePrefixRef = (0, react_1.useRef)(null);
    const voiceSuffixRef = (0, react_1.useRef)('');
    ...
    const lastSetInputRef = (0, react_1.useRef)(null);
    ...
    const stripTrailing = (0, react_1.useCallback)((maxStrip, { char = ' ', anchor = false, floor = 0 } = {}) => {
        ...
        const scan = char === ' ' ? (0, stringUtils_js_1.normalizeFullWidthSpace)(beforeCursor) : beforeCursor;
        let trailing = 0;
    ...
    const voiceInterimTranscript = (0, bun_bundle_1.feature)('VOICE_MODE') ?
        // biome-ignore lint/correctness/useHookAtTopLevel: feature() is a compile-time constant
        (0, voice_js_1.useVoiceState)(s_0 => s_0.voiceInterimTranscript) : '';
    ...
    const handleVoiceTranscript = (0, react_1.useCallback)((text) => {
        if (!(0, bun_bundle_1.feature)('VOICE_MODE'))
            return;
    ...
    const interimRange = (0, react_1.useMemo)(() => {
        if (!(0, bun_bundle_1.feature)('VOICE_MODE'))
            return null;
        if (voicePrefixRef.current === null)
            return null;
 ...
 */
function useVoiceKeybindingHandler({ voiceHandleKeyEvent, stripTrailing, resetAnchor, isActive }) {
    const getVoiceState = (0, voice_js_1.useGetVoiceState)();
    ...
    const voiceKeystroke = (0, react_1.useMemo)(() => {
    ...
    const rapidCountRef = (0, react_1.useRef)(0);
    ...
    const charsInInputRef = (0, react_1.useRef)(0);
    ...
    const recordingFloorRef = (0, react_1.useRef)(0);
    ...
    const isHoldActiveRef = (0, react_1.useRef)(false);
    const resetTimerRef = (0, react_1.useRef)(null);
    ...
    const handleKeyDown = (e) => {
        ...
        if (bareChar !== null) {
            ...
            const normalized = bareChar === ' ' ? (0, stringUtils_js_1.normalizeFullWidthSpace)(e.key) : e.key;
