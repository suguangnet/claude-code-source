...
const ScrollBox_js_1 = __importDefault(require("../ink/components/ScrollBox.js"));
...
const nullRenderingAttachments_js_1 = require("./messages/nullRenderingAttachments.js");
const PromptInputFooterSuggestions_js_1 = __importDefault(require("./PromptInput/PromptInputFooterSuggestions.js"));
...
function useUnseenDivider(messageCount) {
    const [dividerIndex, setDividerIndex] = (0, react_1.useState)(null);
    ...
    const countRef = (0, react_1.useRef)(messageCount);
    ...
    const dividerYRef = (0, react_1.useRef)(null);
    const onRepin = (0, react_1.useCallback)(() => {
    ...
    const onScrollAway = (0, react_1.useCallback)((handle) => {
    ...
    const jumpToNew = (0, react_1.useCallback)((handle_0) => {
        if (!handle_0)
            return;
    ...
    const shiftDivider = (0, react_1.useCallback)((indexDelta, heightDelta) => {
...
function computeUnseenDivider(messages, dividerIndex) {
    ...
    while (anchorIdx < messages.length && (messages[anchorIdx]?.type === 'progress' || (0, nullRenderingAttachments_js_1.isNullRenderingAttachment)(messages[anchorIdx]))) {
        anchorIdx++;
    }
...
function FullscreenLayout(t0) {
    ...
    const { rows: terminalRows, columns } = (0, useTerminalSize_js_1.useTerminalSize)();
    const [stickyPrompt, setStickyPrompt] = (0, react_1.useState)(null);
    let t4;
    ...
    const pillVisible = (0, react_1.useSyncExternalStore)(subscribe, t6);
    let t7;
    ...
    if ((0, fullscreen_js_1.isFullscreenEnvEnabled)()) {
        ...
        let t8;
        if ($[7] !== headerPrompt) {
            t8 = headerPrompt && react_1.default.createElement(StickyPromptHeader, { text: headerPrompt.text, onClick: headerPrompt.scrollTo });
            $[7] = headerPrompt;
            $[8] = t8;
        }
        else {
        ...
        let t10;
        if ($[9] !== scrollable) {
            t10 = react_1.default.createElement(exports.ScrollChromeContext, { value: chromeCtx }, scrollable);
            $[9] = scrollable;
            $[10] = t10;
        }
        else {
        ...
        if ($[11] !== overlay || $[12] !== scrollRef || $[13] !== t10 || $[14] !== t9) {
            t11 = react_1.default.createElement(ScrollBox_js_1.default, { ref: scrollRef, flexGrow: 1, flexDirection: "column", paddingTop: t9, stickyScroll: true },
                t10,
                overlay);
            $[11] = overlay;
            $[12] = scrollRef;
        ...
        if ($[16] !== hidePill || $[17] !== newMessageCount || $[18] !== onPillClick || $[19] !== overlay || $[20] !== pillVisible) {
            t12 = !hidePill && pillVisible && overlay == null && react_1.default.createElement(NewMessagesPill, { count: newMessageCount, onClick: onPillClick });
            $[16] = hidePill;
            $[17] = newMessageCount;
            $[18] = onPillClick;
            $[19] = overlay;
        ...
        let t13;
        if ($[22] !== bottomFloat) {
            t13 = bottomFloat != null && react_1.default.createElement(ink_js_1.Box, { position: "absolute", bottom: 0, right: 0, opaque: true }, bottomFloat);
            $[22] = bottomFloat;
            $[23] = t13;
        }
        else {
        ...
        if ($[24] !== t11 || $[25] !== t12 || $[26] !== t13 || $[27] !== t8) {
            t14 = react_1.default.createElement(ink_js_1.Box, { flexGrow: 1, flexDirection: "column", overflow: "hidden" },
                t8,
                t11,
                t12,
                t13);
        ...
        if ($[29] === Symbol.for("react.memo_cache_sentinel")) {
            t15 = react_1.default.createElement(SuggestionsOverlay, null);
            t16 = react_1.default.createElement(DialogOverlay, null);
            $[29] = t15;
            $[30] = t16;
        }
        else {
        ...
        let t17;
        if ($[31] !== bottom) {
            t17 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", flexShrink: 0, width: "100%", maxHeight: "50%" },
                t15,
                t16,
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", width: "100%", flexGrow: 1, overflowY: "hidden" }, bottom));
            $[31] = bottom;
            $[32] = t17;
        }
        else {
        ...
        if ($[33] !== columns || $[34] !== modal || $[35] !== modalScrollRef || $[36] !== terminalRows) {
            t18 = modal != null && react_1.default.createElement(modalContext_js_1.ModalContext, { value: {
                    rows: terminalRows - MODAL_TRANSCRIPT_PEEK - 1,
                    columns: columns - 4,
                    scrollRef: modalScrollRef ?? null
                } },
                react_1.default.createElement(ink_js_1.Box, { position: "absolute", bottom: 0, left: 0, right: 0, maxHeight: terminalRows - MODAL_TRANSCRIPT_PEEK, flexDirection: "column", overflow: "hidden", opaque: true },
                    react_1.default.createElement(ink_js_1.Box, { flexShrink: 0 },
                        react_1.default.createElement(ink_js_1.Text, { color: "permission" }, "\u2594".repeat(columns))),
                    react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, flexShrink: 0, overflow: "hidden" }, modal)));
            $[33] = columns;
            $[34] = modal;
            $[35] = modalScrollRef;
            $[36] = terminalRows;
        ...
        if ($[38] !== t14 || $[39] !== t17 || $[40] !== t18) {
            t19 = react_1.default.createElement(promptOverlayContext_js_1.PromptOverlayProvider, null,
                t14,
                t17,
                t18);
            $[38] = t14;
...
function NewMessagesPill(t0) {
    ...
    let t4;
    if ($[2] !== count) {
        t4 = count > 0 ? `${count} new ${(0, stringUtils_js_1.plural)(count, "message")}` : "Jump to bottom";
        $[2] = count;
        $[3] = t4;
    }
    else {
    ...
    let t5;
    if ($[4] !== t3 || $[5] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Text, { backgroundColor: t3, dimColor: true },
            " ",
            t4,
            " ",
    ...
    let t6;
    if ($[7] !== onClick || $[8] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Box, { position: "absolute", bottom: 0, left: 0, right: 0, justifyContent: "center" },
            react_1.default.createElement(ink_js_1.Box, { onClick: onClick, onMouseEnter: t1, onMouseLeave: t2 }, t5));
        $[7] = onClick;
        $[8] = t5;
        $[9] = t6;
    }
...
function StickyPromptHeader(t0) {
    ...
    let t4;
    if ($[2] !== text) {
        t4 = react_1.default.createElement(ink_js_1.Text, { color: "subtle", wrap: "truncate-end" },
    ...
    if ($[4] !== onClick || $[5] !== t1 || $[6] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Box, { flexShrink: 0, width: "100%", height: 1, paddingRight: 1, backgroundColor: t1, onClick: onClick, onMouseEnter: t2, onMouseLeave: t3 }, t4);
        $[4] = onClick;
        $[5] = t1;
        $[6] = t4;
        $[7] = t5;
...
function SuggestionsOverlay() {
    ...
    const data = (0, promptOverlayContext_js_1.usePromptOverlay)();
    if (!data || data.suggestions.length === 0) {
        return null;
    }
    let t0;
    if ($[0] !== data.maxColumnWidth || $[1] !== data.selectedSuggestion || $[2] !== data.suggestions) {
        t0 = react_1.default.createElement(ink_js_1.Box, { position: "absolute", bottom: "100%", left: 0, right: 0, paddingX: 2, paddingTop: 1, flexDirection: "column", opaque: true },
            react_1.default.createElement(PromptInputFooterSuggestions_js_1.default, { suggestions: data.suggestions, selectedSuggestion: data.selectedSuggestion, maxColumnWidth: data.maxColumnWidth, overlay: true }));
...
function DialogOverlay() {
    ...
    const node = (0, promptOverlayContext_js_1.usePromptOverlayDialog)();
    if (!node) {
        return null;
    }
    let t0;
    if ($[0] !== node) {
        t0 = react_1.default.createElement(ink_js_1.Box, { position: "absolute", bottom: "100%", left: 0, right: 0, opaque: true }, node);
        $[0] = node;
        $[1] = t0;
    }
    else {
