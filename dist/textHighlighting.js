...
class HighlightSegmenter {
    ...
    segmentTo(targetVisiblePos) {
        ...
        const prefix = (0, ansi_tokenize_1.ansiCodesToString)(prefixCodes);
        const suffix = (0, ansi_tokenize_1.ansiCodesToString)((0, ansi_tokenize_1.undoAnsiCodes)(suffixCodes));
        return {
...
function reduceCodes(codes) {
    return (0, ansi_tokenize_1.reduceAnsiCodes)(codes).filter(c => c.code !== c.endCode);
}
