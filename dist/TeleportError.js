...
const preconditions_js_1 = require("src/utils/background/remote/preconditions.js");
...
const TeleportStash_js_1 = require("./TeleportStash.js");
...
function TeleportError(t0) {
    ...
    const [currentError, setCurrentError] = (0, react_1.useState)(null);
        ...
        case "needsGitStash":
            {
                ...
                if ($[12] !== handleStashComplete) {
                    t9 = react_1.default.createElement(TeleportStash_js_1.TeleportStash, { onStashAndContinue: handleStashComplete, onCancel: onCancel });
        ...
        case "needsLogin":
            {
                if (isLoggingIn) {
                    ...
                    if ($[14] !== handleLoginComplete) {
                        t9 = react_1.default.createElement(ConsoleOAuthFlow_js_1.ConsoleOAuthFlow, { onDone: handleLoginComplete, mode: "login", forceLoginMethod: "claudeai" });
                ...
                if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
                    t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Teleport requires a Claude.ai account."),
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Your Claude Pro/Max subscription will be used by Claude Code."));
                    $[16] = t9;
                }
                else {
                    t9 = $[16];
                ...
                if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
                    t10 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Log in to Claude", onCancel: onCancel },
                        t9,
                        react_1.default.createElement(index_js_1.Select, { options: [{
...
async function getTeleportErrors() {
    ...
    const [needsLogin, isGitClean] = await Promise.all([(0, preconditions_js_1.checkNeedsClaudeAiLogin)(), (0, preconditions_js_1.checkIsGitClean)()]);
    if (needsLogin) {
