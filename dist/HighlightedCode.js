...
const Fallback_js_1 = require("./HighlightedCode/Fallback.js");
...
exports.HighlightedCode = (0, react_1.memo)(function HighlightedCode(t0) {
    ...
    const [measuredWidth, setMeasuredWidth] = (0, react_1.useState)(width || DEFAULT_WIDTH);
    ...
    bb0: {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = (0, colorDiff_js_1.expectColorFile)();
            $[0] = t3;
        }
        else {
            t3 = $[0];
    ...
    if ($[4] !== width) {
        t3 = () => {
            if (!width && ref.current) {
                const { width: elementWidth } = (0, ink_js_1.measureElement)(ref.current);
                if (elementWidth > 0) {
    ...
    bb2: {
        ...
        const lineCount = (0, stringUtils_js_1.countCharInString)(code, "\n") + 1;
        let t7;
        if ($[12] !== lineCount) {
    ...
    if ($[14] !== code || $[15] !== dim || $[16] !== filePath || $[17] !== gutterWidth || $[18] !== lines || $[19] !== syntaxHighlightingDisabled) {
        t7 = React.createElement(ink_js_1.Box, { ref: ref }, lines ? React.createElement(ink_js_1.Box, { flexDirection: "column" }, lines.map((line, i) => gutterWidth > 0 ? React.createElement(CodeLine, { key: i, line: line, gutterWidth: gutterWidth }) : React.createElement(ink_js_1.Text, { key: i },
            React.createElement(ink_js_1.Ansi, null, line)))) : React.createElement(Fallback_js_1.HighlightedCodeFallback, { code: code, filePath: filePath, dim: dim, skipColoring: syntaxHighlightingDisabled }));
        $[14] = code;
        $[15] = dim;
        $[16] = filePath;
        $[17] = gutterWidth;
...
function CodeLine(t0) {
    ...
    let t3;
    if ($[6] !== gutter) {
        t3 = React.createElement(ink_js_1.NoSelect, { fromLeftEdge: true },
            React.createElement(ink_js_1.Text, null,
                React.createElement(ink_js_1.Ansi, null, gutter)));
        $[6] = gutter;
        $[7] = t3;
    }
    else {
