...
function RainbowText(t0) {
    ...
    let t3;
    if ($[2] !== phase || $[3] !== t2) {
        t3 = react_1.default.createElement(react_1.default.Fragment, null, t2.map((ch, i) => react_1.default.createElement(ink_js_1.Text, { key: i, color: (0, thinking_js_1.getRainbowColor)(i + phase) }, ch)));
        $[2] = phase;
        $[3] = t2;
        $[4] = t3;
    }
...
function useSmoothCount(target, time, snap) {
    const displayed = (0, react_1.useRef)(target);
    const lastTick = (0, react_1.useRef)(time);
...
function ReviewRainbowLine(t0) {
    ...
    const [, time] = (0, ink_js_1.useAnimationFrame)(running && !reducedMotion ? TICK_MS : null);
    ...
    if (session.status === "completed") {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ink_js_1.Text, { color: "background" },
                    figures_js_1.DIAMOND_FILLED,
                    " "),
                react_1.default.createElement(RainbowText, { text: "ultrareview", phase: 0 }),
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " ready \u00B7 shift+\u2193 to view"));
            $[0] = t1;
        }
        else {
            t1 = $[0];
        ...
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ink_js_1.Text, { color: "background" },
                    ...
                    " "),
                react_1.default.createElement(RainbowText, { text: "ultrareview", phase: 0 }),
                react_1.default.createElement(ink_js_1.Text, { color: "error", dimColor: true },
                    " \xB7 ",
                    "error"));
            $[1] = t1;
        }
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = react_1.default.createElement(ink_js_1.Text, { color: "background" },
            figures_js_1.DIAMOND_OPEN,
            " ");
        $[7] = t2;
    }
    else {
    ...
    let t4;
    if ($[8] !== t3) {
        t4 = react_1.default.createElement(RainbowText, { text: "ultrareview", phase: t3 });
        $[8] = t3;
        $[9] = t4;
    }
    else {
...
function RemoteSessionProgress(t0) {
    ...
    if (session.isRemoteReview) {
        let t1;
        if ($[0] !== session) {
            t1 = react_1.default.createElement(ReviewRainbowLine, { session: session });
            $[0] = session;
            $[1] = t1;
        }
        else {
    ...
    if (session.status === "completed") {
        ...
        if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(ink_js_1.Text, { bold: true, color: "success", dimColor: true }, "done");
            $[2] = t1;
        }
        else {
            t1 = $[2];
    ...
    if (session.status === "failed") {
        ...
        if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(ink_js_1.Text, { bold: true, color: "error", dimColor: true }, "error");
            $[3] = t1;
        }
        else {
            t1 = $[3];
