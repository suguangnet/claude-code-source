...
const Markdown_js_1 = require("../../components/Markdown.js");
const ink_js_1 = require("../../ink.js");
const slowOperations_js_1 = require("../../utils/slowOperations.js");
const teammateMailbox_js_1 = require("../../utils/teammateMailbox.js");
const ShutdownMessage_js_1 = require("./ShutdownMessage.js");
const TaskAssignmentMessage_js_1 = require("./TaskAssignmentMessage.js");
/**
...
function PlanApprovalRequestDisplay(t0) {
    ...
    let t1;
    if ($[0] !== request.from) {
        t1 = React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, { color: "planMode", bold: true },
    ...
    if ($[2] !== request.planContent) {
        t2 = React.createElement(ink_js_1.Box, { borderStyle: "dashed", borderColor: "subtle", borderLeft: false, borderRight: false, flexDirection: "column", paddingX: 1, marginBottom: 1 },
            React.createElement(Markdown_js_1.Markdown, null, request.planContent));
    ...
    let t4;
    if ($[6] !== t1 || $[7] !== t2 || $[8] !== t3) {
        t4 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginY: 1 },
            React.createElement(ink_js_1.Box, { borderStyle: "round", borderColor: "planMode", flexDirection: "column", paddingX: 1 },
                t1,
                t2,
                t3));
        $[6] = t1;
...
function PlanApprovalResponseDisplay(t0) {
    ...
    if (response.approved) {
        let t1;
        if ($[0] !== senderName) {
            t1 = React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { color: "success", bold: true },
                    "\u2713 Plan Approved by ",
                    senderName));
            $[0] = senderName;
            $[1] = t1;
        ...
        if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, null, "You can now proceed with implementation. Your plan mode restrictions have been lifted."));
            $[2] = t2;
        }
        else {
            t2 = $[2];
        ...
        let t3;
        if ($[3] !== t1) {
            t3 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginY: 1 },
                React.createElement(ink_js_1.Box, { borderStyle: "round", borderColor: "success", flexDirection: "column", paddingX: 1, paddingY: 1 },
                    t1,
                    t2));
            $[3] = t1;
            $[4] = t3;
    ...
    if ($[5] !== senderName) {
        t1 = React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { color: "error", bold: true },
                "\u2717 Plan Rejected by ",
                senderName));
        $[5] = senderName;
        $[6] = t1;
    ...
    if ($[7] !== response.feedback) {
        t2 = response.feedback && React.createElement(ink_js_1.Box, { marginTop: 1, borderStyle: "dashed", borderColor: "subtle", borderLeft: false, borderRight: false, paddingX: 1 },
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = React.createElement(ink_js_1.Box, { marginTop: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true }, "Please revise your plan based on the feedback and call ExitPlanMode again."));
        $[9] = t3;
    }
    else {
        t3 = $[9];
    ...
    if ($[10] !== t1 || $[11] !== t2) {
        t4 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginY: 1 },
            React.createElement(ink_js_1.Box, { borderStyle: "round", borderColor: "error", flexDirection: "column", paddingX: 1, paddingY: 1 },
                t1,
                t2,
                t3));
        $[10] = t1;
...
function tryRenderPlanApprovalMessage(content, senderName) {
    const request = (0, teammateMailbox_js_1.isPlanApprovalRequest)(content);
    if (request) {
        return React.createElement(PlanApprovalRequestDisplay, { request: request });
    }
    const response = (0, teammateMailbox_js_1.isPlanApprovalResponse)(content);
    if (response) {
...
function formatTeammateMessageContent(content) {
    ...
    const shutdownSummary = (0, ShutdownMessage_js_1.getShutdownMessageSummary)(content);
    if (shutdownSummary) {
        return shutdownSummary;
    }
    const idleMsg = (0, teammateMailbox_js_1.isIdleNotification)(content);
    if (idleMsg) {
        return getIdleNotificationSummary(idleMsg);
    }
    const taskAssignmentSummary = (0, TaskAssignmentMessage_js_1.getTaskAssignmentSummary)(content);
