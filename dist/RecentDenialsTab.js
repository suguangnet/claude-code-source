...
const StatusIcon_js_1 = require("../../design-system/StatusIcon.js");
...
function RecentDenialsTab(t0) {
    ...
    const [denials] = (0, react_1.useState)(_temp);
    const [approved, setApproved] = (0, react_1.useState)(_temp2);
    const [retry, setRetry] = (0, react_1.useState)(_temp3);
    const [focusedIdx, setFocusedIdx] = (0, react_1.useState)(0);
    let t3;
    let t4;
    ...
    if (denials.length === 0) {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = React.createElement(ink_js_1.Text, { dimColor: true }, "No recent denials. Commands denied by the auto mode classifier will appear here.");
            $[16] = t10;
        }
        else {
            t10 = $[16];
            ...
            t11 = (d, idx_0) => {
                ...
                return {
                    label: React.createElement(ink_js_1.Text, null,
                        React.createElement(StatusIcon_js_1.StatusIcon, { status: isApproved ? "success" : "error", withSpace: true }),
                        d.display,
                        React.createElement(ink_js_1.Text, { dimColor: true }, suffix)),
                    value: String(idx_0)
                };
            };
            $[21] = approved;
    ...
    if ($[24] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = React.createElement(ink_js_1.Text, null, "Commands recently denied by the auto mode classifier.");
        $[24] = t11;
    }
    else {
        t11 = $[24];
    ...
    if ($[25] !== focusHeader || $[26] !== headerFocused || $[27] !== options || $[28] !== t12) {
        t13 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t11,
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(select_js_1.Select, { options: options, onChange: handleSelect, onFocus: handleFocus, visibleOptionCount: t12, isDisabled: headerFocused, onUpFromFirstItem: focusHeader })));
        $[25] = focusHeader;
        $[26] = headerFocused;
        $[27] = options;
        $[28] = t12;
