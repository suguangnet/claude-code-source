...
const Tabs_js_1 = require("../../components/design-system/Tabs.js");
...
const AddMarketplace_js_1 = require("./AddMarketplace.js");
const BrowseMarketplace_js_1 = require("./BrowseMarketplace.js");
const DiscoverPlugins_js_1 = require("./DiscoverPlugins.js");
const ManageMarketplaces_js_1 = require("./ManageMarketplaces.js");
const ManagePlugins_js_1 = require("./ManagePlugins.js");
const PluginErrors_js_1 = require("./PluginErrors.js");
const parseArgs_js_1 = require("./parseArgs.js");
const ValidatePlugin_js_1 = require("./ValidatePlugin.js");
function MarketplaceList(t0) {
        ...
        t1 = () => {
            const loadList = async function loadList() {
                ...
                try {
                    ...
                    const err = t3;
                    onComplete(`Error loading marketplaces: ${(0, errors_js_1.errorMessage)(err)}`);
                }
            };
            loadList();
        };
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = React.createElement(ink_js_1.Text, null, "Loading marketplaces...");
        $[3] = t3;
    }
    else {
        t3 = $[3];
...
function ErrorsTabContent(t0) {
    ...
    const errors = (0, AppState_js_1.useAppState)(_temp2);
    const installationStatus = (0, AppState_js_1.useAppState)(_temp3);
    ...
    const [marketplaceLoadFailures, setMarketplaceLoadFailures] = (0, react_1.useState)(t1);
    let t2;
    let t3;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = () => {
            (async () => {
                try {
                    const config = await (0, marketplaceManager_js_1.loadKnownMarketplacesConfig)();
                    const { failures } = await (0, marketplaceHelpers_js_1.loadMarketplacesWithGracefulDegradation)(config);
            ...
            case "remove-extra-marketplace":
                {
                    ...
                    setActionMessage(`${figures_1.default.tick} Removed "${action.name}" from ${scopes} settings`);
                    markPluginsChanged();
                    break bb77;
                }
            case "remove-installed-marketplace":
                {
                    (async () => {
                        ;
                        try {
                            await (0, marketplaceManager_js_1.removeMarketplaceSource)(action.name);
                            (0, cacheUtils_js_1.clearAllCaches)();
                            setMarketplaceLoadFailures(prev => prev.filter(f => f.name !== action.name));
                            setActionMessage(`${figures_1.default.tick} Removed marketplace "${action.name}"`);
                            markPluginsChanged();
                        }
                        catch (t6) {
                            const err = t6;
    ...
    if (rows.length === 0) {
        ...
        if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
            t10 = React.createElement(ink_js_1.Box, { marginLeft: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "No plugin errors"));
            $[9] = t10;
        }
        else {
            t10 = $[9];
        ...
        if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
            t11 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
                t10,
    ...
    if ($[11] !== clampedIndex) {
        t11 = (row_0, idx) => {
            ...
            return React.createElement(ink_js_1.Box, { key: idx, marginLeft: 1, flexDirection: "column", marginBottom: 1 },
                React.createElement(ink_js_1.Text, null,
                    React.createElement(ink_js_1.Text, { color: isSelected ? "suggestion" : "error" },
                        isSelected ? figures_1.default.pointer : figures_1.default.cross,
                        " "),
                    React.createElement(ink_js_1.Text, { bold: isSelected }, row_0.label),
                    row_0.scope && React.createElement(ink_js_1.Text, { dimColor: true },
                        " (",
                        row_0.scope,
                        ")")),
                React.createElement(ink_js_1.Box, { marginLeft: 3 },
                    React.createElement(ink_js_1.Text, { color: "error" }, row_0.message)),
                row_0.guidance && React.createElement(ink_js_1.Box, { marginLeft: 3 },
                    React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, row_0.guidance)));
        };
        $[11] = clampedIndex;
        $[12] = t11;
    }
    ...
    let t13;
    if ($[13] !== actionMessage) {
        t13 = actionMessage && React.createElement(ink_js_1.Box, { marginTop: 1, marginLeft: 1 },
            React.createElement(ink_js_1.Text, { color: "claude" }, actionMessage));
        $[13] = actionMessage;
        $[14] = t13;
    }
    else {
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:previous", context: "Select", fallback: "\u2191", description: "navigate" });
        $[15] = t14;
    }
    else {
        t14 = $[15];
    ...
    let t15;
    if ($[16] !== hasAction) {
        t15 = hasAction && React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "resolve" });
        $[16] = hasAction;
        $[17] = t15;
    }
    else {
    ...
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
        t16 = React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" });
        $[18] = t16;
    }
    else {
        t16 = $[18];
    ...
    let t17;
    if ($[19] !== t15) {
        t17 = React.createElement(ink_js_1.Box, { marginTop: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
...
function PluginSettings(t0) {
    const $ = (0, compiler_runtime_1.c)(75);
    ...
    const [activeTab, setActiveTab] = (0, react_1.useState)(t2);
    const [inputValue, setInputValue] = (0, react_1.useState)(viewState.type === "add-marketplace" ? viewState.initialValue || "" : "");
    const [cursorOffset, setCursorOffset] = (0, react_1.useState)(0);
    const [error, setError] = (0, react_1.useState)(null);
    const [result, setResult] = (0, react_1.useState)(null);
    const [childSearchActive, setChildSearchActive] = (0, react_1.useState)(false);
    const setAppState = (0, AppState_js_1.useSetAppState)();
    const pluginErrorCount = (0, AppState_js_1.useAppState)(_temp0);
    ...
    if (viewState.type === "help") {
        ...
        if ($[28] === Symbol.for("react.memo_cache_sentinel")) {
            t16 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
                React.createElement(ink_js_1.Text, { bold: true }, "Plugin Command Usage:"),
                React.createElement(ink_js_1.Text, null, " "),
                React.createElement(ink_js_1.Text, { dimColor: true }, "Installation:"),
                React.createElement(ink_js_1.Text, null, " /plugin install - Browse and install plugins"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin install <marketplace> - Install from specific marketplace"),
                React.createElement(ink_js_1.Text, null, " /plugin install <plugin> - Install specific plugin"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin install <plugin>@<market> - Install plugin from marketplace"),
                React.createElement(ink_js_1.Text, null, " "),
                React.createElement(ink_js_1.Text, { dimColor: true }, "Management:"),
                React.createElement(ink_js_1.Text, null, " /plugin manage - Manage installed plugins"),
                React.createElement(ink_js_1.Text, null, " /plugin enable <plugin> - Enable a plugin"),
                React.createElement(ink_js_1.Text, null, " /plugin disable <plugin> - Disable a plugin"),
                React.createElement(ink_js_1.Text, null, " /plugin uninstall <plugin> - Uninstall a plugin"),
                React.createElement(ink_js_1.Text, null, " "),
                React.createElement(ink_js_1.Text, { dimColor: true }, "Marketplaces:"),
                React.createElement(ink_js_1.Text, null, " /plugin marketplace - Marketplace management menu"),
                React.createElement(ink_js_1.Text, null, " /plugin marketplace add - Add a marketplace"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin marketplace add <path/url> - Add marketplace directly"),
                React.createElement(ink_js_1.Text, null, " /plugin marketplace update - Update marketplaces"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin marketplace update <name> - Update specific marketplace"),
                React.createElement(ink_js_1.Text, null, " /plugin marketplace remove - Remove a marketplace"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin marketplace remove <name> - Remove specific marketplace"),
                React.createElement(ink_js_1.Text, null, " /plugin marketplace list - List all marketplaces"),
                React.createElement(ink_js_1.Text, null, " "),
                React.createElement(ink_js_1.Text, { dimColor: true }, "Validation:"),
                React.createElement(ink_js_1.Text, null,
                    " ",
                    "/plugin validate <path> - Validate a manifest file or directory"),
                React.createElement(ink_js_1.Text, null, " "),
                React.createElement(ink_js_1.Text, { dimColor: true }, "Other:"),
                React.createElement(ink_js_1.Text, null, " /plugin - Main plugin menu"),
                React.createElement(ink_js_1.Text, null, " /plugin help - Show this help"),
                React.createElement(ink_js_1.Text, null, " /plugins - Alias for /plugin"));
            $[28] = t16;
        }
        else {
            t16 = $[28];
    ...
    if (viewState.type === "validate") {
        ...
        if ($[29] !== onComplete || $[30] !== viewState.path) {
            t16 = React.createElement(ValidatePlugin_js_1.ValidatePlugin, { onComplete: onComplete, path: viewState.path });
            $[29] = onComplete;
            $[30] = viewState.path;
            $[31] = t16;
        }
    ...
    if (viewState.type === "add-marketplace") {
        ...
        if ($[34] !== cliMode || $[35] !== cursorOffset || $[36] !== error || $[37] !== inputValue || $[38] !== markPluginsChanged || $[39] !== result) {
            t16 = React.createElement(AddMarketplace_js_1.AddMarketplace, { inputValue: inputValue, setInputValue: setInputValue, cursorOffset: cursorOffset, setCursorOffset: setCursorOffset, error: error, setError: setError, result: result, setResult: setResult, setViewState: setViewState, onAddComplete: markPluginsChanged, cliMode: cliMode });
            $[34] = cliMode;
            $[35] = cursorOffset;
            $[36] = error;
            $[37] = inputValue;
    ...
    if ($[44] !== error || $[45] !== markPluginsChanged || $[46] !== result || $[47] !== viewState.targetMarketplace || $[48] !== viewState.targetPlugin || $[49] !== viewState.type) {
        t17 = React.createElement(Tabs_js_1.Tab, { id: "discover", title: "Discover" }, viewState.type === "browse-marketplace" ? React.createElement(BrowseMarketplace_js_1.BrowseMarketplace, { error: error, setError: setError, result: result, setResult: setResult, setViewState: setViewState, onInstallComplete: markPluginsChanged, targetMarketplace: viewState.targetMarketplace, targetPlugin: viewState.targetPlugin }) : React.createElement(DiscoverPlugins_js_1.DiscoverPlugins, { error: error, setError: setError, result: result, setResult: setResult, setViewState: setViewState, onInstallComplete: markPluginsChanged, onSearchModeChange: setChildSearchActive, targetPlugin: viewState.type === "discover-plugins" ? viewState.targetPlugin : undefined }));
        $[44] = error;
    ...
    if ($[51] !== markPluginsChanged || $[52] !== t18 || $[53] !== t19 || $[54] !== t20) {
        t21 = React.createElement(Tabs_js_1.Tab, { id: "installed", title: "Installed" },
            React.createElement(ManagePlugins_js_1.ManagePlugins, { setViewState: setViewState, setResult: setResult, onManageComplete: markPluginsChanged, onSearchModeChange: setChildSearchActive, targetPlugin: t18, targetMarketplace: t19, action: t20 }));
    ...
    if ($[56] !== error || $[57] !== exitState || $[58] !== markPluginsChanged || $[59] !== t22 || $[60] !== t23) {
        t24 = React.createElement(Tabs_js_1.Tab, { id: "marketplaces", title: "Marketplaces" },
            React.createElement(ManageMarketplaces_js_1.ManageMarketplaces, { setViewState: setViewState, error: error, setError: setError, setResult: setResult, exitState: exitState, onManageComplete: markPluginsChanged, targetMarketplace: t22, action: t23 }));
        $[56] = error;
        $[57] = exitState;
    ...
    if ($[64] !== errorsTabTitle || $[65] !== t25) {
        t26 = React.createElement(Tabs_js_1.Tab, { id: "errors", title: errorsTabTitle }, t25);
        $[64] = errorsTabTitle;
        $[65] = t25;
        $[66] = t26;
    }
    ...
    if ($[67] !== activeTab || $[68] !== childSearchActive || $[69] !== t16 || $[70] !== t17 || $[71] !== t21 || $[72] !== t24 || $[73] !== t26) {
        t27 = React.createElement(Pane_js_1.Pane, { color: "suggestion" },
            React.createElement(Tabs_js_1.Tabs, { title: "Plugins", selectedTab: activeTab, onTabChange: handleTabChange, color: "suggestion", disableNavigation: childSearchActive, banner: t16 },
                t17,
                t21,
                t24,
                t26));
