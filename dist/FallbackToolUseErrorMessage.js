...
const OutputLine_js_1 = require("src/components/shell/OutputLine.js");
...
function FallbackToolUseErrorMessage(t0) {
    ...
    const transcriptShortcut = (0, useShortcutDisplay_js_1.useShortcutDisplay)("app:toggleTranscript", "Global", "ctrl+o");
    let T0;
    let T1;
    let T2;
    let plusLines;
    ...
    if ($[0] !== result || $[1] !== verbose) {
        ...
        if (typeof result !== "string") {
            ...
            const extractedError = (0, messages_js_1.extractTag)(result, "tool_use_error") ?? result;
            const withoutSandboxViolations = (0, sandbox_ui_utils_js_1.removeSandboxViolationTags)(extractedError);
    ...
    if ($[13] !== plusLines || $[14] !== transcriptShortcut || $[15] !== verbose) {
        t5 = !verbose && plusLines > 0 && React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { dimColor: true },
                ...
                " ("),
            React.createElement(ink_js_1.Text, { dimColor: true, bold: true }, transcriptShortcut),
            React.createElement(ink_js_1.Text, null, " "),
            React.createElement(ink_js_1.Text, { dimColor: true }, "to see all)"));
        $[13] = plusLines;
