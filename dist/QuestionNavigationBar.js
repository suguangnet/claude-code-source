...
function QuestionNavigationBar(t0) {
    ...
    if ($[0] !== columns || $[1] !== currentQuestionIndex || $[2] !== hideSubmitTab || $[3] !== questions) {
        bb0: {
            const submitText = hideSubmitTab ? "" : ` ${figures_1.default.tick} Submit `;
            const fixedWidth = (0, stringWidth_js_1.stringWidth)("\u2190 ") + (0, stringWidth_js_1.stringWidth)(" \u2192") + (0, stringWidth_js_1.stringWidth)(submitText);
            ...
            const currentIdealWidth = 4 + (0, stringWidth_js_1.stringWidth)(currentHeader);
    ...
    if ($[14] !== currentQuestionIndex || $[15] !== hideArrows) {
        t3 = !hideArrows && react_1.default.createElement(ink_js_1.Text, { color: currentQuestionIndex === 0 ? "inactive" : undefined },
            "\u2190",
            " ");
    ...
    if ($[17] !== answers || $[18] !== currentQuestionIndex || $[19] !== questions || $[20] !== tabDisplayTexts) {
        ...
        if ($[22] !== answers || $[23] !== currentQuestionIndex || $[24] !== tabDisplayTexts) {
            t5 = (q_1, index_2) => {
                ...
                const checkbox = isAnswered ? figures_1.default.checkboxOn : figures_1.default.checkboxOff;
                const displayText = tabDisplayTexts[index_2] || q_1?.header || `Q${index_2 + 1}`;
                return react_1.default.createElement(ink_js_1.Box, { key: q_1?.question || `question-${index_2}` }, isSelected ? react_1.default.createElement(ink_js_1.Text, { backgroundColor: "permission", color: "inverseText" },
                    " ",
                    checkbox,
                    " ",
                    displayText,
    ...
    if ($[26] !== currentQuestionIndex || $[27] !== hideSubmitTab || $[28] !== questions.length) {
        t5 = !hideSubmitTab && react_1.default.createElement(ink_js_1.Box, { key: "submit" }, currentQuestionIndex === questions.length ? react_1.default.createElement(ink_js_1.Text, { backgroundColor: "permission", color: "inverseText" },
            " ",
    ...
    if ($[30] !== currentQuestionIndex || $[31] !== hideArrows || $[32] !== questions.length) {
        t6 = !hideArrows && react_1.default.createElement(ink_js_1.Text, { color: currentQuestionIndex === questions.length ? "inactive" : undefined },
            " ",
            "\u2192");
    ...
    if ($[34] !== t3 || $[35] !== t4 || $[36] !== t5 || $[37] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", marginBottom: 1 },
            t3,
            t4,
            t5,
            t6);
