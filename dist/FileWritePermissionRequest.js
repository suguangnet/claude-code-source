...
const FileWriteToolDiff_js_1 = require("./FileWriteToolDiff.js");
...
function FileWritePermissionRequest(props) {
    ...
    let t10;
    if ($[9] !== t9) {
        t10 = react_1.default.createElement(ink_js_1.Text, { bold: true }, t9);
        $[9] = t9;
        $[10] = t10;
    }
    else {
    ...
    if ($[14] !== content || $[15] !== fileExists || $[16] !== file_path || $[17] !== oldContent) {
        t12 = react_1.default.createElement(FileWriteToolDiff_js_1.FileWriteToolDiff, { file_path: file_path, content: content, fileExists: fileExists, oldContent: oldContent });
        $[14] = content;
        $[15] = fileExists;
        $[16] = file_path;
        $[17] = oldContent;
    ...
    if ($[19] !== file_path || $[20] !== props.onDone || $[21] !== props.onReject || $[22] !== props.toolUseConfirm || $[23] !== props.toolUseContext || $[24] !== props.workerBadge || $[25] !== t11 || $[26] !== t12 || $[27] !== t7 || $[28] !== t8) {
        t13 = react_1.default.createElement(FilePermissionDialog_js_1.FilePermissionDialog, { toolUseConfirm: t2, toolUseContext: t3, onDone: t4, onReject: t5, workerBadge: t6, title: t7, subtitle: t8, question: t11, content: t12, path: file_path, completionType: "write_file_single", parseInput: parseInput, ideDiffSupport: ideDiffSupport });
        $[19] = file_path;
        $[20] = props.onDone;
        $[21] = props.onReject;
