...
const MemoryFileSelector_js_1 = require("../../components/memory/MemoryFileSelector.js");
const MemoryUpdateNotification_js_1 = require("../../components/memory/MemoryUpdateNotification.js");
...
function MemoryCommand({ onDone }) {
    const handleSelectMemoryFile = async (memoryPath) => {
        try {
            ...
            if (memoryPath.includes((0, envUtils_js_1.getClaudeConfigHomeDir)())) {
                await (0, promises_1.mkdir)((0, envUtils_js_1.getClaudeConfigHomeDir)(), {
                    recursive: true
                });
            }
            ...
            await (0, promptEditor_js_1.editFileInEditor)(memoryPath);
            ...
            onDone(`Opened memory file at ${(0, MemoryUpdateNotification_js_1.getRelativeMemoryPath)(memoryPath)}\n\n${editorHint}`, {
                display: 'system'
            });
        }
        catch (error) {
    ...
    return React.createElement(Dialog_js_1.Dialog, { title: "Memory", onCancel: handleCancel, color: "remember" },
        React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(React.Suspense, { fallback: null },
                React.createElement(MemoryFileSelector_js_1.MemoryFileSelector, { onSelect: handleSelectMemoryFile, onCancel: handleCancel })),
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true },
                    "Learn more: ",
                    React.createElement(ink_js_1.Link, { url: "https://code.claude.com/docs/en/memory" })))));
}
const call = async (onDone) => {
    ...
    await (0, claudemd_js_1.getMemoryFiles)();
