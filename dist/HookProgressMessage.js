...
function HookProgressMessage(t0) {
    ...
    if (hookEvent === "PreToolUse" || hookEvent === "PostToolUse") {
        if (isTranscriptMode) {
            ...
            let t3;
            if ($[6] !== hookEvent) {
                t3 = React.createElement(ink_js_1.Text, { dimColor: true, bold: true }, hookEvent);
                $[6] = hookEvent;
                $[7] = t3;
            }
            else {
            ...
            let t5;
            if ($[8] !== t4) {
                t5 = React.createElement(ink_js_1.Text, { dimColor: true },
                    t4,
                    " ran");
                $[8] = t4;
                $[9] = t5;
            ...
            if ($[10] !== t2 || $[11] !== t3 || $[12] !== t5) {
                t6 = React.createElement(MessageResponse_js_1.MessageResponse, null,
    ...
    if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = React.createElement(ink_js_1.Text, { dimColor: true }, "Running ");
        $[14] = t2;
    }
    else {
        t2 = $[14];
    ...
    let t5;
    if ($[17] !== t4) {
        t5 = React.createElement(ink_js_1.Text, { dimColor: true }, t4);
        $[17] = t4;
        $[18] = t5;
    }
    else {
