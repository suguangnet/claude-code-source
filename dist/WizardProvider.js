...
function WizardProvider(t0) {
    ...
    const [navigationHistory, setNavigationHistory] = (0, react_1.useState)(t4);
    ...
    if ($[32] !== CurrentStepComponent || $[33] !== children) {
        t13 = children || react_1.default.createElement(CurrentStepComponent, null);
    ...
    if ($[35] !== contextValue || $[36] !== t13) {
        t14 = react_1.default.createElement(exports.WizardContext.Provider, { value: contextValue }, t13);
        $[35] = contextValue;
        $[36] = t13;
        $[37] = t14;
    }
