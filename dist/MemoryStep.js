...
function MemoryStep() {
        ...
        t2 = value => {
            ...
            updateWizardData({
                ...
                finalAgent: wizardData.finalAgent ? {
                    ...
                    memory,
                    getSystemPrompt: (0, paths_js_1.isAutoMemoryEnabled)() && memory && agentType ? () => wizardData.systemPrompt + "\n\n" + (0, agentMemory_js_1.loadAgentMemoryPrompt)(agentType, memory) : () => wizardData.systemPrompt
                } : undefined
            });
            goNext();
        };
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(Byline_js_1.Byline, null,
    ...
    if ($[9] !== goBack || $[10] !== handleSelect || $[11] !== memoryOptions) {
        t4 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Configure agent memory", footerText: t3 },
            react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(select_js_1.Select, { key: "memory-select", options: memoryOptions, onChange: handleSelect, onCancel: goBack })));
        $[9] = goBack;
        $[10] = handleSelect;
        $[11] = memoryOptions;
        $[12] = t4;
