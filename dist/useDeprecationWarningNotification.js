...
const deprecation_js_1 = require("src/utils/model/deprecation.js");
...
function useDeprecationWarningNotification(model) {
    ...
    const lastWarningRef = (0, react_1.useRef)(null);
    let t0;
    let t1;
    if ($[0] !== addNotification || $[1] !== model) {
        t0 = () => {
            ...
            const deprecationWarning = (0, deprecation_js_1.getModelDeprecationWarning)(model);
