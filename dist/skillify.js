...
function registerSkillifySkill() {
    ...
    (0, bundledSkills_js_1.registerBundledSkill)({
        ...
        async getPromptForCommand(args, context) {
            const sessionMemory = (await (0, sessionMemoryUtils_js_1.getSessionMemoryContent)()) ?? 'No session memory available.';
            const userMessages = extractUserMessages((0, messages_js_1.getMessagesAfterCompactBoundary)(context.messages));
