...
const use_declared_cursor_js_1 = require("../../ink/hooks/use-declared-cursor.js");
const stringWidth_js_1 = require("../../ink/stringWidth.js");
const ink_js_1 = require("../../ink.js");
const array_js_1 = require("../../utils/array.js");
const select_input_option_js_1 = require("./select-input-option.js");
const select_option_js_1 = require("./select-option.js");
const use_select_input_js_1 = require("./use-select-input.js");
const use_select_state_js_1 = require("./use-select-state.js");
...
function Select(t0) {
    const $ = (0, compiler_runtime_1.c)(72);
    ...
    const [imagesSelected, setImagesSelected] = (0, react_1.useState)(false);
    ...
    const [inputValues, setInputValues] = (0, react_1.useState)(t7);
    let t8;
    ...
    const lastInitialValues = (0, react_1.useRef)(t8);
    let t10;
    let t9;
    ...
    const state = (0, use_select_state_js_1.useSelectState)(t11);
    ...
    if ($[15] !== pastedContents) {
        t13 = () => {
            if (pastedContents && Object.values(pastedContents).some(_temp)) {
                const imageCount = (0, array_js_1.count)(Object.values(pastedContents), _temp2);
    ...
    (0, use_select_input_js_1.useSelectInput)(t14);
    let T0;
    let t15;
    let t16;
    let t17;
    if ($[28] !== hideIndexes || $[29] !== highlightText || $[30] !== imagesSelected || $[31] !== inlineDescriptions || $[32] !== inputValues || $[33] !== isDisabled || $[34] !== layout || $[35] !== onCancel || $[36] !== onChange || $[37] !== onImagePaste || $[38] !== onOpenEditor || $[39] !== onRemoveImage || $[40] !== options.length || $[41] !== pastedContents || $[42] !== selectedImageIndex || $[43] !== state.focusedValue || $[44] !== state.options || $[45] !== state.value || $[46] !== state.visibleFromIndex || $[47] !== state.visibleOptions || $[48] !== state.visibleToIndex) {
        ...
        bb0: {
            ...
            if (layout === "expanded") {
                ...
                t17 = react_1.default.createElement(ink_js_1.Box, { ...styles.container() }, state.visibleOptions.map((option_1, index) => {
                    ...
                    if (option_1.type === "input") {
                        ...
                        return react_1.default.createElement(select_input_option_js_1.SelectInputOption, { key: String(option_1.value), option: option_1, isFocused: isFocused, isSelected: isSelected, shouldShowDownArrow: areMoreOptionsBelow && isLastVisibleOption, shouldShowUpArrow: areMoreOptionsAbove && isFirstVisibleOption, maxIndexWidth: maxIndexWidth, index: i, inputValue: inputValue, onInputChange: value => {
                    ...
                    if (typeof option_1.label === "string" && highlightText && option_1.label.includes(highlightText)) {
                        ...
                        label = react_1.default.createElement(react_1.default.Fragment, null,
                            ...
                            react_1.default.createElement(ink_js_1.Text, { ...styles.highlightedText() }, highlightText),
                    ...
                    return react_1.default.createElement(ink_js_1.Box, { key: String(option_1.value), flexDirection: "column", flexShrink: 0 },
                        react_1.default.createElement(select_option_js_1.SelectOption, { isFocused: isFocused, isSelected: isSelected, shouldShowDownArrow: areMoreOptionsBelow && isLastVisibleOption, shouldShowUpArrow: areMoreOptionsAbove && isFirstVisibleOption },
                            react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled, color: optionColor }, label)),
                        option_1.description && react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
                            react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled || option_1.dimDescription !== false, color: optionColor },
                                react_1.default.createElement(ink_js_1.Ansi, null, option_1.description))),
            ...
            if (layout === "compact-vertical") {
                ...
                t17 = react_1.default.createElement(ink_js_1.Box, { ...styles.container() }, state.visibleOptions.map((option_2, index_1) => {
                    ...
                    if (option_2.type === "input") {
                        ...
                        return react_1.default.createElement(select_input_option_js_1.SelectInputOption, { key: String(option_2.value), option: option_2, isFocused: isFocused_0, isSelected: isSelected_0, shouldShowDownArrow: areMoreOptionsBelow_0 && isLastVisibleOption_0, shouldShowUpArrow: areMoreOptionsAbove_0 && isFirstVisibleOption_0, maxIndexWidth: maxIndexWidth_0, index: i_0, inputValue: inputValue_0, onInputChange: value_1 => {
                    ...
                    if (typeof option_2.label === "string" && highlightText && option_2.label.includes(highlightText)) {
                        ...
                        label_0 = react_1.default.createElement(react_1.default.Fragment, null,
                            labelText_0.slice(0, index_2),
                            react_1.default.createElement(ink_js_1.Text, { ...styles.highlightedText() }, highlightText),
                            labelText_0.slice(index_2 + highlightText.length));
                    }
                    const isOptionDisabled_0 = option_2.disabled === true;
                    return react_1.default.createElement(ink_js_1.Box, { key: String(option_2.value), flexDirection: "column", flexShrink: 0 },
                        react_1.default.createElement(select_option_js_1.SelectOption, { isFocused: isFocused_0, isSelected: isSelected_0, shouldShowDownArrow: areMoreOptionsBelow_0 && isLastVisibleOption_0, shouldShowUpArrow: areMoreOptionsAbove_0 && isFirstVisibleOption_0 },
                            react_1.default.createElement(react_1.default.Fragment, null,
                                !hideIndexes && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, `${i_0}.`.padEnd(maxIndexWidth_0 + 1)),
                                react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled_0, color: isOptionDisabled_0 ? undefined : isSelected_0 ? "success" : isFocused_0 ? "suggestion" : undefined }, label_0))),
                        option_2.description && react_1.default.createElement(ink_js_1.Box, { paddingLeft: hideIndexes ? 4 : maxIndexWidth_0 + 4 },
                            react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled_0 || option_2.dimDescription !== false, color: isOptionDisabled_0 ? undefined : isSelected_0 ? "success" : isFocused_0 ? "suggestion" : undefined },
                                react_1.default.createElement(ink_js_1.Ansi, null, option_2.description))));
                }));
                break bb0;
            }
            let t18;
            ...
            const optionData = state.visibleOptions.map((option_3, index_3) => {
                ...
                if (typeof option_3.label === "string" && highlightText && option_3.label.includes(highlightText)) {
                    ...
                    label_1 = react_1.default.createElement(react_1.default.Fragment, null,
            ...
            if (hasDescriptions) {
                ...
                if ($[61] !== hideIndexes || $[62] !== maxIndexWidth_1) {
                    t19 = data => {
                        ...
                        return 2 + indexWidth + (0, stringWidth_js_1.stringWidth)(labelText_2) + checkmarkWidth;
                    };
                    $[61] = hideIndexes;
                    $[62] = maxIndexWidth_1;
                    $[63] = t19;
                ...
                if ($[64] !== hideIndexes || $[65] !== maxIndexWidth_1 || $[66] !== maxLabelWidth) {
                    t20 = data_0 => {
                        ...
                        const currentLabelWidth = 2 + indexWidth_0 + (0, stringWidth_js_1.stringWidth)(labelText_3) + checkmarkWidth_0;
                        const padding = maxLabelWidth - currentLabelWidth;
                        return react_1.default.createElement(TwoColumnRow, { key: String(data_0.option.value), isFocused: data_0.isFocused },
                            react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", flexShrink: 0 },
                                data_0.isFocused ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : data_0.shouldShowDownArrow ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.arrowDown) : data_0.shouldShowUpArrow ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.arrowUp) : react_1.default.createElement(ink_js_1.Text, null, " "),
                                react_1.default.createElement(ink_js_1.Text, null, " "),
                                react_1.default.createElement(ink_js_1.Text, { dimColor: data_0.isOptionDisabled, color: data_0.isOptionDisabled ? undefined : data_0.isSelected ? "success" : data_0.isFocused ? "suggestion" : undefined },
                                    !hideIndexes && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, `${data_0.index}.`.padEnd(maxIndexWidth_1 + 2)),
                                    data_0.label),
                                data_0.isSelected && react_1.default.createElement(ink_js_1.Text, { color: "success" },
                                    " ",
                                    figures_1.default.tick),
                                padding > 0 && react_1.default.createElement(ink_js_1.Text, null, " ".repeat(padding))),
                            react_1.default.createElement(ink_js_1.Box, { flexGrow: 1, marginLeft: 2 },
                                react_1.default.createElement(ink_js_1.Text, { wrap: "wrap", dimColor: data_0.isOptionDisabled || data_0.option.dimDescription !== false, color: data_0.isOptionDisabled ? undefined : data_0.isSelected ? "success" : data_0.isFocused ? "suggestion" : undefined },
                                    react_1.default.createElement(ink_js_1.Ansi, null, data_0.option.description || " "))));
                    };
                    $[64] = hideIndexes;
                    $[65] = maxIndexWidth_1;
                    $[66] = maxLabelWidth;
                ...
                t17 = react_1.default.createElement(ink_js_1.Box, { ...styles.container() }, optionData.map(t20));
                break bb0;
            }
            T0 = ink_js_1.Box;
            ...
            t16 = state.visibleOptions.map((option_4, index_4) => {
                ...
                if (typeof option_4.label === "string" && highlightText && option_4.label.includes(highlightText)) {
                    ...
                    label_2 = react_1.default.createElement(react_1.default.Fragment, null,
                ...
                return react_1.default.createElement(select_option_js_1.SelectOption, { key: String(option_4.value), isFocused: isFocused_3, isSelected: isSelected_3, shouldShowDownArrow: areMoreOptionsBelow_3 && isLastVisibleOption_3, shouldShowUpArrow: areMoreOptionsAbove_3 && isFirstVisibleOption_3 },
                    react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", flexShrink: 0 },
                        !hideIndexes && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, `${i_3}.`.padEnd(maxIndexWidth_1 + 2)),
                        react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled_2, color: isOptionDisabled_2 ? undefined : isSelected_3 ? "success" : isFocused_3 ? "suggestion" : undefined },
                            label_2,
                            inlineDescriptions && option_4.description && react_1.default.createElement(ink_js_1.Text, { dimColor: isOptionDisabled_2 || option_4.dimDescription !== false },
                                " ",
                                option_4.description))),
                    !inlineDescriptions && option_4.description && react_1.default.createElement(ink_js_1.Box, { flexShrink: 99, marginLeft: 2 },
                        react_1.default.createElement(ink_js_1.Text, { wrap: "wrap-trim", dimColor: isOptionDisabled_2 || option_4.dimDescription !== false, color: isOptionDisabled_2 ? undefined : isSelected_3 ? "success" : isFocused_3 ? "suggestion" : undefined },
                            react_1.default.createElement(ink_js_1.Ansi, null, option_4.description))));
            });
        }
        $[28] = hideIndexes;
        $[29] = highlightText;
    ...
    if ($[68] !== T0 || $[69] !== t15 || $[70] !== t16) {
        t18 = react_1.default.createElement(T0, { ...t15 }, t16);
        $[68] = T0;
        $[69] = t15;
        $[70] = t16;
        $[71] = t18;
...
function TwoColumnRow(t0) {
    ...
    const cursorRef = (0, use_declared_cursor_js_1.useDeclaredCursor)(t1);
    let t2;
    if ($[2] !== children || $[3] !== cursorRef) {
        t2 = react_1.default.createElement(ink_js_1.Box, { ref: cursorRef, flexDirection: "row" }, children);
        $[2] = children;
        $[3] = cursorRef;
        $[4] = t2;
    }
