...
function BypassPermissionsModeDialog(t0) {
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            ...
            react_1.default.createElement(ink_js_1.Text, null, "By proceeding, you accept all responsibility for actions taken while running in Bypass Permissions mode."),
    ...
    let t5;
    if ($[5] !== onChange) {
        t5 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "WARNING: Claude Code running in Bypass Permissions mode", color: "error", onCancel: handleEscape },
            t3,
            react_1.default.createElement(index_js_2.Select, { options: t4, onChange: value_0 => onChange(value_0) }));
        $[5] = onChange;
        $[6] = t5;
    }
    else {
