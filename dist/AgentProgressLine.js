...
function AgentProgressLine(t0) {
    ...
    if ($[7] !== agentType || $[8] !== color || $[9] !== description || $[10] !== descriptionColor || $[11] !== hideType || $[12] !== name) {
        t6 = hideType ? React.createElement(React.Fragment, null,
            React.createElement(ink_js_1.Text, { bold: true }, name ?? description ?? agentType),
            name && description && React.createElement(ink_js_1.Text, { dimColor: true },
                ": ",
                description)) : React.createElement(React.Fragment, null,
            React.createElement(ink_js_1.Text, { bold: true, backgroundColor: color, color: color ? "inverseText" : undefined }, agentType),
            description && React.createElement(React.Fragment, null,
                " (",
                React.createElement(ink_js_1.Text, { backgroundColor: descriptionColor, color: descriptionColor ? "inverseText" : undefined }, description),
                ")"));
        $[7] = agentType;
        $[8] = color;
        $[9] = description;
    ...
    if ($[14] !== isBackgrounded || $[15] !== tokens || $[16] !== toolUseCount) {
        t7 = !isBackgrounded && React.createElement(React.Fragment, null,
            ...
            tokens !== null && React.createElement(React.Fragment, null,
                " \u00B7 ",
                (0, format_js_1.formatNumber)(tokens),
                " tokens"));
        $[14] = isBackgrounded;
        $[15] = tokens;
        $[16] = toolUseCount;
    ...
    if ($[18] !== t5 || $[19] !== t6 || $[20] !== t7) {
        t8 = React.createElement(ink_js_1.Text, { dimColor: t5 },
            t6,
            t7);
        $[18] = t5;
        $[19] = t6;
    ...
    let t9;
    if ($[22] !== t4 || $[23] !== t8) {
        t9 = React.createElement(ink_js_1.Box, { paddingLeft: 3 },
            t4,
            t8);
        $[22] = t4;
        $[23] = t8;
    ...
    if ($[25] !== getStatusText || $[26] !== isBackgrounded || $[27] !== isLast) {
        t10 = !isBackgrounded && React.createElement(ink_js_1.Box, { paddingLeft: 3, flexDirection: "row" },
            React.createElement(ink_js_1.Text, { dimColor: true }, isLast ? "   \u23BF  " : "\u2502  \u23BF  "),
            React.createElement(ink_js_1.Text, { dimColor: true }, getStatusText()));
        $[25] = getStatusText;
        $[26] = isBackgrounded;
        $[27] = isLast;
        $[28] = t10;
