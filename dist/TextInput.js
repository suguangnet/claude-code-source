...
const useClipboardImageHint_js_1 = require("../hooks/useClipboardImageHint.js");
const useSettings_js_1 = require("../hooks/useSettings.js");
const useTextInput_js_1 = require("../hooks/useTextInput.js");
const ink_js_1 = require("../ink.js");
const envUtils_js_1 = require("../utils/envUtils.js");
const BaseTextInput_js_1 = require("./BaseTextInput.js");
...
function TextInput(props) {
    ...
    const accessibilityEnabled = (0, react_1.useMemo)(() => (0, envUtils_js_1.isEnvTruthy)(process.env.CLAUDE_CODE_ACCESSIBILITY), []);
    ...
    const audioLevels = (0, bun_bundle_1.feature)('VOICE_MODE') ?
        // biome-ignore lint/correctness/useHookAtTopLevel: feature() is a compile-time constant
        (0, voice_js_1.useVoiceState)(s_0 => s_0.voiceAudioLevels) : [];
    const smoothedRef = (0, react_1.useRef)(new Array(CURSOR_WAVEFORM_WIDTH).fill(0));
    const needsAnimation = isVoiceRecording && !reducedMotion;
    const [animRef, animTime] = (0, bun_bundle_1.feature)('VOICE_MODE') ?
        // biome-ignore lint/correctness/useHookAtTopLevel: feature() is a compile-time constant
        (0, ink_js_1.useAnimationFrame)(needsAnimation ? 50 : null) : [() => { }, 0];
    ...
    if (!canShowCursor) {
        ...
        const { r, g, b } = isSilent ? {
            ...
            g: 128,
            b: 128
        } : (0, utils_js_1.hueToRgb)(hue);
        invert = () => chalk_1.default.rgb(r, g, b)(BARS[barIndex]);
    }
    else {
        invert = chalk_1.default.inverse;
    }
    const textInputState = (0, useTextInput_js_1.useTextInput)({
        value: props.value,
    ...
    return react_1.default.createElement(ink_js_1.Box, { ref: animRef },
        react_1.default.createElement(BaseTextInput_js_1.BaseTextInput, { inputState: textInputState, terminalFocus: isTerminalFocused, highlights: props.highlights, invert: invert, hidePlaceholderText: isVoiceRecording, ...props }));
}
