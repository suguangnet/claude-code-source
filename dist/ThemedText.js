...
exports.TextHoverColorContext = void 0;
exports.default = ThemedText;
const compiler_runtime_1 = require("react/compiler-runtime");
const react_1 = __importStar(require("react"));
const Text_js_1 = __importDefault(require("../../ink/components/Text.js"));
...
exports.TextHoverColorContext = react_1.default.createContext(undefined);
/**
...
function ThemedText(t0) {
    ...
    const hoverColor = (0, react_1.useContext)(exports.TextHoverColorContext);
    ...
    if ($[0] !== bold || $[1] !== children || $[2] !== inverse || $[3] !== italic || $[4] !== resolvedBackgroundColor || $[5] !== resolvedColor || $[6] !== strikethrough || $[7] !== underline || $[8] !== wrap) {
        t8 = react_1.default.createElement(Text_js_1.default, { color: resolvedColor, backgroundColor: resolvedBackgroundColor, bold: bold, italic: italic, underline: underline, strikethrough: strikethrough, inverse: inverse, wrap: wrap }, children);
        $[0] = bold;
        $[1] = children;
        $[2] = inverse;
        $[3] = italic;
