...
function ChannelDowngradeDialog(t0) {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "How would you like to handle this?");
        $[6] = t4;
    }
    else {
        t4 = $[6];
    ...
    if ($[10] !== handleSelect || $[11] !== t7) {
        t8 = react_1.default.createElement(index_js_1.Select, { options: t7, onChange: handleSelect });
        $[10] = handleSelect;
        $[11] = t7;
        $[12] = t8;
    }
    ...
    if ($[13] !== handleCancel || $[14] !== t3 || $[15] !== t8) {
        t9 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Switch to Stable Channel", onCancel: handleCancel, color: "permission", hideBorder: true, hideInputGuide: true },
            t3,
            t4,
            t8);
        $[13] = handleCancel;
