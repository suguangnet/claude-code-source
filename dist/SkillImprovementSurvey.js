...
const FeedbackSurveyView_js_1 = require("./FeedbackSurvey/FeedbackSurveyView.js");
function SkillImprovementSurvey(t0) {
    ...
    if ($[0] !== handleSelect || $[1] !== inputValue || $[2] !== setInputValue || $[3] !== skillName || $[4] !== updates) {
        t1 = react_1.default.createElement(SkillImprovementSurveyView, { skillName: skillName, updates: updates, onSelect: handleSelect, inputValue: inputValue, setInputValue: setInputValue });
        $[0] = handleSelect;
        $[1] = inputValue;
        $[2] = setInputValue;
        $[3] = skillName;
...
function SkillImprovementSurveyView(t0) {
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Text, { color: "ansi:cyan" },
    ...
    let t6;
    if ($[10] !== t5) {
        t6 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginLeft: 2 }, t5);
        $[10] = t5;
        $[11] = t6;
    }
    else {
    ...
    if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = react_1.default.createElement(ink_js_1.Box, { width: 12 },
            react_1.default.createElement(ink_js_1.Text, null,
                react_1.default.createElement(ink_js_1.Text, { color: "ansi:cyan" }, "1"),
                ": Apply"));
        $[12] = t7;
    }
    else {
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = react_1.default.createElement(ink_js_1.Box, { marginLeft: 2, marginTop: 1 },
            t7,
            react_1.default.createElement(ink_js_1.Box, { width: 14 },
                react_1.default.createElement(ink_js_1.Text, null,
                    react_1.default.createElement(ink_js_1.Text, { color: "ansi:cyan" }, "0"),
                    ": Dismiss")));
        $[13] = t8;
    }
    else {
    ...
    let t9;
    if ($[14] !== t4 || $[15] !== t6) {
        t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            t4,
            t6,
            t8);
        $[14] = t4;
