...
const sentinelApps_1 = require("@ant/computer-use-mcp/sentinelApps");
const types_1 = require("@ant/computer-use-mcp/types");
...
const DENY_ALL_RESPONSE = {
    granted: [],
    denied: [],
    flags: types_1.DEFAULT_GRANT_FLAGS
};
/**
...
function ComputerUseTccPanel(t0) {
    ...
    const onChange = t1;
    const t2 = tccState.accessibility ? `${figures_1.default.tick} granted` : `${figures_1.default.cross} not granted`;
    let t3;
    if ($[8] !== t2) {
    ...
    const t4 = tccState.screenRecording ? `${figures_1.default.tick} granted` : `${figures_1.default.cross} not granted`;
    let t5;
    if ($[10] !== t4) {
        t5 = React.createElement(ink_js_1.Text, null,
            "Screen Recording:",
            " ",
            t4);
        $[10] = t4;
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = React.createElement(ink_js_1.Text, { dimColor: true }, "Grant the missing permissions in System Settings, then select \"Try again\". macOS may require you to restart Claude Code after granting Screen Recording.");
        $[15] = t7;
    }
    else {
        t7 = $[15];
    ...
    if ($[16] !== onChange || $[17] !== onDone || $[18] !== options) {
        t8 = React.createElement(select_js_1.Select, { options: options, onChange: onChange, onCancel: onDone });
        $[16] = onChange;
        $[17] = onDone;
        $[18] = options;
        $[19] = t8;
    ...
    let t9;
    if ($[20] !== t6 || $[21] !== t8) {
        t9 = React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1 },
            t6,
            t7,
            t8);
        $[20] = t6;
    ...
    let t10;
    if ($[23] !== onDone || $[24] !== t9) {
        t10 = React.createElement(Dialog_js_1.Dialog, { title: "Computer Use needs macOS permissions", onCancel: onDone }, t9);
        $[23] = onDone;
        $[24] = t9;
        $[25] = t10;
    }
...
function ComputerUseAppListPanel(t0) {
    const $ = (0, compiler_runtime_1.c)(48);
    const { request, onDone } = t0;
    let t1;
    if ($[0] !== request.apps) {
    ...
    const [checked] = (0, react_1.useState)(t1);
    let t2;
    ...
    if ($[19] !== request.reason) {
        t12 = request.reason ? React.createElement(ink_js_1.Text, { dimColor: true }, request.reason) : null;
        $[19] = request.reason;
        $[20] = t12;
    }
    else {
    ...
    if ($[21] !== checked || $[22] !== request.apps) {
        ...
        if ($[24] !== checked) {
            t14 = a_3 => {
                ...
                if (!resolved) {
                    return React.createElement(ink_js_1.Text, { key: a_3.requestedName, dimColor: true },
                        "  ",
                        figures_1.default.circle,
                        " ",
                        a_3.requestedName,
                        " ",
                        React.createElement(ink_js_1.Text, { dimColor: true }, "(not installed)"));
                }
                if (a_3.alreadyGranted) {
                    return React.createElement(ink_js_1.Text, { key: resolved.bundleId, dimColor: true },
                        "  ",
                        figures_1.default.tick,
                        " ",
                        resolved.displayName,
                        " ",
                        React.createElement(ink_js_1.Text, { dimColor: true }, "(already granted)"));
                }
                const sentinel = (0, sentinelApps_1.getSentinelCategory)(resolved.bundleId);
                const isChecked = checked.has(resolved.bundleId);
                return React.createElement(ink_js_1.Box, { key: resolved.bundleId, flexDirection: "column" },
                    React.createElement(ink_js_1.Text, null,
                        "  ",
                        isChecked ? figures_1.default.circleFilled : figures_1.default.circle,
                        " ",
                        resolved.displayName),
                    sentinel ? React.createElement(ink_js_1.Text, { bold: true },
                        "    ",
    ...
    let t14;
    if ($[26] !== t13) {
        t14 = React.createElement(ink_js_1.Box, { flexDirection: "column" }, t13);
        $[26] = t13;
        $[27] = t14;
    }
    else {
    ...
    if ($[28] !== requestedFlagKeys) {
        t15 = requestedFlagKeys.length > 0 ? React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, { dimColor: true }, "Also requested:"),
    ...
    if ($[30] !== request.willHide) {
        t16 = request.willHide && request.willHide.length > 0 ? React.createElement(ink_js_1.Text, { dimColor: true },
            request.willHide.length,
            " other",
            " ",
            (0, stringUtils_js_1.plural)(request.willHide.length, "app"),
    ...
    if ($[35] !== options || $[36] !== t17 || $[37] !== t18) {
        t19 = React.createElement(select_js_1.Select, { options: options, onChange: t17, onCancel: t18 });
        $[35] = options;
        $[36] = t17;
        $[37] = t18;
        $[38] = t19;
    ...
    if ($[39] !== t12 || $[40] !== t14 || $[41] !== t15 || $[42] !== t16 || $[43] !== t19) {
        t20 = React.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1, paddingY: 1, gap: 1 },
            t12,
            t14,
            t15,
            t16,
    ...
    let t21;
    if ($[45] !== t11 || $[46] !== t20) {
        t21 = React.createElement(Dialog_js_1.Dialog, { title: "Computer Use wants to control these apps", onCancel: t11 }, t20);
        $[45] = t11;
        $[46] = t20;
        $[47] = t21;
    }
...
function _temp4(flag) {
    return React.createElement(ink_js_1.Text, { key: flag, dimColor: true },
        "  ",
        "\u00B7 ",
        flag);
}
