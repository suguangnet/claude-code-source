 ...
 */
exports.getOsRelease = (0, memoize_js_1.default)(async () => {
    try {
...
function detectMise() {
    ...
    if (/[/\\]mise[/\\]installs[/\\]/i.test(execPath)) {
        (0, debug_js_1.logForDebugging)(`Detected mise installation: ${execPath}`);
        return true;
    }
    return false;
}
...
function detectAsdf() {
    ...
    if (/[/\\]\.?asdf[/\\]installs[/\\]/i.test(execPath)) {
        (0, debug_js_1.logForDebugging)(`Detected asdf installation: ${execPath}`);
        return true;
    }
    return false;
}
...
function detectHomebrew() {
    ...
    if (execPath.includes('/Caskroom/')) {
        (0, debug_js_1.logForDebugging)(`Detected Homebrew cask installation: ${execPath}`);
        return true;
    }
    return false;
}
...
function detectWinget() {
    ...
    for (const pattern of wingetPatterns) {
        if (pattern.test(execPath)) {
            (0, debug_js_1.logForDebugging)(`Detected winget installation: ${execPath}`);
            return true;
        }
    }
    return false;
 ...
 */
exports.detectPacman = (0, memoize_js_1.default)(async () => {
    const platform = (0, platform_js_1.getPlatform)();
    if (platform !== 'linux') {
        return false;
    }
    const osRelease = await (0, exports.getOsRelease)();
    if (osRelease && !isDistroFamily(osRelease, ['arch'])) {
        return false;
    }
    const execPath = process.execPath || process.argv[0] || '';
    const result = await (0, execFileNoThrow_js_1.execFileNoThrow)('pacman', ['-Qo', execPath], {
        timeout: 5000,
        useCwd: false,
    });
    if (result.code === 0 && result.stdout) {
        (0, debug_js_1.logForDebugging)(`Detected pacman installation: ${result.stdout.trim()}`);
        return true;
    }
    return false;
});
 ...
 */
exports.detectDeb = (0, memoize_js_1.default)(async () => {
    const platform = (0, platform_js_1.getPlatform)();
    if (platform !== 'linux') {
        return false;
    }
    ...
    const execPath = process.execPath || process.argv[0] || '';
    const result = await (0, execFileNoThrow_js_1.execFileNoThrow)('dpkg', ['-S', execPath], {
        timeout: 5000,
        useCwd: false,
    });
    if (result.code === 0 && result.stdout) {
        (0, debug_js_1.logForDebugging)(`Detected deb installation: ${result.stdout.trim()}`);
        return true;
    }
    return false;
});
 ...
 */
exports.detectRpm = (0, memoize_js_1.default)(async () => {
    const platform = (0, platform_js_1.getPlatform)();
    if (platform !== 'linux') {
        return false;
    }
    ...
    const execPath = process.execPath || process.argv[0] || '';
    const result = await (0, execFileNoThrow_js_1.execFileNoThrow)('rpm', ['-qf', execPath], {
        timeout: 5000,
        useCwd: false,
    });
    if (result.code === 0 && result.stdout) {
        (0, debug_js_1.logForDebugging)(`Detected rpm installation: ${result.stdout.trim()}`);
        return true;
    }
    return false;
});
 ...
 */
exports.detectApk = (0, memoize_js_1.default)(async () => {
    const platform = (0, platform_js_1.getPlatform)();
    if (platform !== 'linux') {
        return false;
    }
    ...
    const execPath = process.execPath || process.argv[0] || '';
    const result = await (0, execFileNoThrow_js_1.execFileNoThrow)('apk', ['info', '--who-owns', execPath], {
        timeout: 5000,
        useCwd: false,
    });
    if (result.code === 0 && result.stdout) {
        (0, debug_js_1.logForDebugging)(`Detected apk installation: ${result.stdout.trim()}`);
        return true;
    }
    return false;
});
 ...
 */
exports.getPackageManager = (0, memoize_js_1.default)(async () => {
    if (detectHomebrew()) {
        return 'homebrew';
    }
    if (detectWinget()) {
    ...
    if (await (0, exports.detectPacman)()) {
        return 'pacman';
    }
    if (await (0, exports.detectApk)()) {
        return 'apk';
    }
    if (await (0, exports.detectDeb)()) {
        return 'deb';
    }
    if (await (0, exports.detectRpm)()) {
        return 'rpm';
    }
    return 'unknown';
});
