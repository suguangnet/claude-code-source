...
function SelectHookMode(t0) {
    ...
    if (hooksForSelectedMatcher.length === 0) {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "No hooks configured for this event."),
                React.createElement(ink_js_1.Text, { dimColor: true }, "To add hooks, edit settings.json directly or ask Claude."));
            $[0] = t1;
        }
        else {
            t1 = $[0];
        ...
        if ($[1] !== hookEventMetadata.description || $[2] !== onCancel || $[3] !== title) {
            t2 = React.createElement(Dialog_js_1.Dialog, { title: title, subtitle: hookEventMetadata.description, onCancel: onCancel, inputGuide: _temp }, t1);
    ...
    if ($[10] !== onCancel || $[11] !== t2 || $[12] !== t3) {
        t4 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(select_js_1.Select, { options: t2, onChange: t3, onCancel: onCancel }));
        $[10] = onCancel;
        $[11] = t2;
        $[12] = t3;
        $[13] = t4;
    ...
    if ($[14] !== hookEventMetadata.description || $[15] !== onCancel || $[16] !== t4 || $[17] !== title) {
        t5 = React.createElement(Dialog_js_1.Dialog, { title: title, subtitle: t1, onCancel: onCancel }, t4);
...
function _temp2(hook, index) {
    return {
        label: `[${hook.config.type}] ${(0, hooksSettings_js_1.getHookDisplayText)(hook.config)}`,
        value: index.toString(),
        description: hook.source === "pluginHook" && hook.pluginName ? `${(0, hooksSettings_js_1.hookSourceHeaderDisplayString)(hook.source)} (${hook.pluginName})` : (0, hooksSettings_js_1.hookSourceHeaderDisplayString)(hook.source)
    };
}
function _temp() {
