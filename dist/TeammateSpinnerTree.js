...
const TeammateSpinnerLine_js_1 = require("./TeammateSpinnerLine.js");
...
function TeammateSpinnerTree(t0) {
    ...
    const showTeammateMessagePreview = (0, AppState_js_1.useAppState)(_temp3);
    let T0;
    let isHideSelected;
    let t1;
    let t2;
    ...
    if ($[0] !== allIdle || $[1] !== isInSelectionMode || $[2] !== leaderIdleText || $[3] !== leaderTokenCount || $[4] !== leaderVerb || $[5] !== selectedIndex || $[6] !== showTeammateMessagePreview || $[7] !== tasks || $[8] !== viewingAgentTaskId) {
        ...
        bb0: {
            ...
            const t7 = isLeaderSelected ? figures_1.default.pointer : " ";
            let t8;
            if ($[16] !== isLeaderHighlighted || $[17] !== t6 || $[18] !== t7) {
                t8 = React.createElement(ink_js_1.Text, { color: t6, bold: isLeaderHighlighted }, t7);
            ...
            if ($[20] !== isLeaderHighlighted || $[21] !== t10 || $[22] !== t9) {
                t11 = React.createElement(ink_js_1.Text, { dimColor: t9, bold: isLeaderHighlighted },
                    t10,
                    " ");
            ...
            if ($[24] !== isLeaderHighlighted || $[25] !== t12) {
                t13 = React.createElement(ink_js_1.Text, { bold: isLeaderHighlighted, color: t12 }, "team-lead");
            ...
            if ($[27] !== isLeaderForegrounded || $[28] !== leaderVerb) {
                t14 = !isLeaderForegrounded && leaderVerb && React.createElement(ink_js_1.Text, { dimColor: true },
                    ": ",
                    leaderVerb,
                    "\u2026");
            ...
            if ($[30] !== isLeaderForegrounded || $[31] !== leaderIdleText || $[32] !== leaderVerb) {
                t15 = !isLeaderForegrounded && !leaderVerb && leaderIdleText && React.createElement(ink_js_1.Text, { dimColor: true },
                    ": ",
                    leaderIdleText);
            ...
            if ($[34] !== isLeaderHighlighted || $[35] !== leaderTokenCount) {
                t16 = leaderTokenCount !== undefined && leaderTokenCount > 0 && React.createElement(ink_js_1.Text, { dimColor: !isLeaderHighlighted },
                    " ",
                    "\u00B7 ",
                    (0, format_js_1.formatNumber)(leaderTokenCount),
                    " tokens");
            ...
            if ($[37] !== isLeaderHighlighted) {
                t17 = isLeaderHighlighted && React.createElement(ink_js_1.Text, { dimColor: true },
                    " \u00B7 ",
            ...
            if ($[39] !== isLeaderForegrounded || $[40] !== isLeaderSelected) {
                t18 = isLeaderSelected && !isLeaderForegrounded && React.createElement(ink_js_1.Text, { dimColor: true }, " \u00B7 enter to view");
            ...
            if ($[42] !== t11 || $[43] !== t13 || $[44] !== t14 || $[45] !== t15 || $[46] !== t16 || $[47] !== t17 || $[48] !== t18 || $[49] !== t8) {
                t3 = React.createElement(ink_js_1.Box, { paddingLeft: 3 },
                    t8,
                    t11,
                    t13,
                    t14,
...
function HideRow(t0) {
    ...
    if ($[0] !== isSelected || $[1] !== t1 || $[2] !== t2) {
        t3 = React.createElement(ink_js_1.Text, { color: t1, bold: isSelected }, t2);
        $[0] = isSelected;
        $[1] = t1;
        $[2] = t2;
        $[3] = t3;
    ...
    if ($[4] !== isSelected || $[5] !== t4 || $[6] !== t5) {
        t6 = React.createElement(ink_js_1.Text, { dimColor: t4, bold: isSelected },
            t5,
            " ");
        $[4] = isSelected;
        $[5] = t4;
    ...
    if ($[8] !== isSelected || $[9] !== t7) {
        t8 = React.createElement(ink_js_1.Text, { dimColor: t7, bold: isSelected }, "hide");
        $[8] = isSelected;
        $[9] = t7;
        $[10] = t8;
    }
    ...
    let t9;
    if ($[11] !== isSelected) {
        t9 = isSelected && React.createElement(ink_js_1.Text, { dimColor: true }, " \u00B7 enter to collapse");
        $[11] = isSelected;
        $[12] = t9;
    }
    else {
    ...
    if ($[13] !== t3 || $[14] !== t6 || $[15] !== t8 || $[16] !== t9) {
        t10 = React.createElement(ink_js_1.Box, { paddingLeft: 3 },
            t3,
            t6,
            t8,
            t9);
