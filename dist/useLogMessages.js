...
function useLogMessages(messages, ignore = false) {
    ...
    const lastRecordedLengthRef = (0, react_1.useRef)(0);
    const lastParentUuidRef = (0, react_1.useRef)(undefined);
    ...
    const firstMessageUuidRef = (0, react_1.useRef)(undefined);
    ...
    const callSeqRef = (0, react_1.useRef)(0);
    (0, react_1.useEffect)(() => {
        if (ignore)
            return;
        ...
        if (isIncremental || wasFirstRender || isSameHeadShrink) {
            ...
            const last = (0, sessionStorage_js_1.cleanMessagesForLogging)(slice, messages).findLast(sessionStorage_js_1.isChainParticipant);
            if (last)
