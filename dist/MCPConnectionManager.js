...
const useManageMCPConnections_js_1 = require("./useManageMCPConnections.js");
const MCPConnectionContext = (0, react_1.createContext)(null);
function useMcpReconnect() {
    const context = (0, react_1.useContext)(MCPConnectionContext);
    if (!context) {
...
function MCPConnectionManager(t0) {
    ...
    const { reconnectMcpServer, toggleMcpServer } = (0, useManageMCPConnections_js_1.useManageMCPConnections)(dynamicMcpConfig, isStrictMcpConfig);
    let t1;
    ...
    if ($[3] !== children || $[4] !== value) {
        t2 = react_1.default.createElement(MCPConnectionContext.Provider, { value: value }, children);
        $[3] = children;
        $[4] = value;
        $[5] = t2;
    }
