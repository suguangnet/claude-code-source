...
const useSettingsChange_js_1 = require("../../hooks/useSettingsChange.js");
const ink_js_1 = require("../../ink.js");
const useKeybinding_js_1 = require("../../keybindings/useKeybinding.js");
const hooksConfigManager_js_1 = require("../../utils/hooks/hooksConfigManager.js");
...
const SelectEventMode_js_1 = require("./SelectEventMode.js");
const SelectHookMode_js_1 = require("./SelectHookMode.js");
const SelectMatcherMode_js_1 = require("./SelectMatcherMode.js");
const ViewHookMode_js_1 = require("./ViewHookMode.js");
function HooksConfigMenu(t0) {
    ...
    const [disabledByPolicy, setDisabledByPolicy] = (0, react_1.useState)(_temp);
    const [restrictedByPolicy, setRestrictedByPolicy] = (0, react_1.useState)(_temp2);
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = source => {
            if (source === "policySettings") {
                const settings_0 = (0, settings_js_1.getSettings_DEPRECATED)();
                const hooksDisabled_0 = settings_0?.disableAllHooks === true;
                setDisabledByPolicy(hooksDisabled_0 && (0, settings_js_1.getSettingsForSource)("policySettings")?.disableAllHooks === true);
                setRestrictedByPolicy((0, settings_js_1.getSettingsForSource)("policySettings")?.allowManagedHooksOnly === true);
            }
        };
        $[1] = t2;
    }
    ...
    const mcp = (0, AppState_js_1.useAppState)(_temp3);
    const appStateStore = (0, AppState_js_1.useAppStateStore)();
    let t3;
    ...
    const settings_1 = (0, settings_js_1.getSettings_DEPRECATED)();
    ...
    if (hooksDisabled_1) {
        ...
        if ($[35] === Symbol.for("react.memo_cache_sentinel")) {
            t21 = React.createElement(ink_js_1.Text, { bold: true }, "disabled");
            $[35] = t21;
        }
        else {
            t21 = $[35];
        ...
        if ($[36] !== totalHooksCount) {
            t23 = React.createElement(ink_js_1.Text, { bold: true }, totalHooksCount);
            $[36] = totalHooksCount;
            $[37] = t23;
        }
        else {
        ...
        if ($[42] !== t22 || $[43] !== t23 || $[44] !== t24 || $[45] !== t25) {
            t26 = React.createElement(ink_js_1.Text, null,
        ...
        if ($[47] === Symbol.for("react.memo_cache_sentinel")) {
            t27 = React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "When hooks are disabled:"));
            t28 = React.createElement(ink_js_1.Text, { dimColor: true }, "\u00B7 No hook commands will execute");
            t29 = React.createElement(ink_js_1.Text, { dimColor: true }, "\u00B7 StatusLine will not be displayed");
            t30 = React.createElement(ink_js_1.Text, { dimColor: true }, "\u00B7 Tool operations will proceed without hook validation");
            $[47] = t27;
            $[48] = t28;
            $[49] = t29;
            $[50] = t30;
        ...
        let t31;
        if ($[51] !== t26) {
            t31 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
                t26,
                t27,
                t28,
                t29,
        ...
        if ($[53] !== disabledByPolicy) {
            t32 = !disabledByPolicy && React.createElement(ink_js_1.Text, { dimColor: true }, "To re-enable hooks, remove \"disableAllHooks\" from settings.json or ask Claude.");
            $[53] = disabledByPolicy;
            $[54] = t32;
        }
        else {
        ...
        let t33;
        if ($[55] !== t31 || $[56] !== t32) {
            t33 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                t31,
                t32);
            $[55] = t31;
            $[56] = t32;
        ...
        if ($[58] !== handleExit || $[59] !== t33) {
            t34 = React.createElement(Dialog_js_1.Dialog, { title: "Hook Configuration - Disabled", onCancel: handleExit, inputGuide: _temp6 }, t33);
            $[58] = handleExit;
            $[59] = t33;
            $[60] = t34;
        }
        ...
        case "select-event":
            {
                ...
                if ($[63] !== handleExit || $[64] !== hookEventMetadata || $[65] !== hooksByEvent || $[66] !== restrictedByPolicy || $[67] !== t21 || $[68] !== totalHooksCount) {
                    t22 = React.createElement(SelectEventMode_js_1.SelectEventMode, { hookEventMetadata: hookEventMetadata, hooksByEvent: hooksByEvent, totalHooksCount: totalHooksCount, restrictedByPolicy: restrictedByPolicy, onSelectEvent: t21, onCancel: handleExit });
                    $[63] = handleExit;
        ...
        case "select-matcher":
            {
                ...
                if ($[73] !== hooksByEventAndMatcher || $[74] !== modeState.event || $[75] !== sortedMatchersForSelectedEvent || $[76] !== t21.description || $[77] !== t22) {
                    t24 = React.createElement(SelectMatcherMode_js_1.SelectMatcherMode, { selectedEvent: modeState.event, matchersForSelectedEvent: sortedMatchersForSelectedEvent, hooksByEventAndMatcher: hooksByEventAndMatcher, eventDescription: t21.description, onSelect: t22, onCancel: t23 });
        ...
        case "select-hook":
            {
                ...
                if ($[84] !== hooksForSelectedMatcher || $[85] !== modeState.event || $[86] !== modeState.matcher || $[87] !== t21 || $[88] !== t22 || $[89] !== t23) {
                    t24 = React.createElement(SelectHookMode_js_1.SelectHookMode, { selectedEvent: modeState.event, selectedMatcher: modeState.matcher, hooksForSelectedMatcher: hooksForSelectedMatcher, hookEventMetadata: t21, onSelect: t22, onCancel: t23 });
        ...
        case "view-hook":
            {
                ...
                if ($[96] !== modeState.hook || $[97] !== t23 || $[98] !== t24) {
                    t25 = React.createElement(ViewHookMode_js_1.ViewHookMode, { selectedHook: t21, eventSupportsMatcher: t23, onCancel: t24 });
                    $[96] = modeState.hook;
                    $[97] = t23;
                    $[98] = t24;
                    $[99] = t25;
...
function _temp6() {
    return React.createElement(ink_js_1.Text, null, "Esc to close");
}
...
function _temp2() {
    return (0, settings_js_1.getSettingsForSource)("policySettings")?.allowManagedHooksOnly === true;
}
function _temp() {
    const settings = (0, settings_js_1.getSettings_DEPRECATED)();
    const hooksDisabled = settings?.disableAllHooks === true;
    return hooksDisabled && (0, settings_js_1.getSettingsForSource)("policySettings")?.disableAllHooks === true;
}
