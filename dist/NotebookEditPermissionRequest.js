...
const NotebookEditToolDiff_js_1 = require("./NotebookEditToolDiff.js");
function NotebookEditPermissionRequest(props) {
    const $ = (0, compiler_runtime_1.c)(52);
    ...
    if ($[22] !== T0 || $[23] !== t0 || $[24] !== t1) {
        t11 = react_1.default.createElement(T0, { bold: t0 }, t1);
        $[22] = T0;
        $[23] = t0;
        $[24] = t1;
        $[25] = t11;
    ...
    if ($[26] !== T1 || $[27] !== t11 || $[28] !== t2 || $[29] !== t3 || $[30] !== t4) {
        t12 = react_1.default.createElement(T1, null,
            t2,
            t3,
            t4,
            t11,
    ...
    if ($[32] !== parsed.cell_id || $[33] !== parsed.cell_type || $[34] !== parsed.edit_mode || $[35] !== parsed.new_source || $[36] !== parsed.notebook_path || $[37] !== props.verbose || $[38] !== t13) {
        t14 = react_1.default.createElement(NotebookEditToolDiff_js_1.NotebookEditToolDiff, { notebook_path: parsed.notebook_path, cell_id: parsed.cell_id, new_source: parsed.new_source, cell_type: parsed.cell_type, edit_mode: parsed.edit_mode, verbose: props.verbose, width: t13 });
        $[32] = parsed.cell_id;
        $[33] = parsed.cell_type;
        $[34] = parsed.edit_mode;
    ...
    if ($[40] !== T2 || $[41] !== language || $[42] !== notebook_path || $[43] !== t10 || $[44] !== t12 || $[45] !== t14 || $[46] !== t5 || $[47] !== t6 || $[48] !== t7 || $[49] !== t8 || $[50] !== t9) {
        t15 = react_1.default.createElement(T2, { toolUseConfirm: t5, toolUseContext: t6, onDone: t7, onReject: t8, workerBadge: t9, title: t10, question: t12, content: t14, path: notebook_path, completionType: "tool_use_single", languageName: language, parseInput: parseInput });
        $[40] = T2;
        $[41] = language;
        $[42] = notebook_path;
        $[43] = t10;
...
function _temp(input) {
    const result = NotebookEditTool_js_1.NotebookEditTool.inputSchema.safeParse(input);
    if (!result.success) {
        (0, log_js_1.logError)(new Error(`Failed to parse notebook edit input: ${result.error.message}`));
        return {
            notebook_path: "",
            new_source: "",
            cell_id: ""
