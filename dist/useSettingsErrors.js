...
const useSettingsChange_js_1 = require("../useSettingsChange.js");
...
function useSettingsErrors() {
    ...
    const [errors_0, setErrors] = (0, react_1.useState)(_temp);
    let t0;
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = () => {
            const { errors: errors_1 } = (0, allErrors_js_1.getSettingsWithAllErrors)();
            setErrors(errors_1);
        };
        $[0] = t0;
    }
