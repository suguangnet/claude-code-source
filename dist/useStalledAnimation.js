...
function useStalledAnimation(time, currentResponseLength, hasActiveTools = false, reducedMotion = false) {
    const lastTokenTime = (0, react_1.useRef)(time);
    const lastResponseLength = (0, react_1.useRef)(currentResponseLength);
    const mountTime = (0, react_1.useRef)(time);
    const stalledIntensityRef = (0, react_1.useRef)(0);
    const lastSmoothTime = (0, react_1.useRef)(time);
