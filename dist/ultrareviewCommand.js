...
const reviewRemote_js_1 = require("./reviewRemote.js");
const UltrareviewOverageDialog_js_1 = require("./UltrareviewOverageDialog.js");
...
async function launchAndDone(args, context, onDone, billingNote, signal) {
    const result = await (0, reviewRemote_js_1.launchRemoteReview)(args, context, billingNote);
...
const call = async (onDone, context, args) => {
    const gate = await (0, reviewRemote_js_1.checkOverageGate)();
    ...
    if (gate.kind === 'needs-confirm') {
        return react_1.default.createElement(UltrareviewOverageDialog_js_1.UltrareviewOverageDialog, { onProceed: async (signal) => {
