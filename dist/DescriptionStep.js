...
function DescriptionStep() {
    ...
    const [whenToUse, setWhenToUse] = (0, react_1.useState)(wizardData.whenToUse || "");
    const [cursorOffset, setCursorOffset] = (0, react_1.useState)(whenToUse.length);
    ...
    if ($[1] !== whenToUse) {
        t1 = async () => {
            const result = await (0, promptEditor_js_1.editPromptInEditor)(whenToUse);
    ...
    if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = react_1.default.createElement(ink_js_1.Text, null, "When should Claude use this agent?");
        $[8] = t5;
    }
    else {
        t5 = $[8];
    ...
    if ($[9] !== cursorOffset || $[10] !== handleSubmit || $[11] !== whenToUse) {
        t6 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            react_1.default.createElement(TextInput_js_1.default, { value: whenToUse, onChange: setWhenToUse, onSubmit: handleSubmit, placeholder: "e.g., use this agent after you're done writing code...", columns: 80, cursorOffset: cursorOffset, onChangeCursorOffset: setCursorOffset, focus: true, showCursor: true }));
        $[9] = cursorOffset;
        $[10] = handleSubmit;
        $[11] = whenToUse;
        $[12] = t6;
    ...
    let t7;
    if ($[13] !== error) {
        t7 = error && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
    ...
    let t8;
    if ($[15] !== t6 || $[16] !== t7) {
        t8 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Description (tell Claude when to use this agent)", footerText: t4 },
