...
exports.VERIFICATION_AGENT = void 0;
...
const prompt_js_1 = require("src/tools/FileWriteTool/prompt.js");
...
You MAY write ephemeral test scripts to a temp directory (/tmp or $TMPDIR) via ${toolName_js_1.BASH_TOOL_NAME} redirection when inline commands aren't sufficient — e.g., a multi-step race harness or a Playwright test. Clean up after yourself.

Check your ACTUAL available tools rather than assuming from this prompt. You may have browser automation (mcp__claude-in-chrome__*, mcp__playwright__*), ${prompt_js_2.WEB_FETCH_TOOL_NAME}, or other MCP tools depending on the session — do not skip capabilities you didn't think to check for.
...
exports.VERIFICATION_AGENT = {
    ...
    disallowedTools: [
        ...
        prompt_js_1.FILE_WRITE_TOOL_NAME,
