...
const ConfigurableShortcutHint_js_1 = require("../../components/ConfigurableShortcutHint.js");
const Byline_js_1 = require("../../components/design-system/Byline.js");
const MCPRemoteServerMenu_js_1 = require("../../components/mcp/MCPRemoteServerMenu.js");
const MCPStdioServerMenu_js_1 = require("../../components/mcp/MCPStdioServerMenu.js");
const MCPToolDetailView_js_1 = require("../../components/mcp/MCPToolDetailView.js");
const MCPToolListView_js_1 = require("../../components/mcp/MCPToolListView.js");
const SearchBox_js_1 = require("../../components/SearchBox.js");
const useSearchInput_js_1 = require("../../hooks/useSearchInput.js");
...
const MCPConnectionManager_js_1 = require("../../services/mcp/MCPConnectionManager.js");
...
const mcpbHandler_js_1 = require("../../utils/plugins/mcpbHandler.js");
...
const PluginErrors_js_1 = require("./PluginErrors.js");
const PluginOptionsDialog_js_1 = require("./PluginOptionsDialog.js");
const PluginOptionsFlow_js_1 = require("./PluginOptionsFlow.js");
const UnifiedInstalledCell_js_1 = require("./UnifiedInstalledCell.js");
const usePagination_js_1 = require("./usePagination.js");
/**
...
async function getBaseFileNames(dirPath) {
    try {
        ...
        (0, debug_js_1.logForDebugging)(`Failed to read plugin components from ${dirPath}: ${errorMsg}`, {
            level: 'error'
        });
...
async function getSkillDirNames(dirPath) {
    try {
        ...
        const errorMsg = (0, errors_js_1.errorMessage)(error);
        (0, debug_js_1.logForDebugging)(`Failed to read skill directories from ${dirPath}: ${errorMsg}`, {
            level: 'error'
        });
        (0, log_js_1.logError)((0, errors_js_1.toError)(error));
        // Return empty array to allow graceful degradation - plugin details can still be shown
...
function PluginComponentsDisplay({ plugin, marketplace }) {
        ...
        async function loadComponents() {
            try {
                ...
                if (marketplace === 'builtin') {
                    const builtinDef = (0, builtinPlugins_js_1.getBuiltinPluginDefinition)(plugin.name);
                    if (builtinDef) {
                ...
                const marketplaceData = await (0, marketplaceManager_js_1.getMarketplace)(marketplace);
    ...
    if (error) {
        return React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            React.createElement(ink_js_1.Text, { bold: true }, "Components:"),
    ...
    return React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
        React.createElement(ink_js_1.Text, { bold: true }, "Installed components:"),
        components.commands ? React.createElement(ink_js_1.Text, { dimColor: true },
            "\u2022 Commands:",
            ' ',
        ...
        components.agents ? React.createElement(ink_js_1.Text, { dimColor: true },
            "\u2022 Agents:",
            ' ',
        ...
        components.skills ? React.createElement(ink_js_1.Text, { dimColor: true },
            "\u2022 Skills:",
            ' ',
        ...
        components.hooks ? React.createElement(ink_js_1.Text, { dimColor: true },
            "\u2022 Hooks:",
            ' ',
        ...
        components.mcpServers ? React.createElement(ink_js_1.Text, { dimColor: true },
            "\u2022 MCP Servers:",
            ' ',
...
function filterManagedDisabledPlugins(plugins) {
    return plugins.filter(plugin => {
        ...
        return !(0, pluginPolicy_js_1.isPluginBlockedByPolicy)(`${plugin.name}@${marketplace}`);
    });
}
function ManagePlugins({ setViewState: setParentViewState, setResult, onManageComplete, onSearchModeChange, targetPlugin, targetMarketplace, action }) {
    // App state for MCP access
    const mcpClients = (0, AppState_js_1.useAppState)(s => s.mcp.clients);
    const mcpTools = (0, AppState_js_1.useAppState)(s_0 => s_0.mcp.tools);
    const pluginErrors = (0, AppState_js_1.useAppState)(s_1 => s_1.plugins.errors);
    const flaggedPlugins = (0, pluginFlagging_js_1.getFlaggedPlugins)();
    // Search state
    const [isSearchMode, setIsSearchModeRaw] = (0, react_1.useState)(false);
    const setIsSearchMode = (0, react_1.useCallback)((active) => {
        setIsSearchModeRaw(active);
        onSearchModeChange?.(active);
    }, [onSearchModeChange]);
    const isTerminalFocused = (0, ink_js_1.useTerminalFocus)();
    const { columns: terminalWidth } = (0, useTerminalSize_js_1.useTerminalSize)();
    // View state
    const [viewState, setViewState] = (0, react_1.useState)('plugin-list');
    const { query: searchQuery, setQuery: setSearchQuery, cursorOffset: searchCursorOffset } = (0, useSearchInput_js_1.useSearchInput)({
        isActive: viewState === 'plugin-list' && isSearchMode,
        onExit: () => {
            setIsSearchMode(false);
        }
    });
    const [selectedPlugin, setSelectedPlugin] = (0, react_1.useState)(null);
    // Data state
    const [marketplaces, setMarketplaces] = (0, react_1.useState)([]);
    const [pluginStates, setPluginStates] = (0, react_1.useState)([]);
    const [loading, setLoading] = (0, react_1.useState)(true);
    const [pendingToggles, setPendingToggles] = (0, react_1.useState)(new Map());
    ...
    const hasAutoNavigated = (0, react_1.useRef)(false);
    ...
    const pendingAutoActionRef = (0, react_1.useRef)(undefined);
    // MCP toggle hook
    const toggleMcpServer = (0, MCPConnectionManager_js_1.useMcpToggleEnabled)();
    ...
    const unifiedItems = (0, react_1.useMemo)(() => {
        ...
        const pluginScopes = (0, pluginStartupCheck_js_1.getPluginEditableScopes)();
        ...
        for (const [pluginId_0, errors_0] of orphanErrorsBySource) {
            ...
            if (pluginId_0 in flaggedPlugins)
                continue;
            const parsed = (0, pluginIdentifier_js_1.parsePluginIdentifier)(pluginId_0);
        ...
        for (const [pluginId_1, entry] of Object.entries(flaggedPlugins)) {
            const parsed_0 = (0, pluginIdentifier_js_1.parsePluginIdentifier)(pluginId_1);
    ...
    const flaggedIds = (0, react_1.useMemo)(() => unifiedItems.filter(item_3 => item_3.type === 'flagged-plugin').map(item_4 => item_4.id), [unifiedItems]);
    (0, react_1.useEffect)(() => {
    ...
    const pagination = (0, usePagination_js_1.usePagination)({
        totalItems: filteredItems.length,
        selectedIndex,
        maxVisible: 8
    });
    // Details view state
    const [detailsMenuIndex, setDetailsMenuIndex] = (0, react_1.useState)(0);
    const [isProcessing, setIsProcessing] = (0, react_1.useState)(false);
    const [processError, setProcessError] = (0, react_1.useState)(null);
    // Configuration state
    const [configNeeded, setConfigNeeded] = (0, react_1.useState)(null);
    const [_isLoadingConfig, setIsLoadingConfig] = (0, react_1.useState)(false);
    const [selectedPluginHasMcpb, setSelectedPluginHasMcpb] = (0, react_1.useState)(false);
    ...
    (0, react_1.useEffect)(() => {
        ...
        async function detectMcpb() {
            ...
            let hasMcpb = false;
            if (mcpServersSpec) {
                hasMcpb = typeof mcpServersSpec === 'string' && (0, mcpbHandler_js_1.isMcpbSource)(mcpServersSpec) || Array.isArray(mcpServersSpec) && mcpServersSpec.some(s_2 => typeof s_2 === 'string' && (0, mcpbHandler_js_1.isMcpbSource)(s_2));
            }
            ...
            if (!hasMcpb) {
                try {
                    ...
                    const marketplace_1 = (0, slowOperations_js_1.jsonParse)(content);
                    ...
                    if (entry_0?.mcpServers) {
                        ...
                        hasMcpb = typeof spec === 'string' && (0, mcpbHandler_js_1.isMcpbSource)(spec) || Array.isArray(spec) && spec.some((s_3) => typeof s_3 === 'string' && (0, mcpbHandler_js_1.isMcpbSource)(s_3));
                    }
                }
                catch (err) {
                    (0, debug_js_1.logForDebugging)(`Failed to read raw marketplace.json: ${err}`);
                }
            }
    ...
    (0, react_1.useEffect)(() => {
        async function loadInstalledPlugins() {
            ...
            try {
                ...
                const mergedSettings = (0, settings_js_1.getSettings_DEPRECATED)(); // Use merged settings to respect all layers
                ...
                for (const [name, plugins] of Object.entries(pluginsByMarketplace)) {
                    const enabledCount = (0, array_js_1.count)(plugins, p => {
                ...
                for (const marketplace of marketplaceInfos) {
                    for (const plugin of marketplace.installedPlugins) {
                        ...
                        const scope = plugin.isBuiltin ? 'builtin' : (0, pluginOperations_js_1.getPluginInstallationFromV2)(pluginId).scope;
                        allStates.push({
                            plugin,
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (targetPlugin && marketplaces.length > 0 && !loading) {
            ...
            const { name: targetName, marketplace: targetMktFromId } = (0, pluginIdentifier_js_1.parsePluginIdentifier)(targetPlugin);
            ...
            for (const marketplace_2 of marketplacesToSearch) {
                ...
                if (plugin) {
                    ...
                    const { scope: scope_4 } = (0, pluginOperations_js_1.getPluginInstallationFromV2)(pluginId_2);
                    const pluginState = {
                        plugin,
    ...
    const handleSingleOperation = async (operation) => {
        ...
        try {
            ...
            switch (operation) {
                case 'enable':
                    {
                        const enableResult = await (0, pluginOperations_js_1.enablePluginOp)(pluginId_3);
                ...
                case 'disable':
                    {
                        const disableResult = await (0, pluginOperations_js_1.disablePluginOp)(pluginId_3);
                ...
                case 'uninstall':
                    {
                        ...
                        const installs = (0, installedPluginsManager_js_1.loadInstalledPluginsV2)().plugins[pluginId_3];
                        const isLastScope = !installs || installs.length <= 1;
                        const dataSize = isLastScope ? await (0, pluginDirectories_js_1.getPluginDataDirSize)(pluginId_3) : null;
                        if (dataSize) {
                            setIsProcessing(false);
                            setViewState({
                        ...
                        const result_0 = await (0, pluginOperations_js_1.uninstallPluginOp)(pluginId_3, pluginScope);
                        if (!result_0.success) {
                ...
                case 'update':
                    {
                        if (isBuiltin)
                            break; // guarded above; narrows pluginScope
                        const result = await (0, pluginOperations_js_1.updatePluginOp)(pluginId_3, pluginScope);
                        if (!result.success) {
            ...
            const settingsAfter = (0, settings_js_1.getSettings_DEPRECATED)();
            ...
            (0, log_js_1.logError)((0, errors_js_1.toError)(error_0));
        }
    };
    ...
    const handleSingleOperationRef = (0, react_1.useRef)(handleSingleOperation);
    ...
    const handleToggle = React.useCallback(() => {
        ...
        if (item_7?.type === 'plugin') {
            ...
            const mergedSettings_0 = (0, settings_js_1.getSettings_DEPRECATED)();
                    ...
                    void (async () => {
                        try {
                            if (currentPending === 'will-disable') {
                                await (0, pluginOperations_js_1.enablePluginOp)(pluginId_4);
                            }
                            else {
                                await (0, pluginOperations_js_1.disablePluginOp)(pluginId_4);
                            }
                            (0, cacheUtils_js_1.clearAllCaches)();
                        }
                        catch (err_0) {
                            (0, log_js_1.logError)(err_0);
                        }
                    })();
                }
                else {
    ...
    const detailsMenuItems = React.useMemo(() => {
        if (viewState !== 'plugin-details' || !selectedPlugin)
            return [];
        const mergedSettings_1 = (0, settings_js_1.getSettings_DEPRECATED)();
                ...
                menuItems.push({
                    ...
                    action: async () => {
                        ...
                        try {
                            ...
                            const result_1 = await (0, mcpbHandler_js_1.loadMcpbFile)(mcpbPath, selectedPlugin.plugin.path, pluginId_6, undefined, undefined, true);
                            ...
                            const errorMsg = (0, errors_js_1.errorMessage)(err_2);
        ...
        if (selectedPlugin.plugin.manifest.homepage) {
            menuItems.push({
                label: 'Open homepage',
                action: () => void (0, browser_js_1.openBrowser)(selectedPlugin.plugin.manifest.homepage)
            });
        }
        if (selectedPlugin.plugin.manifest.repository) {
            menuItems.push({
                ...
                action: () => void (0, browser_js_1.openBrowser)(selectedPlugin.plugin.manifest.repository)
            });
        }
        menuItems.push({
        ...
        'select:accept': () => {
            if (typeof viewState === 'object' && viewState.type === 'failed-plugin-details') {
                void (async () => {
                    ...
                    const result_2 = (0, pluginOperations_js_1.isInstallableScope)(pluginScope_1) ? await (0, pluginOperations_js_1.uninstallPluginOp)(pluginId_7, pluginScope_1, false) : await (0, pluginOperations_js_1.uninstallPluginOp)(pluginId_7, 'user', false);
    ...
    (0, useKeybinding_js_1.useKeybindings)({
        'confirm:yes': () => {
            ...
            // point).
            const { error: error_2 } = (0, settings_js_1.updateSettingsForSource)('localSettings', {
                enabledPlugins: {
                    ...(0, settings_js_1.getSettingsForSource)('localSettings')?.enabledPlugins,
                    [pluginId_8]: false
                }
            });
            if (error_2) {
    ...
    (0, ink_js_1.useInput)((input, key) => {
        ...
        const doUninstall = async (deleteDataDir) => {
            ...
            setProcessError(null);
            try {
                const result_3 = await (0, pluginOperations_js_1.uninstallPluginOp)(pluginId_9, pluginScope_2, deleteDataDir);
                if (!result_3.success)
                    throw new Error(result_3.message);
                (0, cacheUtils_js_1.clearAllCaches)();
                const suffix = deleteDataDir ? '' : ' · data preserved';
                setResult(`${figures_1.default.tick} ${result_3.message}${suffix}`);
                if (onManageComplete)
                    void onManageComplete();
                setParentViewState({
                    type: 'menu'
    ...
    // eslint-disable-next-line custom-rules/prefer-use-keybindings -- useInput needed for raw search mode text input
    (0, ink_js_1.useInput)((input_0, key_0) => {
    ...
    // Loading state
    if (loading) {
        return React.createElement(ink_js_1.Text, null, "Loading installed plugins\u2026");
    }
    // No plugins or MCPs installed
    if (unifiedItems.length === 0) {
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Box, { marginBottom: 1 },
                React.createElement(ink_js_1.Text, { bold: true }, "Manage plugins")),
            React.createElement(ink_js_1.Text, null, "No plugins or MCP servers installed."),
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "Esc to go back")));
    }
    if (typeof viewState === 'object' && viewState.type === 'plugin-options' && selectedPlugin) {
        ...
        return React.createElement(PluginOptionsFlow_js_1.PluginOptionsFlow, { plugin: selectedPlugin.plugin, pluginId: pluginId_10, onDone: (outcome, detail) => {
                switch (outcome) {
                    case 'configured':
    ...
    if (typeof viewState === 'object' && viewState.type === 'configuring-options' && selectedPlugin) {
        ...
        return React.createElement(PluginOptionsDialog_js_1.PluginOptionsDialog, { title: `Configure ${selectedPlugin.plugin.name}`, subtitle: "Plugin options", configSchema: viewState.schema, initialValues: (0, pluginOptionsStorage_js_1.loadPluginOptions)(pluginId_11), onSave: values => {
                try {
                    (0, pluginOptionsStorage_js_1.savePluginOptions)(pluginId_11, values, viewState.schema);
                    (0, cacheUtils_js_1.clearAllCaches)();
                    setResult('Configuration saved. Run /reload-plugins for changes to take effect.');
                }
                catch (err_3) {
                    setProcessError(`Failed to save configuration: ${(0, errors_js_1.errorMessage)(err_3)}`);
                }
                setViewState('plugin-details');
    ...
    if (viewState === 'configuring' && configNeeded && selectedPlugin) {
        ...
        async function handleSave(config) {
            ...
            try {
                ...
                await (0, mcpbHandler_js_1.loadMcpbFile)(mcpbPath_0, selectedPlugin.plugin.path, pluginId_12, undefined, config);
                ...
                const errorMsg_0 = (0, errors_js_1.errorMessage)(err_4);
        ...
        return React.createElement(PluginOptionsDialog_js_1.PluginOptionsDialog, { title: `Configure ${configNeeded.manifest.name}`, subtitle: `Plugin: ${selectedPlugin.plugin.name}`, configSchema: configNeeded.configSchema, initialValues: configNeeded.existingConfig, onSave: handleSave, onCancel: handleCancel });
    }
    ...
    if (typeof viewState === 'object' && viewState.type === 'flagged-detail') {
        ...
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { bold: true },
                    fp.name,
                    " @ ",
                    fp.marketplace)),
            React.createElement(ink_js_1.Box, { marginBottom: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "Status: "),
                React.createElement(ink_js_1.Text, { color: "error" }, "Removed")),
            React.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
                React.createElement(ink_js_1.Text, { color: "error" },
                    "Removed from marketplace \u00B7 reason: ",
                    fp.reason),
                React.createElement(ink_js_1.Text, null, fp.text),
                React.createElement(ink_js_1.Text, { dimColor: true },
                    "Flagged on ",
                    new Date(fp.flaggedAt).toLocaleDateString())),
            React.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
                React.createElement(ink_js_1.Box, null,
                    React.createElement(ink_js_1.Text, null,
                        figures_1.default.pointer,
                        " "),
                    React.createElement(ink_js_1.Text, { color: "suggestion" }, "Dismiss"))),
            React.createElement(Byline_js_1.Byline, null,
                React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "dismiss" }),
                React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" })));
    }
    ...
    if (viewState === 'confirm-project-uninstall' && selectedPlugin) {
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, { bold: true, color: "warning" },
                selectedPlugin.plugin.name,
                " is enabled in .claude/settings.json (shared with your team)"),
            React.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
                React.createElement(ink_js_1.Text, null, "Disable it just for you in .claude/settings.local.json?"),
                React.createElement(ink_js_1.Text, { dimColor: true }, "This has the same effect as uninstalling, without affecting other contributors.")),
            processError && React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { color: "error" }, processError)),
            React.createElement(ink_js_1.Box, { marginTop: 1 }, isProcessing ? React.createElement(ink_js_1.Text, { dimColor: true }, "Disabling\u2026") : React.createElement(Byline_js_1.Byline, null,
                React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:yes", context: "Confirmation", fallback: "y", description: "disable" }),
                React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" }))));
    }
    ...
    if (typeof viewState === 'object' && viewState.type === 'confirm-data-cleanup' && selectedPlugin) {
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, { bold: true },
                ...
                " of persistent data"),
            React.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
                React.createElement(ink_js_1.Text, null, "Delete it along with the plugin?"),
                React.createElement(ink_js_1.Text, { dimColor: true }, (0, pluginDirectories_js_1.pluginDataDirPath)(`${selectedPlugin.plugin.name}@${selectedPlugin.marketplace}`))),
            processError && React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { color: "error" }, processError)),
            React.createElement(ink_js_1.Box, { marginTop: 1 }, isProcessing ? React.createElement(ink_js_1.Text, { dimColor: true }, "Uninstalling\u2026") : React.createElement(ink_js_1.Text, null,
                React.createElement(ink_js_1.Text, { bold: true }, "y"),
                " to delete \u00B7 ",
                React.createElement(ink_js_1.Text, { bold: true }, "n"),
                " to keep \u00B7",
                ' ',
                React.createElement(ink_js_1.Text, { bold: true }, "esc"),
                " to cancel")));
    }
    // Plugin details view
    if (viewState === 'plugin-details' && selectedPlugin) {
        const mergedSettings_2 = (0, settings_js_1.getSettings_DEPRECATED)(); // Use merged settings to respect all layers
        ...
        const pluginErrorsSection = filteredPluginErrors.length === 0 ? null : React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            React.createElement(ink_js_1.Text, { bold: true, color: "error" },
            ...
            filteredPluginErrors.map((error_3, i_0) => {
                const guidance = (0, PluginErrors_js_1.getErrorGuidance)(error_3);
                return React.createElement(ink_js_1.Box, { key: i_0, flexDirection: "column", marginLeft: 2 },
                    React.createElement(ink_js_1.Text, { color: "error" }, (0, PluginErrors_js_1.formatErrorMessage)(error_3)),
                    guidance && React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
        ...
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            ...
            React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, "Scope: "),
                React.createElement(ink_js_1.Text, null, selectedPlugin.scope || 'user')),
            selectedPlugin.plugin.manifest.version && React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, "Version: "),
                React.createElement(ink_js_1.Text, null, selectedPlugin.plugin.manifest.version)),
            selectedPlugin.plugin.manifest.description && React.createElement(ink_js_1.Box, { marginBottom: 1 },
                React.createElement(ink_js_1.Text, null, selectedPlugin.plugin.manifest.description)),
            selectedPlugin.plugin.manifest.author && React.createElement(ink_js_1.Box, null,
                React.createElement(ink_js_1.Text, { dimColor: true }, "Author: "),
                React.createElement(ink_js_1.Text, null, selectedPlugin.plugin.manifest.author.name)),
            React.createElement(ink_js_1.Box, { marginBottom: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "Status: "),
                React.createElement(ink_js_1.Text, { color: isEnabled_2 ? 'success' : 'warning' }, isEnabled_2 ? 'Enabled' : 'Disabled'),
                selectedPlugin.pendingUpdate && React.createElement(ink_js_1.Text, { color: "suggestion" }, " \u00B7 Marked for update")),
            React.createElement(PluginComponentsDisplay, { plugin: selectedPlugin.plugin, marketplace: selectedPlugin.marketplace }),
            pluginErrorsSection,
            React.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" }, detailsMenuItems.map((item_9, index_0) => {
                const isSelected = index_0 === detailsMenuIndex;
                return React.createElement(ink_js_1.Box, { key: index_0 },
                    isSelected && React.createElement(ink_js_1.Text, null,
                        figures_1.default.pointer,
                        " "),
                    !isSelected && React.createElement(ink_js_1.Text, null, '  '),
                    React.createElement(ink_js_1.Text, { bold: isSelected, color: item_9.label.includes('Uninstall') ? 'error' : item_9.label.includes('Update') ? 'suggestion' : undefined }, item_9.label));
            })),
            isProcessing && React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, null, "Processing\u2026")),
            processError && React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { color: "error" }, processError)),
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                    React.createElement(Byline_js_1.Byline, null,
                        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:previous", context: "Select", fallback: "\u2191", description: "navigate" }),
                        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "select" }),
                        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" })))));
    }
    ...
    if (typeof viewState === 'object' && viewState.type === 'failed-plugin-details') {
        ...
        const errorMessage_0 = firstError ? (0, PluginErrors_js_1.formatErrorMessage)(firstError) : 'Failed to load';
        return React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(ink_js_1.Text, null,
                React.createElement(ink_js_1.Text, { bold: true }, failedPlugin_0.name),
                React.createElement(ink_js_1.Text, { dimColor: true },
                    " @ ",
                ...
                React.createElement(ink_js_1.Text, { dimColor: true },
                    ...
                    ")")),
            React.createElement(ink_js_1.Text, { color: "error" }, errorMessage_0),
            failedPlugin_0.scope === 'managed' ? React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true }, "Managed by your organization \u2014 contact your admin")) : React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { color: "suggestion" },
                    figures_1.default.pointer,
                    " "),
                React.createElement(ink_js_1.Text, { bold: true }, "Remove")),
            isProcessing && React.createElement(ink_js_1.Text, null, "Processing\u2026"),
            processError && React.createElement(ink_js_1.Text, { color: "error" }, processError),
            React.createElement(ink_js_1.Box, { marginTop: 1 },
                React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                    React.createElement(Byline_js_1.Byline, null,
                        failedPlugin_0.scope !== 'managed' && React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "remove" }),
                        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" })))));
    }
    // MCP detail view
    if (typeof viewState === 'object' && viewState.type === 'mcp-detail') {
        const client_3 = viewState.client;
        const serverToolsCount = (0, utils_js_1.filterToolsByServer)(mcpTools, client_3.name).length;
        ...
        if (configType === 'stdio') {
            ...
            return React.createElement(MCPStdioServerMenu_js_1.MCPStdioServerMenu, { server: server, serverToolsCount: serverToolsCount, onViewTools: handleMcpViewTools, onCancel: handleMcpCancel, onComplete: handleMcpComplete, borderless: true });
        }
            ...
            return React.createElement(MCPRemoteServerMenu_js_1.MCPRemoteServerMenu, { server: server_0, serverToolsCount: serverToolsCount, onViewTools: handleMcpViewTools, onCancel: handleMcpCancel, onComplete: handleMcpComplete, borderless: true });
        }
            ...
            return React.createElement(MCPRemoteServerMenu_js_1.MCPRemoteServerMenu, { server: server_1, serverToolsCount: serverToolsCount, onViewTools: handleMcpViewTools, onCancel: handleMcpCancel, onComplete: handleMcpComplete, borderless: true });
        }
            ...
            return React.createElement(MCPRemoteServerMenu_js_1.MCPRemoteServerMenu, { server: server_2, serverToolsCount: serverToolsCount, onViewTools: handleMcpViewTools, onCancel: handleMcpCancel, onComplete: handleMcpComplete, borderless: true });
        }
    ...
    if (typeof viewState === 'object' && viewState.type === 'mcp-tools') {
        ...
        return React.createElement(MCPToolListView_js_1.MCPToolListView, { server: server_3, onSelectTool: (tool) => {
                setViewState({
    ...
    if (typeof viewState === 'object' && viewState.type === 'mcp-tool-detail') {
        ...
        return React.createElement(MCPToolDetailView_js_1.MCPToolDetailView, { tool: tool_0, server: server_4, onBack: () => setViewState({
                type: 'mcp-tools',
                client: client_5
            }) });
    }
    ...
    return React.createElement(ink_js_1.Box, { flexDirection: "column" },
        React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(SearchBox_js_1.SearchBox, { query: searchQuery, isFocused: isSearchMode, isTerminalFocused: isTerminalFocused, width: terminalWidth - 4, cursorOffset: searchCursorOffset })),
        filteredItems.length === 0 && searchQuery && React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true },
                "No items match \"",
                searchQuery,
                "\"")),
        pagination.scrollPosition.canScrollUp && React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { dimColor: true },
                " ",
                figures_1.default.arrowUp,
                " more above")),
        visibleItems.map((item_10, visibleIndex) => {
            ...
            return React.createElement(React.Fragment, { key: item_10.id },
                showScopeHeader && React.createElement(ink_js_1.Box, { marginTop: visibleIndex > 0 ? 1 : 0, paddingLeft: 2 },
                    React.createElement(ink_js_1.Text, { dimColor: item_10.scope !== 'flagged', color: item_10.scope === 'flagged' ? 'warning' : undefined, bold: item_10.scope === 'flagged' }, getScopeLabel(item_10.scope))),
                React.createElement(UnifiedInstalledCell_js_1.UnifiedInstalledCell, { item: item_10, isSelected: isSelected_0 }));
        }),
        pagination.scrollPosition.canScrollDown && React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { dimColor: true },
                " ",
                figures_1.default.arrowDown,
                " more below")),
        React.createElement(ink_js_1.Box, { marginTop: 1, marginLeft: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                React.createElement(Byline_js_1.Byline, null,
                    React.createElement(ink_js_1.Text, null, "type to search"),
                    React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "plugin:toggle", context: "Plugin", fallback: "Space", description: "toggle" }),
                    React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:accept", context: "Select", fallback: "Enter", description: "details" }),
                    React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "back" })))),
        pendingToggles.size > 0 && React.createElement(ink_js_1.Box, { marginLeft: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Run /reload-plugins to apply changes")));
}
