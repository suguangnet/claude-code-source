...
const FallbackToolUseRejectedMessage_js_1 = require("../../FallbackToolUseRejectedMessage.js");
function UserToolRejectMessage(t0) {
    ...
    if (!tool || !tool.renderToolUseRejectedMessage) {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = React.createElement(FallbackToolUseRejectedMessage_js_1.FallbackToolUseRejectedMessage, null);
            $[0] = t1;
        }
        else {
            t1 = $[0];
        ...
        bb0: {
            ...
            if (!parsedInput.success) {
                ...
                if ($[12] === Symbol.for("react.memo_cache_sentinel")) {
                    t4 = React.createElement(FallbackToolUseRejectedMessage_js_1.FallbackToolUseRejectedMessage, null);
                    $[12] = t4;
                }
                else {
                    t4 = $[12];
            ...
            t2 = tool.renderToolUseRejectedMessage(parsedInput.data, {
                ...
                theme,
                isTranscriptMode
            }) ?? React.createElement(FallbackToolUseRejectedMessage_js_1.FallbackToolUseRejectedMessage, null);
        }
        $[1] = columns;
        $[2] = input;
        $[3] = isTranscriptMode;
