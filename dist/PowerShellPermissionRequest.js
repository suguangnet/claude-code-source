...
const destructiveCommandWarning_js_1 = require("../../../tools/PowerShellTool/destructiveCommandWarning.js");
const PowerShellTool_js_1 = require("../../../tools/PowerShellTool/PowerShellTool.js");
const readOnlyValidation_js_1 = require("../../../tools/PowerShellTool/readOnlyValidation.js");
const staticPrefix_js_1 = require("../../../utils/powershell/staticPrefix.js");
...
const powershellToolUseOptions_js_1 = require("./powershellToolUseOptions.js");
function PowerShellPermissionRequest(props) {
    const { toolUseConfirm, toolUseContext, onDone, onReject, workerBadge } = props;
    const { command, description } = PowerShellTool_js_1.PowerShellTool.inputSchema.parse(toolUseConfirm.input);
    ...
    const [editablePrefix, setEditablePrefix] = (0, react_1.useState)(command.includes('\n') ? undefined : command);
    ...
    (0, react_1.useEffect)(() => {
        ...
        (0, staticPrefix_js_1.getCompoundCommandPrefixesStatic)(command, element => (0, readOnlyValidation_js_1.isAllowlistedCommand)(element, element.text)).then(prefixes => {
    ...
    const options = (0, react_1.useMemo)(() => (0, powershellToolUseOptions_js_1.powershellToolUseOptions)({
    ...
    return react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { workerBadge: workerBadge, title: "PowerShell command" },
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: explainerState.visible }, PowerShellTool_js_1.PowerShellTool.renderToolUseMessage({
                command,
                description
            }, {
                theme,
        ...
        showPermissionDebug ? react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(PermissionDecisionDebugInfo_js_1.PermissionDecisionDebugInfo, { permissionResult: toolUseConfirm.permissionResult, toolName: "PowerShell" }),
            ...
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                ...
                destructiveWarning && react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
                    react_1.default.createElement(ink_js_1.Text, { color: "warning" }, destructiveWarning)),
                react_1.default.createElement(ink_js_1.Text, null, "Do you want to proceed?"),
                react_1.default.createElement(select_js_1.Select, { options: options, inlineDescriptions: true, onChange: onSelect, onCancel: () => handleReject(), onFocus: handleFocus, onInputModeToggle: handleInputModeToggle })),
