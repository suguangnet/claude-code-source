...
function TaskStatusText(t0) {
    ...
    if ($[0] !== color || $[1] !== displayLabel || $[2] !== suffix) {
        t1 = react_1.default.createElement(ink_js_1.Text, { color: color, dimColor: true },
            "(",
            displayLabel,
            suffix,
            ")");
        ...
        case "completed":
            {
                ...
                if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
                    t1 = react_1.default.createElement(TaskStatusText, { status: "completed", label: "done" });
                    $[0] = t1;
                }
                else {
                    t1 = $[0];
        ...
        case "failed":
            {
                ...
                if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
                    t1 = react_1.default.createElement(TaskStatusText, { status: "failed", label: "error" });
                    $[1] = t1;
                }
                else {
                    t1 = $[1];
        ...
        case "killed":
            {
                ...
                if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
                    t1 = react_1.default.createElement(TaskStatusText, { status: "killed", label: "stopped" });
                    $[2] = t1;
                }
                else {
                    t1 = $[2];
        ...
        case "pending":
            {
                ...
                if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
                    t1 = react_1.default.createElement(TaskStatusText, { status: "running" });
                    $[3] = t1;
                }
                else {
                    t1 = $[3];
