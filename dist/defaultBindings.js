...
const IMAGE_PASTE_KEY = (0, platform_js_1.getPlatform)() === 'windows' ? 'alt+v' : 'ctrl+v';
...
const SUPPORTS_TERMINAL_VT_MODE = (0, platform_js_1.getPlatform)() !== 'windows' ||
...
exports.DEFAULT_BINDINGS = [
    {
        ...
        bindings: {
            ...
            ...((0, bun_bundle_1.feature)('QUICK_SEARCH')
                ? {
