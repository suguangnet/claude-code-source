...
const ink_js_2 = require("src/utils/ink.js");
...
const ShellProgress_js_1 = require("./ShellProgress.js");
const taskStatusUtils_js_1 = require("./taskStatusUtils.js");
function BackgroundTask(t0) {
    const $ = (0, compiler_runtime_1.c)(92);
        ...
        case "local_bash":
            {
                ...
                let t3;
                if ($[3] !== task) {
                    t3 = React.createElement(ShellProgress_js_1.ShellProgress, { shell: task });
                    $[3] = task;
                    $[4] = t3;
                }
                else {
                ...
                let t4;
                if ($[5] !== t2 || $[6] !== t3) {
                    t4 = React.createElement(ink_js_1.Text, null,
                        t2,
                        " ",
                        t3);
                    $[5] = t2;
        ...
        case "remote_agent":
            {
                if (task.isRemoteReview) {
                    ...
                    if ($[8] !== task) {
                        t1 = React.createElement(ink_js_1.Text, null,
                            React.createElement(RemoteSessionProgress_js_1.RemoteSessionProgress, { session: task }));
                        $[8] = task;
                        $[9] = t1;
                    }
                    else {
                ...
                const t1 = running ? figures_js_1.DIAMOND_OPEN : figures_js_1.DIAMOND_FILLED;
                let t2;
                if ($[10] !== t1) {
                ...
                let t5;
                if ($[16] !== task) {
                    t5 = React.createElement(RemoteSessionProgress_js_1.RemoteSessionProgress, { session: task });
                    $[16] = task;
                    $[17] = t5;
                }
                else {
        ...
        case "local_agent":
            {
                ...
                if ($[25] !== t2 || $[26] !== t3 || $[27] !== task.status) {
                    t4 = React.createElement(ShellProgress_js_1.TaskStatusText, { status: task.status, label: t2, suffix: t3 });
                    $[25] = t2;
                    $[26] = t3;
                    $[27] = task.status;
                    $[28] = t4;
        ...
        case "in_process_teammate":
            {
                ...
                if ($[32] !== activityLimit || $[33] !== task) {
                    const activity = (0, taskStatusUtils_js_1.describeTeammateActivity)(task);
                    T1 = ink_js_1.Text;
                    let t5;
                    if ($[40] !== task.identity.color) {
                        t5 = (0, ink_js_2.toInkColor)(task.identity.color);
                    ...
                    if ($[42] !== t5 || $[43] !== task.identity.agentName) {
                        t4 = React.createElement(ink_js_1.Text, { color: t5 },
                            "@",
        ...
        case "local_workflow":
            {
                ...
                if ($[57] !== task.agentCount || $[58] !== task.status) {
                    t3 = task.status === "running" ? `${task.agentCount} ${(0, stringUtils_js_1.plural)(task.agentCount, "agent")}` : task.status === "completed" ? "done" : undefined;
                    $[57] = task.agentCount;
                    $[58] = task.status;
                    $[59] = t3;
                }
                ...
                if ($[60] !== t3 || $[61] !== t4 || $[62] !== task.status) {
                    t5 = React.createElement(ShellProgress_js_1.TaskStatusText, { status: task.status, label: t3, suffix: t4 });
                    $[60] = t3;
                    $[61] = t4;
                    $[62] = task.status;
                    $[63] = t5;
        ...
        case "dream":
            {
                ...
                if ($[77] !== n || $[78] !== task.phase || $[79] !== task.sessionsReviewing) {
                    t1 = task.phase === "updating" && n > 0 ? `${n} ${(0, stringUtils_js_1.plural)(n, "file")}` : `${task.sessionsReviewing} ${(0, stringUtils_js_1.plural)(task.sessionsReviewing, "session")}`;
                    $[77] = n;
                    $[78] = task.phase;
