...
const useVimInput_js_1 = require("../hooks/useVimInput.js");
...
function VimTextInput(props) {
    ...
    const t14 = isTerminalFocused ? chalk_1.default.inverse : _temp;
    let t15;
    if ($[0] !== theme) {
    ...
    const vimInputState = (0, useVimInput_js_1.useVimInput)(t16);
    ...
    if ($[34] !== isTerminalFocused || $[35] !== props || $[36] !== vimInputState) {
        t19 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            react_1.default.createElement(BaseTextInput_js_1.BaseTextInput, { inputState: vimInputState, terminalFocus: isTerminalFocused, highlights: props.highlights, ...props }));
