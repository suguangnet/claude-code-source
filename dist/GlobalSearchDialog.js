...
const highlightMatch_js_1 = require("../utils/highlightMatch.js");
...
const FuzzyPicker_js_1 = require("./design-system/FuzzyPicker.js");
...
function GlobalSearchDialog(t0) {
    const $ = (0, compiler_runtime_1.c)(40);
    ...
    const [matches, setMatches] = (0, react_1.useState)(t1);
    ...
    if ($[3] !== focused) {
        t4 = () => {
            ...
            const absolute = (0, path_1.resolve)((0, cwd_js_1.getCwd)(), focused.file);
            const start = Math.max(0, focused.line - PREVIEW_CONTEXT_LINES - 1);
            (0, readFileInRange_js_1.readFileInRange)(absolute, start, PREVIEW_CONTEXT_LINES * 2 + 1, undefined, controller.signal).then(r => {
    ...
    if ($[7] !== matches.length || $[8] !== onDone) {
        t7 = m_3 => {
            const opened = (0, editor_js_1.openFileInExternalEditor)((0, path_1.resolve)((0, cwd_js_1.getCwd)(), m_3.file), m_3.line);
    ...
    if ($[20] !== maxPathWidth || $[21] !== maxTextWidth || $[22] !== query) {
        t13 = (m_7, isFocused) => React.createElement(ink_js_1.Text, { color: isFocused ? "suggestion" : undefined },
            React.createElement(ink_js_1.Text, { dimColor: true },
                (0, format_js_1.truncatePathMiddle)(m_7.file, maxPathWidth),
                ":",
                m_7.line),
            " ",
            (0, highlightMatch_js_1.highlightMatch)((0, format_js_1.truncateToWidth)(m_7.text.trimStart(), maxTextWidth), query));
        $[20] = maxPathWidth;
        $[21] = maxTextWidth;
        $[22] = query;
        $[23] = t13;
    ...
    if ($[24] !== preview || $[25] !== previewWidth || $[26] !== query) {
        t14 = m_8 => preview?.file === m_8.file && preview.line === m_8.line ? React.createElement(React.Fragment, null,
            React.createElement(ink_js_1.Text, { dimColor: true },
                (0, format_js_1.truncatePathMiddle)(m_8.file, previewWidth),
                ":",
                m_8.line),
            preview.content.split("\n").map((line_0, i) => React.createElement(ink_js_1.Text, { key: i }, (0, highlightMatch_js_1.highlightMatch)((0, format_js_1.truncateToWidth)(line_0, previewWidth), query)))) : React.createElement(LoadingState_js_1.LoadingState, { message: "Loading\u2026", dimColor: true });
        $[24] = preview;
        $[25] = previewWidth;
        $[26] = query;
        $[27] = t14;
    ...
    if ($[28] !== handleOpen || $[29] !== matchLabel || $[30] !== matches || $[31] !== onDone || $[32] !== t10 || $[33] !== t11 || $[34] !== t12 || $[35] !== t13 || $[36] !== t14 || $[37] !== t9 || $[38] !== visibleResults) {
        t15 = React.createElement(FuzzyPicker_js_1.FuzzyPicker, { title: "Global Search", placeholder: "Type to search\u2026", items: matches, getKey: matchKey, visibleCount: visibleResults, direction: "up", previewPosition: t9, onQueryChange: handleQueryChange, onFocus: setFocused, onSelect: handleOpen, onTab: t10, onShiftTab: t11, onCancel: onDone, emptyMessage: t12, matchLabel: matchLabel, selectAction: "open in editor", renderItem: t13, renderPreview: t14 });
        $[28] = handleOpen;
        $[29] = matchLabel;
        $[30] = matches;
        $[31] = onDone;
...
function _temp4(query_0, controller_1, setMatches_0, setTruncated_0, setIsSearching_0) {
    ...
    let collected = 0;
    (0, ripgrep_js_1.ripGrepStream)(["-n", "--no-heading", "-i", "-m", String(MAX_MATCHES_PER_FILE), "-F", "-e", query_0], cwd, controller_1.signal, lines => {
        ...
        for (const line of lines) {
            ...
            const rel = (0, filesystem_js_1.relativePath)(cwd, m_1.file);
            parsed.push({
                ...m_1,
