...
const use_multi_select_state_js_1 = require("./use-multi-select-state.js");
function SelectMulti(t0) {
    ...
    const state = (0, use_multi_select_state_js_1.useMultiSelectState)(t6);
    let T0;
    let T1;
    let t7;
    let t8;
    ...
    if ($[17] !== hideIndexes || $[18] !== isDisabled || $[19] !== onCancel || $[20] !== onImagePaste || $[21] !== onOpenEditor || $[22] !== onRemoveImage || $[23] !== options.length || $[24] !== pastedContents || $[25] !== state) {
        ...
        t8 = state.visibleOptions.map((option, index) => {
            ...
            if (option.type === "input") {
                ...
                return react_1.default.createElement(ink_js_1.Box, { key: String(option.value), gap: 1 },
                    react_1.default.createElement(select_input_option_js_1.SelectInputOption, { option: option, isFocused: isOptionFocused, isSelected: false, shouldShowDownArrow: areMoreOptionsBelow && isLastVisibleOption, shouldShowUpArrow: areMoreOptionsAbove && isFirstVisibleOption, maxIndexWidth: maxIndexWidth, index: i, inputValue: inputValue, onInputChange: value => {
                        ...
                        react_1.default.createElement(ink_js_1.Text, { color: isSelected ? "success" : undefined },
                            "[",
            ...
            return react_1.default.createElement(ink_js_1.Box, { key: String(option.value), gap: 1 },
                react_1.default.createElement(select_option_js_1.SelectOption, { isFocused: isOptionFocused, isSelected: false, shouldShowDownArrow: areMoreOptionsBelow && isLastVisibleOption, shouldShowUpArrow: areMoreOptionsAbove && isFirstVisibleOption, description: option.description },
                    !hideIndexes && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, `${i}.`.padEnd(maxIndexWidth)),
                    react_1.default.createElement(ink_js_1.Text, { color: isSelected ? "success" : undefined },
                        "[",
                        isSelected ? figures_1.default.tick : " ",
                        "]"),
                    react_1.default.createElement(ink_js_1.Text, { color: isOptionFocused ? "suggestion" : undefined }, option.label)));
        });
        $[17] = hideIndexes;
        $[18] = isDisabled;
        $[19] = onCancel;
    ...
    if ($[31] !== T0 || $[32] !== t7 || $[33] !== t8) {
        t10 = react_1.default.createElement(T0, { flexDirection: t7 }, t8);
        $[31] = T0;
        $[32] = t7;
        $[33] = t8;
        $[34] = t10;
    ...
    if ($[35] !== onSubmit || $[36] !== state.isSubmitFocused || $[37] !== submitButtonText) {
        t11 = submitButtonText && onSubmit && react_1.default.createElement(ink_js_1.Box, { marginTop: 0, gap: 1 },
            state.isSubmitFocused ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : react_1.default.createElement(ink_js_1.Text, null, " "),
            react_1.default.createElement(ink_js_1.Box, { marginLeft: 3 },
                react_1.default.createElement(ink_js_1.Text, { color: state.isSubmitFocused ? "suggestion" : undefined, bold: true }, submitButtonText)));
        $[35] = onSubmit;
    ...
    if ($[39] !== T1 || $[40] !== t10 || $[41] !== t11 || $[42] !== t9) {
        t12 = react_1.default.createElement(T1, { flexDirection: t9 },
            t10,
            t11);
        $[39] = T1;
        $[40] = t10;
