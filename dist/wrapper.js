...
const ComputerUseApproval_js_1 = require("../../components/permissions/ComputerUseApproval/ComputerUseApproval.js");
const debug_js_1 = require("../debug.js");
const computerUseLock_js_1 = require("./computerUseLock.js");
const escHotkey_js_1 = require("./escHotkey.js");
const gates_js_1 = require("./gates.js");
const hostAdapter_js_1 = require("./hostAdapter.js");
const toolRendering_js_1 = require("./toolRendering.js");
/**
...
function buildSessionContext() {
    return {
        ...
        getGrantFlags: () => tuc().getAppState().computerUseMcpState?.grantFlags ?? computer_use_mcp_1.DEFAULT_GRANT_FLAGS,
        ...
        checkCuLock: async () => {
            const c = await (0, computerUseLock_js_1.checkComputerUseLock)();
            switch (c.kind) {
                case 'free':
                    return {
                        holder: undefined,
        ...
        acquireCuLock: async () => {
            const r = await (0, computerUseLock_js_1.tryAcquireComputerUseLock)();
            if (r.kind === 'blocked') {
            ...
            if (r.fresh) {
                ...
                const escRegistered = (0, escHotkey_js_1.registerEscHotkey)(() => {
...
function getOrBind() {
    ...
    binding = {
        ctx,
        dispatch: (0, computer_use_mcp_1.bindSessionContext)((0, hostAdapter_js_1.getComputerUseHostAdapter)(), (0, gates_js_1.getChicagoCoordinateMode)(), ctx)
    };
    return binding;
}
function getComputerUseMCPToolOverrides(toolName) {
    const call = async (args, context) => {
        ...
        if (telemetry?.error_kind) {
            (0, debug_js_1.logForDebugging)(`[Computer Use MCP] ${toolName} error_kind=${telemetry.error_kind}`);
        }
    ...
    return {
        ...(0, toolRendering_js_1.getComputerUseMCPRenderingOverrides)(toolName),
        call
    };
}
/**
...
async function runPermissionDialog(req) {
    ...
    if (!setToolJSX) {
        ...
        return {
            granted: [],
            denied: [],
            flags: computer_use_mcp_1.DEFAULT_GRANT_FLAGS
        };
    }
    try {
