...
const useNotifyAfterTimeout_js_1 = require("../../hooks/useNotifyAfterTimeout.js");
...
const elicitationValidation_js_1 = require("../../utils/mcp/elicitationValidation.js");
...
function ResolvingSpinner() {
    ...
    let t3;
    if ($[2] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Text, { color: "warning" }, t2);
        $[2] = t2;
        $[3] = t3;
    }
    else {
...
function ElicitationDialog(t0) {
    ...
    if (event.params.mode === "url") {
        ...
        if ($[0] !== event || $[1] !== onResponse || $[2] !== onWaitingDismiss) {
            t1 = react_1.default.createElement(ElicitationURLDialog, { event: event, onResponse: onResponse, onWaitingDismiss: onWaitingDismiss });
            $[0] = event;
            $[1] = onResponse;
            $[2] = onWaitingDismiss;
            $[3] = t1;
    ...
    if ($[4] !== event || $[5] !== onResponse) {
        t1 = react_1.default.createElement(ElicitationFormDialog, { event: event, onResponse: onResponse });
        $[4] = event;
        $[5] = onResponse;
        $[6] = t1;
    }
...
function ElicitationFormDialog({ event, onResponse }) {
    ...
    const [focusedButton, setFocusedButton] = (0, react_1.useState)(hasFields ? null : 'accept');
    ...
    const [validationErrors, setValidationErrors] = (0, react_1.useState)(() => {
        ...
        for (const [propName_0, propSchema_0] of Object.entries(requestedSchema.properties)) {
            if (isTextField(propSchema_0) && propSchema_0?.default !== undefined) {
                const validation = (0, elicitationValidation_js_1.validateElicitationInput)(String(propSchema_0.default), propSchema_0);
    ...
    const schemaFields = (0, react_1.useMemo)(() => {
    ...
    const [currentFieldIndex, setCurrentFieldIndex] = (0, react_1.useState)(hasFields ? 0 : undefined);
    ...
    const [textInputCursorOffset, setTextInputCursorOffset] = (0, react_1.useState)(textInputValue.length);
    const [resolvingFields, setResolvingFields] = (0, react_1.useState)(() => new Set());
    // Accordion state (shared by multi-select and single-select enum)
    const [expandedAccordion, setExpandedAccordion] = (0, react_1.useState)();
    const [accordionOptionIndex, setAccordionOptionIndex] = (0, react_1.useState)(0);
    const dateDebounceRef = (0, react_1.useRef)(undefined);
    const resolveAbortRef = (0, react_1.useRef)(new Map());
    const enumTypeaheadRef = (0, react_1.useRef)({
        buffer: '',
        timer: undefined
    });
    ...
    const currentFieldIsText = currentField !== undefined && isTextField(currentField.schema) && !(0, elicitationValidation_js_1.isEnumSchema)(currentField.schema);
    ...
    const syncTextInput = (0, react_1.useCallback)((fieldIndex) => {
    ...
    function validateMultiSelect(fieldName, schema_0) {
        ...
        if (min !== undefined && selected.length < min && (selected.length > 0 || fieldRequired)) {
            updateValidationError(fieldName, `Select at least ${min} ${(0, stringUtils_js_1.plural)(min, 'item')}`);
        }
        else if (max !== undefined && selected.length > max) {
            updateValidationError(fieldName, `Select at most ${max} ${(0, stringUtils_js_1.plural)(max, 'item')}`);
        }
        else {
    ...
    function commitTextField(fieldName_3, schema_1, value_0) {
        ...
        const validation_0 = (0, elicitationValidation_js_1.validateElicitationInput)(value_0, schema_1);
    ...
    function resolveFieldAsync(fieldName_4, schema_2, rawValue) {
        ...
        void (0, elicitationValidation_js_1.validateElicitationInputAsync)(rawValue, schema_2, controller_0.signal).then(result => {
    ...
    (0, useKeybinding_js_1.useKeybinding)('confirm:no', () => {
    ...
    (0, ink_js_1.useInput)((_input, key) => {
        ...
        if (expandedAccordion && currentField && (0, elicitationValidation_js_1.isMultiSelectEnumSchema)(currentField.schema)) {
            ...
            const msValues = (0, elicitationValidation_js_1.getMultiSelectValues)(msSchema);
            ...
            if (_input === ' ') {
                ...
                if (optionValue !== undefined) {
                    ...
                    if (min_0 !== undefined && newSelected.length < min_0 && (newSelected.length > 0 || currentField.isRequired)) {
                        updateValidationError(currentField.name, `Select at least ${min_0} ${(0, stringUtils_js_1.plural)(min_0, 'item')}`);
                    }
                    else if (max_0 !== undefined && newSelected.length > max_0) {
                        updateValidationError(currentField.name, `Select at most ${max_0} ${(0, stringUtils_js_1.plural)(max_0, 'item')}`);
                    }
                    else {
            ...
            if (_input) {
                const labels_0 = msValues.map(v_0 => (0, elicitationValidation_js_1.getMultiSelectLabel)(msSchema, v_0).toLowerCase());
        ...
        if (expandedAccordion && currentField && (0, elicitationValidation_js_1.isEnumSchema)(currentField.schema)) {
            ...
            const enumValues = (0, elicitationValidation_js_1.getEnumValues)(enumSchema);
            if (key.leftArrow || key.escape) {
                setExpandedAccordion(undefined);
                return;
            }
            ...
            if (_input) {
                const labels_1 = enumValues.map(v_1 => (0, elicitationValidation_js_1.getEnumLabel)(enumSchema, v_1).toLowerCase());
        ...
        if ((0, elicitationValidation_js_1.isEnumSchema)(schema_5) || (0, elicitationValidation_js_1.isMultiSelectEnumSchema)(schema_5)) {
            ...
            if ((0, elicitationValidation_js_1.isEnumSchema)(schema_5)) {
                const vals = (0, elicitationValidation_js_1.getEnumValues)(schema_5);
                labels_2 = vals.map(v_2 => (0, elicitationValidation_js_1.getEnumLabel)(schema_5, v_2).toLowerCase());
                if (value_1 !== undefined) {
                    startIdx = Math.max(0, vals.indexOf(value_1));
                }
            }
            else {
                const vals_0 = (0, elicitationValidation_js_1.getMultiSelectValues)(schema_5);
                labels_2 = vals_0.map(v_3 => (0, elicitationValidation_js_1.getMultiSelectLabel)(schema_5, v_3).toLowerCase());
            }
            if (key.rightArrow) {
    ...
    const scrollWindow = (0, react_1.useMemo)(() => {
    ...
    function renderFormFields() {
        ...
        return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            hasFieldsAbove && react_1.default.createElement(ink_js_1.Box, { marginLeft: 2 },
            ...
            schemaFields.slice(scrollWindow.start, scrollWindow.end).map((field_0, visibleIdx) => {
                ...
                const checkbox = isResolving ? react_1.default.createElement(ResolvingSpinner, null) : error_0 ? react_1.default.createElement(ink_js_1.Text, { color: "error" }, figures_1.default.warning) : hasValue ? react_1.default.createElement(ink_js_1.Text, { color: "success", dimColor: !isActive }, figures_1.default.tick) : isRequired ? react_1.default.createElement(ink_js_1.Text, { color: "error" }, "*") : react_1.default.createElement(ink_js_1.Text, null, " ");
                ...
                const label = react_1.default.createElement(ink_js_1.Text, { color: activeColor, bold: isActive }, schema_6.title || name_1);
                ...
                if ((0, elicitationValidation_js_1.isMultiSelectEnumSchema)(schema_6)) {
                    const msValues_0 = (0, elicitationValidation_js_1.getMultiSelectValues)(schema_6);
                    const selected_1 = value_3 ?? [];
                    const isExpanded = expandedAccordion === name_1 && isActive;
                    if (isExpanded) {
                        valueContent = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.triangleDownSmall);
                        accordionContent = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginLeft: 6 }, msValues_0.map((optVal, optIdx) => {
                            const optLabel = (0, elicitationValidation_js_1.getMultiSelectLabel)(schema_6, optVal);
                            const isChecked = selected_1.includes(optVal);
                            const isFocused = optIdx === accordionOptionIndex;
                            return react_1.default.createElement(ink_js_1.Box, { key: optVal, gap: 1 },
                                react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, isFocused ? figures_1.default.pointer : ' '),
                                react_1.default.createElement(ink_js_1.Text, { color: isChecked ? 'success' : undefined }, isChecked ? figures_1.default.checkboxOn : figures_1.default.checkboxOff),
                                react_1.default.createElement(ink_js_1.Text, { color: isFocused ? 'suggestion' : undefined, bold: isFocused }, optLabel));
                        }));
                    }
                    else {
                        // Collapsed: ▸ arrow then comma-joined selected items
                        const arrow = isActive ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                            figures_1.default.triangleRightSmall,
                            " ") : null;
                        if (selected_1.length > 0) {
                            const displayLabels = selected_1.map(v_4 => (0, elicitationValidation_js_1.getMultiSelectLabel)(schema_6, v_4));
                            valueContent = react_1.default.createElement(ink_js_1.Text, null,
                                arrow,
                                react_1.default.createElement(ink_js_1.Text, { color: activeColor, bold: isActive }, displayLabels.join(', ')));
                        }
                        else {
                            valueContent = react_1.default.createElement(ink_js_1.Text, null,
                                arrow,
                                react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "not set"));
                        }
                    }
                }
                else if ((0, elicitationValidation_js_1.isEnumSchema)(schema_6)) {
                    const enumValues_0 = (0, elicitationValidation_js_1.getEnumValues)(schema_6);
                    const isExpanded_0 = expandedAccordion === name_1 && isActive;
                    if (isExpanded_0) {
                        valueContent = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.triangleDownSmall);
                        accordionContent = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginLeft: 6 }, enumValues_0.map((optVal_0, optIdx_0) => {
                            const optLabel_0 = (0, elicitationValidation_js_1.getEnumLabel)(schema_6, optVal_0);
                            const isSelected = value_3 === optVal_0;
                            const isFocused_0 = optIdx_0 === accordionOptionIndex;
                            return react_1.default.createElement(ink_js_1.Box, { key: optVal_0, gap: 1 },
                                react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, isFocused_0 ? figures_1.default.pointer : ' '),
                                react_1.default.createElement(ink_js_1.Text, { color: isSelected ? 'success' : undefined }, isSelected ? figures_1.default.radioOn : figures_1.default.radioOff),
                                react_1.default.createElement(ink_js_1.Text, { color: isFocused_0 ? 'suggestion' : undefined, bold: isFocused_0 }, optLabel_0));
                        }));
                    }
                    else {
                        // Collapsed: ▸ arrow then current value
                        const arrow_0 = isActive ? react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                            figures_1.default.triangleRightSmall,
                            " ") : null;
                        if (hasValue) {
                            valueContent = react_1.default.createElement(ink_js_1.Text, null,
                                arrow_0,
                                react_1.default.createElement(ink_js_1.Text, { color: activeColor, bold: isActive }, (0, elicitationValidation_js_1.getEnumLabel)(schema_6, value_3)));
                        }
                        else {
                            valueContent = react_1.default.createElement(ink_js_1.Text, null,
                                arrow_0,
                    ...
                    if (isActive) {
                        valueContent = hasValue ? react_1.default.createElement(ink_js_1.Text, { color: activeColor, bold: true }, value_3 ? figures_1.default.checkboxOn : figures_1.default.checkboxOff) : react_1.default.createElement(ink_js_1.Text, { dimColor: true }, figures_1.default.checkboxOff);
                    }
                    else {
                        valueContent = hasValue ? react_1.default.createElement(ink_js_1.Text, null, value_3 ? figures_1.default.checkboxOn : figures_1.default.checkboxOff) : react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "not set");
                    }
                }
                else if (isTextField(schema_6)) {
                    if (isActive) {
                        valueContent = react_1.default.createElement(TextInput_js_1.default, { value: textInputValue, onChange: handleTextInputChange, onSubmit: handleTextInputSubmit, placeholder: `Type something\u{2026}`, columns: Math.min(columns - 20, 60), cursorOffset: textInputCursorOffset, onChangeCursorOffset: setTextInputCursorOffset, focus: true, showCursor: true });
                    }
                    else {
                        const displayValue = hasValue && (0, elicitationValidation_js_1.isDateTimeSchema)(schema_6) ? formatDateDisplay(String(value_3), schema_6) : String(value_3);
                        valueContent = hasValue ? react_1.default.createElement(ink_js_1.Text, null, displayValue) : react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "not set");
                    }
                }
                else {
                    valueContent = hasValue ? react_1.default.createElement(ink_js_1.Text, null, String(value_3)) : react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "not set");
                }
                return react_1.default.createElement(ink_js_1.Box, { key: name_1, flexDirection: "column" },
                    react_1.default.createElement(ink_js_1.Box, { gap: 1 },
                        react_1.default.createElement(ink_js_1.Text, { color: selectionColor }, isActive ? figures_1.default.pointer : ' '),
                        checkbox,
                        react_1.default.createElement(ink_js_1.Box, null,
                            label,
                            react_1.default.createElement(ink_js_1.Text, { color: activeColor }, ": "),
                            valueContent)),
                    accordionContent,
                    schema_6.description && react_1.default.createElement(ink_js_1.Box, { marginLeft: 6 },
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, schema_6.description)),
                    react_1.default.createElement(ink_js_1.Box, { marginLeft: 6, height: 1 }, error_0 ? react_1.default.createElement(ink_js_1.Text, { color: "error", italic: true }, error_0) : react_1.default.createElement(ink_js_1.Text, null, " ")));
            }),
            hasFieldsBelow && react_1.default.createElement(ink_js_1.Box, { marginLeft: 2 },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true },
    ...
    return react_1.default.createElement(Dialog_js_1.Dialog, { title: `MCP server \u201c${serverName}\u201d requests your input`, subtitle: `\n${message}`, color: "permission", onCancel: () => onResponse('cancel'), isCancelActive: (!currentField || !!focusedButton) && !expandedAccordion, inputGuide: exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
            "Press ",
            exitState.keyName,
            " again to exit") : react_1.default.createElement(Byline_js_1.Byline, null,
            react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" }),
            react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\u2191\u2193", action: "navigate" }),
            currentField && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Backspace", action: "unset" }),
            currentField && currentField.schema.type === 'boolean' && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Space", action: "toggle" }),
            currentField && (0, elicitationValidation_js_1.isEnumSchema)(currentField.schema) && (expandedAccordion ? react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Space", action: "select" }) : react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\u2192", action: "expand" })),
            currentField && (0, elicitationValidation_js_1.isMultiSelectEnumSchema)(currentField.schema) && (expandedAccordion ? react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Space", action: "toggle" }) : react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\u2192", action: "expand" }))) },
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            renderFormFields(),
            react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(ink_js_1.Text, { color: "success" }, focusedButton === 'accept' ? figures_1.default.pointer : ' '),
                react_1.default.createElement(ink_js_1.Text, { bold: focusedButton === 'accept', color: focusedButton === 'accept' ? 'success' : undefined, dimColor: focusedButton !== 'accept' }, ' Accept  '),
                react_1.default.createElement(ink_js_1.Text, { color: "error" }, focusedButton === 'decline' ? figures_1.default.pointer : ' '),
                react_1.default.createElement(ink_js_1.Text, { bold: focusedButton === 'decline', color: focusedButton === 'decline' ? 'error' : undefined, dimColor: focusedButton !== 'decline' }, ' Decline'))));
}
function ElicitationURLDialog({ event, onResponse, onWaitingDismiss }) {
    ...
    const phaseRef = (0, react_1.useRef)('prompt');
    const [focusedButton, setFocusedButton] = (0, react_1.useState)('accept');
    ...
    const onWaitingDismissRef = (0, react_1.useRef)(onWaitingDismiss);
    ...
    if (phase === 'waiting') {
        ...
        return react_1.default.createElement(Dialog_js_1.Dialog, { title: `MCP server \u201c${serverName}\u201d \u2014 waiting for completion`, subtitle: `\n${message}`, color: "permission", onCancel: () => onWaitingDismiss?.('cancel'), isCancelActive: true, inputGuide: exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
                "Press ",
                exitState.keyName,
                " again to exit") : react_1.default.createElement(Byline_js_1.Byline, null,
                react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" }),
                react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "\\u2190\\u2192", action: "switch" })) },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
                    react_1.default.createElement(ink_js_1.Text, null,
                        urlBeforeDomain,
                        react_1.default.createElement(ink_js_1.Text, { bold: true }, domain),
                        urlAfterDomain)),
                react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, "Waiting for the server to confirm completion\u2026")),
                react_1.default.createElement(ink_js_1.Box, null,
                    react_1.default.createElement(ink_js_1.Text, { color: "success" }, focusedButton === 'open' ? figures_1.default.pointer : ' '),
                    react_1.default.createElement(ink_js_1.Text, { bold: focusedButton === 'open', color: focusedButton === 'open' ? 'success' : undefined, dimColor: focusedButton !== 'open' }, ' Reopen URL  '),
                    react_1.default.createElement(ink_js_1.Text, { color: "success" }, focusedButton === 'action' ? figures_1.default.pointer : ' '),
                    react_1.default.createElement(ink_js_1.Text, { bold: focusedButton === 'action', color: focusedButton === 'action' ? 'success' : undefined, dimColor: focusedButton !== 'action' }, ` ${actionLabel}`),
                    showCancel && react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(ink_js_1.Text, null, " "),
                        react_1.default.createElement(ink_js_1.Text, { color: "error" }, focusedButton === 'cancel' ? figures_1.default.pointer : ' '),
                        react_1.default.createElement(ink_js_1.Text, { bold: focusedButton === 'cancel', color: focusedButton === 'cancel' ? 'error' : undefined, dimColor: focusedButton !== 'cancel' }, ' Cancel')))));
    }
    return react_1.default.createElement(Dialog_js_1.Dialog, { title: `MCP server \u201c${serverName}\u201d wants to open a URL`, subtitle: `\n${message}`, color: "permission", onCancel: () => onResponse('cancel'), isCancelActive: true, inputGuide: exitState_0 => exitState_0.pending ? react_1.default.createElement(ink_js_1.Text, null,
            "Press ",
            exitState_0.keyName,
            " again to exit") : react_1.default.createElement(Byline_js_1.Byline, null,
            react_1.default.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "cancel" }),
