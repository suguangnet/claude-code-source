...
function CompactSummary(t0) {
    ...
    if (metadata) {
        ...
        if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = React.createElement(ink_js_1.Box, { minWidth: 2 },
                React.createElement(ink_js_1.Text, { color: "text" }, figures_js_1.BLACK_CIRCLE));
            $[2] = t2;
        }
        else {
            t2 = $[2];
        ...
        if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = React.createElement(ink_js_1.Text, { bold: true }, "Summarized conversation");
            $[3] = t3;
        }
        else {
            t3 = $[3];
        ...
        if ($[4] !== isTranscriptMode || $[5] !== metadata) {
            t4 = !isTranscriptMode && React.createElement(MessageResponse_js_1.MessageResponse, null,
                React.createElement(ink_js_1.Box, { flexDirection: "column" },
                    ...
                    metadata.userContext && React.createElement(ink_js_1.Text, { dimColor: true },
                        "Context: ",
                        "\u201C",
                        metadata.userContext,
                        "\u201D"),
                    React.createElement(ink_js_1.Text, { dimColor: true },
                        React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "app:toggleTranscript", context: "Global", fallback: "ctrl+o", description: "expand history", parens: true }))));
            $[4] = isTranscriptMode;
            $[5] = metadata;
            $[6] = t4;
        }
        ...
        if ($[7] !== isTranscriptMode || $[8] !== textContent) {
            t5 = isTranscriptMode && React.createElement(MessageResponse_js_1.MessageResponse, null,
                React.createElement(ink_js_1.Text, null, textContent));
            $[7] = isTranscriptMode;
            $[8] = textContent;
            $[9] = t5;
        }
    ...
    if ($[14] !== isTranscriptMode) {
        t3 = !isTranscriptMode && React.createElement(ink_js_1.Text, { dimColor: true },
            " ",
            React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "app:toggleTranscript", context: "Global", fallback: "ctrl+o", description: "expand", parens: true }));
        $[14] = isTranscriptMode;
        $[15] = t3;
    }
    else {
    ...
    let t4;
    if ($[16] !== t3) {
        t4 = React.createElement(ink_js_1.Box, { flexDirection: "row" },
            t2,
            React.createElement(ink_js_1.Box, { flexDirection: "column" },
