...
function FallbackPermissionRequest(t0) {
    ...
    if ($[16] !== userFacingName) {
        ...
        if (showAlwaysAllowOptions) {
            const t8 = react_1.default.createElement(ink_js_1.Text, { bold: true }, userFacingName);
            let t9;
            if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
                t9 = react_1.default.createElement(ink_js_1.Text, { bold: true }, originalCwd);
                $[18] = t9;
            }
            else {
                t9 = $[18];
    ...
    if ($[31] !== originalUserFacingName) {
        t12 = originalUserFacingName.endsWith(" (MCP)") ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, " (MCP)") : "";
    ...
    let t15;
    if ($[39] !== t14) {
        t15 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, t14);
        $[39] = t14;
        $[40] = t15;
    }
    else {
    ...
    let t16;
    if ($[41] !== t13 || $[42] !== t15) {
        t16 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            t13,
            t15);
        $[41] = t13;
        $[42] = t15;
    ...
    if ($[44] !== toolUseConfirm.permissionResult) {
        t17 = react_1.default.createElement(PermissionRuleExplanation_js_1.PermissionRuleExplanation, { permissionResult: toolUseConfirm.permissionResult, toolType: "tool" });
    ...
    if ($[46] !== handleCancel || $[47] !== handleSelect || $[48] !== options || $[49] !== toolAnalyticsContext) {
        t18 = react_1.default.createElement(PermissionPrompt_js_1.PermissionPrompt, { options: options, onSelect: handleSelect, onCancel: handleCancel, toolAnalyticsContext: toolAnalyticsContext });
        $[46] = handleCancel;
        $[47] = handleSelect;
        $[48] = options;
    ...
    let t19;
    if ($[51] !== t17 || $[52] !== t18) {
        t19 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t17,
            t18);
        $[51] = t17;
        $[52] = t18;
    ...
    if ($[54] !== t16 || $[55] !== t19 || $[56] !== workerBadge) {
        t20 = react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { title: "Tool use", workerBadge: workerBadge },
            t16,
            t19);
        $[54] = t16;
        $[55] = t19;
