...
function PrBadge(t0) {
    ...
    if ($[2] !== bold || $[3] !== number || $[4] !== statusColor || $[5] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Text, { color: statusColor, dimColor: t2, bold: bold },
            "#",
            number);
        $[2] = bold;
        $[3] = number;
    ...
    let t5;
    if ($[7] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Text, { dimColor: t4 }, "PR");
        $[7] = t4;
        $[8] = t5;
    }
    else {
    ...
    if ($[9] !== bold || $[10] !== number || $[11] !== statusColor || $[12] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Text, { color: statusColor, dimColor: t6, underline: true, bold: bold },
            "#",
            number);
        $[9] = bold;
        $[10] = number;
    ...
    if ($[14] !== label || $[15] !== t7 || $[16] !== url) {
        t8 = react_1.default.createElement(ink_js_1.Link, { url: url, fallback: label }, t7);
        $[14] = label;
        $[15] = t7;
        $[16] = url;
        $[17] = t8;
