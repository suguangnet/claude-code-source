...
function SandboxOverridesTab(t0) {
    ...
    const isLocked = sandbox_adapter_js_1.SandboxManager.areSandboxSettingsLockedByPolicy();
    const currentAllowUnsandboxed = sandbox_adapter_js_1.SandboxManager.areUnsandboxedCommandsAllowed();
    if (!isEnabled) {
        let t1;
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingY: 1 },
                react_1.default.createElement(ink_js_1.Text, { color: "subtle" }, "Sandbox is not enabled. Enable sandbox to configure override settings."));
            $[0] = t1;
        }
        else {
            t1 = $[0];
    ...
    if (isLocked) {
        ...
        if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
            t1 = react_1.default.createElement(ink_js_1.Text, { color: "subtle" }, "Override settings are managed by a higher-priority configuration and cannot be changed locally.");
            $[1] = t1;
        }
        else {
            t1 = $[1];
        ...
        if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingY: 1 },
                t1,
    ...
    let t1;
    if ($[3] !== onComplete) {
        t1 = react_1.default.createElement(OverridesSelect, { onComplete: onComplete, currentMode: currentAllowUnsandboxed ? "open" : "closed" });
        $[3] = onComplete;
        $[4] = t1;
    }
    else {
...
function OverridesSelect(t0) {
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = react_1.default.createElement(ink_js_1.Box, { marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Text, { bold: true }, "Configure Overrides:"));
        $[11] = t8;
    }
    else {
        t8 = $[11];
    ...
    if ($[14] !== focusHeader || $[15] !== handleSelect || $[16] !== headerFocused || $[17] !== options || $[18] !== t9) {
        t10 = react_1.default.createElement(select_js_1.Select, { options: options, onChange: handleSelect, onCancel: t9, onUpFromFirstItem: focusHeader, isDisabled: headerFocused });
        $[14] = focusHeader;
        $[15] = handleSelect;
        $[16] = headerFocused;
        $[17] = options;
    ...
    if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: true }, "Allow unsandboxed fallback:"),
            " ",
    ...
    if ($[21] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: true }, "Strict sandbox mode:"),
            " ",
    ...
    if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1, gap: 1 },
            t11,
            t12,
            react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                "Learn more:",
                " ",
                react_1.default.createElement(ink_js_1.Link, { url: "https://code.claude.com/docs/en/sandboxing#configure-sandboxing" }, "code.claude.com/docs/en/sandboxing#configure-sandboxing")));
        $[22] = t13;
    }
    else {
        t13 = $[22];
    ...
    let t14;
    if ($[23] !== t10) {
        t14 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingY: 1 },
            t8,
            t10,
            t13);
        $[23] = t10;
