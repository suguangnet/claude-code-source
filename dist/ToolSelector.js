...
const agentToolUtils_js_1 = require("src/tools/AgentTool/agentToolUtils.js");
...
const FileReadTool_js_1 = require("src/tools/FileReadTool/FileReadTool.js");
const FileWriteTool_js_1 = require("src/tools/FileWriteTool/FileWriteTool.js");
const GlobTool_js_1 = require("src/tools/GlobTool/GlobTool.js");
const GrepTool_js_1 = require("src/tools/GrepTool/GrepTool.js");
const ListMcpResourcesTool_js_1 = require("src/tools/ListMcpResourcesTool/ListMcpResourcesTool.js");
const NotebookEditTool_js_1 = require("src/tools/NotebookEditTool/NotebookEditTool.js");
const ReadMcpResourceTool_js_1 = require("src/tools/ReadMcpResourceTool/ReadMcpResourceTool.js");
const TaskOutputTool_js_1 = require("src/tools/TaskOutputTool/TaskOutputTool.js");
const TaskStopTool_js_1 = require("src/tools/TaskStopTool/TaskStopTool.js");
const TodoWriteTool_js_1 = require("src/tools/TodoWriteTool/TodoWriteTool.js");
const TungstenTool_js_1 = require("src/tools/TungstenTool/TungstenTool.js");
const WebFetchTool_js_1 = require("src/tools/WebFetchTool/WebFetchTool.js");
const WebSearchTool_js_1 = require("src/tools/WebSearchTool/WebSearchTool.js");
...
function getToolBuckets() {
    return {
        ...
        EXECUTION: {
            ...
            toolNames: new Set([BashTool_js_1.BashTool.name, "external" === 'ant' ? TungstenTool_js_1.TungstenTool.name : undefined].filter(n => n !== undefined))
        },
        MCP: {
            name: 'MCP tools',
            toolNames: new Set(),
...
function getMcpServerBuckets(tools) {
    ...
    tools.forEach(tool => {
        if ((0, utils_js_1.isMcpTool)(tool)) {
            const mcpInfo = (0, mcpStringUtils_js_1.mcpInfoFromString)(tool.name);
...
function ToolSelector(t0) {
    const $ = (0, compiler_runtime_1.c)(69);
    ...
    const [selectedTools, setSelectedTools] = (0, react_1.useState)(expandedInitialTools);
    const [focusIndex, setFocusIndex] = (0, react_1.useState)(0);
    const [showIndividualTools, setShowIndividualTools] = (0, react_1.useState)(false);
    let t3;
    ...
    if ($[22] !== selectedSet) {
        t9 = bucketTools => {
            const selected = (0, array_js_1.count)(bucketTools, t_5 => selectedSet.has(t_5.name));
    ...
    if ($[24] !== createBucketToggleAction || $[25] !== customAgentTools || $[26] !== focusIndex || $[27] !== handleConfirm || $[28] !== isAllSelected || $[29] !== selectedSet || $[30] !== showIndividualTools || $[31] !== toolsByBucket.edit || $[32] !== toolsByBucket.execution || $[33] !== toolsByBucket.mcp || $[34] !== toolsByBucket.other || $[35] !== toolsByBucket.readOnly) {
        ...
        navigableItems.push({
            id: "bucket-all",
            label: `${isAllSelected ? figures_1.default.checkboxOn : figures_1.default.checkboxOff} All tools`,
            action: t10
        });
        ...
        bucketConfigs.forEach(t11 => {
            ...
            const selected_0 = (0, array_js_1.count)(bucketTools_0, t_8 => selectedSet.has(t_8.name));
            const isFullySelected = selected_0 === bucketTools_0.length;
            navigableItems.push({
                id,
                label: `${isFullySelected ? figures_1.default.checkboxOn : figures_1.default.checkboxOff} ${name_1}`,
        ...
        if (showIndividualTools) {
            if (mcpServerBuckets.length > 0) {
                ...
                mcpServerBuckets.forEach(t13 => {
                    ...
                    const selected_1 = (0, array_js_1.count)(serverTools, t_9 => selectedSet.has(t_9.name));
                    const isFullySelected_0 = selected_1 === serverTools.length;
                    navigableItems.push({
                        id: `mcp-server-${serverName}`,
                        label: `${isFullySelected_0 ? figures_1.default.checkboxOn : figures_1.default.checkboxOff} ${serverName} (${serverTools.length} ${(0, stringUtils_js_1.plural)(serverTools.length, "tool")})`,
                        action: () => {
            ...
            customAgentTools.forEach(tool_0 => {
                ...
                if (tool_0.name.startsWith("mcp__")) {
                    const mcpInfo = (0, mcpStringUtils_js_1.mcpInfoFromString)(tool_0.name);
                    displayName = mcpInfo ? `${mcpInfo.toolName} (${mcpInfo.serverName})` : tool_0.name;
                }
                navigableItems.push({
                    id: `tool-${tool_0.name}`,
                    label: `${selectedSet.has(tool_0.name) ? figures_1.default.checkboxOn : figures_1.default.checkboxOff} ${displayName}`,
    ...
    const t15 = focusIndex === 0 ? `${figures_1.default.pointer} ` : "  ";
    let t16;
    if ($[52] !== t13 || $[53] !== t14 || $[54] !== t15) {
        t16 = react_1.default.createElement(ink_js_1.Text, { color: t13, bold: t14 },
            t15,
            "[ Continue ]");
        $[52] = t13;
        $[53] = t14;
    ...
    if ($[56] === Symbol.for("react.memo_cache_sentinel")) {
        t17 = react_1.default.createElement(Divider_js_1.Divider, { width: 40 });
        $[56] = t17;
    }
    else {
        t17 = $[56];
    ...
    if ($[59] !== focusIndex || $[60] !== t18) {
        t19 = t18.map((item_0, index) => {
            ...
            return react_1.default.createElement(react_1.default.Fragment, { key: item_0.id },
                isToggleButton && react_1.default.createElement(Divider_js_1.Divider, { width: 40 }),
                isHeader && index > 0 && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 }),
                react_1.default.createElement(ink_js_1.Text, { color: isHeader ? undefined : isCurrentlyFocused ? "suggestion" : undefined, dimColor: isHeader, bold: isToggleButton && isCurrentlyFocused },
                    isHeader ? "" : isCurrentlyFocused ? `${figures_1.default.pointer} ` : "  ",
    ...
    let t21;
    if ($[62] !== t20) {
        t21 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1, flexDirection: "column" },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, t20));
        $[62] = t20;
        $[63] = t21;
    }
    else {
    ...
    if ($[64] !== handleKeyDown || $[65] !== t16 || $[66] !== t19 || $[67] !== t21) {
        t22 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
            t16,
            t17,
            t19,
            t21);
