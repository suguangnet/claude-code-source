...
function DreamDetailDialog(t0) {
    ...
    const elapsedTime = (0, useElapsedTime_js_1.useElapsedTime)(task.startTime, task.status === "running", 1000, 0);
    let t1;
    if ($[0] !== onDone) {
        t1 = {
            "confirm:yes": onDone
    ...
    if ($[8] !== elapsedTime || $[9] !== handleKeyDown || $[10] !== onBack || $[11] !== onDone || $[12] !== onKill || $[13] !== task.filesTouched.length || $[14] !== task.sessionsReviewing || $[15] !== task.status || $[16] !== task.turns) {
        ...
        if ($[33] !== task.sessionsReviewing) {
            t18 = (0, stringUtils_js_1.plural)(task.sessionsReviewing, "session");
        ...
        if ($[35] !== task.filesTouched.length) {
            t19 = task.filesTouched.length > 0 && react_1.default.createElement(react_1.default.Fragment, null,
                " ",
                "\u00B7 ",
                task.filesTouched.length,
                " ",
                (0, stringUtils_js_1.plural)(task.filesTouched.length, "file"),
                " touched");
        ...
        if ($[42] !== onBack || $[43] !== onKill || $[44] !== task.status) {
            t12 = exitState => exitState.pending ? react_1.default.createElement(ink_js_1.Text, null,
                "Press ",
                exitState.keyName,
                ...
                task.status === "running" && onKill && react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "x", action: "stop" }));
            $[42] = onBack;
            $[43] = onKill;
            $[44] = task.status;
            $[45] = t12;
        ...
        if ($[46] === Symbol.for("react.memo_cache_sentinel")) {
            t20 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Status:");
            $[46] = t20;
        }
        else {
            t20 = $[46];
        ...
        if ($[47] !== task.status) {
            t6 = react_1.default.createElement(ink_js_1.Text, null,
                t20,
                " ",
                task.status === "running" ? react_1.default.createElement(ink_js_1.Text, { color: "background" }, "running") : task.status === "completed" ? react_1.default.createElement(ink_js_1.Text, { color: "success" }, task.status) : react_1.default.createElement(ink_js_1.Text, { color: "error" }, task.status));
            $[47] = task.status;
            $[48] = t6;
        }
        else {
        ...
        t7 = shown.length === 0 ? react_1.default.createElement(ink_js_1.Text, { dimColor: true }, task.status === "running" ? "Starting\u2026" : "(no text output)") : react_1.default.createElement(react_1.default.Fragment, null,
            hidden > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                "(",
                hidden,
                " earlier ",
                (0, stringUtils_js_1.plural)(hidden, "turn"),
                ")"),
            shown.map(_temp2));
        $[8] = elapsedTime;
        $[9] = handleKeyDown;
    ...
    if ($[49] !== T0 || $[50] !== t4 || $[51] !== t5 || $[52] !== t6 || $[53] !== t7) {
        t17 = react_1.default.createElement(T0, { flexDirection: t4, gap: t5 },
            t6,
            t7);
        $[49] = T0;
        $[50] = t4;
    ...
    if ($[55] !== T1 || $[56] !== t10 || $[57] !== t11 || $[58] !== t12 || $[59] !== t17 || $[60] !== t8 || $[61] !== t9) {
        t18 = react_1.default.createElement(T1, { title: t8, subtitle: t9, onCancel: t10, color: t11, inputGuide: t12 }, t17);
        $[55] = T1;
        $[56] = t10;
        $[57] = t11;
        $[58] = t12;
    ...
    if ($[63] !== T2 || $[64] !== t13 || $[65] !== t14 || $[66] !== t15 || $[67] !== t16 || $[68] !== t18) {
        t19 = react_1.default.createElement(T2, { flexDirection: t13, tabIndex: t14, autoFocus: t15, onKeyDown: t16 }, t18);
        $[63] = T2;
        $[64] = t13;
        $[65] = t14;
        $[66] = t15;
...
function _temp2(turn, i) {
    return react_1.default.createElement(ink_js_1.Box, { key: i, flexDirection: "column" },
        react_1.default.createElement(ink_js_1.Text, { wrap: "wrap" }, turn.text),
        turn.toolUseCount > 0 && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            "  ",
            "(",
            turn.toolUseCount,
            " ",
            (0, stringUtils_js_1.plural)(turn.toolUseCount, "tool"),
            ")"));
}
function _temp(t) {
    return t.text !== "";
