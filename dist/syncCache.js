...
const syncCacheState_js_1 = require("./syncCacheState.js");
let cached;
...
function isRemoteManagedSettingsEligible() {
    ...
    if (tokens?.accessToken &&
        tokens.scopes?.includes(oauth_js_1.CLAUDE_AI_INFERENCE_SCOPE) &&
    ...
    try {
        const { key: apiKey } = (0, auth_js_1.getAnthropicApiKeyWithSource)({
