...
function TeamMemCountParts(t0) {
    ...
    if ($[0] !== hasPrecedingParts || $[1] !== isActiveGroup || $[2] !== tmReadCount || $[3] !== tmSearchCount || $[4] !== tmWriteCount) {
        ...
        if (tmReadCount > 0) {
            ...
            if (count > 0) {
                ...
                if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
                    t2 = react_1.default.createElement(ink_js_1.Text, { key: "comma-tmr" }, ", ");
                    $[6] = t2;
                }
                else {
                    t2 = $[6];
            ...
            let t2;
            if ($[7] !== tmReadCount) {
                t2 = react_1.default.createElement(ink_js_1.Text, { bold: true }, tmReadCount);
                $[7] = tmReadCount;
                $[8] = t2;
            }
            else {
            ...
            if ($[9] !== t2 || $[10] !== t3 || $[11] !== verb) {
                t4 = react_1.default.createElement(ink_js_1.Text, { key: "team-mem-read" },
                    verb,
                    " ",
                    t2,
                    " team",
        ...
        if (tmSearchCount > 0) {
            ...
            if (count > 0) {
                ...
                if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
                    t2 = react_1.default.createElement(ink_js_1.Text, { key: "comma-tms" }, ", ");
                    $[13] = t2;
                }
                else {
                    t2 = $[13];
            ...
            let t3;
            if ($[14] !== t2) {
                t3 = react_1.default.createElement(ink_js_1.Text, { key: "team-mem-search" }, t2);
                $[14] = t2;
                $[15] = t3;
            }
            else {
        ...
        if (tmWriteCount > 0) {
            ...
            if (count > 0) {
                ...
                if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
                    t2 = react_1.default.createElement(ink_js_1.Text, { key: "comma-tmw" }, ", ");
                    $[16] = t2;
                }
                else {
                    t2 = $[16];
            ...
            let t2;
            if ($[17] !== tmWriteCount) {
                t2 = react_1.default.createElement(ink_js_1.Text, { bold: true }, tmWriteCount);
                $[17] = tmWriteCount;
                $[18] = t2;
            }
            else {
            ...
            if ($[19] !== t2 || $[20] !== t3 || $[21] !== verb_1) {
                t4 = react_1.default.createElement(ink_js_1.Text, { key: "team-mem-write" },
                    verb_1,
                    " ",
                    t2,
                    " team",
        ...
        t1 = react_1.default.createElement(react_1.default.Fragment, null, nodes);
        $[0] = hasPrecedingParts;
        $[1] = isActiveGroup;
        $[2] = tmReadCount;
        $[3] = tmSearchCount;
