...
function GroupedToolUseContent({ message, tools, lookups, inProgressToolUseIDs, shouldAnimate }) {
    const tool = (0, Tool_js_1.findToolByName)(tools, message.toolName);
    ...
    const toolUsesData = message.messages.map(msg => {
        ...
        return {
            ...
            progressMessages: (0, Tool_js_1.filterToolProgressMessages)(lookups.progressMessagesByToolUseID.get(content.id) ?? []),
            result
        };
    });
