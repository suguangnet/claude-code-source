...
const setWith_js_1 = __importDefault(require("lodash-es/setWith.js"));
const React = __importStar(require("react"));
const ink_js_1 = require("../ink.js");
const treeify_js_1 = require("../utils/treeify.js");
/**
...
function ValidationErrorsList(t0) {
    ...
    if ($[0] !== errors || $[1] !== themeName) {
        ...
        t2 = sortedFiles.map(file_0 => {
            ...
            const treeOutput = (0, treeify_js_1.treeify)(errorTree, {
                showValues: true,
                themeName,
                treeCharColors: {
                    treeChar: "inactive",
            ...
            return React.createElement(ink_js_1.Box, { key: file_0, flexDirection: "column" },
                React.createElement(ink_js_1.Text, null, file_0),
                React.createElement(ink_js_1.Box, { marginLeft: 1 },
                    React.createElement(ink_js_1.Text, { dimColor: true }, treeOutput)),
                suggestionPairs.size > 0 && React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 }, Array.from(suggestionPairs.values()).map(_temp3)));
        });
        $[0] = errors;
        $[1] = themeName;
        $[2] = T0;
...
function _temp3(pair, index) {
    return React.createElement(ink_js_1.Box, { key: `suggestion-pair-${index}`, flexDirection: "column", marginBottom: 1 },
        pair.suggestion && React.createElement(ink_js_1.Text, { dimColor: true, wrap: "wrap" }, pair.suggestion),
        pair.docLink && React.createElement(ink_js_1.Text, { dimColor: true, wrap: "wrap" },
            "Learn more: ",
            pair.docLink));
}
function _temp2(a, b) {
