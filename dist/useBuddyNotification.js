...
function RainbowText(t0) {
    ...
    let t1;
    if ($[0] !== text) {
        t1 = react_1.default.createElement(react_1.default.Fragment, null, [...text].map(_temp));
        $[0] = text;
        $[1] = t1;
    }
    else {
...
function _temp(ch, i) {
    return react_1.default.createElement(ink_js_1.Text, { key: i, color: (0, thinking_js_1.getRainbowColor)(i) }, ch);
}
function useBuddyNotification() {
    ...
    if ($[0] !== addNotification || $[1] !== removeNotification) {
        t0 = () => {
            ...
            addNotification({
                key: "buddy-teaser",
                jsx: react_1.default.createElement(RainbowText, { text: "/buddy" }),
                priority: "immediate",
                timeoutMs: 15000
            });
