...
const COLOR_OPTIONS = ['automatic', ...agentColorManager_js_1.AGENT_COLORS];
function ColorPicker(t0) {
    ...
    const [selectedIndex, setSelectedIndex] = (0, react_1.useState)(Math.max(0, t2));
    let t3;
    ...
    if ($[5] !== selectedIndex) {
        t4 = COLOR_OPTIONS.map((option, index) => {
            ...
            return react_1.default.createElement(ink_js_1.Box, { key: option, flexDirection: "row", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, { color: isSelected ? "suggestion" : undefined }, isSelected ? figures_1.default.pointer : " "),
                option === "automatic" ? react_1.default.createElement(ink_js_1.Text, { bold: isSelected }, "Automatic color") : react_1.default.createElement(ink_js_1.Box, { gap: 1 },
                    react_1.default.createElement(ink_js_1.Text, { backgroundColor: agentColorManager_js_1.AGENT_COLOR_TO_THEME_COLOR[option], color: "inverseText" }, " "),
                    react_1.default.createElement(ink_js_1.Text, { bold: isSelected }, (0, stringUtils_js_1.capitalize)(option))));
        });
        $[5] = selectedIndex;
        $[6] = t4;
    }
    ...
    let t5;
    if ($[7] !== t4) {
        t5 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" }, t4);
        $[7] = t4;
        $[8] = t5;
    }
    else {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = react_1.default.createElement(ink_js_1.Text, null, "Preview: ");
        $[9] = t6;
    }
    else {
        t6 = $[9];
    ...
    if ($[10] !== agentName || $[11] !== selectedValue) {
        t7 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
            t6,
            selectedValue === undefined || selectedValue === "automatic" ? react_1.default.createElement(ink_js_1.Text, { inverse: true, bold: true },
                " ",
                "@",
                agentName,
                " ") : react_1.default.createElement(ink_js_1.Text, { backgroundColor: agentColorManager_js_1.AGENT_COLOR_TO_THEME_COLOR[selectedValue], color: "inverseText", bold: true },
                " ",
                "@",
                agentName,
                " "));
    ...
    if ($[13] !== handleKeyDown || $[14] !== t5 || $[15] !== t7) {
        t8 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
            t5,
            t7);
        $[13] = handleKeyDown;
        $[14] = t5;
