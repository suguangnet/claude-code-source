...
const figures_js_1 = require("src/constants/figures.js");
const PermissionMode_js_1 = require("src/utils/permissions/PermissionMode.js");
const v4_1 = require("zod/v4");
const ink_js_1 = require("../../ink.js");
const Tool_js_1 = require("../../Tool.js");
const lazySchema_js_1 = require("../../utils/lazySchema.js");
const prompt_js_1 = require("./prompt.js");
const questionOptionSchema = (0, lazySchema_js_1.lazySchema)(() => v4_1.z.object({
...
const questionSchema = (0, lazySchema_js_1.lazySchema)(() => v4_1.z.object({
    ...
    header: v4_1.z.string().describe(`Very short label displayed as a chip/tag (max ${prompt_js_1.ASK_USER_QUESTION_TOOL_CHIP_WIDTH} chars). Examples: "Auth method", "Library", "Approach".`),
...
const annotationsSchema = (0, lazySchema_js_1.lazySchema)(() => {
    const annotationSchema = v4_1.z.object({
...
const commonFields = (0, lazySchema_js_1.lazySchema)(() => ({
...
const inputSchema = (0, lazySchema_js_1.lazySchema)(() => v4_1.z.strictObject({
    questions: v4_1.z.array(questionSchema()).min(1).max(4).describe('Questions to ask the user (1-4 questions)'),
    ...commonFields()
...
function AskUserQuestionResultMessage(t0) {
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = React.createElement(ink_js_1.Box, { flexDirection: "row" },
            React.createElement(ink_js_1.Text, { color: (0, PermissionMode_js_1.getModeColor)("default") },
                figures_js_1.BLACK_CIRCLE,
                "\u00A0"),
            React.createElement(ink_js_1.Text, null, "User answered Claude's questions:"));
        $[0] = t1;
    }
    else {
        t1 = $[0];
    ...
    let t2;
    if ($[1] !== answers) {
        t2 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
            t1,
            React.createElement(MessageResponse_js_1.MessageResponse, null,
                React.createElement(ink_js_1.Box, { flexDirection: "column" }, Object.entries(answers).map(_temp))));
        $[1] = answers;
        $[2] = t2;
    }
    else {
...
function _temp(t0) {
    ...
    return React.createElement(ink_js_1.Text, { key: questionText, color: "inactive" },
        "\u00B7 ",
        questionText,
        " \u2192 ",
        answer);
...
exports.AskUserQuestionTool = (0, Tool_js_1.buildTool)({
    ...
    async prompt() {
        const format = (0, state_js_1.getQuestionPreviewFormat)();
        if (format === undefined) {
            // SDK consumer that hasn't opted into a preview format — omit preview
            // guidance (they may not render the field at all).
            return prompt_js_1.ASK_USER_QUESTION_TOOL_PROMPT;
        }
        return prompt_js_1.ASK_USER_QUESTION_TOOL_PROMPT + prompt_js_1.PREVIEW_FEATURE_PROMPT[format];
    },
    get inputSchema() {
        return inputSchema();
    },
    ...
    renderToolUseRejectedMessage() {
        return React.createElement(ink_js_1.Box, { flexDirection: "row", marginTop: 1 },
            React.createElement(ink_js_1.Text, { color: (0, PermissionMode_js_1.getModeColor)('default') },
                figures_js_1.BLACK_CIRCLE,
                "\u00A0"),
            React.createElement(ink_js_1.Text, null, "User declined to answer questions"));
    },
