...
function TaskAssignmentDisplay(t0) {
    ...
    if ($[0] !== assignment.assignedBy || $[1] !== assignment.taskId) {
        t1 = React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, { color: "cyan_FOR_SUBAGENTS_ONLY", bold: true },
                "Task #",
                assignment.taskId,
                " assigned by ",
    ...
    if ($[3] !== assignment.subject) {
        t2 = React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.Text, { bold: true }, assignment.subject));
    ...
    if ($[5] !== assignment.description) {
        t3 = assignment.description && React.createElement(ink_js_1.Box, { marginTop: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true }, assignment.description));
    ...
    if ($[7] !== t1 || $[8] !== t2 || $[9] !== t3) {
        t4 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginY: 1 },
            React.createElement(ink_js_1.Box, { borderStyle: "round", borderColor: "cyan_FOR_SUBAGENTS_ONLY", flexDirection: "column", paddingX: 1, paddingY: 1 },
                t1,
                t2,
                t3));
        $[7] = t1;
...
function tryRenderTaskAssignmentMessage(content) {
    const assignment = (0, teammateMailbox_js_1.isTaskAssignment)(content);
    if (assignment) {
