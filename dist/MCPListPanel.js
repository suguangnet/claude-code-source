...
const McpParsingWarnings_js_1 = require("./McpParsingWarnings.js");
...
function MCPListPanel(t0) {
    const $ = (0, compiler_runtime_1.c)(78);
    ...
    if ($[37] !== getServerIndex || $[38] !== selectedIndex || $[39] !== theme) {
        t17 = server_3 => {
            ...
            return react_1.default.createElement(ink_js_1.Box, { key: `${server_3.name}-${index}` },
                react_1.default.createElement(ink_js_1.Text, { color: isSelected ? "suggestion" : undefined }, isSelected ? `${figures_1.default.pointer} ` : "  "),
                react_1.default.createElement(ink_js_1.Text, { color: isSelected ? "suggestion" : undefined }, server_3.name),
                react_1.default.createElement(ink_js_1.Text, { dimColor: !isSelected },
                    " \u00B7 ",
                    statusIcon,
                    " "),
                react_1.default.createElement(ink_js_1.Text, { dimColor: !isSelected }, statusText));
        };
        $[37] = getServerIndex;
        $[38] = selectedIndex;
        $[39] = theme;
    ...
    if ($[41] !== getAgentServerIndex || $[42] !== selectedIndex || $[43] !== theme) {
        t18 = agentServer_1 => {
            ...
            const statusIcon_0 = agentServer_1.needsAuth ? (0, ink_js_1.color)("warning", theme)(figures_1.default.triangleUpOutline) : (0, ink_js_1.color)("inactive", theme)(figures_1.default.radioOff);
            const statusText_0 = agentServer_1.needsAuth ? "may need auth" : "agent-only";
            return react_1.default.createElement(ink_js_1.Box, { key: `agent-${agentServer_1.name}-${index_0}` },
                react_1.default.createElement(ink_js_1.Text, { color: isSelected_0 ? "suggestion" : undefined }, isSelected_0 ? `${figures_1.default.pointer} ` : "  "),
                react_1.default.createElement(ink_js_1.Text, { color: isSelected_0 ? "suggestion" : undefined }, agentServer_1.name),
                react_1.default.createElement(ink_js_1.Text, { dimColor: !isSelected_0 },
                    " \u00B7 ",
                    statusIcon_0,
                    " "),
                react_1.default.createElement(ink_js_1.Text, { dimColor: !isSelected_0 }, statusText_0));
        };
    ...
    if ($[45] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = react_1.default.createElement(McpParsingWarnings_js_1.McpParsingWarnings, null);
        $[45] = t19;
    }
    else {
        t19 = $[45];
    ...
    if ($[48] !== renderServerItem || $[49] !== serversByScope) {
        t22 = SCOPE_ORDER.map(scope_0 => {
            ...
            return react_1.default.createElement(ink_js_1.Box, { key: scope_0, flexDirection: "column", marginBottom: 1 },
                react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, heading.label),
                    heading.path && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                        " (",
                        heading.path,
                        ")")),
    ...
    if ($[51] !== claudeAiServers || $[52] !== renderServerItem) {
        t23 = claudeAiServers.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
                react_1.default.createElement(ink_js_1.Text, { bold: true }, "claude.ai")),
    ...
    if ($[54] !== agentServers || $[55] !== renderAgentServerItem) {
        t24 = agentServers.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
                react_1.default.createElement(ink_js_1.Text, { bold: true }, "Agent MCPs")),
            [...new Set(agentServers.flatMap(_temp6))].map(agentName => react_1.default.createElement(ink_js_1.Box, { key: agentName, flexDirection: "column", marginTop: 1 },
                react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
    ...
    if ($[57] !== dynamicServers || $[58] !== renderServerItem) {
        t25 = dynamicServers.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            react_1.default.createElement(ink_js_1.Box, { paddingLeft: 2 },
                react_1.default.createElement(ink_js_1.Text, { bold: true }, dynamicHeading.label),
                dynamicHeading.path && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    " (",
                    dynamicHeading.path,
                    ")")),
    ...
    if ($[60] !== hasFailedClients) {
        t26 = hasFailedClients && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, debugMode ? "\u203B Error logs shown inline with --debug" : "\u203B Run claude --debug to see error logs");
        $[60] = hasFailedClients;
        $[61] = t26;
    }
    else {
    ...
    if ($[62] === Symbol.for("react.memo_cache_sentinel")) {
        t27 = react_1.default.createElement(ink_js_1.Text, { dimColor: true },
            react_1.default.createElement(ink_js_1.Link, { url: "https://code.claude.com/docs/en/mcp" }, "https://code.claude.com/docs/en/mcp"),
            " ",
            "for help");
        $[62] = t27;
    }
    ...
    let t28;
    if ($[63] !== t26) {
        t28 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t26,
            t27);
        $[63] = t26;
        $[64] = t28;
    ...
    if ($[65] !== t22 || $[66] !== t23 || $[67] !== t24 || $[68] !== t25 || $[69] !== t28) {
        t29 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t22,
            t23,
            t24,
            t25,
    ...
    if ($[71] !== handleCancel || $[72] !== t21 || $[73] !== t29) {
        t30 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Manage MCP servers", subtitle: t21, onCancel: handleCancel, hideInputGuide: true }, t29);
        $[71] = handleCancel;
        $[72] = t21;
        $[73] = t29;
        $[74] = t30;
    ...
    if ($[75] === Symbol.for("react.memo_cache_sentinel")) {
        t31 = react_1.default.createElement(ink_js_1.Box, { paddingX: 1 },
    ...
    let t32;
    if ($[76] !== t30) {
        t32 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t19,
            t30,
            t31);
        $[76] = t30;
