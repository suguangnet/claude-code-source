...
function QuickOpenDialog(t0) {
    ...
    const [results, setResults] = (0, react_1.useState)(t1);
    const [query, setQuery] = (0, react_1.useState)("");
    const [focusedPath, setFocusedPath] = (0, react_1.useState)(undefined);
    const [preview, setPreview] = (0, react_1.useState)(null);
    const queryGenRef = (0, react_1.useRef)(0);
    let t2;
    let t3;
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = q => {
            ...
            (0, fileSuggestions_js_1.generateFileSuggestions)(q, true).then(items => {
    ...
    if ($[4] !== effectivePreviewLines || $[5] !== focusedPath) {
        t5 = () => {
            ...
            const absolute = path.resolve((0, cwd_js_1.getCwd)(), focusedPath);
            (0, readFileInRange_js_1.readFileInRange)(absolute, 0, effectivePreviewLines, undefined, controller.signal).then(r => {
    ...
    if ($[8] !== onDone || $[9] !== results.length) {
        t7 = p_1 => {
            const opened = (0, editor_js_1.openFileInExternalEditor)(path.resolve((0, cwd_js_1.getCwd)(), p_1));
    ...
    let t12;
    if ($[19] !== maxPathWidth) {
        t12 = (p_6, isFocused) => React.createElement(ink_js_1.Text, { color: isFocused ? "suggestion" : undefined }, (0, format_js_1.truncatePathMiddle)(p_6, maxPathWidth));
        $[19] = maxPathWidth;
        $[20] = t12;
    }
    else {
    ...
    if ($[21] !== preview || $[22] !== previewWidth || $[23] !== query) {
        t13 = p_7 => preview ? React.createElement(React.Fragment, null,
            React.createElement(ink_js_1.Text, { dimColor: true },
                (0, format_js_1.truncatePathMiddle)(p_7, previewWidth),
                preview.path !== p_7 ? " \xB7 loading\u2026" : ""),
            preview.content.split("\n").map((line, i_1) => React.createElement(ink_js_1.Text, { key: i_1 }, (0, highlightMatch_js_1.highlightMatch)((0, format_js_1.truncateToWidth)(line, previewWidth), query)))) : React.createElement(LoadingState_js_1.LoadingState, { message: "Loading preview\u2026", dimColor: true });
        $[21] = preview;
        $[22] = previewWidth;
        $[23] = query;
        $[24] = t13;
