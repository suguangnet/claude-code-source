...
function GlimmerMessage(t0) {
    ...
    if ($[0] !== flashOpacity || $[1] !== message || $[2] !== messageColor || $[3] !== mode || $[4] !== shimmerColor || $[5] !== stalledIntensity || $[6] !== themeName) {
        ...
        bb0: {
            ...
            if ($[10] !== message) {
                segs = [];
                for (const { segment } of (0, intl_js_1.getGraphemeSegmenter)().segment(message)) {
                    segs.push({
                        segment,
            ...
            let t3;
            if ($[12] !== message) {
                t3 = (0, stringWidth_js_1.stringWidth)(message);
                $[12] = message;
                $[13] = t3;
            }
            else {
            ...
            if (stalledIntensity > 0) {
                ...
                if (baseRGB) {
                    const interpolated = (0, utils_js_1.interpolateColor)(baseRGB, ERROR_RED, stalledIntensity);
                    const color = (0, utils_js_1.toRGBColor)(interpolated);
                    let t5;
                    if ($[17] !== color) {
                    ...
                    t2 = React.createElement(React.Fragment, null,
                        React.createElement(ink_js_1.Text, { color: color }, message),
                        t5);
                    break bb0;
                }
                ...
                if ($[19] !== color_0 || $[20] !== message) {
                    t5 = React.createElement(ink_js_1.Text, { color: color_0 }, message);
                    $[19] = color_0;
                    $[20] = message;
                    $[21] = t5;
                }
                ...
                let t6;
                if ($[22] !== color_0) {
                    t6 = React.createElement(ink_js_1.Text, { color: color_0 }, " ");
                    $[22] = color_0;
                    $[23] = t6;
                }
                else {
            ...
            if (mode === "tool-use") {
                ...
                const baseRGB_0 = baseColorStr_0 ? (0, utils_js_1.parseRGB)(baseColorStr_0) : null;
                const shimmerRGB = shimmerColorStr ? (0, utils_js_1.parseRGB)(shimmerColorStr) : null;
                if (baseRGB_0 && shimmerRGB) {
                    const interpolated_0 = (0, utils_js_1.interpolateColor)(baseRGB_0, shimmerRGB, flashOpacity);
                    const t5 = React.createElement(ink_js_1.Text, { color: (0, utils_js_1.toRGBColor)(interpolated_0) }, message);
                    let t6;
                    if ($[27] !== messageColor) {
                        t6 = React.createElement(ink_js_1.Text, { color: messageColor }, " ");
                        $[27] = messageColor;
                        $[28] = t6;
                    }
                    else {
                ...
                if ($[32] !== color_1 || $[33] !== message) {
                    t5 = React.createElement(ink_js_1.Text, { color: color_1 }, message);
                    $[32] = color_1;
                    $[33] = message;
                    $[34] = t5;
                }
    ...
    if (shimmerStart >= messageWidth || shimmerEnd < 0) {
        ...
        if ($[40] !== message || $[41] !== messageColor) {
            t3 = React.createElement(ink_js_1.Text, { color: messageColor }, message);
            $[40] = message;
            $[41] = messageColor;
            $[42] = t3;
        }
        ...
        let t4;
        if ($[43] !== messageColor) {
            t4 = React.createElement(ink_js_1.Text, { color: messageColor }, " ");
            $[43] = messageColor;
            $[44] = t4;
        }
        else {
    ...
    if ($[59] !== before || $[60] !== messageColor) {
        t3 = before && React.createElement(ink_js_1.Text, { color: messageColor }, before);
        $[59] = before;
        $[60] = messageColor;
        $[61] = t3;
    }
    ...
    if ($[62] !== shim || $[63] !== shimmerColor) {
        t4 = React.createElement(ink_js_1.Text, { color: shimmerColor }, shim);
        $[62] = shim;
        $[63] = shimmerColor;
        $[64] = t4;
    }
    ...
    if ($[65] !== after || $[66] !== messageColor) {
        t5 = after && React.createElement(ink_js_1.Text, { color: messageColor }, after);
        $[65] = after;
        $[66] = messageColor;
        $[67] = t5;
    }
