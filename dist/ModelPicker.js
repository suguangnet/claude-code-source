...
const useExitOnCtrlCDWithKeybindings_js_1 = require("src/hooks/useExitOnCtrlCDWithKeybindings.js");
...
function ModelPicker(t0) {
    const $ = (0, compiler_runtime_1.c)(82);
    ...
    const [focusedValue, setFocusedValue] = (0, react_1.useState)(initialValue);
    const isFastMode = (0, AppState_js_1.useAppState)(_temp);
    const [hasToggledEffort, setHasToggledEffort] = (0, react_1.useState)(false);
    ...
    const [effort, setEffort] = (0, react_1.useState)(t1);
    ...
    bb0: {
        if (initial !== null && !modelOptions.some(opt => opt.value === initial)) {
            let t5;
            if ($[4] !== initial) {
                t5 = (0, model_js_1.modelDisplayString)(initial);
                $[4] = initial;
                $[5] = t5;
            }
            else {
    ...
    if ($[35] !== effort || $[36] !== hasToggledEffort || $[37] !== onSelect || $[38] !== setAppState || $[39] !== skipSettingsWrite) {
        t14 = function handleSelect(value_0) {
            ...
            if (!skipSettingsWrite) {
                const effortLevel = (0, effort_js_1.resolvePickerEffortPersistence)(effort, getDefaultEffortLevelForOption(value_0), (0, settings_js_1.getSettingsForSource)("userSettings")?.effortLevel, hasToggledEffort);
                const persistable = (0, effort_js_1.toPersistableEffort)(effortLevel);
            ...
            const selectedEffort = hasToggledEffort && selectedModel && (0, effort_js_1.modelSupportsEffort)(selectedModel) ? effort : undefined;
    ...
    if ($[41] === Symbol.for("react.memo_cache_sentinel")) {
        t15 = React.createElement(ink_js_1.Text, { color: "remember", bold: true }, "Select model");
        $[41] = t15;
    }
    else {
        t15 = $[41];
    ...
    let t17;
    if ($[42] !== t16) {
        t17 = React.createElement(ink_js_1.Text, { dimColor: true }, t16);
        $[42] = t16;
        $[43] = t17;
    }
    else {
    ...
    let t18;
    if ($[44] !== sessionModel) {
        t18 = sessionModel && React.createElement(ink_js_1.Text, { dimColor: true },
            "Currently using ",
            (0, model_js_1.modelDisplayString)(sessionModel),
    ...
    let t19;
    if ($[46] !== t17 || $[47] !== t18) {
        t19 = React.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
            t15,
            t17,
            t18);
        $[46] = t17;
    ...
    if ($[49] !== handleFocus || $[50] !== handleSelect || $[51] !== initialFocusValue || $[52] !== initialValue || $[53] !== selectOptions || $[54] !== t20 || $[55] !== visibleCount) {
        t21 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            React.createElement(index_js_2.Select, { defaultValue: initialValue, defaultFocusValue: initialFocusValue, options: selectOptions, onChange: handleSelect, onFocus: handleFocus, onCancel: t20, visibleOptionCount: visibleCount }));
        $[49] = handleFocus;
        $[50] = handleSelect;
    ...
    let t22;
    if ($[57] !== hiddenCount) {
        t22 = hiddenCount > 0 && React.createElement(ink_js_1.Box, { paddingLeft: 3 },
    ...
    let t23;
    if ($[59] !== t21 || $[60] !== t22) {
        t23 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            t21,
            t22);
        $[59] = t21;
        $[60] = t22;
    ...
    if ($[62] !== displayEffort || $[63] !== focusedDefaultEffort || $[64] !== focusedModelName || $[65] !== focusedSupportsEffort) {
        t24 = React.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" }, focusedSupportsEffort ? React.createElement(ink_js_1.Text, { dimColor: true },
            React.createElement(EffortLevelIndicator, { effort: displayEffort }),
            " ",
            (0, capitalize_js_1.default)(displayEffort),
            " effort",
            displayEffort === focusedDefaultEffort ? " (default)" : "",
            " ",
            React.createElement(ink_js_1.Text, { color: "subtle" }, "\u2190 \u2192 to adjust")) : React.createElement(ink_js_1.Text, { color: "subtle" },
    ...
    if ($[67] !== showFastModeNotice) {
        t25 = (0, fastMode_js_1.isFastModeEnabled)() ? showFastModeNotice ? React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true },
                "Fast mode is ",
                React.createElement(ink_js_1.Text, { bold: true }, "ON"),
                " and available with",
                " ",
                fastMode_js_1.FAST_MODE_MODEL_DISPLAY,
                " only (/fast). Switching to other models turn off fast mode.")) : (0, fastMode_js_1.isFastModeAvailable)() && !(0, fastMode_js_1.isFastModeCooldown)() ? React.createElement(ink_js_1.Box, { marginBottom: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true },
                "Use ",
                React.createElement(ink_js_1.Text, { bold: true }, "/fast"),
    ...
    if ($[69] !== t19 || $[70] !== t23 || $[71] !== t24 || $[72] !== t25) {
        t26 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t19,
            t23,
            t24,
            t25);
    ...
    if ($[74] !== exitState || $[75] !== isStandaloneCommand) {
        t27 = isStandaloneCommand && React.createElement(ink_js_1.Text, { dimColor: true, italic: true }, exitState.pending ? React.createElement(React.Fragment, null,
            "Press ",
            exitState.keyName,
            " again to exit") : React.createElement(Byline_js_1.Byline, null,
            React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "confirm" }),
            React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "select:cancel", context: "Select", fallback: "Esc", description: "exit" })));
        $[74] = exitState;
    ...
    let t28;
    if ($[77] !== t26 || $[78] !== t27) {
        t28 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t26,
            t27);
        $[77] = t26;
        $[78] = t27;
    ...
    let t29;
    if ($[80] !== content) {
        t29 = React.createElement(Pane_js_1.Pane, { color: "permission" }, content);
        $[80] = content;
        $[81] = t29;
    }
    else {
...
function EffortLevelIndicator(t0) {
    ...
    let t4;
    if ($[2] !== t1 || $[3] !== t3) {
        t4 = React.createElement(ink_js_1.Text, { color: t1 }, t3);
        $[2] = t1;
        $[3] = t3;
        $[4] = t4;
    }
...
function getDefaultEffortLevelForOption(value) {
    const resolved = resolveOptionModel(value) ?? (0, model_js_1.getDefaultMainLoopModel)();
    const defaultValue = (0, effort_js_1.getDefaultEffortForModel)(resolved);
