...
const select_js_1 = require("../../../components/CustomSelect/select.js");
...
const autoModeDenials_js_1 = require("../../../utils/autoModeDenials.js");
...
const Pane_js_1 = require("../../design-system/Pane.js");
const Tabs_js_1 = require("../../design-system/Tabs.js");
const SearchBox_js_1 = require("../../SearchBox.js");
const AddPermissionRules_js_1 = require("./AddPermissionRules.js");
const AddWorkspaceDirectory_js_1 = require("./AddWorkspaceDirectory.js");
const PermissionRuleDescription_js_1 = require("./PermissionRuleDescription.js");
const PermissionRuleInput_js_1 = require("./PermissionRuleInput.js");
const RecentDenialsTab_js_1 = require("./RecentDenialsTab.js");
const RemoveWorkspaceDirectory_js_1 = require("./RemoveWorkspaceDirectory.js");
const WorkspaceTab_js_1 = require("./WorkspaceTab.js");
function RuleSourceText(t0) {
    ...
    let t3;
    if ($[2] !== t2) {
        t3 = React.createElement(ink_js_1.Text, { dimColor: true }, t2);
        $[2] = t2;
        $[3] = t3;
    }
    else {
...
function RuleDetails(t0) {
    const $ = (0, compiler_runtime_1.c)(42);
    ...
    let t3;
    if ($[3] !== t2) {
        t3 = React.createElement(ink_js_1.Text, { bold: true }, t2);
        $[3] = t2;
        $[4] = t3;
    }
    else {
    ...
    let t4;
    if ($[5] !== rule.ruleValue) {
        t4 = React.createElement(PermissionRuleDescription_js_1.PermissionRuleDescription, { ruleValue: rule.ruleValue });
        $[5] = rule.ruleValue;
        $[6] = t4;
    }
    else {
    ...
    let t6;
    if ($[9] !== t3 || $[10] !== t4 || $[11] !== t5) {
        t6 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginX: 2 },
            t3,
            t4,
            t5);
        $[9] = t3;
    ...
    if ($[13] !== exitState.keyName || $[14] !== exitState.pending) {
        t7 = React.createElement(ink_js_1.Box, { marginLeft: 3 }, exitState.pending ? React.createElement(ink_js_1.Text, { dimColor: true },
            "Press ",
            exitState.keyName,
            " again to exit") : React.createElement(ink_js_1.Text, { dimColor: true }, "Esc to cancel"));
    ...
    if (rule.source === "policySettings") {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
            t8 = React.createElement(ink_js_1.Text, { bold: true, color: "permission" }, "Rule details");
            $[16] = t8;
        }
        else {
            t8 = $[16];
        ...
        if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
            t9 = React.createElement(ink_js_1.Text, { italic: true },
        ...
        if ($[18] !== ruleDescription) {
            t10 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, borderStyle: "round", paddingLeft: 1, paddingRight: 1, borderColor: "permission" },
                t8,
                ruleDescription,
                t9);
            $[18] = ruleDescription;
    ...
    let t9;
    if ($[25] !== t8) {
        t9 = React.createElement(ink_js_1.Text, { bold: true, color: "error" },
            "Delete ",
            t8,
            " tool?");
        $[25] = t8;
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t10 = React.createElement(ink_js_1.Text, null, "Are you sure you want to delete this permission rule?");
        $[27] = t10;
    }
    else {
        t10 = $[27];
    ...
    if ($[32] !== onCancel || $[33] !== t11) {
        t13 = React.createElement(select_js_1.Select, { onChange: t11, onCancel: onCancel, options: t12 });
        $[32] = onCancel;
        $[33] = t11;
        $[34] = t13;
    }
    ...
    if ($[35] !== ruleDescription || $[36] !== t13 || $[37] !== t9) {
        t14 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, borderStyle: "round", paddingLeft: 1, paddingRight: 1, borderColor: "error" },
            t9,
            ruleDescription,
            t10,
            t13);
...
function RulesTabContent(props) {
    const $ = (0, compiler_runtime_1.c)(26);
    ...
    const tabWidth = (0, Tabs_js_1.useTabsWidth)();
    const { headerFocused, focusHeader, blurHeader } = (0, Tabs_js_1.useTabHeaderFocus)();
    let t0;
    let t1;
    ...
    if ($[9] !== cursorOffset || $[10] !== isFocused || $[11] !== searchQuery || $[12] !== t4 || $[13] !== tabWidth) {
        t5 = React.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
            React.createElement(SearchBox_js_1.SearchBox, { query: searchQuery, isFocused: t4, isTerminalFocused: isFocused, width: tabWidth, cursorOffset: cursorOffset }));
        $[9] = cursorOffset;
        $[10] = isFocused;
        $[11] = searchQuery;
        $[12] = t4;
    ...
    if ($[15] !== focusHeader || $[16] !== lastFocusedRuleKey || $[17] !== onCancel || $[18] !== onSelect || $[19] !== options || $[20] !== t6 || $[21] !== t7) {
        t8 = React.createElement(select_js_1.Select, { options: options, onChange: onSelect, onCancel: onCancel, visibleOptionCount: t6, isDisabled: t7, defaultFocusValue: lastFocusedRuleKey, onUpFromFirstItem: focusHeader });
        $[15] = focusHeader;
    ...
    let t9;
    if ($[23] !== t5 || $[24] !== t8) {
        t9 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
            t5,
            t8);
        $[23] = t5;
        $[24] = t8;
...
function PermissionRulesTab(t0) {
    ...
    if ($[0] !== t0) {
        ...
        const t9 = t8[tab];
        if ($[11] !== t9) {
            t4 = React.createElement(ink_js_1.Text, null, t9);
            $[11] = t9;
            $[12] = t4;
        }
        else {
...
function PermissionRuleList(t0) {
    const $ = (0, compiler_runtime_1.c)(113);
    ...
    const [changes, setChanges] = (0, react_1.useState)(t2);
    const toolPermissionContext = (0, AppState_js_1.useAppState)(_temp);
    ...
    const denialStateRef = (0, react_1.useRef)(t3);
    let t4;
    ...
    const [selectedRule, setSelectedRule] = (0, react_1.useState)();
    const [lastFocusedRuleKey, setLastFocusedRuleKey] = (0, react_1.useState)();
    const [addingRuleToTab, setAddingRuleToTab] = (0, react_1.useState)(null);
    const [validatedRule, setValidatedRule] = (0, react_1.useState)(null);
    const [isAddingWorkspaceDirectory, setIsAddingWorkspaceDirectory] = (0, react_1.useState)(false);
    const [removingDirectory, setRemovingDirectory] = (0, react_1.useState)(null);
    const [isSearchMode, setIsSearchMode] = (0, react_1.useState)(false);
    const [headerFocused, setHeaderFocused] = (0, react_1.useState)(true);
    let t5;
    ...
    if ($[5] !== toolPermissionContext) {
        map = new Map();
        (0, permissions_js_1.getAllowRules)(toolPermissionContext).forEach(rule => {
    ...
    if ($[7] !== toolPermissionContext) {
        map_0 = new Map();
        (0, permissions_js_1.getDenyRules)(toolPermissionContext).forEach(rule_0 => {
    ...
    if ($[9] !== toolPermissionContext) {
        map_1 = new Map();
        (0, permissions_js_1.getAskRules)(toolPermissionContext).forEach(rule_1 => {
    ...
    if ($[11] !== allowRulesByKey || $[12] !== askRulesByKey || $[13] !== denyRulesByKey) {
        t6 = (tab, t7) => {
            ...
            if (tab !== "workspace" && tab !== "recent" && !query) {
                options.push({
                    label: `Add a new rule${figures_1.default.ellipsis}`,
                    value: "add-new-rule"
                });
            }
            const sortedRuleKeys = Array.from(rulesByKey.keys()).sort((a, b) => {
                ...
                if (ruleA && ruleB) {
                    const ruleAString = (0, permissionRuleParser_js_1.permissionRuleValueToString)(ruleA.ruleValue).toLowerCase();
                    const ruleBString = (0, permissionRuleParser_js_1.permissionRuleValueToString)(ruleB.ruleValue).toLowerCase();
            ...
            for (const ruleKey of sortedRuleKeys) {
                ...
                if (rule_2) {
                    const ruleString = (0, permissionRuleParser_js_1.permissionRuleValueToString)(rule_2.ruleValue);
    ...
    const { query: searchQuery, setQuery: setSearchQuery, cursorOffset: searchCursorOffset } = (0, useSearchInput_js_1.useSearchInput)(t9);
    let t10;
    ...
    if ($[26] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = (rules, unreachable) => {
            ...
            for (const rule_3 of rules) {
                setChanges(prev => [...prev, `Added ${rule_3.ruleBehavior} rule ${chalk_1.default.bold((0, permissionRuleParser_js_1.permissionRuleValueToString)(rule_3.ruleValue))}`]);
            }
            if (unreachable && unreachable.length > 0) {
                for (const u of unreachable) {
                    const severity = u.shadowType === "deny" ? "blocked" : "shadowed";
                    setChanges(prev_0 => [...prev_0, chalk_1.default.yellow(`${figures_1.default.warning} Warning: ${(0, permissionRuleParser_js_1.permissionRuleValueToString)(u.rule.ruleValue)} is ${severity}`), chalk_1.default.dim(`  ${u.reason}`), chalk_1.default.dim(`  Fix: ${u.fix}`)]);
                }
            }
        };
        $[26] = t14;
    ...
    if ($[36] !== getRulesOptions || $[37] !== selectedRule || $[38] !== setAppState || $[39] !== toolPermissionContext) {
        t21 = () => {
            ...
            const selectedKey = (0, slowOperations_js_1.jsonStringify)(selectedRule);
            ...
            setChanges(prev_2 => [...prev_2, `Deleted ${selectedRule.ruleBehavior} rule ${chalk_1.default.bold((0, permissionRuleParser_js_1.permissionRuleValueToString)(selectedRule.ruleValue))}`]);
    ...
    if (addingRuleToTab && addingRuleToTab !== "workspace" && addingRuleToTab !== "recent") {
        ...
        if ($[45] !== addingRuleToTab) {
            t22 = React.createElement(PermissionRuleInput_js_1.PermissionRuleInput, { onCancel: handleRuleInputCancel, onSubmit: handleRuleInputSubmit, ruleBehavior: addingRuleToTab });
            $[45] = addingRuleToTab;
            $[46] = t22;
        }
        else {
    ...
    if (validatedRule) {
        ...
        if ($[51] !== t22 || $[52] !== t23 || $[53] !== toolPermissionContext || $[54] !== validatedRule.ruleBehavior) {
            t24 = React.createElement(AddPermissionRules_js_1.AddPermissionRules, { onAddRules: handleAddRulesSuccess, onCancel: handleAddRuleCancel, ruleValues: t22, ruleBehavior: validatedRule.ruleBehavior, initialContext: toolPermissionContext, setToolPermissionContext: t23 });
            $[51] = t22;
            $[52] = t23;
    ...
    if (isAddingWorkspaceDirectory) {
        ...
        if ($[56] !== setAppState || $[57] !== toolPermissionContext) {
            t22 = (path_0, remember) => {
                ...
                const updatedContext = (0, PermissionUpdate_js_1.applyPermissionUpdate)(toolPermissionContext, permissionUpdate);
                setAppState(prev_4 => ({
                    ...prev_4,
                ...
                setChanges(prev_5 => [...prev_5, `Added directory ${chalk_1.default.bold(path_0)} to workspace${remember ? " and saved to local settings" : " for this session"}`]);
        ...
        if ($[60] !== t22 || $[61] !== toolPermissionContext) {
            t24 = React.createElement(AddWorkspaceDirectory_js_1.AddWorkspaceDirectory, { onAddDirectory: t22, onCancel: t23, permissionContext: toolPermissionContext });
            $[60] = t22;
    ...
    if (removingDirectory) {
        ...
        if ($[63] !== removingDirectory) {
            t22 = () => {
                setChanges(prev_6 => [...prev_6, `Removed directory ${chalk_1.default.bold(removingDirectory)} from workspace`]);
        ...
        if ($[68] !== removingDirectory || $[69] !== t22 || $[70] !== t24 || $[71] !== toolPermissionContext) {
            t25 = React.createElement(RemoveWorkspaceDirectory_js_1.RemoveWorkspaceDirectory, { directoryPath: removingDirectory, onRemove: t22, onCancel: t23, permissionContext: toolPermissionContext, setPermissionContext: t24 });
    ...
    if ($[82] === Symbol.for("react.memo_cache_sentinel")) {
        t24 = React.createElement(Tabs_js_1.Tab, { id: "recent", title: "Recently denied" },
            React.createElement(RecentDenialsTab_js_1.RecentDenialsTab, { onHeaderFocusChange: handleHeaderFocusChange, onStateChange: handleDenialStateChange }));
        $[82] = t24;
    }
    else {
        t24 = $[82];
    ...
    if ($[83] !== sharedRulesProps) {
        t25 = React.createElement(Tabs_js_1.Tab, { id: "allow", title: "Allow" },
    ...
    if ($[85] !== sharedRulesProps) {
        t26 = React.createElement(Tabs_js_1.Tab, { id: "ask", title: "Ask" },
    ...
    if ($[87] !== sharedRulesProps) {
        t27 = React.createElement(Tabs_js_1.Tab, { id: "deny", title: "Deny" },
    ...
    if ($[89] === Symbol.for("react.memo_cache_sentinel")) {
        t28 = React.createElement(ink_js_1.Text, null, "Claude Code can read files in the workspace, and make edits when auto-accept edits is on.");
        $[89] = t28;
    }
    else {
        t28 = $[89];
    ...
    if ($[90] !== onExit || $[91] !== toolPermissionContext) {
        t29 = React.createElement(Tabs_js_1.Tab, { id: "workspace", title: "Workspace" },
            React.createElement(ink_js_1.Box, { flexDirection: "column" },
                t28,
                React.createElement(WorkspaceTab_js_1.WorkspaceTab, { onExit: onExit, toolPermissionContext: toolPermissionContext, onRequestAddDirectory: handleRequestAddDirectory, onRequestRemoveDirectory: handleRequestRemoveDirectory, onHeaderFocusChange: handleHeaderFocusChange })));
        $[90] = onExit;
    ...
    if ($[93] !== defaultTab || $[94] !== isHidden || $[95] !== t23 || $[96] !== t25 || $[97] !== t26 || $[98] !== t27 || $[99] !== t29) {
        t30 = React.createElement(Tabs_js_1.Tabs, { title: "Permissions:", color: "permission", defaultTab: defaultTab, hidden: isHidden, initialHeaderFocused: !hasDenials, navFromContent: t23 },
            t24,
            t25,
            t26,
            t27,
    ...
    if ($[101] !== defaultTab || $[102] !== exitState.keyName || $[103] !== exitState.pending || $[104] !== headerFocused || $[105] !== isSearchMode) {
        t31 = React.createElement(ink_js_1.Box, { marginTop: 1, paddingLeft: 1 },
            React.createElement(ink_js_1.Text, { dimColor: true }, exitState.pending ? React.createElement(React.Fragment, null,
                "Press ",
                exitState.keyName,
    ...
    let t32;
    if ($[107] !== t30 || $[108] !== t31) {
        t32 = React.createElement(Pane_js_1.Pane, { color: "permission" },
            t30,
            t31);
        $[107] = t30;
        $[108] = t31;
    ...
    if ($[110] !== handleKeyDown || $[111] !== t32) {
        t33 = React.createElement(ink_js_1.Box, { flexDirection: "column", onKeyDown: handleKeyDown }, t32);
        $[110] = handleKeyDown;
        $[111] = t32;
        $[112] = t33;
    }
