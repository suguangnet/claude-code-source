...
function RemoteCallout({ onDone }) {
    ...
    return react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { title: "Remote Control" },
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            react_1.default.createElement(ink_js_1.Box, { marginBottom: 1, flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Text, null, "Remote Control lets you access this CLI session from the web (claude.ai/code) or the Claude app, so you can pick up where you left off on any device."),
                react_1.default.createElement(ink_js_1.Text, null, " "),
                react_1.default.createElement(ink_js_1.Text, null, "You can disconnect remote access anytime by running /remote-control again.")),
