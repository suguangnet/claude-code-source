...
const SetContext = (0, react_1.createContext)(null);
const DialogContext = (0, react_1.createContext)(null);
const SetDialogContext = (0, react_1.createContext)(null);
function PromptOverlayProvider(t0) {
    ...
    if ($[0] !== children || $[1] !== dialog) {
        t1 = react_1.default.createElement(DialogContext.Provider, { value: dialog }, children);
        $[0] = children;
        $[1] = dialog;
        $[2] = t1;
    }
    ...
    let t2;
    if ($[3] !== data || $[4] !== t1) {
        t2 = react_1.default.createElement(SetContext.Provider, { value: setData },
            react_1.default.createElement(SetDialogContext.Provider, { value: setDialog },
                react_1.default.createElement(DataContext.Provider, { value: data }, t1)));
        $[3] = data;
        $[4] = t1;
        $[5] = t2;
    }
...
function useSetPromptOverlay(data) {
    ...
    const set = (0, react_1.useContext)(SetContext);
    let t0;
    let t1;
    if ($[0] !== data || $[1] !== set) {
        t0 = () => {
...
function useSetPromptOverlayDialog(node) {
    const $ = (0, compiler_runtime_1.c)(4);
    const set = (0, react_1.useContext)(SetDialogContext);
    let t0;
    let t1;
    if ($[0] !== node || $[1] !== set) {
        t0 = () => {
