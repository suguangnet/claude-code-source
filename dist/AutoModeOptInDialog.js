...
function AutoModeOptInDialog(t0) {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            react_1.default.createElement(ink_js_1.Text, null, exports.AUTO_MODE_DESCRIPTION),
    ...
    if ($[11] !== onDecline || $[12] !== t7 || $[13] !== t8) {
        t9 = react_1.default.createElement(index_js_2.Select, { options: t7, onChange: t8, onCancel: onDecline });
        $[11] = onDecline;
        $[12] = t7;
        $[13] = t8;
        $[14] = t9;
    ...
    if ($[15] !== onDecline || $[16] !== t9) {
        t10 = react_1.default.createElement(Dialog_js_1.Dialog, { title: "Enable auto mode?", color: "warning", onCancel: onDecline },
            t3,
            t9);
        $[15] = onDecline;
        $[16] = t9;
