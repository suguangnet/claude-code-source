        ...
        case BashTool_js_1.BashTool.name:
            {
                if (ruleValue.ruleContent) {
                    if (ruleValue.ruleContent.endsWith(":*")) {
                        ...
                        if ($[2] !== t1) {
                            t2 = React.createElement(ink_js_1.Text, { dimColor: true },
                                ...
                                " ",
                                React.createElement(ink_js_1.Text, { bold: true }, t1));
                            $[2] = t1;
                            $[3] = t2;
                        }
                        else {
                        ...
                        if ($[4] !== ruleValue.ruleContent) {
                            t1 = React.createElement(ink_js_1.Text, { dimColor: true },
                                "The Bash command ",
                                React.createElement(ink_js_1.Text, { bold: true }, ruleValue.ruleContent));
                    ...
                    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
                        t1 = React.createElement(ink_js_1.Text, { dimColor: true }, "Any Bash command");
                        $[6] = t1;
                    }
                    else {
                        t1 = $[6];
        ...
        default:
            {
                if (!ruleValue.ruleContent) {
                    ...
                    if ($[7] !== ruleValue.toolName) {
                        t1 = React.createElement(ink_js_1.Text, { dimColor: true },
                            "Any use of the ",
                            React.createElement(ink_js_1.Text, { bold: true }, ruleValue.toolName),
                            " tool");
