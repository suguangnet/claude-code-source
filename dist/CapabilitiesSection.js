...
function CapabilitiesSection(t0) {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = react_1.default.createElement(ink_js_1.Text, { bold: true }, "Capabilities: ");
        $[4] = t1;
    }
    else {
        t1 = $[4];
    ...
    let t2;
    if ($[5] !== capabilities) {
        t2 = capabilities.length > 0 ? react_1.default.createElement(Byline_js_1.Byline, null, capabilities) : "none";
        $[5] = capabilities;
        $[6] = t2;
    }
    else {
    ...
    if ($[7] !== t2) {
        t3 = react_1.default.createElement(ink_js_1.Box, null,
            t1,
            react_1.default.createElement(ink_js_1.Text, { color: "text" }, t2));
        $[7] = t2;
        $[8] = t3;
    }
    else {
