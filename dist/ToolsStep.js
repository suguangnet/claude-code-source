...
function ToolsStep(t0) {
    ...
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = react_1.default.createElement(Byline_js_1.Byline, null,
            react_1.default.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "toggle selection" }),
    ...
    if ($[4] !== goBack || $[5] !== handleComplete || $[6] !== initialTools || $[7] !== tools) {
        t3 = react_1.default.createElement(WizardDialogLayout_js_1.WizardDialogLayout, { subtitle: "Select tools", footerText: t2 },
            react_1.default.createElement(ToolSelector_js_1.ToolSelector, { tools: tools, initialTools: initialTools, onComplete: handleComplete, onCancel: goBack }));
        $[4] = goBack;
        $[5] = handleComplete;
        $[6] = initialTools;
        $[7] = tools;
