...
const environmentSelection_js_1 = require("../utils/teleport/environmentSelection.js");
...
const LoadingState_js_1 = require("./design-system/LoadingState.js");
...
function RemoteEnvironmentDialog(t0) {
    ...
    const { onDone } = t0;
    const [loadingState, setLoadingState] = (0, react_1.useState)("loading");
    let t1;
    ...
    const [environments, setEnvironments] = (0, react_1.useState)(t1);
    const [selectedEnvironment, setSelectedEnvironment] = (0, react_1.useState)(null);
    const [selectedEnvironmentSource, setSelectedEnvironmentSource] = (0, react_1.useState)(null);
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = () => {
            ...
            const fetchInfo = async function fetchInfo() {
                ;
                try {
                    const result = await (0, environmentSelection_js_1.getEnvironmentSelectionInfo)();
                    if (cancelled) {
                        return;
                    }
                    ...
                    const fetchError = (0, errors_js_1.toError)(err);
    ...
    if ($[3] !== environments || $[4] !== onDone) {
        t4 = function handleSelect(value) {
            ...
            onDone(`Set default remote environment to ${chalk_1.default.bold(selectedEnv.name)} (${selectedEnv.environment_id})`);
        };
        $[3] = environments;
        $[4] = onDone;
        $[5] = t4;
    ...
    if (loadingState === "loading") {
        ...
        if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = React.createElement(LoadingState_js_1.LoadingState, { message: "Loading environments\u2026" });
            $[6] = t5;
        }
        else {
            t5 = $[6];
        ...
        let t6;
        if ($[7] !== onDone) {
            t6 = React.createElement(Dialog_js_1.Dialog, { title: DIALOG_TITLE, onCancel: onDone, hideInputGuide: true }, t5);
            $[7] = onDone;
            $[8] = t6;
        }
        else {
    ...
    if (error) {
        let t5;
        if ($[9] !== error) {
            t5 = React.createElement(ink_js_1.Text, { color: "error" },
                "Error: ",
                error);
            $[9] = error;
            $[10] = t5;
        ...
        let t6;
        if ($[11] !== onDone || $[12] !== t5) {
            t6 = React.createElement(Dialog_js_1.Dialog, { title: DIALOG_TITLE, onCancel: onDone }, t5);
            $[11] = onDone;
            $[12] = t5;
            $[13] = t6;
        }
    ...
    if (!selectedEnvironment) {
        ...
        if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = React.createElement(ink_js_1.Text, null, "No remote environments available.");
            $[14] = t5;
        }
        else {
            t5 = $[14];
        ...
        let t6;
        if ($[15] !== onDone) {
            t6 = React.createElement(Dialog_js_1.Dialog, { title: DIALOG_TITLE, subtitle: SETUP_HINT, onCancel: onDone }, t5);
            $[15] = onDone;
            $[16] = t6;
        }
        else {
...
function EnvironmentLabel(t0) {
    ...
    if ($[0] !== environment.name) {
        t1 = React.createElement(ink_js_1.Text, { bold: true }, environment.name);
        $[0] = environment.name;
        $[1] = t1;
    }
    else {
...
function SingleEnvironmentContent(t0) {
    ...
    let t3;
    if ($[3] !== onDone || $[4] !== t2) {
        t3 = React.createElement(Dialog_js_1.Dialog, { title: DIALOG_TITLE, subtitle: SETUP_HINT, onCancel: onDone }, t2);
        $[3] = onDone;
        $[4] = t2;
        $[5] = t3;
    }
...
function MultipleEnvironmentsContent(t0) {
    ...
    if ($[0] !== selectedEnvironmentSource) {
        t1 = selectedEnvironmentSource && selectedEnvironmentSource !== "localSettings" ? ` (from ${(0, constants_js_1.getSettingSourceName)(selectedEnvironmentSource)} settings)` : "";
    ...
    if ($[2] !== selectedEnvironment.name) {
        t2 = React.createElement(ink_js_1.Text, { bold: true }, selectedEnvironment.name);
    ...
    if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = React.createElement(ink_js_1.Text, { dimColor: true }, SETUP_HINT);
        $[7] = t4;
    }
    else {
        t4 = $[7];
    ...
    if ($[8] !== environments || $[9] !== loadingState || $[10] !== onSelect || $[11] !== selectedEnvironment.environment_id) {
        t5 = loadingState === "updating" ? React.createElement(LoadingState_js_1.LoadingState, { message: "Updating\u2026" }) : React.createElement(select_js_1.Select, { options: environments.map(_temp), defaultValue: selectedEnvironment.environment_id, onChange: onSelect, onCancel: () => onSelect("cancel"), layout: "compact-vertical" });
        $[8] = environments;
        $[9] = loadingState;
        $[10] = onSelect;
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(ink_js_1.Text, { dimColor: true },
            React.createElement(Byline_js_1.Byline, null,
                React.createElement(KeyboardShortcutHint_js_1.KeyboardShortcutHint, { shortcut: "Enter", action: "select" }),
    ...
    if ($[14] !== onCancel || $[15] !== subtitle || $[16] !== t5) {
        t7 = React.createElement(Dialog_js_1.Dialog, { title: DIALOG_TITLE, subtitle: subtitle, onCancel: onCancel, hideInputGuide: true },
            t4,
            t5,
            t6);
        $[14] = onCancel;
...
function _temp(env) {
    return {
        label: React.createElement(ink_js_1.Text, null,
            env.name,
            " ",
