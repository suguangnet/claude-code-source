...
const ideDiffConfig_js_1 = require("../FilePermissionDialog/ideDiffConfig.js");
const ideDiffSupport = {
    getConfig: (input) => (0, ideDiffConfig_js_1.createSingleEditDiffConfig)(input.file_path, input.old_string, input.new_string, input.replace_all),
...
function FileEditPermissionRequest(props) {
    ...
    if ($[36] !== file_path || $[37] !== t14) {
        t15 = react_1.default.createElement(FileEditToolDiff_js_1.FileEditToolDiff, { file_path: file_path, edits: t14 });
        $[36] = file_path;
        $[37] = t14;
        $[38] = t15;
    }
    ...
    if ($[39] !== T2 || $[40] !== file_path || $[41] !== t10 || $[42] !== t12 || $[43] !== t15 || $[44] !== t4 || $[45] !== t5 || $[46] !== t6 || $[47] !== t7 || $[48] !== t8 || $[49] !== t9) {
        t16 = react_1.default.createElement(T2, { toolUseConfirm: t4, toolUseContext: t5, onDone: t6, onReject: t7, workerBadge: t8, title: t9, subtitle: t10, question: t12, content: t15, path: file_path, completionType: "str_replace_single", parseInput: parseInput, ideDiffSupport: ideDiffSupport });
        $[39] = T2;
        $[40] = file_path;
        $[41] = t10;
        $[42] = t12;
