...
const generateSessionName_js_1 = require("../../../commands/rename/generateSessionName.js");
...
const autoModeStateModule = (0, bun_bundle_1.feature)('TRANSCRIPT_CLASSIFIER') ? require('../../../utils/permissions/autoModeState.js') : null;
...
function autoNameSessionFromPlan(plan, setAppState, isClearContext) {
    if ((0, state_js_1.isSessionPersistenceDisabled)() || (0, settings_js_1.getSettings_DEPRECATED)()?.cleanupPeriodDays === 0) {
        return;
    }
    ...
    [(0, messages_js_1.createUserMessage)({
        ...
        await (0, sessionStorage_js_1.saveCustomTitle)(sessionId, name, fullPath, 'auto');
        await (0, sessionStorage_js_1.saveAgentName)(sessionId, name, fullPath, 'auto');
        setAppState(prev => {
...
function ExitPlanModePermissionRequest({ toolUseConfirm, onDone, onReject, workerBadge, setStickyFooter }) {
    ...
    const [planFeedback, setPlanFeedback] = (0, react_1.useState)('');
    const [pastedContents, setPastedContents] = (0, react_1.useState)({});
    const nextPasteIdRef = (0, react_1.useRef)(0);
    const showClearContext = (0, AppState_js_1.useAppState)(s => s.settings.showClearContextOnPlanAccept) ?? false;
    ...
    const showUltraplan = (0, bun_bundle_1.feature)('ULTRAPLAN') ? !ultraplanSessionUrl && !ultraplanLaunching : false;
    ...
    const options = (0, react_1.useMemo)(() => buildPlanApprovalOptions({
        showClearContext,
        showUltraplan,
    ...
    const onRemoveImage = (0, react_1.useCallback)((id) => {
        setPastedContents(prev => {
            const next = {
                ...prev
            };
    ...
    // (see issue #10878)
    const isV2 = toolUseConfirm.tool.name === constants_js_2.EXIT_PLAN_MODE_V2_TOOL_NAME;
    const inputPlan = isV2 ? undefined : toolUseConfirm.input.plan;
    const planFilePath = isV2 ? (0, plans_js_1.getPlanFilePath)() : undefined;
    ...
    const rawPlan = inputPlan ?? (0, plans_js_1.getPlan)();
    ...
    // not user input.
    const [planStructureVariant] = (0, react_1.useState)(() => ((0, planModeV2_js_1.getPewterLedgerVariant)() ?? undefined));
    const [currentPlan, setCurrentPlan] = (0, react_1.useState)(() => {
        if (inputPlan)
            return inputPlan;
        const plan = (0, plans_js_1.getPlan)();
        return plan ?? 'No plan found. Please write your plan to the plan file first.';
    });
    const [showSaveMessage, setShowSaveMessage] = (0, react_1.useState)(false);
    ...
    const [planEditedLocally, setPlanEditedLocally] = (0, react_1.useState)(false);
        ...
        if (e.ctrl && e.key === 'g') {
            ...
            void (async () => {
                if (isV2 && planFilePath) {
                    const result = await (0, promptEditor_js_1.editFileInEditor)(planFilePath);
                    if (result.error) {
                        addNotification({
                    ...
                    const result = await (0, promptEditor_js_1.editPromptInEditor)(currentPlan);
                    if (result.error) {
                        addNotification({
                            key: 'external-editor-error',
                            text: result.error,
    ...
    async function handleResponse(value) {
        ...
        if (value === 'ultraplan') {
            ...
            }).then(msg => (0, messageQueueManager_js_1.enqueuePendingNotification)({
                value: msg,
        ...
        if ((0, bun_bundle_1.feature)('TRANSCRIPT_CLASSIFIER')) {
            const goingToAuto = (value === 'yes-resume-auto-mode' || value === 'yes-auto-clear-context') && (0, permissionSetup_js_1.isAutoModeGateEnabled)();
            ...
            if (value !== 'no' && !goingToAuto && autoWasUsedDuringPlan) {
                ...
                setAppState(prev => ({
                    ...
                    toolPermissionContext: {
                        ...(0, permissionSetup_js_1.restoreDangerousPermissions)(prev.toolPermissionContext),
        ...
        const isResumeAutoOption = (0, bun_bundle_1.feature)('TRANSCRIPT_CLASSIFIER') ? value === 'yes-resume-auto-mode' : false;
        ...
        if (value !== 'no' && !isKeepContextOption) {
            ...
            const verificationInstruction = undefined === 'true' ? `\n\nIMPORTANT: When you have finished implementing the plan, you MUST call the "VerifyPlanExecution" tool directly (NOT the ${constants_js_1.AGENT_TOOL_NAME} tool or an agent) to trigger background verification.` : '';
            ...
            const teamHint = (0, agentSwarmsEnabled_js_1.isAgentSwarmsEnabled)() ? `\n\nIf this plan can be broken down into multiple independent tasks, consider using the ${constants_js_3.TEAM_CREATE_TOOL_NAME} tool to create a team and parallelize the work.` : '';
        ...
        if ((0, bun_bundle_1.feature)('TRANSCRIPT_CLASSIFIER') && value === 'yes-resume-auto-mode' && (0, permissionSetup_js_1.isAutoModeGateEnabled)()) {
            ...
            setAppState(prev => ({
                ...prev,
                toolPermissionContext: (0, permissionSetup_js_1.stripDangerousPermissionsForAutoMode)({
    ...
    const editorName = editor ? (0, ide_js_1.toIDEDisplayName)(editor) : null;
    ...
    const handleResponseRef = (0, react_1.useRef)(handleResponse);
    handleResponseRef.current = handleResponse;
    const handleCancelRef = (0, react_1.useRef)(undefined);
    ...
    (0, react_1.useLayoutEffect)(() => {
        if (!useStickyFooter)
            return;
        setStickyFooter(react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", borderStyle: "round", borderColor: "planMode", borderLeft: false, borderRight: false, borderBottom: false, paddingX: 1 },
            react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Would you like to proceed?"),
            react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(index_js_2.Select, { options: options, onChange: v => void handleResponseRef.current(v), onCancel: () => handleCancelRef.current?.(), onImagePaste: onImagePaste, pastedContents: pastedContents, onRemoveImage: onRemoveImage })),
            editorName && react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1, marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "ctrl-g to edit in "),
                react_1.default.createElement(ink_js_1.Text, { bold: true, dimColor: true }, editorName),
                isV2 && planFilePath && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    " \u00B7 ",
                    (0, file_js_1.getDisplayPath)(planFilePath)),
                showSaveMessage && react_1.default.createElement(react_1.default.Fragment, null,
    ...
    if (isEmpty) {
        ...
        return react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { color: "planMode", title: "Exit plan mode?", workerBadge: workerBadge },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1, marginTop: 1 },
                react_1.default.createElement(ink_js_1.Text, null, "Claude wants to exit plan mode"),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(index_js_2.Select, { options: [{
                                label: 'Yes',
                                value: 'yes'
                            }, {
                                label: 'No',
    ...
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
        react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { color: "planMode", title: "Ready to code?", innerPaddingX: 0, workerBadge: workerBadge },
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 },
                react_1.default.createElement(ink_js_1.Box, { paddingX: 1, flexDirection: "column" },
                    react_1.default.createElement(ink_js_1.Text, null, "Here is Claude's plan:")),
                react_1.default.createElement(ink_js_1.Box, { borderColor: "subtle", borderStyle: "dashed", flexDirection: "column", borderLeft: false, borderRight: false, paddingX: 1, marginBottom: 1, 
                    // Necessary for Windows Terminal to render properly
                    overflow: "hidden" },
                    react_1.default.createElement(Markdown_js_1.Markdown, null, currentPlan)),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1 },
                    react_1.default.createElement(PermissionRuleExplanation_js_1.PermissionRuleExplanation, { permissionResult: toolUseConfirm.permissionResult, toolType: "tool" }),
                    (0, bashClassifier_js_1.isClassifierPermissionsEnabled)() && allowedPrompts && allowedPrompts.length > 0 && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
                        react_1.default.createElement(ink_js_1.Text, { bold: true }, "Requested permissions:"),
                        allowedPrompts.map((p, i) => react_1.default.createElement(ink_js_1.Text, { key: i, dimColor: true },
                            '  ',
                            "\u00B7 ",
                            p.tool,
                            "(",
                            bashClassifier_js_1.PROMPT_PREFIX,
                            " ",
                            p.prompt,
                            ")"))),
                    !useStickyFooter && react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Claude has written up a plan and is ready to execute. Would you like to proceed?"),
                        react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                            react_1.default.createElement(index_js_2.Select, { options: options, onChange: handleResponse, onCancel: () => handleCancelRef.current?.(), onImagePaste: onImagePaste, pastedContents: pastedContents, onRemoveImage: onRemoveImage })))))),
        !useStickyFooter && editorName && react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1, paddingX: 1, marginTop: 1 },
            react_1.default.createElement(ink_js_1.Box, null,
                ...
                isV2 && planFilePath && react_1.default.createElement(ink_js_1.Text, { dimColor: true },
                    " \u00B7 ",
                    (0, file_js_1.getDisplayPath)(planFilePath))),
            showSaveMessage && react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, ' · '),
                react_1.default.createElement(ink_js_1.Text, { color: "success" },
                    figures_1.default.tick,
                    "Plan saved!"))));
...
function buildPlanApprovalOptions({ showClearContext, showUltraplan, usedPercent, isAutoModeAvailable, isBypassPermissionsModeAvailable, onFeedbackChange }) {
    const options = [];
...
function getContextUsedPercent(usage, permissionMode) {
    ...
    const contextWindowSize = (0, context_js_1.getContextWindowForModel)(runtimeModel, (0, state_js_1.getSdkBetas)());
    const { used } = (0, context_js_1.calculateContextPercentages)({
