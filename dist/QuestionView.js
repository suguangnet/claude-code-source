...
const PreviewQuestionView_js_1 = require("./PreviewQuestionView.js");
const QuestionNavigationBar_js_1 = require("./QuestionNavigationBar.js");
function QuestionView(t0) {
    const $ = (0, compiler_runtime_1.c)(114);
    ...
    const isInPlanMode = (0, AppState_js_1.useAppState)(_temp) === "plan";
    const [isFooterFocused, setIsFooterFocused] = (0, react_1.useState)(false);
    const [footerIndex, setFooterIndex] = (0, react_1.useState)(0);
    const [isOtherFocused, setIsOtherFocused] = (0, react_1.useState)(false);
    let t2;
    ...
    if ($[47] !== isInPlanMode || $[48] !== planFilePath) {
        t8 = isInPlanMode && planFilePath && react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 0 },
            react_1.default.createElement(Divider_js_1.Divider, { color: "inactive" }),
            react_1.default.createElement(ink_js_1.Text, { color: "inactive" },
                "Planning: ",
                react_1.default.createElement(FilePathLink_js_1.FilePathLink, { filePath: planFilePath })));
        $[47] = isInPlanMode;
        $[48] = planFilePath;
        $[49] = t8;
    }
    ...
    if ($[50] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = react_1.default.createElement(ink_js_1.Box, { marginTop: -1 },
            react_1.default.createElement(Divider_js_1.Divider, { color: "inactive" }));
        $[50] = t9;
    }
    else {
    ...
    if ($[51] !== answers || $[52] !== currentQuestionIndex || $[53] !== hideSubmitTab || $[54] !== questions) {
        t10 = react_1.default.createElement(QuestionNavigationBar_js_1.QuestionNavigationBar, { questions: questions, currentQuestionIndex: currentQuestionIndex, answers: answers, hideSubmitTab: hideSubmitTab });
        $[51] = answers;
    ...
    if ($[56] !== question.question) {
        t11 = react_1.default.createElement(PermissionRequestTitle_js_1.PermissionRequestTitle, { title: question.question, color: "text" });
    ...
    if ($[58] !== currentQuestionIndex || $[59] !== handleFocus || $[60] !== handleOpenEditor || $[61] !== isFooterFocused || $[62] !== onAnswer || $[63] !== onCancel || $[64] !== onImagePaste || $[65] !== onRemoveImage || $[66] !== onSubmit || $[67] !== onUpdateQuestionState || $[68] !== options || $[69] !== pastedContents || $[70] !== question.multiSelect || $[71] !== question.question || $[72] !== questionStates || $[73] !== questionText || $[74] !== questions.length) {
        t12 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 }, question.multiSelect ? react_1.default.createElement(index_js_1.SelectMulti, { key: question.question, options: options, defaultValue: questionStates[question.question]?.selectedValue, onChange: values => {
                onUpdateQuestionState(questionText, {
            ...
            }, onFocus: handleFocus, onCancel: onCancel, submitButtonText: currentQuestionIndex === questions.length - 1 ? "Submit" : "Next", onSubmit: onSubmit, onDownFromLastItem: handleDownFromLastItem, isDisabled: isFooterFocused, onOpenEditor: handleOpenEditor, onImagePaste: onImagePaste, pastedContents: pastedContents, onRemoveImage: onRemoveImage }) : react_1.default.createElement(index_js_1.Select, { key: question.question, options: options, defaultValue: questionStates[question.question]?.selectedValue, onChange: value_1 => {
                onUpdateQuestionState(questionText, {
    ...
    if ($[76] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = react_1.default.createElement(Divider_js_1.Divider, { color: "inactive" });
        $[76] = t13;
    }
    else {
        t13 = $[76];
    ...
    if ($[77] !== footerIndex || $[78] !== isFooterFocused) {
        t14 = isFooterFocused && footerIndex === 0 ? react_1.default.createElement(ink_js_1.Text, { color: "suggestion" }, figures_1.default.pointer) : react_1.default.createElement(ink_js_1.Text, null, " ");
        $[77] = footerIndex;
        $[78] = isFooterFocused;
        $[79] = t14;
    }
    ...
    let t17;
    if ($[80] !== t15 || $[81] !== t16) {
        t17 = react_1.default.createElement(ink_js_1.Text, { color: t15 },
            t16,
            ". Chat about this");
        $[80] = t15;
        $[81] = t16;
    ...
    let t18;
    if ($[83] !== t14 || $[84] !== t17) {
        t18 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
            t14,
            t17);
        $[83] = t14;
        $[84] = t17;
    ...
    if ($[86] !== footerIndex || $[87] !== isFooterFocused || $[88] !== isInPlanMode || $[89] !== options.length) {
        t19 = isInPlanMode && react_1.default.createElement(ink_js_1.Box, { flexDirection: "row", gap: 1 },
            ...
            react_1.default.createElement(ink_js_1.Text, { color: isFooterFocused && footerIndex === 1 ? "suggestion" : undefined },
                options.length + 2,
    ...
    let t20;
    if ($[91] !== t18 || $[92] !== t19) {
        t20 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t13,
            t18,
            t19);
        $[91] = t18;
    ...
    if ($[94] !== questions.length) {
        t21 = questions.length === 1 ? react_1.default.createElement(react_1.default.Fragment, null,
    ...
    if ($[96] !== isOtherFocused) {
        t22 = isOtherFocused && editorName && react_1.default.createElement(react_1.default.Fragment, null,
            " \u00B7 ctrl+g to edit in ",
            editorName);
        $[96] = isOtherFocused;
        $[97] = t22;
    ...
    let t23;
    if ($[98] !== t21 || $[99] !== t22) {
        t23 = react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
    ...
    if ($[101] !== minContentHeight || $[102] !== t12 || $[103] !== t20 || $[104] !== t23) {
        t24 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", minHeight: minContentHeight },
            t12,
            t20,
            t23);
    ...
    if ($[106] !== t10 || $[107] !== t11 || $[108] !== t24) {
        t25 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingTop: 0 },
            t10,
            t11,
            t24);
        $[106] = t10;
    ...
    if ($[110] !== handleKeyDown || $[111] !== t25 || $[112] !== t8) {
        t26 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 0, tabIndex: 0, autoFocus: true, onKeyDown: handleKeyDown },
            t8,
            t9,
            t25);
        $[110] = handleKeyDown;
