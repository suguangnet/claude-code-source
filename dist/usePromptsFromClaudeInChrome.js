...
const ClaudeInChromePromptNotificationSchema = (0, lazySchema_js_1.lazySchema)(() => v4_1.z.object({
...
function findChromeClient(clients) {
    return clients.find((client) => client.type === 'connected' && client.name === common_js_1.CLAUDE_IN_CHROME_MCP_SERVER_NAME);
}
