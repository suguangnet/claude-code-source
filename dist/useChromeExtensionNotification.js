...
async function _temp() {
    ...
    if (true && !(0, auth_js_1.isClaudeAISubscriber)()) {
        return {
            ...
            jsx: React.createElement(ink_js_1.Text, { color: "error" }, "Claude in Chrome requires a claude.ai subscription"),
            priority: "immediate",
            timeoutMs: 5000
        };
    }
    const installed = await (0, setup_js_1.isChromeExtensionInstalled)();
    if (!installed && !(0, envUtils_js_1.isRunningOnHomespace)()) {
        return {
            key: "chrome-extension-not-detected",
            jsx: React.createElement(ink_js_1.Text, { color: "warning" }, "Chrome extension not detected \u00B7 https://claude.ai/chrome to install"),
            priority: "immediate",
            timeoutMs: 3000
        };
    }
