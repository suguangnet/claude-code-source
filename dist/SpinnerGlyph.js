...
const DEFAULT_CHARACTERS = (0, utils_js_1.getDefaultCharacters)();
...
function SpinnerGlyph(t0) {
    ...
    if (reducedMotion) {
        ...
        if ($[0] !== isDim || $[1] !== messageColor) {
            t4 = React.createElement(ink_js_1.Box, { flexWrap: "wrap", height: 1, width: 2 },
                React.createElement(ink_js_1.Text, { color: messageColor, dimColor: isDim }, REDUCED_MOTION_DOT));
            $[0] = isDim;
            $[1] = messageColor;
            $[2] = t4;
        }
    ...
    if (stalledIntensity > 0) {
        ...
        if (baseRGB) {
            ...
            return React.createElement(ink_js_1.Box, { flexWrap: "wrap", height: 1, width: 2 },
                React.createElement(ink_js_1.Text, { color: (0, utils_js_1.toRGBColor)(interpolated) }, spinnerChar));
        }
        const color = stalledIntensity > 0.5 ? "error" : messageColor;
        let t4;
        if ($[3] !== color || $[4] !== spinnerChar) {
            t4 = React.createElement(ink_js_1.Box, { flexWrap: "wrap", height: 1, width: 2 },
                React.createElement(ink_js_1.Text, { color: color }, spinnerChar));
            $[3] = color;
            $[4] = spinnerChar;
            $[5] = t4;
        }
    ...
    if ($[6] !== messageColor || $[7] !== spinnerChar) {
        t4 = React.createElement(ink_js_1.Box, { flexWrap: "wrap", height: 1, width: 2 },
            React.createElement(ink_js_1.Text, { color: messageColor }, spinnerChar));
        $[6] = messageColor;
        $[7] = spinnerChar;
        $[8] = t4;
    }
