...
function UserLocalCommandOutputMessage(t0) {
    ...
    if ($[0] !== content) {
        ...
        bb0: {
            const stdout = (0, messages_js_2.extractTag)(content, "local-command-stdout");
            const stderr = (0, messages_js_2.extractTag)(content, "local-command-stderr");
            if (!stdout && !stderr) {
                let t2;
                if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
                    t2 = React.createElement(MessageResponse_js_1.MessageResponse, null,
                        React.createElement(ink_js_1.Text, { dimColor: true }, messages_js_1.NO_CONTENT_MESSAGE));
                    $[3] = t2;
                }
                else {
                    t2 = $[3];
...
function IndentedContent(t0) {
    ...
    const { children } = t0;
    if (children.startsWith(`${figures_js_1.DIAMOND_OPEN} `) || children.startsWith(`${figures_js_1.DIAMOND_FILLED} `)) {
        let t1;
        if ($[0] !== children) {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = React.createElement(ink_js_1.Text, { dimColor: true }, "  \u23BF  ");
        $[2] = t1;
    }
    else {
        t1 = $[2];
    ...
    let t2;
    if ($[3] !== children) {
        t2 = React.createElement(ink_js_1.Box, { flexDirection: "row" },
            t1,
            React.createElement(ink_js_1.Box, { flexDirection: "column", flexGrow: 1 },
                React.createElement(Markdown_js_1.Markdown, null, children)));
        $[3] = children;
        $[4] = t2;
    }
    else {
...
function CloudLaunchContent(t0) {
    ...
    let t2;
    if ($[4] !== diamond) {
        t2 = React.createElement(ink_js_1.Text, { color: "background" },
            diamond,
            " ");
        $[4] = diamond;
        $[5] = t2;
    ...
    let t3;
    if ($[6] !== label) {
        t3 = React.createElement(ink_js_1.Text, { bold: true }, label);
        $[6] = label;
        $[7] = t3;
    }
    else {
    ...
    let t4;
    if ($[8] !== suffix) {
        t4 = suffix && React.createElement(ink_js_1.Text, { dimColor: true }, suffix);
        $[8] = suffix;
        $[9] = t4;
    }
    else {
    ...
    let t6;
    if ($[14] !== rest) {
        t6 = rest && React.createElement(ink_js_1.Box, { flexDirection: "row" },
            React.createElement(ink_js_1.Text, { dimColor: true }, "  \u23BF  "),
            React.createElement(ink_js_1.Text, { dimColor: true }, rest));
        $[14] = rest;
        $[15] = t6;
    }
    else {
