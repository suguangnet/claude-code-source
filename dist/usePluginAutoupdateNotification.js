...
function usePluginAutoupdateNotification() {
    ...
    const [updatedPlugins, setUpdatedPlugins] = (0, react_1.useState)(t0);
    let t1;
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = () => {
            ...
            const unsubscribe = (0, pluginAutoupdate_js_1.onPluginsAutoUpdated)(plugins => {
                (0, debug_js_1.logForDebugging)(`Plugin autoupdate notification: ${plugins.length} plugin(s) updated`);
            ...
            addNotification({
                ...
                jsx: React.createElement(React.Fragment, null,
                    React.createElement(ink_js_1.Text, { color: "success" },
                        ...
                        " ",
                        displayNames),
                    React.createElement(ink_js_1.Text, { dimColor: true }, " \u00B7 Run /reload-plugins to apply")),
                priority: "low",
                timeoutMs: 10000
            });
            (0, debug_js_1.logForDebugging)(`Showing plugin autoupdate notification for: ${pluginNames.join(", ")}`);
        };
