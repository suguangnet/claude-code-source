...
const index_js_1 = require("../CustomSelect/index.js");
...
function MCPStdioServerMenu({ server, serverToolsCount, onViewTools, onCancel, onComplete, borderless = false }) {
    ...
    const handleToggleEnabled = react_1.default.useCallback(async () => {
        ...
        try {
            ...
            onComplete(`Failed to ${action} MCP server '${server.name}': ${(0, errors_js_1.errorMessage)(err)}`);
        }
    ...
    if (isReconnecting) {
        return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1, padding: 1 },
            ...
            react_1.default.createElement(ink_js_1.Box, null,
                ...
                react_1.default.createElement(ink_js_1.Text, null, " Restarting MCP server process")),
    ...
    return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
        react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 1, borderStyle: borderless ? undefined : 'round' },
            ...
            react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 0 },
                react_1.default.createElement(ink_js_1.Box, null,
                    ...
                    server.client.type === 'disabled' ? react_1.default.createElement(ink_js_1.Text, null,
                        ...
                        react_1.default.createElement(ink_js_1.Text, null, " connecting\u2026")) : react_1.default.createElement(ink_js_1.Text, null,
                        (0, ink_js_1.color)('error', theme)(figures_1.default.cross),
                        " failed")),
                react_1.default.createElement(ink_js_1.Box, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Command: "),
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true }, server.config.command)),
                server.config.args && server.config.args.length > 0 && react_1.default.createElement(ink_js_1.Box, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Args: "),
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true }, server.config.args.join(' '))),
                react_1.default.createElement(ink_js_1.Box, null,
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "Config location: "),
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true }, (0, utils_js_1.describeMcpConfigFilePath)((0, config_js_1.getMcpConfigByName)(server.name)?.scope ?? 'dynamic'))),
            ...
            menuOptions.length > 0 && react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                react_1.default.createElement(index_js_1.Select, { options: menuOptions, onChange: async (value) => {
                        if (value === 'tools') {
                            onViewTools();
                        }
                            ...
                            try {
                                ...
                                const { message } = (0, reconnectHelpers_js_1.handleReconnectResult)(result, server.name);
                                onComplete?.(message);
                            }
                            catch (err_0) {
                                onComplete?.((0, reconnectHelpers_js_1.handleReconnectError)(err_0, server.name));
                            }
                            finally {
