...
function inputToPermissionRuleContent(input) {
    try {
        const parsedInput = WebFetchTool_js_1.WebFetchTool.inputSchema.safeParse(input);
...
function WebFetchPermissionRequest(t0) {
    ...
    if ($[5] !== hostname) {
        ...
        if (showAlwaysAllowOptions) {
            const t5 = react_1.default.createElement(ink_js_1.Text, { bold: true }, hostname);
            let t6;
            if ($[7] !== t5) {
                t6 = {
        ...
        if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = {
                label: react_1.default.createElement(ink_js_1.Text, null,
                    ...
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "(esc)")),
                value: "no"
            };
            $[9] = t5;
        }
    ...
    let t7;
    if ($[18] !== t6) {
        t7 = react_1.default.createElement(ink_js_1.Text, null, t6);
        $[18] = t6;
        $[19] = t7;
    }
    else {
    ...
    if ($[20] !== toolUseConfirm.description) {
        t8 = react_1.default.createElement(ink_js_1.Text, { dimColor: true }, toolUseConfirm.description);
    ...
    let t9;
    if ($[22] !== t7 || $[23] !== t8) {
        t9 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingX: 2, paddingY: 1 },
            t7,
            t8);
        $[22] = t7;
        $[23] = t8;
    ...
    if ($[25] !== toolUseConfirm.permissionResult) {
        t10 = react_1.default.createElement(PermissionRuleExplanation_js_1.PermissionRuleExplanation, { permissionResult: toolUseConfirm.permissionResult, toolType: "tool" });
    ...
    if ($[27] === Symbol.for("react.memo_cache_sentinel")) {
        t11 = react_1.default.createElement(ink_js_1.Text, null, "Do you want to allow Claude to fetch this content?");
        $[27] = t11;
    }
    else {
        t11 = $[27];
    ...
    if ($[30] !== onChange || $[31] !== options || $[32] !== t12) {
        t13 = react_1.default.createElement(select_js_1.Select, { options: options, onChange: onChange, onCancel: t12 });
        $[30] = onChange;
        $[31] = options;
        $[32] = t12;
        $[33] = t13;
    ...
    let t14;
    if ($[34] !== t10 || $[35] !== t13) {
        t14 = react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
            t10,
            t11,
            t13);
        $[34] = t10;
    ...
    if ($[37] !== t14 || $[38] !== t9 || $[39] !== workerBadge) {
        t15 = react_1.default.createElement(PermissionDialog_js_1.PermissionDialog, { title: "Fetch", workerBadge: workerBadge },
            t9,
            t14);
        $[37] = t14;
        $[38] = t9;
