...
const index_js_1 = require("../../components/CustomSelect/index.js");
...
const it2Setup_js_1 = require("./backends/it2Setup.js");
function It2SetupPrompt(t0) {
    const $ = (0, compiler_runtime_1.c)(44);
    const { onDone, tmuxAvailable } = t0;
    const [step, setStep] = (0, react_1.useState)("initial");
    const [packageManager, setPackageManager] = (0, react_1.useState)(null);
    ...
    if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = () => {
            (0, it2Setup_js_1.detectPythonPackageManager)().then(pm => {
    ...
    if ($[6] !== onDone || $[7] !== step) {
        t6 = (_input, key) => {
            if (step === "api-instructions" && key.return) {
                setStep("verifying");
                (0, it2Setup_js_1.verifyIt2Setup)().then(result => {
                    if (result.success) {
    ...
    if ($[9] !== packageManager) {
        t7 = async function handleInstall() {
            ...
            setStep("installing");
            const result_0 = await (0, it2Setup_js_1.installIt2)(packageManager);
            if (result_0.success) {
    ...
    if ($[13] !== error || $[14] !== handleInstall || $[15] !== handleUseTmux || $[16] !== onDone || $[17] !== packageManager || $[18] !== step || $[19] !== tmuxAvailable) {
        ...
        function renderInitialPrompt() {
            ...
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, null,
                    ...
                    " ",
                    react_1.default.createElement(ink_js_1.Text, { bold: true }, "it2"),
                    " CLI tool."),
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "This enables teammates to appear as split panes within your current window."),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(index_js_1.Select, { options: options, onChange: value => {
                            bb61: switch (value) {
                                case "install":
                                    {
                                        handleInstall();
            ...
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Box, null,
                    ...
                    react_1.default.createElement(ink_js_1.Text, null,
                        ...
                        packageManager,
                        "\u2026")),
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "This may take a moment."));
        }
        function renderInstallFailed() {
            ...
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                ...
                error && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, error),
                ...
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(index_js_1.Select, { options: options_0, onChange: value_0 => {
                            bb89: switch (value_0) {
                                case "retry":
                                    {
                                        handleInstall();
        ...
        function renderApiInstructions() {
            const instructions = (0, it2Setup_js_1.getPythonApiInstructions)();
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, { color: "success" }, "\u2713 it2 installed successfully"),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", marginTop: 1 }, instructions.map(_temp)),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Press Enter when ready to verify\u2026")));
        }
        function renderVerifying() {
            return react_1.default.createElement(ink_js_1.Box, null,
                react_1.default.createElement(Spinner_js_1.Spinner, null),
                react_1.default.createElement(ink_js_1.Text, null, " Verifying it2 can communicate with iTerm2\u2026"));
        }
        function renderSuccess() {
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column" },
                react_1.default.createElement(ink_js_1.Text, { color: "success" }, "\u2713 iTerm2 split pane support is ready"),
                react_1.default.createElement(ink_js_1.Text, { dimColor: true }, "Teammates will now appear as split panes."));
        }
        function renderFailed() {
            ...
            return react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
                react_1.default.createElement(ink_js_1.Text, { color: "error" }, "Verification failed"),
                error && react_1.default.createElement(ink_js_1.Text, { dimColor: true }, error),
                react_1.default.createElement(ink_js_1.Text, null, "Make sure:"),
                react_1.default.createElement(ink_js_1.Box, { flexDirection: "column", paddingLeft: 2 },
                    react_1.default.createElement(ink_js_1.Text, null, "\u00B7 Python API is enabled in iTerm2 preferences"),
                    react_1.default.createElement(ink_js_1.Text, null, "\u00B7 You may need to restart iTerm2 after enabling")),
                react_1.default.createElement(ink_js_1.Box, { marginTop: 1 },
                    react_1.default.createElement(index_js_1.Select, { options: options_1, onChange: value_1 => {
                            bb115: switch (value_1) {
                                case "retry":
                                    {
                                        setStep("verifying");
                                        (0, it2Setup_js_1.verifyIt2Setup)().then(result_1 => {
                                            if (result_1.success) {
                                                (0, it2Setup_js_1.markIt2SetupComplete)();
                                                setStep("success");
                                                setTimeout(onDone, 1500, "installed");
        ...
        if ($[28] === Symbol.for("react.memo_cache_sentinel")) {
            t12 = react_1.default.createElement(ink_js_1.Text, { bold: true, color: "permission" }, "iTerm2 Split Pane Setup");
            $[28] = t12;
        }
        else {
            t12 = $[28];
    ...
    if ($[29] !== exitState || $[30] !== step) {
        t15 = step !== "installing" && step !== "verifying" && step !== "success" && react_1.default.createElement(ink_js_1.Text, { dimColor: true, italic: true }, exitState.pending ? react_1.default.createElement(react_1.default.Fragment, null,
            "Press ",
            exitState.keyName,
            " again to exit") : react_1.default.createElement(react_1.default.Fragment, null, "Esc to cancel"));
        $[29] = exitState;
        $[30] = step;
        $[31] = t15;
    }
    ...
    if ($[32] !== T0 || $[33] !== t10 || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 || $[37] !== t15 || $[38] !== t9) {
        t16 = react_1.default.createElement(T0, { flexDirection: t9, gap: t10, paddingBottom: t11 },
            t12,
            t13,
            t15);
        $[32] = T0;
    ...
    if ($[40] !== T1 || $[41] !== t14 || $[42] !== t16) {
        t17 = react_1.default.createElement(T1, { color: t14 }, t16);
        $[40] = T1;
        $[41] = t14;
        $[42] = t16;
        $[43] = t17;
...
function _temp(line, i) {
    return react_1.default.createElement(ink_js_1.Text, { key: i }, line);
}
