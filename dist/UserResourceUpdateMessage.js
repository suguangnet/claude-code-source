...
function _temp(update, i) {
    return React.createElement(ink_js_1.Box, { key: i },
        React.createElement(ink_js_1.Text, null,
            React.createElement(ink_js_1.Text, { color: "success" }, figures_js_1.REFRESH_ARROW),
            " ",
            React.createElement(ink_js_1.Text, { dimColor: true },
                update.server,
                ":"),
            " ",
            React.createElement(ink_js_1.Text, { color: "suggestion" }, update.kind === "resource" ? formatUri(update.target) : update.target),
            update.reason && React.createElement(ink_js_1.Text, { dimColor: true },
                " \u00B7 ",
                update.reason)));
}
