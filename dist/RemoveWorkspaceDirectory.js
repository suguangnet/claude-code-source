...
function RemoveWorkspaceDirectory(t0) {
    ...
    if ($[0] !== directoryPath || $[1] !== onRemove || $[2] !== permissionContext || $[3] !== setPermissionContext) {
        t1 = () => {
            const updatedContext = (0, PermissionUpdate_js_1.applyPermissionUpdate)(permissionContext, {
    ...
    let t3;
    if ($[8] !== directoryPath) {
        t3 = React.createElement(ink_js_1.Box, { marginX: 2, flexDirection: "column" },
            React.createElement(ink_js_1.Text, { bold: true }, directoryPath));
        $[8] = directoryPath;
        $[9] = t3;
    }
    else {
    ...
    if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = React.createElement(ink_js_1.Text, null, "Claude Code will no longer have access to files in this directory.");
        $[10] = t4;
    }
    else {
        t4 = $[10];
    ...
    if ($[12] !== handleSelect || $[13] !== onCancel) {
        t6 = React.createElement(select_js_1.Select, { onChange: handleSelect, onCancel: onCancel, options: t5 });
        $[12] = handleSelect;
        $[13] = onCancel;
        $[14] = t6;
    }
    ...
    if ($[15] !== onCancel || $[16] !== t3 || $[17] !== t6) {
        t7 = React.createElement(Dialog_js_1.Dialog, { title: "Remove directory from workspace?", onCancel: onCancel, color: "error" },
            t3,
            t4,
            t6);
        $[15] = onCancel;
