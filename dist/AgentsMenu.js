...
const useMergedTools_js_1 = require("../../hooks/useMergedTools.js");
...
const AgentDetail_js_1 = require("./AgentDetail.js");
const AgentEditor_js_1 = require("./AgentEditor.js");
const AgentNavigationFooter_js_1 = require("./AgentNavigationFooter.js");
const AgentsList_js_1 = require("./AgentsList.js");
const agentFileUtils_js_1 = require("./agentFileUtils.js");
const CreateAgentWizard_js_1 = require("./new-agent-creation/CreateAgentWizard.js");
function AgentsMenu(t0) {
    const $ = (0, compiler_runtime_1.c)(157);
    ...
    const [modeState, setModeState] = (0, react_1.useState)(t1);
    const agentDefinitions = (0, AppState_js_1.useAppState)(_temp);
    const mcpTools = (0, AppState_js_1.useAppState)(_temp2);
    const toolPermissionContext = (0, AppState_js_1.useAppState)(_temp3);
    ...
    const mergedTools = (0, useMergedTools_js_1.useMergedTools)(tools, mcpTools, toolPermissionContext);
    ...
    if ($[26] !== setAppState) {
        t12 = async (agent) => {
            ;
            try {
                await (0, agentFileUtils_js_1.deleteAgentFromFile)(agent);
                setAppState(state => {
                    ...
                    return {
                        ...
                        agentDefinitions: {
                            ...
                            activeAgents: (0, loadAgentsDir_js_1.getActiveAgentsFromList)(allAgents_0)
                        }
                    };
                });
                setChanges(prev_0 => [...prev_0, `Deleted agent: ${chalk_1.default.bold(agent.agentType)}`]);
                setModeState({
                    mode: "list-agents",
                    source: "all"
                });
        ...
        case "list-agents":
            {
                ...
                if ($[40] !== changes || $[41] !== modeState.source || $[42] !== resolvedAgents || $[43] !== t15 || $[44] !== t16) {
                    t18 = React.createElement(AgentsList_js_1.AgentsList, { source: modeState.source, agents: resolvedAgents, onBack: t15, onSelect: t16, onCreateNew: t17, changes: changes });
                    $[40] = changes;
                    $[41] = modeState.source;
                    $[42] = resolvedAgents;
                    $[43] = t15;
                ...
                if ($[46] === Symbol.for("react.memo_cache_sentinel")) {
                    t19 = React.createElement(AgentNavigationFooter_js_1.AgentNavigationFooter, null);
                    $[46] = t19;
                }
                else {
                    t19 = $[46];
        ...
        case "create-agent":
            {
                ...
                if ($[50] !== agents || $[51] !== mergedTools) {
                    t14 = React.createElement(CreateAgentWizard_js_1.CreateAgentWizard, { tools: mergedTools, existingAgents: agents, onComplete: handleAgentCreated, onCancel: t13 });
                    $[50] = agents;
                    $[51] = mergedTools;
                    $[52] = t14;
                }
        ...
        case "agent-menu":
            {
                ...
                if ($[73] !== handleMenuSelect || $[74] !== menuItems || $[75] !== t20) {
                    t21 = React.createElement(select_js_1.Select, { options: menuItems, onChange: handleMenuSelect, onCancel: t20 });
                    $[73] = handleMenuSelect;
                    $[74] = menuItems;
                    $[75] = t20;
                    $[76] = t21;
                ...
                let t22;
                if ($[77] !== changes) {
                    t22 = changes.length > 0 && React.createElement(ink_js_1.Box, { marginTop: 1 },
                ...
                let t23;
                if ($[79] !== t21 || $[80] !== t22) {
                    t23 = React.createElement(ink_js_1.Box, { flexDirection: "column" },
                        t21,
                        t22);
                    $[79] = t21;
                    $[80] = t22;
                ...
                if ($[82] !== modeState.agent.agentType || $[83] !== t19 || $[84] !== t23) {
                    t24 = React.createElement(Dialog_js_1.Dialog, { title: modeState.agent.agentType, onCancel: t19, hideInputGuide: true }, t23);
                ...
                if ($[86] === Symbol.for("react.memo_cache_sentinel")) {
                    t25 = React.createElement(AgentNavigationFooter_js_1.AgentNavigationFooter, null);
                    $[86] = t25;
                }
                else {
                    t25 = $[86];
        ...
        case "view-agent":
            {
                ...
                if ($[100] !== agentToDisplay || $[101] !== allAgents || $[102] !== mergedTools || $[103] !== t15) {
                    t16 = React.createElement(AgentDetail_js_1.AgentDetail, { agent: agentToDisplay, tools: mergedTools, allAgents: allAgents, onBack: t15 });
                    $[100] = agentToDisplay;
                    $[101] = allAgents;
                    $[102] = mergedTools;
                    $[103] = t15;
                ...
                if ($[105] !== agentToDisplay.agentType || $[106] !== t14 || $[107] !== t16) {
                    t17 = React.createElement(Dialog_js_1.Dialog, { title: agentToDisplay.agentType, onCancel: t14, hideInputGuide: true }, t16);
                ...
                if ($[109] === Symbol.for("react.memo_cache_sentinel")) {
                    t18 = React.createElement(AgentNavigationFooter_js_1.AgentNavigationFooter, { instructions: "Press Enter or Esc to go back" });
                    $[109] = t18;
                }
                else {
                    t18 = $[109];
        ...
        case "delete-confirm":
            {
                ...
                if ($[115] !== modeState.agent.agentType) {
                    t15 = React.createElement(ink_js_1.Text, null,
                        "Are you sure you want to delete the agent",
                        " ",
                        React.createElement(ink_js_1.Text, { bold: true }, modeState.agent.agentType),
                        "?");
                ...
                if ($[117] !== modeState.agent.source) {
                    t16 = React.createElement(ink_js_1.Box, { marginTop: 1 },
                ...
                let t19;
                if ($[124] !== t17 || $[125] !== t18) {
                    t19 = React.createElement(ink_js_1.Box, { marginTop: 1 },
                        React.createElement(select_js_1.Select, { options: deleteOptions, onChange: t17, onCancel: t18 }));
                    $[124] = t17;
                    $[125] = t18;
                    $[126] = t19;
                }
                ...
                if ($[127] !== t14 || $[128] !== t15 || $[129] !== t16 || $[130] !== t19) {
                    t20 = React.createElement(Dialog_js_1.Dialog, { title: "Delete agent", onCancel: t14, color: "error" },
                        t15,
                        t16,
                        t19);
                    $[127] = t14;
                ...
                if ($[132] === Symbol.for("react.memo_cache_sentinel")) {
                    t21 = React.createElement(AgentNavigationFooter_js_1.AgentNavigationFooter, { instructions: "Press \u2191\u2193 to navigate, Enter to select, Esc to cancel" });
                    $[132] = t21;
                }
                else {
                    t21 = $[132];
        ...
        case "edit-agent":
            {
                ...
                if ($[145] !== agentToEdit || $[146] !== mergedTools || $[147] !== t16 || $[148] !== t17) {
                    t18 = React.createElement(AgentEditor_js_1.AgentEditor, { agent: agentToEdit, tools: mergedTools, onSaved: t16, onBack: t17 });
                    $[145] = agentToEdit;
                    $[146] = mergedTools;
                    $[147] = t16;
                    $[148] = t17;
                ...
                if ($[150] !== t14 || $[151] !== t15 || $[152] !== t18) {
                    t19 = React.createElement(Dialog_js_1.Dialog, { title: t14, onCancel: t15, hideInputGuide: true }, t18);
                    $[150] = t14;
                    $[151] = t15;
                    $[152] = t18;
                    $[153] = t19;
                ...
                if ($[154] === Symbol.for("react.memo_cache_sentinel")) {
                    t20 = React.createElement(AgentNavigationFooter_js_1.AgentNavigationFooter, null);
                    $[154] = t20;
                }
                else {
                    t20 = $[154];
