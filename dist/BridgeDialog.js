...
function BridgeDialog(t0) {
    ...
    const connected = (0, AppState_js_1.useAppState)(_temp);
    const sessionActive = (0, AppState_js_1.useAppState)(_temp2);
    const reconnecting = (0, AppState_js_1.useAppState)(_temp3);
    const connectUrl = (0, AppState_js_1.useAppState)(_temp4);
    const sessionUrl = (0, AppState_js_1.useAppState)(_temp5);
    const error = (0, AppState_js_1.useAppState)(_temp6);
    const explicit = (0, AppState_js_1.useAppState)(_temp7);
    const environmentId = (0, AppState_js_1.useAppState)(_temp8);
    const sessionId = (0, AppState_js_1.useAppState)(_temp9);
    const verbose = (0, AppState_js_1.useAppState)(_temp0);
    ...
    const indicator = error ? figures_js_1.BRIDGE_FAILED_INDICATOR : figures_js_1.BRIDGE_READY_INDICATOR;
    let T0;
    let T1;
    let footerText;
    let t11;
    ...
    if ($[20] !== branchName || $[21] !== displayUrl || $[22] !== environmentId || $[23] !== error || $[24] !== indicator || $[25] !== onDone || $[26] !== qrText || $[27] !== sessionActive || $[28] !== sessionId || $[29] !== showQR || $[30] !== statusColor || $[31] !== statusLabel || $[32] !== verbose) {
        ...
        if ($[45] !== displayUrl || $[46] !== error || $[47] !== sessionActive) {
            t18 = error ? bridgeStatusUtil_js_1.FAILED_FOOTER_TEXT : displayUrl ? sessionActive ? (0, bridgeStatusUtil_js_1.buildActiveFooterText)(displayUrl) : (0, bridgeStatusUtil_js_1.buildIdleFooterText)(displayUrl) : undefined;
            $[45] = displayUrl;
            $[46] = error;
            $[47] = sessionActive;
            $[48] = t18;
        ...
        if ($[49] !== indicator || $[50] !== statusColor || $[51] !== statusLabel) {
            t19 = React.createElement(ink_js_1.Text, { color: statusColor },
                indicator,
                " ",
                statusLabel);
            $[49] = indicator;
        ...
        let t20;
        if ($[53] !== contextSuffix) {
            t20 = React.createElement(ink_js_1.Text, { dimColor: true }, contextSuffix);
            $[53] = contextSuffix;
            $[54] = t20;
        }
        else {
        ...
        let t21;
        if ($[55] !== t19 || $[56] !== t20) {
            t21 = React.createElement(ink_js_1.Text, null,
                t19,
                t20);
            $[55] = t19;
            $[56] = t20;
        ...
        let t22;
        if ($[58] !== error) {
            t22 = error && React.createElement(ink_js_1.Text, { color: "error" }, error);
            $[58] = error;
            $[59] = t22;
        }
        else {
        ...
        if ($[60] !== environmentId || $[61] !== verbose) {
            t23 = verbose && environmentId && React.createElement(ink_js_1.Text, { dimColor: true },
                "Environment: ",
                environmentId);
            $[60] = environmentId;
            $[61] = verbose;
        ...
        if ($[63] !== sessionId || $[64] !== verbose) {
            t24 = verbose && sessionId && React.createElement(ink_js_1.Text, { dimColor: true },
                "Session: ",
                sessionId);
            $[63] = sessionId;
            $[64] = verbose;
        ...
        t14 = showQR && qrLines.length > 0 && React.createElement(ink_js_1.Box, { flexDirection: "column" }, qrLines.map(_temp14));
        $[20] = branchName;
        $[21] = displayUrl;
        $[22] = environmentId;
        $[23] = error;
    ...
    let t18;
    if ($[71] !== footerText) {
        t18 = footerText && React.createElement(ink_js_1.Text, { dimColor: true }, footerText);
        $[71] = footerText;
        $[72] = t18;
    }
    else {
    ...
    if ($[73] === Symbol.for("react.memo_cache_sentinel")) {
        t19 = React.createElement(ink_js_1.Text, { dimColor: true }, "d to disconnect \u00B7 space for QR code \u00B7 Enter/Esc to close");
        $[73] = t19;
    }
    else {
        t19 = $[73];
...
function _temp14(line, i) {
    return React.createElement(ink_js_1.Text, { key: i }, line);
}
function _temp13(l) {
    return l.length > 0;
}
