...
const SuggestionItemRow = (0, react_1.memo)(function SuggestionItemRow(t0) {
    const $ = (0, compiler_runtime_1.c)(36);
    const { item, maxColumnWidth, isSelected } = t0;
    const columns = (0, useTerminalSize_js_1.useTerminalSize)().columns;
    ...
    if (isUnified) {
        ...
        if (isFile) {
            ...
            if ($[2] !== item.description) {
                t2 = item.description ? Math.min(20, (0, stringWidth_js_1.stringWidth)(item.description)) : 0;
                $[2] = item.description;
                $[3] = t2;
            }
            else {
            ...
            if ($[4] !== item.displayText || $[5] !== maxPathLength) {
                t3 = (0, format_js_1.truncatePathMiddle)(item.displayText, maxPathLength);
                $[4] = item.displayText;
                $[5] = maxPathLength;
                $[6] = t3;
            }
            ...
            if (isMcpResource) {
                ...
                if ($[7] !== item.displayText) {
                    t2 = (0, format_js_1.truncateToWidth)(item.displayText, 30);
                    $[7] = item.displayText;
                    $[8] = t2;
                }
                else {
        ...
        const availableWidth = columns - 2 - (0, stringWidth_js_1.stringWidth)(displayText) - separatorWidth - 4;
        let lineContent;
        if (item.description) {
            const maxDescLength = Math.max(0, availableWidth);
            let t2;
            if ($[9] !== item.description || $[10] !== maxDescLength) {
                t2 = (0, format_js_1.truncateToWidth)(item.description.replace(/\s+/g, " "), maxDescLength);
                $[9] = item.description;
                $[10] = maxDescLength;
                $[11] = t2;
            }
        ...
        if ($[12] !== dimColor || $[13] !== lineContent || $[14] !== textColor) {
            t2 = React.createElement(ink_js_1.Text, { color: textColor, dimColor: dimColor, wrap: "truncate" }, lineContent);
            $[12] = dimColor;
            $[13] = lineContent;
            $[14] = textColor;
            $[15] = t2;
    ...
    const displayTextWidth = Math.min(maxColumnWidth ?? (0, stringWidth_js_1.stringWidth)(item.displayText) + 5, maxNameWidth);
    ...
    if ((0, stringWidth_js_1.stringWidth)(displayText_0) > displayTextWidth - 2) {
        ...
        if ($[16] !== displayText_0 || $[17] !== t1) {
            t2 = (0, format_js_1.truncateToWidth)(displayText_0, t1);
            $[16] = displayText_0;
            $[17] = t1;
            $[18] = t2;
        }
    ...
    const paddedDisplayText = displayText_0 + " ".repeat(Math.max(0, displayTextWidth - (0, stringWidth_js_1.stringWidth)(displayText_0)));
    const tagText = item.tag ? `[${item.tag}] ` : "";
    const tagWidth = (0, stringWidth_js_1.stringWidth)(tagText);
    ...
    if ($[22] !== paddedDisplayText || $[23] !== shouldDim || $[24] !== textColor_0) {
        t2 = React.createElement(ink_js_1.Text, { color: textColor_0, dimColor: shouldDim }, paddedDisplayText);
    ...
    let t3;
    if ($[26] !== tagText) {
        t3 = tagText ? React.createElement(ink_js_1.Text, { dimColor: true }, tagText) : null;
        $[26] = tagText;
        $[27] = t3;
    }
    else {
    ...
    if ($[28] !== t4 || $[29] !== t5 || $[30] !== truncatedDescription) {
        t6 = React.createElement(ink_js_1.Text, { color: t4, dimColor: t5 }, truncatedDescription);
        $[28] = t4;
        $[29] = t5;
    ...
    if ($[32] !== t2 || $[33] !== t3 || $[34] !== t6) {
        t7 = React.createElement(ink_js_1.Text, { wrap: "truncate" },
            t2,
            t3,
            t6);
        $[32] = t2;
...
function PromptInputFooterSuggestions(t0) {
    ...
    const maxVisibleItems = overlay ? exports.OVERLAY_MAX_ITEMS : Math.min(6, Math.max(1, rows - 3));
