...
function getSourceTitle(source) {
    ...
    return `${(0, capitalize_js_1.default)((0, constants_js_1.getSettingSourceName)(source))} skills`;
}
function getSourceSubtitle(source, skills) {
    ...
    const skillsPath = (0, file_js_1.getDisplayPath)((0, loadSkillsDir_js_1.getSkillsPath)(source, 'skills'));
    const hasCommandsSkills = skills.some(s => s.loadedFrom === 'commands_DEPRECATED');
    return hasCommandsSkills ? `${skillsPath}, ${(0, file_js_1.getDisplayPath)((0, loadSkillsDir_js_1.getSkillsPath)(source, 'commands'))}` : skillsPath;
}
function SkillsMenu(t0) {
    ...
    if (skills.length === 0) {
        ...
        if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
            t3 = React.createElement(ink_js_1.Text, { dimColor: true }, "Create skills in .claude/skills/ or ~/.claude/skills/");
            $[6] = t3;
        }
        else {
            t3 = $[6];
        ...
        if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
            t4 = React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
                React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "close" }));
            $[7] = t4;
        }
        else {
            t4 = $[7];
        ...
        let t5;
        if ($[8] !== handleCancel) {
            t5 = React.createElement(Dialog_js_1.Dialog, { title: "Skills", subtitle: "No skills found", onCancel: handleCancel, hideInputGuide: true },
                t3,
                t4);
            $[8] = handleCancel;
            $[9] = t5;
    ...
    if ($[10] !== skillsBySource) {
        t3 = source_0 => {
            ...
            return React.createElement(ink_js_1.Box, { flexDirection: "column", key: source_0 },
                React.createElement(ink_js_1.Box, null,
                    React.createElement(ink_js_1.Text, { bold: true, dimColor: true }, title),
                    subtitle && React.createElement(ink_js_1.Text, { dimColor: true },
                        " (",
                        subtitle,
                        ")")),
    ...
    if ($[24] !== t10 || $[25] !== t11 || $[26] !== t7 || $[27] !== t8 || $[28] !== t9) {
        t12 = React.createElement(ink_js_1.Box, { flexDirection: "column", gap: 1 },
            t7,
            t8,
            t9,
            t10,
    ...
    if ($[30] === Symbol.for("react.memo_cache_sentinel")) {
        t13 = React.createElement(ink_js_1.Text, { dimColor: true, italic: true },
            React.createElement(ConfigurableShortcutHint_js_1.ConfigurableShortcutHint, { action: "confirm:no", context: "Confirmation", fallback: "Esc", description: "close" }));
        $[30] = t13;
    }
    else {
    ...
    if ($[31] !== handleCancel || $[32] !== t12 || $[33] !== t6) {
        t14 = React.createElement(Dialog_js_1.Dialog, { title: "Skills", subtitle: t6, onCancel: handleCancel, hideInputGuide: true },
            t12,
            t13);
        $[31] = handleCancel;
        $[32] = t12;
...
function _temp3(skill_0) {
    const estimatedTokens = (0, loadSkillsDir_js_1.estimateSkillFrontmatterTokens)(skill_0);
    const tokenDisplay = `~${(0, format_js_1.formatTokens)(estimatedTokens)}`;
    const pluginName = skill_0.source === "plugin" ? skill_0.pluginInfo?.pluginManifest.name : undefined;
    return React.createElement(ink_js_1.Box, { key: `${skill_0.name}-${skill_0.source}` },
        React.createElement(ink_js_1.Text, null, (0, commands_js_1.getCommandName)(skill_0)),
