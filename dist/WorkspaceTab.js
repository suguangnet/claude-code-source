...
function WorkspaceTab(t0) {
    ...
    if ($[12] !== additionalDirectories) {
        ...
        if ($[14] === Symbol.for("react.memo_cache_sentinel")) {
            t6 = {
                label: `Add directory${figures_1.default.ellipsis}`,
                value: "add-directory"
            };
            $[14] = t6;
        }
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
        t6 = React.createElement(ink_js_1.Box, { flexDirection: "row", marginTop: 1, marginLeft: 2, gap: 1 },
            React.createElement(ink_js_1.Text, null, `-  ${(0, state_js_1.getOriginalCwd)()}`),
            React.createElement(ink_js_1.Text, { dimColor: true }, "(Original working directory)"));
        $[15] = t6;
    }
    else {
        t6 = $[15];
    ...
    if ($[16] !== focusHeader || $[17] !== handleCancel || $[18] !== handleDirectorySelect || $[19] !== headerFocused || $[20] !== options || $[21] !== t7) {
        t8 = React.createElement(ink_js_1.Box, { flexDirection: "column", marginBottom: 1 },
            t6,
            React.createElement(select_js_1.Select, { options: options, onChange: handleDirectorySelect, onCancel: handleCancel, visibleOptionCount: t7, onUpFromFirstItem: focusHeader, isDisabled: headerFocused }));
        $[16] = focusHeader;
        $[17] = handleCancel;
