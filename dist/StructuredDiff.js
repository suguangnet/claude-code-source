...
const Fallback_js_1 = require("./StructuredDiff/Fallback.js");
...
function renderColorDiff(patch, firstLine, filePath, fileContent, theme, width, dim, splitGutter) {
    const ColorDiff = (0, colorDiff_js_1.expectColorDiff)();
    if (!ColorDiff)
        return null;
    ...
    let contents = null;
    if (gutterWidth > 0) {
        gutters = lines.map(l => (0, sliceAnsi_js_1.default)(l, 0, gutterWidth));
        contents = lines.map(l => (0, sliceAnsi_js_1.default)(l, gutterWidth));
    }
    const entry = {
        lines,
        gutterWidth,
...
exports.StructuredDiff = (0, react_1.memo)(function StructuredDiff(t0) {
    ...
    if ($[0] !== dim || $[1] !== fileContent || $[2] !== filePath || $[3] !== firstLine || $[4] !== patch || $[5] !== safeWidth || $[6] !== skipHighlighting || $[7] !== syntaxHighlightingDisabled || $[8] !== theme) {
        const splitGutter = (0, fullscreen_js_1.isFullscreenEnvEnabled)();
    ...
    if (!cached) {
        ...
        if ($[10] !== dim || $[11] !== patch || $[12] !== width) {
            t3 = React.createElement(ink_js_1.Box, null,
                React.createElement(Fallback_js_1.StructuredDiffFallback, { patch: patch, dim: dim, width: width }));
            $[10] = dim;
            $[11] = patch;
            $[12] = width;
            $[13] = t3;
    ...
    if (gutterWidth > 0 && gutters && contents) {
        ...
        if ($[14] !== gutterWidth || $[15] !== gutters) {
            t3 = React.createElement(ink_js_1.NoSelect, { fromLeftEdge: true },
                React.createElement(ink_js_1.RawAnsi, { lines: gutters, width: gutterWidth }));
            $[14] = gutterWidth;
            $[15] = gutters;
            $[16] = t3;
        }
        ...
        if ($[17] !== contents || $[18] !== t4) {
            t5 = React.createElement(ink_js_1.RawAnsi, { lines: contents, width: t4 });
            $[17] = contents;
            $[18] = t4;
            $[19] = t5;
        }
        ...
        let t6;
        if ($[20] !== t3 || $[21] !== t5) {
            t6 = React.createElement(ink_js_1.Box, { flexDirection: "row" },
                t3,
                t5);
            $[20] = t3;
            $[21] = t5;
    ...
    if ($[23] !== lines || $[24] !== safeWidth) {
        t3 = React.createElement(ink_js_1.Box, null,
            React.createElement(ink_js_1.RawAnsi, { lines: lines, width: safeWidth }));
        $[23] = lines;
        $[24] = safeWidth;
        $[25] = t3;
    }
